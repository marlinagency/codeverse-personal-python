...
<html lang="en-US">
<head>
<title>Python __init__() Method</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">__init__() Method</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_classes_basics.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The __init__() Method</h2>

<p>All classes have a built-in method called <code class='w3-codespan'>__init__()</code>, which is always executed when the class is being initiated.</p>

<p>The <code class='w3-codespan'>__init__()</code> method is used to assign values to object properties, or to perform operations that are necessary when the object is being created.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a class named Person, use the <code class='w3-codespan'>__init__()</code> method to assign values for name and age:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class3">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">__init__()</code> method is called automatically every time the class is being used to create a new object.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Why Use __init__()?</h2>

<p>Without the <code class='w3-codespan'>__init__()</code> method, you would need to set properties manually for each object:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a class without <code class='w3-codespan'>__init__()</code>:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; pass<br><br>p1 = Person()<br>p1.name = "Tobias"<br>p1.age = 25<br><br>print(p1.name)<br>print(p1.age)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_init_without">Try it Yourself &raquo;</a>
</div>

<p>Using <code class='w3-codespan'>__init__()</code> makes it easier to create objects with initial values:</p>

<div class="w3-example">
<h3>Example</h3>
<p>With <code class='w3-codespan'>__init__()</code>, you can set initial values when creating the object:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person("Linus", 28)<br><br>print(p1.name)<br>print(p1.age)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_init_with">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Default Values in __init__()</h2>

<p>You can also set default values for parameters in the <code class='w3-codespan'>__init__()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set a default value for the age parameter:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age=18):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person("Emil")<br>p2 = Person("Tobias", 25)<br><br>print(p1.name, p1.age)<br>print(p2.name, p2.age)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_init_default">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class='w3-codespan'>__init__()</code> method can have as many parameters as you need:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a Person class with multiple parameters:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age, city, country):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br>&nbsp;&nbsp;&nbsp; self.city = city<br>&nbsp;&nbsp;&nbsp; self.country = country<br><br>p1 = Person("Linus", 30, "Oslo", "Norway")<br><br>print(p1.name)<br>print(p1.age)<br>print(p1.city)<br>print(p1.country)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_init_multiple">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_class_init.js"></div>
<hr>
