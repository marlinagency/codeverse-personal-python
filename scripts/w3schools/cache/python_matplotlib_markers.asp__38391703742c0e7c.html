...
<html lang="en-US">
<head>
<title>Matplotlib Markers</title>
<meta charset="utf-8">
...
<h1>Matplotlib <span class="color_h1">Markers</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="matplotlib_plotting.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="matplotlib_line.asp">Next &#10095;</a>
</div>
<hr>

<h2>Markers</h2>
<p>You can use the keyword argument <code class="w3-codespan">marker</code> to 
emphasize each point with a specified marker:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Mark each point with a circle:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, marker = 'o')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_o.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Mark each point with a star:</p>
<div class="w3-code notranslate pythonHigh">
...
<br>
plt.plot(ypoints, marker = '*')<br>
...
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_star.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker2">Try it Yourself &raquo;</a>
</div>
...
<p>You can choose any of these markers:</p>
...
<td>'o'</td>
<td>Circle</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_o">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'*'</td>
<td>Star</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_star">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'.'</td>
<td>Point</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_point">Try it  &raquo;</a></td>
</tr>
<tr>
<td>','</td>
<td>Pixel</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_pixel">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'x'</td>
<td>X</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_x">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'X'</td>
<td>X (filled)</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_x_filled">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'+'</td>
<td>Plus</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_plus">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'P'</td>
<td>Plus (filled)</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_plus_filled">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'s'</td>
<td>Square</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_s">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'D'</td>
<td>Diamond</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_D">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'d'</td>
<td>Diamond (thin)</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_thin_d">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'p'</td>
<td>Pentagon</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_p">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'H'</td>
<td>Hexagon</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_H">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'h'</td>
<td>Hexagon</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_hexagon">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'v'</td>
<td>Triangle Down</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_v">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'^'</td>
<td>Triangle Up</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_triangle_up">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'&lt;'</td>
<td>Triangle Left</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_triangle_left">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'&gt;'</td>
<td>Triangle Right</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_triangle_right">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'1'</td>
<td>Tri Down</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_1">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'2'</td>
<td>Tri Up</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_2">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'3'</td>
<td>Tri Left</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_3">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'4'</td>
<td>Tri Right</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_4">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'|'</td>
<td>Vline</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_vline">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'_'</td>
<td>Hline</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_marker_hline">Try it  &raquo;</a></td>
</tr>
</tbody>
</table>
...
<h2>Format Strings <code class="w3-codespan">fmt</code></h2>
<p>You can also use the <em>shortcut string notation</em> parameter to specify the marker.</p>
<p>This parameter is also called <code class="w3-codespan">fmt</code>, and is written with this syntax:</p>

<code class="w3-codespan"><em>marker</em>|<em>line</em>|<em>color</em></code>
...
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, 'o:r')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_fmt1.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker3">Try it Yourself &raquo;</a>
</div>

<p>The marker value can be anything from the Marker Reference above.</p>

<p>The line value can be one of the following:</p>
...
<td>'-'</td>
<td>Solid line</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_line_solid">Try it  &raquo;</a></td>
</tr>
<tr>
<td>':'</td>
<td>Dotted line</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_line_dot">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'--'</td>
<td>Dashed line</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_line_dash">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'-.'</td>
<td>Dashed/dotted line</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_line_dashdot">Try it  &raquo;</a></td>
</tr>
</tbody>
</table>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> If you leave out the <em>line</em> value in the fmt parameter, no line will be plotted.</p>
</div>


<p>The short color value can be one of the following:</p>
...
<td>'r'</td>
<td>Red</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'g'</td>
<td>Green</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_g">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'b'</td>
<td>Blue</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_b">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'c'</td>
<td>Cyan</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_c">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'m'</td>
<td>Magenta</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_m">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'y'</td>
<td>Yellow</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_y">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'k'</td>
<td>Black</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_k">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'w'</td>
<td>White</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_fmt_w">Try it  &raquo;</a></td>
</tr>
</tbody>
</table>
...
<p>You can use the keyword argument <code class="w3-codespan">markersize</code> or the 
shorter version, <code class="w3-codespan">ms</code> to set the size of the markers:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the size of the markers to 20:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, marker = 'o', ms = 20)<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_o_20.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker_size">Try it Yourself &raquo;</a>
</div>
...
<p>You can use the keyword argument <code class="w3-codespan">markeredgecolor</code> or 
the shorter <code class="w3-codespan">mec</code> to set the color of the <em>
edge</em> of the markers:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the EDGE color to red:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, marker = 'o', ms = 20, mec = 'r')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_o_mec.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker_color1">Try it Yourself &raquo;</a>
</div>

<p>You can use the keyword argument <code class="w3-codespan">markerfacecolor</code> or 
the shorter <code class="w3-codespan">mfc</code> to set the color inside the edge of the markers:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the FACE color to red:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, marker = 'o', ms = 20, mfc = 'r')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_o_mfc.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker_color2">Try it Yourself &raquo;</a>
</div>

<p>Use <em>both </em>the <code class="w3-codespan">mec</code> and <code class="w3-codespan">mfc</code> arguments to color the entire marker:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the color of both the <em>edge</em> and the <em>face</em> to red:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, marker = 'o', ms = 20, mec = 'r', mfc = 'r')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_o_mec_mfc.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker_color3">Try it Yourself &raquo;</a>
</div>


<p>You can also use <a href="/colors/colors_hexadecimal.asp">Hexadecimal color values</a>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Mark each point with a beautiful green color:</p>
<div class="w3-code notranslate pythonHigh">
...
<br>
plt.plot(ypoints, marker = 'o', ms = 20, mec = '#4CAF50', mfc = '#4CAF50')<br>
...
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_o_hex.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker_color_green">Try it Yourself &raquo;</a>
</div>

<p>Or any of the <a href="/colors/colors_names.asp">140 supported color names</a>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Mark each point with the color named "hotpink":</p>
<div class="w3-code notranslate pythonHigh">
...
<br>
plt.plot(ypoints, marker = 'o', ms = 20, mec = 'hotpink', mfc = 'hotpink')<br>
...
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_marker_hotpink.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_marker_color_hotpink">Try it Yourself &raquo;</a>
</div>
