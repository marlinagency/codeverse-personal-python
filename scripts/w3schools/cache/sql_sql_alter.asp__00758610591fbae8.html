...
an existing table.</p>
<p>Common <code class="w3-codespan">ALTER TABLE</code> operations are:</p>
<ul>
  <li>Add column - Adds a new column to a table</li>
  <li>Drop column - Deletes a column in a table</li>
  <li>Rename column - Renames a column</li>
  <li>Modify column - Changes the data type, size, or constraints of a column</li>
  <li>Add constraint - Adds a new constraint</li>
  <li>Rename table - Renames a table</li>
</ul>
<hr>
...
<div class="w3-code notranslate sqlHigh">
ALTER TABLE <em>table_name</em><br>
RENAME COLUMN <em>old_name</em> to <em>new_name</em>;
</div></div>

<p>To rename a column in a table in SQL Server, use the following syntax:</p>
<h3>Syntax for SQL Server:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
EXEC sp_rename '<em>table_name.old_name</em>', '<em>new_name</em>', 'COLUMN';
</div></div>
<hr>

<h2>ALTER TABLE - MODIFY Datatype</h2>
<p>To modify the data type, size or constraints of a column in a table, use the following syntax:</p>
<h3>Syntax for SQL Server / MS Access:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE <em>table_name</em><br>
ALTER COLUMN <em>column_name new_datatype constraint</em>;
</div></div>

<h3>Syntax for MySQL / Oracle:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE <em>table_name</em><br>
MODIFY <em>column_name new_datatype constraint</em>;
</div></div>

<p>The following SQL modifies the size of the &quot;Email&quot; column 
to varchar(100), and we also add a <code class="w3-codespan"><a href="sql_notnull.asp">NOT NULL</a></code>  
constraint:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Customers<br>MODIFY Email varchar(100) NOT NULL;
</div>
</div>
<hr>

<h2>ALTER TABLE - ADD CONSTRAINT</h2>
<p>To add a constraint to an existing table, use the following syntax:</p>
<h3>Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE <em>table_name</em><br>
ADD CONSTRAINT <em>constraint_name constraint_definition</em>;
</div></div>

<p>The following SQL adds a constraint named "CHK_Age" that is a <code class="w3-codespan"><a href="sql_check.asp">CHECK</a></code> constraint 
that ensures that the &quot;Age&quot; column has a value of 18 and above:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Members<br>ADD CONSTRAINT CHK_Age CHECK (Age &gt;= 18);
</div>
</div>
<hr>

<h2>ALTER TABLE - Rename table</h2>
<p>To rename a table, use the following syntax:</p>
<h3>Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE <em>table_name</em><br>
RENAME TO <em>new_table_name</em>;
</div></div>

<p>The following SQL renames the &quot;Customers&quot; table to &quot;Clients&quot;:</p>
...
<p>Assume we have a &quot;Persons&quot; table, that looks like this:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_alter.js"></div>
<hr>
