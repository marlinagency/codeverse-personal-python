...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_max.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_sum.asp">Next &#10095;</a>
</div>
<hr>
<h2>The SQL COUNT() Function</h2>
<p>The <code class="w3-codespan">COUNT()</code> function returns the number of 
rows that matches a specified criterion.</p>
<h3>COUNT() Syntax</h3>
<div class="w3-example ws-light-grey">
<p><code class="sqlHigh">
  SELECT COUNT([DISTINCT] <em>column_name</em> | *)<br>
  FROM <em>table_name</em><br>
  WHERE <em>condition</em>;</code></p>
</div>
<p>The behavior of <code class="w3-codespan">COUNT()</code> depends on the argument used within the parentheses:</p>
<ul>
<li><code class="w3-codespan">COUNT(*)</code> - Counts the total number of rows in a table (including NULL values).</li>
<li><code class="w3-codespan">COUNT(columnname)</code> - Counts all non-null values in the column.</li>
<li><code class="w3-codespan">COUNT(DISTINCT columnname)</code> - Counts only the unique, non-null values in the column.</li>
</ul>
<hr>
<!--start-->
<h2>Using COUNT(*)</h2>
<p>The following SQL uses <code class="w3-codespan">COUNT(*)</code>, and counts the total number of rows in the "Products" table (will include NULL values):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(*)<br>FROM Products;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_count" class="w3-btn w3-margin-bottom">
...
<h2>Demo Database</h2>
<p>Below is a selection from the <a href="trysql.asp?filename=trysql_products" target="_blank"><strong>Products</strong></a> table used in the examples:</p>
...
<hr>
<!--start-->
<h2>Using COUNT(column_name)</h2>

<p>The <code class="w3-codespan">COUNT(column_name)</code> counts all non-null values in the specified column.</p>
<p>The following SQL counts all non-null values of the "ProductName" column:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(ProductName)<br>FROM Products;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_count3" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using COUNT(DISTINCT column_name)</h2>
<p>You can ignore duplicates by using the <code class="w3-codespan">DISTINCT</code> keyword.</p>
<p>The <code class="w3-codespan">COUNT(DISTINCT column_name)</code> counts only the unique, non-null values in the column.</p>
<p>If <code class="w3-codespan">DISTINCT</code> is specified, rows with the same value for the specified column will be counted as one.</p>
<p>The following SQL counts the unique, non-null values of the "Price" column:</p>
<div class="w3-example">
<h3>Example</h3>
<p>How many <em>different</em> prices are there in the &quot;Products&quot; table:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(DISTINCT Price)<br>FROM Products;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_count_distinct" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>You can add a <code class="w3-codespan">WHERE</code> clause to specify conditions:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Count the number of products where Price is higher than 20:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(ProductID)<br>FROM Products<br>WHERE Price &gt; 20;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_count2" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use an Alias</h2>
<p>When using <code class="w3-codespan">COUNT()</code>, the returned column will not have a name. Use the
<code class="w3-codespan">AS</code> keyword to give the column a descriptive name.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Name the &quot;count&quot; column "Number of records":</p>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(*) AS [Number of records]<br>FROM Products;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_count_as" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use COUNT() with GROUP BY</h2>
<p>Here we use the <code class="w3-codespan">COUNT()</code> function and the
<code class="w3-codespan">GROUP BY</code> clause, to return the number of 
records 
for EACH category in the &quot;Products&quot; table:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(*) AS [Number of records], CategoryID<br>FROM Products<br>GROUP 
  BY CategoryID;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_count_groupby" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<p>You will learn more about the
<code class="w3-codespan"><a href="sql_groupby.asp">GROUP BY</a></code> clause later in this tutorial.</p>

<hr>
<div id="exercisecontainer" src="xrcise_count.js"></div>
<hr>
