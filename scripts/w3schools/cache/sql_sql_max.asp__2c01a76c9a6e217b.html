...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="sql_count.asp">Next &#10095;</a>
</div>
<hr>

<h2>The SQL MAX() Function</h2>
<p>The <code class="w3-codespan">MAX()</code> function returns the largest value of the selected column.</p>
<p>The <code class="w3-codespan">MAX()</code> function works with numeric, string, and date data types.</p>
<div class="w3-example">
<h3>MAX Example</h3>
<p>Return the highest price in the Price column, in the &quot;Products&quot; table:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT MAX(Price)<br>FROM Products;</div>
...
<p>When you use <code class="w3-codespan">MAX()</code>, the returned column will not have a 
name.</p>
<p>Use the 
<code class="w3-codespan">AS</code> keyword, to give the column a descriptive 
name:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT MAX(Price) AS HighestPrice<br>
  FROM Products;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_max_as" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Use MAX() with Date Column</h2>
<p>The following SQL returns the latest BirthDate in the BirthDate column, in the <a href="trysql.asp?filename=trysql_employees" target="_blank"><strong>Employees</strong></a> table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT MAX(BirthDate) AS LatestBirthdate<br>
  FROM Employees;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_max_as2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>


<h2>Use MAX() with GROUP BY</h2>
<p>Here we use the <code class="w3-codespan">MAX()</code> function and the
<code class="w3-codespan">GROUP BY</code> clause, to return the highest price 
for each category in the Products table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT MAX(Price) AS HighestPrice, CategoryID<br>
  FROM Products<br>
  GROUP BY CategoryID;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_max_groupby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div id="exercisecontainer" src="xrcise_min_max.js"></div>
<hr>
