...
<html lang="en-US">
<head>
<title>Python Output Values / Print Text</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Output / Print</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_challenges_statements.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_output_numbers.asp">Next &#10095;</a>
</div>
<hr>

<h2>Print Text</h2>

<p>You have already learned that you can use the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function to display text or output values:</p>
...
<div class="w3-example">
  ...
  <p>
    <a target="_blank" class="w3-btn" href="trypython.asp?filename=demo_output">Try it Yourself &raquo;</a>
  </p>
</div>

<p>You can use the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function as many times as you want. Each call prints text on a new line by default:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
    print("Hello World!")<br>
    print("I am learning Python.")<br>
    print("It is awesome!")
  </div>
  <p>
    <a target="_blank" class="w3-btn" href="trypython.asp?filename=demo_output_many">Try it Yourself &raquo;</a>
  </p>
</div>
...
<h2>Double Quotes</h2>
<p>Text in Python must be inside quotes. You can use either <code class="w3-codespan">"</code> double quotes or <code class="w3-codespan">'</code> single quotes:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
    print("This will work!")<br>
    print('This will also work!')
  </div>
  <p>
    <a target="_blank" class="w3-btn" href="trypython.asp?filename=demo_output_quotes">Try it Yourself &raquo;</a>
  </p>
</div>

<p>If you forget to put the text inside quotes, Python will give an error:</p>
...
<div class="w3-example w3-pale-red">
  ...
  <p>
    <a target="_blank" class="w3-btn" href="trypython.asp?filename=demo_output_quotes_error">Try it Yourself &raquo;</a>
  </p>
</div>
...
<h2>Print Without a New Line</h2>

<p>By default, the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function ends with a new line.</p>
<p>If you want to print multiple words on the same line, you can use the <code class="w3-codespan">end</code> parameter:</p>
...
<div class="w3-example">
  ...
  <p>
    <a target="_blank" class="w3-btn" href="trypython.asp?filename=demo_output_same_line">Try it Yourself &raquo;</a>
  </p>
</div>

<p>Note that we add a space after <code class="w3-codespan">end=" "</code> for better readability.</p>
