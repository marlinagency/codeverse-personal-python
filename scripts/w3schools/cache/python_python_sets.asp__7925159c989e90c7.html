...
<a class="w3-left w3-btn" href="python_challenges_tuples_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets_access.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<p>Set is one of 4 built-in data types in Python used to store collections of 
data, the other 3 are <a href="python_lists.asp">List</a>, 
<a href="python_tuples.asp">Tuple</a>, and <a href="python_dictionaries.asp">Dictionary</a>, all with different qualities and usage.</p>

<p>A set is a collection which is <em>unordered</em>, <em>unchangeable*</em>, and <em>unindexed</em>.</p>

<div class="w3-panel ws-note">
  <p><strong>* Note:</strong> Set <em>items</em> are unchangeable, but you can remove 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set">Try it Yourself &raquo;</a>
</div>
...
<p>Set items can appear in a different order every time you use them, 
and cannot be referred to by index or key.</p>
...
<div class="w3-panel ws-note">
<p>Once a set is created, you cannot change its items, but you can remove items 
and add new items.</p>
</div>
...
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;apple&quot;}<br><br>
  print(thisset)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_sets_duplicate_error">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The values <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code>
...
<div class="w3-example">
<h3>Example</h3>
<p><code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code>
  and <code class="w3-codespan">1</code> is considered the same value:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, True, 1, 2}<br><br>
  print(thisset)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_sets_duplicate_true">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The values <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>
...
<div class="w3-example">
<h3>Example</h3>
<p><code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>
  and <code class="w3-codespan">0</code> is considered the same value:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, False, True, 0}<br><br>
  print(thisset)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_sets_duplicate_false">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>To determine how many items a set has, use the <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> 
function.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_length">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate pythonHigh">
  ...
  set2 = {1, 5, 7, 9, 3}<br>
  set3 = {True, False, False}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_datatypes">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;abc&quot;, 34, True, 40, &quot;male&quot;}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_datatypes2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-codeline notranslate">
&lt;class 'set'&gt;
</div>
...
<div class="w3-code notranslate pythonHigh">
myset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>
print(type(myset))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_datatypes3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The set() Constructor</h2>
<p>It is also possible to use the <span class="w3-codespan"><a href="ref_func_set.asp">set()</a></span> 
...
print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<ul>
<li><strong><a href="python_lists.asp">List</a></strong> is a collection which is ordered and changeable. Allows duplicate members.</li>
...
<div class="w3-panel ws-note">
  <p>*Set <em>items</em> are unchangeable, but you can remove items and add new 
  items.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_sets.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_tuples_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets_access.asp">Next &#10095;</a>
