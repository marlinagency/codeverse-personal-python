...
<h1>SQL <span class="color_h1">ALL Operator</span></h1>
...
<p>The <code class="w3-codespan">ALL</code> operator is used to compare a value 
to every value returned by a subquery.</p>
<p>The <code class="w3-codespan">ALL</code> operator evaluates to TRUE if <strong>
every value</strong> in the subquery result-set meet the condition.</p>
<p>The <code class="w3-codespan">ALL</code> operator is typically used with
<code class="w3-codespan">WHERE</code> and <code class="w3-codespan">HAVING</code> statements.</p>
...
<div class="w3-code notranslate sqlHigh">
  ...
  WHERE 
  <em>column_name operator</em> ALL (<em>subquery</em>);</div></div>
...
<p>The following SQL returns the ProductName if ALL the records in the &quot;OrderDetails&quot; table has Quantity equal to 10. This will of course return FALSE 
because the Quantity column has many different values (not only the value of 10):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT ProductName<br>FROM Products<br>WHERE ProductID = ALL (<br>&nbsp; SELECT ProductID<br>&nbsp; FROM OrderDetails<br>&nbsp; WHERE Quantity = 10<br>);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_all3" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_any_all.js"></div>
<hr>
