...
<h1>Python <span class="color_h1">*args and **kwargs</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_arguments.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_scope.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>*args and **kwargs</h2>
<p>By default, a function must be called with the correct number of arguments. </p>
<p>However, sometimes you may not know how many arguments that will be passed into your function.</p>
<p>*args and **kwargs allow functions to accept a unknown number of arguments.</p>

<hr>
<h2>Arbitrary Arguments - *args</h2>

<p>If you do not know how many arguments will be passed into your function, add a <code class="w3-codespan">*</code> before the parameter name.</p>

<p>This way, the function will receive a <em>tuple</em> of arguments and can access the items accordingly:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using *args to accept any number of arguments:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(<strong>*kids</strong>):<br>&nbsp; print(&quot;The youngest child is &quot; + kids[2])<br><br>
  my_function(&quot;Emil&quot;, &quot;Tobias&quot;, &quot;Linus&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_args1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><em>Arbitrary Arguments</em> are often shortened to <em>*args</em> in Python documentation.</p>
</div>
...
<p>The <code class="w3-codespan">*args</code> parameter allows a function to accept any number of positional arguments.</p>

<p>Inside the function, <code class="w3-codespan">args</code> becomes a tuple containing all the passed arguments:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Accessing individual arguments from *args:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(*args):<br>&nbsp; print(&quot;Type:&quot;, type(args))<br>&nbsp; print(&quot;First argument:&quot;, args[0])<br>&nbsp; print(&quot;Second argument:&quot;, args[1])<br>&nbsp; print(&quot;All arguments:&quot;, args)<br><br>
  my_function(&quot;Emil&quot;, &quot;Tobias&quot;, &quot;Linus&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_args_type">Try it Yourself &raquo;</a>
</div>
...
<hr>
<!--start-->
<h2>Using *args with Regular Arguments</h2>

<p>You can combine regular parameters with *args.</p>

<p>Regular parameters must come before *args:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def my_function(greeting, *names):<br>&nbsp; for name in names:<br>&nbsp;&nbsp;&nbsp; print(greeting, name)<br><br>
  my_function(&quot;Hello&quot;, &quot;Emil&quot;, &quot;Tobias&quot;, &quot;Linus&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_args_regular">Try it Yourself &raquo;</a>
</div>

<p>In this example, <code class="w3-codespan">&quot;Hello&quot;</code> is assigned to <code class="w3-codespan">greeting</code>, and the rest are collected in <code class="w3-codespan">names</code>.</p>

<!--stop-->
<hr>
<!--start-->
<h2>Practical Example with *args</h2>

<p>*args is useful when you want to create flexible functions:</p>

<div class="w3-example">
<h3>Example</h3>
<p>A function that calculates the sum of any number of values:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(*numbers):<br>&nbsp; total = 0<br>&nbsp; for num in numbers:<br>&nbsp;&nbsp;&nbsp; total += num<br>&nbsp; return total<br><br>
  print(my_function(1, 2, 3))<br>print(my_function(10, 20, 30, 40))<br>print(my_function(5))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_args_sum">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Finding the maximum value:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(*numbers):<br>&nbsp; if len(numbers) == 0:<br>&nbsp;&nbsp;&nbsp; return None<br>&nbsp; max_num = numbers[0]<br>&nbsp; for num in numbers:<br>&nbsp;&nbsp;&nbsp; if num &gt; max_num:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; max_num = num<br>&nbsp; return max_num<br><br>
  print(my_function(3, 7, 2, 9, 1))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_args_max">Try it Yourself &raquo;</a>
</div>
...
<p>If you do not know how many keyword arguments will be passed into your function, add two asterisks <code class="w3-codespan">**</code> before the parameter name.</p>

<p>This way, the function will receive a <em>dictionary</em> of arguments and can access the items accordingly:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using **kwargs to accept any number of keyword arguments:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(<strong>**kid</strong>):<br>&nbsp; print(&quot;His last name is &quot; + kid[&quot;lname&quot;])<br><br>
  my_function(fname = &quot;Tobias&quot;, lname = &quot;Refsnes&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_kwargs1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><em>Arbitrary Keyword Arguments</em> are often shortened to <em>**kwargs</em> in Python documentation.</p>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>What is **kwargs?</h2>

<p>The <code class="w3-codespan">**kwargs</code> parameter allows a function to accept any number of keyword arguments.</p>

<p>Inside the function, <code class="w3-codespan">kwargs</code> becomes a dictionary containing all the keyword arguments:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Accessing values from **kwargs:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(**myvar):<br>&nbsp; print(&quot;Type:&quot;, type(myvar))<br>&nbsp; print(&quot;Name:&quot;, myvar[&quot;name&quot;])<br>&nbsp; print(&quot;Age:&quot;, myvar[&quot;age&quot;])<br>&nbsp; print(&quot;All data:&quot;, myvar)<br><br>
  my_function(name = &quot;Tobias&quot;, age = 30, city = &quot;Bergen&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_kwargs_type">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>Using **kwargs with Regular Arguments</h2>

<p>You can combine regular parameters with **kwargs.</p>

<p>Regular parameters must come before **kwargs:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def my_function(username, **details):<br>&nbsp; print(&quot;Username:&quot;, username)<br>&nbsp; print(&quot;Additional details:&quot;)<br>&nbsp; for key, value in details.items():<br>&nbsp;&nbsp;&nbsp; print(&quot; &quot;, key + &quot;:&quot;, value)<br><br>
  my_function(&quot;emil123&quot;, age = 25, city = &quot;Oslo&quot;, hobby = &quot;coding&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_kwargs_regular">Try it Yourself &raquo;</a>
</div>
...
<p>You can use both *args and **kwargs in the same function.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def my_function(title, *args, **kwargs):<br>&nbsp; print(&quot;Title:&quot;, title)<br>&nbsp; print(&quot;Positional arguments:&quot;, args)<br>&nbsp; print(&quot;Keyword arguments:&quot;, kwargs)<br><br>
  my_function(&quot;User Info&quot;, &quot;Emil&quot;, &quot;Tobias&quot;, age = 25, city = &quot;Oslo&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_args_kwargs_both">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">*</code> and <code class="w3-codespan">**</code> operators can also be used when <em>calling</em> functions to unpack (expand) a list or dictionary into separate arguments.</p>

<h3>Unpacking Lists with *</h3>

<p>If you have values stored in a list, you can use <code class="w3-codespan">*</code> to unpack them into individual arguments:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using * to unpack a list into arguments:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(a, b, c):<br>&nbsp; return a + b + c<br><br>
  numbers = [1, 2, 3]<br>result = my_function(*numbers)  # Same as: my_function(1, 2, 3)<br>print(result)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_unpack_list">Try it Yourself &raquo;</a>
</div>

<h3>Unpacking Dictionaries with **</h3>

<p>If you have keyword arguments stored in a dictionary, you can use <code class="w3-codespan">**</code> to unpack them:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using ** to unpack a dictionary into keyword arguments:</p>
<div class="w3-code notranslate pythonHigh">
  def my_function(fname, lname):<br>&nbsp; print(&quot;Hello&quot;, fname, lname)<br><br>
  person = {&quot;fname&quot;: &quot;Emil&quot;, &quot;lname&quot;: &quot;Refsnes&quot;}<br>my_function(**person)  # Same as: my_function(fname=&quot;Emil&quot;, lname=&quot;Refsnes&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_unpack_dict">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Remember:</strong> Use <code class="w3-codespan">*</code> and <code class="w3-codespan">**</code> in function definitions to <em>collect</em> arguments, and use them in function calls to <em>unpack</em> arguments.</p>
</div>

<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_args_kwargs.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_arguments.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_scope.asp">Next &#10095;</a>
