...
<h1>Python - Remove List Items</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_lists_add.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_loop.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Remove Specified Item</h2>

<p>The <code class="w3-codespan"><a href="ref_list_remove.asp">remove()</a></code> method removes the specified item.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_remove">Try it Yourself &raquo;</a>
</div>

<p>If there are more than one item with the specified value, the <code class="w3-codespan"><a href="ref_list_remove.asp">remove()</a></code> method removes the first 
occurrence:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Remove the first occurrence of "banana":</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;banana&quot;, &quot;kiwi&quot;]<br>
thislist.remove("banana")<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_remove2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan"><a href="ref_list_pop.asp">pop()</a></code> method removes the specified 
index.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_pop2">Try it Yourself &raquo;</a>
</div>

<p>If you do not specify the index, the <code class="w3-codespan"><a href="ref_list_pop.asp">pop()</a></code> method removes the last item.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_pop">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<p>The <code class="w3-codespan"><a href="ref_keyword_del.asp">del</a></code> keyword also removes the specified 
index:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_del">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan"><a href="ref_keyword_del.asp">del</a></code> keyword can also delete the list completely.</p>


<div class="w3-example">
<h3>Example</h3>
<p>Delete the entire list:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
  del
thislist</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_del2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>The <code class="w3-codespan"><a href="ref_list_clear.asp">clear()</a></code> method empties the list.</p>

<p>The list still remains, but it has no content.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Clear the list content:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
  thislist.clear()<br>print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_clear">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_lists_remove.js"></div>
<hr>
