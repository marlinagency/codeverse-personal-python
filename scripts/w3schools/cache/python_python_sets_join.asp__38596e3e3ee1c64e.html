...
<h1>Python - <span class="color_h1">Join Sets</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_sets_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_frozenset.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Join Sets</h2>
<p>There are several ways to join two or more sets in Python.</p>
<p>The <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> and <code class="w3-codespan"><a href="ref_set_update.asp">update()</a></code> methods joins all items from both sets.</p>
<p>The <code class="w3-codespan"><a href="ref_set_intersection.asp">intersection()</a></code> method keeps ONLY the duplicates.</p>
<p>The <code class="w3-codespan"><a href="ref_set_difference.asp">difference()</a></code> method keeps the items 
from the first set that are not in the other set(s).</p>
<p>The <code class="w3-codespan"><a href="ref_set_symmetric_difference.asp">symmetric_difference()</a></code> method keeps all 
items EXCEPT the duplicates.</p>
...
<p>The <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> method returns a new set with all items from both sets.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Join set1 and set2 into a new set:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>set2 = {1, 2, 3}<br><br>
  set3 = set1.union(set2)<br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_union">Try it Yourself &raquo;</a>
</div>

<p>You can use the <code class="w3-codespan">|</code> operator instead of the <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> method, and you will get the same result.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use <code class="w3-codespan">|</code> to join two sets:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>set2 = {1, 2, 3}<br><br>
  set3 = set1 | set2<br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_union_pipe">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>All the joining methods and operators can be used to join multiple sets.</p>

<p>When using a method, just add more sets in the parentheses, separated by commas:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Join multiple sets with the <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> method:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>set2 = {1, 2, 3}<br>set3 = {&quot;John&quot;, &quot;Elena&quot;}<br>set4 = {&quot;apple&quot;, 
  &quot;bananas&quot;, &quot;cherry&quot;}<br><br>
  myset = set1.union(set2, set3, set4)<br>print(myset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_join_multiple">Try it Yourself &raquo;</a>
</div>

<p>When using the <code class="w3-codespan">|</code> operator, separate the sets 
with more <code class="w3-codespan">|</code> operators:</p>
...
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>set2 = {1, 2, 3}<br>set3 = {&quot;John&quot;, &quot;Elena&quot;}<br>set4 = {&quot;apple&quot;, 
  &quot;bananas&quot;, &quot;cherry&quot;}<br><br>
  myset = set1 | set2 | set3 |set4<br>print(myset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_join_multiple_pipe">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Join a Set and a Tuple</h2>

<p>The <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> method allows you to join a set with other data types, like lists or tuples.</p>

<p>The result will be a set.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Join a set with a tuple:</p>
<div class="w3-code notranslate pythonHigh">
  x = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>y = (1, 2, 3)<br><br>
  z = x.union(y)<br>print(z)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_union_tuple">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The&nbsp; <code class="w3-codespan">|</code> 
operator only allows you to join sets with sets, and not with other data types like you 
can with the&nbsp; <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> method.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan"><a href="ref_set_update.asp">update()</a></code> method inserts all items from one set into another.</p>

<p>The <code class="w3-codespan"><a href="ref_set_update.asp">update()</a></code> changes the original set, and does not return a new set.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan"><a href="ref_set_update.asp">update()</a></code> method inserts the items in set2 into set1:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;a&quot;, &quot;b&quot; , &quot;c&quot;}<br>set2 = {1, 2, 3}<br><br>
  set1.update(set2)<br>print(set1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_update2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Both <code class="w3-codespan"><a href="ref_set_union.asp">union()</a></code> and <code class="w3-codespan"><a href="ref_set_update.asp">update()</a></code>
...
<!--start-->
<h2>Intersection</h2>
<p>Keep ONLY the duplicates</p>

<p>The <code class="w3-codespan"><a href="ref_set_intersection.asp">intersection()</a></code> method will return a new set, that only contains the items that are present in both sets.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Join set1 and set2, but keep only the duplicates:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {"google", "microsoft", "apple"}<br><br>
  set3 = set1.intersection(set2)<br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_intersection">Try it Yourself &raquo;</a>
</div>

<p>You can use the <code class="w3-codespan">&amp;</code> operator instead of the <code class="w3-codespan">
<a href="ref_set_intersection.asp">intersection()</a></code> method, and you will get the same result.</p>
...
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {"google", "microsoft", "apple"}<br><br>
  set3 = set1 
  &amp; set2<br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_intersection_and">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">&amp;</code> 
operator only allows you to join sets with sets, and not with other data types like you 
can with the <code class="w3-codespan"><a href="ref_set_intersection.asp">intersection()</a></code> method.</p>
</div>
<!--stop-->
<!--start-->
<p>The <code class="w3-codespan"><a href="ref_set_intersection_update.asp">intersection_update()</a></code> method will also keep ONLY the duplicates,
but it will change the original set instead of returning a new set.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Keep the items that exist in both <code class="w3-codespan">set1</code>, and 
<code class="w3-codespan">set2</code>:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>set1.intersection_update(set2)<br><br>print(set1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_intersection_update">Try it Yourself &raquo;</a>
</div>

<p>The values <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code> and <code class="w3-codespan"><a href="ref_keyword_true.asp">1</a></code> 
are considered the same value. The same goes for <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code> and <code class="w3-codespan"><a href="ref_keyword_false.asp">0</a></code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Join sets that contains the values <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code>,
<code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>, <code class="w3-codespan">1</code>, and
<code class="w3-codespan">0</code>, and see what is considered as duplicates:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, 1,&nbsp; &quot;banana&quot;, 0, &quot;cherry&quot;}<br>
  set2 = {False, &quot;google&quot;, 
  1, &quot;apple&quot;, 2, True}<br>
  <br>set3 = set1.intersection(set2)<br><br>print(set3)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_intersection_true">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan"><a href="ref_set_difference.asp"><a href="ref_set_difference.asp">difference()</a></a></code> method will
return a new set that will contain only the items from the first set that are not present in the other set.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Keep all items from set1 that are not in set2:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>set3 = set1.difference(set2)<br><br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_difference">Try it Yourself &raquo;</a>
</div>

<p>You can use the <code class="w3-codespan">-</code> operator instead of the <code class="w3-codespan">
<a href="ref_set_difference.asp">difference()</a></code> method, and you will get the same result.</p>
...
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {"google", "microsoft", "apple"}<br><br>
  set3 = set1 - set2<br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_difference_minus">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">-</code> 
operator only allows you to join sets with sets, and not with other data types like you 
can with the <code class="w3-codespan"><a href="ref_set_difference.asp">difference()</a></code> method.</p>
</div>
<!--stop-->
<!--start-->
<p>The <code class="w3-codespan"><a href="ref_set_difference_update.asp">difference_update()</a></code> method will keep 
the items from the first set that are not in the other set,
but it will change the original set instead of returning a new set.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan"><a href="ref_set_difference_update.asp">difference_update()</a></code> method to keep only the items
from the first set that are not present in the other set:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>set1.difference_update(set2)<br><br>print(set1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_difference_update">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Symmetric Differences</h2>

<p>The <code class="w3-codespan"><a href="ref_set_symmetric_difference.asp">symmetric_difference()</a></code> method will keep only the elements that are NOT present in both sets.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Keep the items that are not present in both sets:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>set3 = set1.symmetric_difference(set2)<br><br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_symmetric_difference">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<p>You can use the <code class="w3-codespan">^</code> operator instead of the <code class="w3-codespan">
<a href="ref_set_symmetric_difference.asp">symmetric_difference()</a></code> method, and you will get the same result.</p>
...
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {"google", "microsoft", "apple"}<br><br>
  set3 = set1 ^ set2<br>print(set3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_symmetric_difference_caret">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">^</code> 
operator only allows you to join sets with sets, and not with other data types like you 
can with the <code class="w3-codespan"><a href="ref_set_symmetric_difference.asp">symmetric_difference()</a></code> method.</p>
</div>
<!--stop-->
<!--start-->
<p>The <code class="w3-codespan"><a href="ref_set_symmetric_difference_update.asp">symmetric_difference_update()</a></code> method will also keep all 
but the duplicates,
but it will change the original set instead of returning a new set.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan"><a href="ref_set_symmetric_difference_update.asp">symmetric_difference_update()</a></code> method to keep the items that are not present in both sets:</p>
<div class="w3-code notranslate pythonHigh">
  set1 = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>set2 = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>set1.symmetric_difference_update(set2)<br><br>print(set1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_symmetric_difference_update">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_sets_join.js"></div>
<hr>
