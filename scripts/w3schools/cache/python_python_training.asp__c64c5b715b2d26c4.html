...
<h1>Python <span class="color_h1">Training</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_bootcamp.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="https://campus.w3schools.com/products/python-certificate?utm_source=w3schools&utm_medium=referral&utm_campaign=python_exam&utm_content=get_your_certificate">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel ws-info">
  <p><strong>Introduction:</strong> Python is a popular programming language that can be used for a wide range of applications.</p>
  <p>W3Schools offers an Python training course that covers Python foundations and more.</p>
  <p>The course includes the W3Schools <strong>Certified Python Developer</strong> certification.</p>
  <p>The Python training is relevant for companies and schools that want to certify their employees or students.</p>
  <p>Organizations can track learner progress, get insights and manage everything from licenses to certificates with <strong>W3Schools Academy</strong>.</p>
  <p>Remember that you can always learn for free on W3Schools with the <a href="https://www.w3schools.com/python/default.asp" target="_blank">Python Tutorial</a>.</p>
  <div class="w3-margin-top">
  <a href="https://order.w3schools.com/academy/self-service/" target="_blank" class="w3-btn w3-margin-bottom" style="background-color: #04AA6D; color: white;">Buy W3Schools Academy &raquo;</a>
  <a href="https://webinars.w3schools.com/webinar/w3schools-academy-for-educators-17442?session=replay&showform=1?session=replay&showform=1" target="_blank" class="w3-btn w3-margin-bottom" style="background-color: #282A35; color: white; padding: 8px 16px;">Watch Demo &raquo;</a>
  <p style="font-size:smaller">*Academy is available for companies and schools only.</p>
</div>
</div>
<hr>
...
<div class="w3-row-padding w3-center">
  <div class="w3-third">
    <i style="font-size: 44px; color: #282A35;" class="fa fa-code brr" aria-hidden="true"></i>
    <h4 style="font-weight:500">Track progress</h4>
    <p>Get analytics to track learner progress and results.</p>
  </div>

  <div class="w3-third">
    <i style="font-size: 44px; color: #282A35;" class="fa fa-graduation-cap brr" aria-hidden="true"></i>
    <h4 style="font-weight:500">Self-paced</h4>
    <p>Flexible timelines and pacing to match busy schedules.</p>
  </div>

  <div class="w3-third">
    <i style="font-size: 44px; color: #282A35;" class="fa fa-globe brr" aria-hidden="true"></i>
    <h4 style="font-weight:500">Globally Recognized</h4>
    <p>Certifications that are trusted by leading organizations worldwide</p>
  </div>
</div>
<hr>

<h2>Python Training with W3Schools</h2>
<p>W3Schools has been training millions of learners since 1998.</p>
<p>Governments, schools, and organizations worldwide trust W3Schools to train employees and students.</p>
<p>W3Schools training materials and content have been well-proven over the years and are updated regularly.</p>
<p>With the W3Schools Academy pricing model, it is now one of the worlds most affordable quality Python training options there is.</p>
<a href="/academy/index.php" target="_blank" class="w3-btn w3-margin-bottom" style="background-color: #04AA6D; color: white;">Learn About Academy &raquo;</a>
<hr>

<h2>Learning Outcomes</h2>
<p>The Certificate Course includes all the training materials to pass the <strong>Certified Python Developer</strong> certification exam.</p>
<p>No prerequisites are required to take the course.</p>
<p>The learners will be able to:</p>

<ul>
    <li>Understand Python basics, such as syntax, variables, and data types.</li>
    <li>Write Python code using loops, conditionals, and functions.</li>
    <li>Handle files (open, read, write) using Python.</li>
    <li>Use Python libraries and modules for specific tasks.</li>
    <li>Work with data structures like lists, tuples, sets, and dictionaries.</li>
    <li>Develop programs that use object-oriented concepts such as classes and inheritance.</li>
    <li>Develop a problem-solving mindset.</li>
</ul>

<div class="w3-panel ws-note">
  <p>If you are not a company or school, you can still buy the course for personal use.</p>
  <p>Read more about W3Schools courses here: <a href="https://campus.w3schools.com/" target="_blank">W3Schools Courses</a></p>
</div>
<hr>

<h2>Certified Python Developer</h2>
<p>After completing the training modules the learner will take the end of pathway exam.</p>
<p>When the learner passes the exam, the learner will get the <strong>Certified Python Developer</strong> certification.</p>
<p>The exam is a multiple choice exam with 60 questions and a duration of 60 minutes.</p>
<p>Image of a Python Certificate:</p>
<img src="img_cert_python.jpg" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
<p>The certificate does not expire and is valid for lifetime.</p>
<p>It is shareable and can be added to your CV or LinkedIn <span class="fa fa-linkedin-square fa-2x"></span> profile.</p>
<p>You can read more about the certificate here: <a href="python_exam.asp" target="_blank">Python Certificate</a></p>
<hr>

<h2>Track Learner Progress</h2>
<p>As an employer or a school you can track learner progress and results.</p>
<p>Assign courses to learners with ease and get them started in no time.</p>
<p>With W3Schools Academy you can manage everything from licenses to certificates.</p>
<p>It will give you everything you need to train your employees or students in different technologies.</p>
<p>Image of class overview in Academy:</p>
<img src="python_class.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
<p>You can read more about the Academy here: <a href="https://www.w3schools.com/academy/index.php" target="_blank">W3Schools Academy</a></p>

<div class="w3-panel ws-info">
<p><strong>Note:</strong> If you don't want to track progress, there is an option to give them access to the course without any management.</p>
</div>
...
<p>The course is designed to be interactive and fun to learn.</p>
<p>The learner will engage with different learning activities to keep them engaged.</p>
<p>This includes quizzes, code exercises, challenges, and a final exam.</p>
<p>Stay engaged with hands-on coding challenges that help you practice and test what you've learned.</p>
<p>Image of one of the activity types in the course, a Python Challenge:</p>
<img src="python_challenge.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
<p>Python is best learned by doing, and this is why we have included a lot of challenges in the course.</p>
<ul>
  <li>You will get access to hundreds of coding challenges</li>
  <li>Get instant feedback with auto-grading</li>
  <li>Receive personalized guidance with manual grading</li>
  <li>Work on exercises ranging from simple to complex</li>
</ul>
<p>You can read more about the different types of activities here: <a href="/academy/academy_code_excercises.php" target="_blank">Coding Exercises</a></p>
<hr>

<h2>Training Course Overview</h2>
<div style="overflow-x:auto;">
<table class="ws-table-all" style="width:100%; border-collapse: collapse; margin: 25px 0;">
  <tr>
    <td style="width:30%; padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Pricing Academy</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">$49.99 / year per learner</td>
  </tr>
  <tr>
    <td style="width:30%; padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Availability</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">For companies and schools only</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Course level</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Beginner</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Time to complete</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">66 hours on average</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Course Format</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Self-paced</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Language</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">English</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Prerequisites</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">None</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Exam and Certification</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Included</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Number of certificates</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">1</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Certificate name</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Certified Python Developer</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Exam format</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Multiple choice</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Certification skill level</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Intermediate (40%), Advanced (75%) and Professional (90%)</td>
  </tr>
  <tr>
    <td style="padding:16px; background-color:#f8f9fa; border:1px solid #ddd;"><strong>Certification Expiration</strong></td>
    <td style="padding:16px; border:1px solid #ddd;">Never</td>
  </tr>
</table>
</div>
<hr>
...
<ol>
  ...
  <li>Assign the Python course to your class</li>
  <li>Monitor learner progress through the admin dashboard</li>
  <li>Review analytics and certification results</li>
</ol>
<hr>

<p>Are you ready to start training your employees today?</p>
<p><a class="ws-btn" href="https://order.w3schools.com/academy/self-service/" target="_blank">Buy Access to Academy Now &raquo;</a></p>
<hr>
