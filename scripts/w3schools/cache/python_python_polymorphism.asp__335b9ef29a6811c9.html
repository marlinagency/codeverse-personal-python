...
<h1>Python <span class="color_h1">Polymorphism</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_inheritance.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_polymorphism.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">The word "polymorphism" means "many forms", and in programming it refers to
...
<p>An example of a Python function that can be used on different objects is the 
<code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> function.</p>

<h3>String</h3>
<p>For strings <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> returns the number of characters:</p>
...
<br>
print(len(x))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_poly_1">Try it Yourself &raquo;</a>
</div>
<h3>Tuple</h3>
<p>For tuples <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> returns the number of items 
in the tuple:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
...
<br>
print(len(mytuple))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_poly_2">Try it Yourself &raquo;</a>
</div>
<h3>Dictionary</h3>
<p>For dictionaries <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> returns the number of key/value pairs 
in the dictionary:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_poly_3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>Polymorphism is often used in Class methods, where we can have multiple 
classes with the same method name.</p>

<p>For example, say we have three classes: <code class="w3-codespan">Car</code>, 
<code class="w3-codespan">Boat</code>, and <code class="w3-codespan">Plane</code>, and they all have 
a method called <code class="w3-codespan">move()</code>:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Different classes with the same method:</p>
  <div class="w3-code notranslate pythonHigh">
class Car:<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;print("Fly!")<br>
<br>
car1 = Car("Ford", "Mustang")  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#Create a Car object<br>
boat1 = Boat("Ibiza", "Touring 20") #Create a Boat object<br>
plane1 = Plane("Boeing", "747") &nbsp;&nbsp;&nbsp;&nbsp;#Create a Plane object<br>
<br>
for x in (car1, boat1, plane1):<br>
&nbsp;&nbsp;x.move()<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_poly_4">Try it Yourself &raquo;
</a>
</div>

<p>Look at the for loop at the end.
Because of polymorphism we can execute the same method for all three classes.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Inheritance Class Polymorphism</h2>

<p>What about classes with child classes with the same name? Can we use polymorphism there?</p>

<p>Yes. If we use the example above and make a parent class called 
...
<div class="w3-example">
<h3>Example</h3>
  <p>Create a class called <code class="w3-codespan">Vehicle</code> and make <code class="w3-codespan">Car</code>, 
<code class="w3-codespan">Boat</code>, <code class="w3-codespan">Plane</code>
  child classes of 
  <code class="w3-codespan">Vehicle</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    class Vehicle:<br>&nbsp; def __init__(self, brand, model):<br>&nbsp;&nbsp;&nbsp; 
    self.brand = brand<br>&nbsp;&nbsp;&nbsp; self.model = model<br><br>&nbsp; 
    def move(self):<br>&nbsp;&nbsp;&nbsp; print(&quot;Move!&quot;)<br><br>class 
    Car(Vehicle):<br>&nbsp; pass<br><br>class Boat(Vehicle):<br>&nbsp; def 
    move(self):<br>&nbsp;&nbsp;&nbsp; print(&quot;Sail!&quot;)<br><br>class 
    Plane(Vehicle):<br>&nbsp; def move(self):<br>&nbsp;&nbsp;&nbsp; 
    print(&quot;Fly!&quot;)<br><br>car1 = Car(&quot;Ford&quot;, &quot;Mustang&quot;)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; #Create a Car object<br>
    boat1 = Boat(&quot;Ibiza&quot;, &quot;Touring 20&quot;) #Create a Boat object<br>plane1 = 
    Plane(&quot;Boeing&quot;, &quot;747&quot;)&nbsp;&nbsp;&nbsp;&nbsp; #Create a Plane object<br><br>for x in (car1, boat1, 
    plane1):<br>&nbsp; print(x.brand)<br>&nbsp; print(x.model)<br>&nbsp; x.move()<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_poly_5">Try it Yourself &raquo;
</a>
</div>

<p>Child classes inherits the properties and methods from the parent class.</p>
<p>In the example above you can see that the <code class="w3-codespan">Car</code> class is empty, but 
it inherits <code class="w3-codespan">brand</code>, <code class="w3-codespan">
model</code>, and <code class="w3-codespan">move()</code> from
<code class="w3-codespan">Vehicle</code>.</p>
<p>The <code class="w3-codespan">Boat</code> and <code class="w3-codespan">Plane</code> classes also 
...
<code class="w3-codespan">move()</code> method.</p>
<p>Because of polymorphism we can execute the same method for all classes.</p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_polymorphism.js"></div>
<hr>
