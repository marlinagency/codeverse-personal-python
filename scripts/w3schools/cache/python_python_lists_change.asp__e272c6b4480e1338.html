...
<h1>Python - <span class="color_h1">Change List Items</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_lists_access.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_add.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Change Item Value</h2>

<p>To change the value of a specific item, 
refer to the index number:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_change">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>To change the value of items within a specific range, define a list with the new values, and refer to the range of index numbers where you want to insert the new values:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the values "banana" and "cherry" with the values "blackcurrant" and "watermelon":</p>
<div class="w3-code notranslate pythonHigh">
thislist = ["apple", "banana", "cherry", &quot;orange&quot;, &quot;kiwi&quot;, &quot;mango&quot;]<br>
thislist[1:3] = ["blackcurrant", &quot;watermelon&quot;]<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_change_range">Try it Yourself &raquo;</a>
</div>

<p>If you insert <em>more</em> items than you replace, the new items will be inserted 
where you specified, and the remaining items will move accordingly:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the second value by replacing it with <em>two</em> new 
values:</p>
<div class="w3-code notranslate pythonHigh">
  thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>thislist[1:2] = [&quot;blackcurrant&quot;, 
  &quot;watermelon&quot;]<br>print(thislist) </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_change2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The length of the list will change when the number of items inserted does not match the number of items replaced.</p>
</div>

<p>If you insert <em>less</em> items than you replace, the new items will be inserted 
where you specified, and the remaining items will move accordingly:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the second and third value by replacing it with <em>one</em>  
value:</p>
<div class="w3-code notranslate pythonHigh">
  thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>thislist[1:3] = [&quot;watermelon&quot;]<br>print(thislist) </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_change3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>To insert a new list item, without replacing any of the existing values, we can use the <code class="w3-codespan"><a href="ref_list_insert.asp">insert()</a></code> method.</p>

<p>The <code class="w3-codespan"><a href="ref_list_insert.asp">insert()</a></code> method inserts an item at the specified index:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Insert &quot;watermelon&quot; as the third item:</p>
<div class="w3-code notranslate pythonHigh">
thislist = ["apple", "banana", "cherry"]<br>
thislist.insert(2, &quot;watermelon&quot;)<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_change2_insert">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> As a result of the example above, the list will now contain 4 items.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_lists_change.js"></div>
<hr>
