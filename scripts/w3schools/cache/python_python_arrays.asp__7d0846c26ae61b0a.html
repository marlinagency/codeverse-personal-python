...
<a class="w3-left w3-btn" href="python_challenges_range.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_arrays.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Python does not have built-in support for Arrays, 
  but <a href="python_lists.asp">Python Lists</a> can be used instead.</p>
</div>
<hr>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This page shows you how to use LISTS as ARRAYS, however, to work with arrays in Python you will have to import
  a library, like the <a href="numpy/default.asp">NumPy library</a>.</p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array1">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate pythonHigh">
  x = cars[0]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  cars[0] = "Toyota"</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Use the <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> method to return the length of 
...
<div class="w3-code notranslate pythonHigh">
  x = len(cars)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array4">Try it Yourself &raquo;</a>
</div>
...
<p>You can use the <code class="w3-codespan"><a href="python_for_loops.asp">for in</a></code> loop to loop through all the elements of an array.</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Print each item in the <code class="w3-codespan">cars</code> array:</p>
<div class="w3-code notranslate pythonHigh">
  for x in cars:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array5">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can use the <code class="w3-codespan"><a href="ref_list_append.asp">append()</a></code> method to add an element to an array.</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Add one more element to the <code class="w3-codespan">cars</code> array:</p>
<div class="w3-code notranslate pythonHigh">
cars.append(&quot;Honda&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array6">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can use the <code class="w3-codespan"><a href="ref_list_pop.asp">pop()</a></code> method to remove an element from the array.</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Delete the second element of the <code class="w3-codespan">cars</code> array:</p>
<div class="w3-code notranslate pythonHigh">
cars.pop(1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array7">Try it Yourself &raquo;</a>
</div>

<p>You can also use the <code class="w3-codespan"><a href="ref_list_remove.asp">remove()</a></code> method to remove an element from the array.</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Delete the element that has the value &quot;Volvo&quot;:</p>
<div class="w3-code notranslate pythonHigh">
cars.remove(&quot;Volvo&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_array8">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The list's <code class="w3-codespan"><a href="ref_list_remove.asp">remove()</a></code> method 
...
<hr>
<div id="exercisecontainer" src="xrcise_arrays.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_range.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_arrays.asp">Next &#10095;</a>
