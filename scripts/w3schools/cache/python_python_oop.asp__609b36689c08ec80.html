...
<h1>Python <span class="color_h1">OOP</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_virtualenv.asp">&#10094; Previous</a>
...
<p><strong>OOP</strong> stands for <strong>Object-Oriented Programming</strong>.</p>
<p>Python is an object-oriented language, allowing you to structure your code using classes and objects for better organization and reusability.</p>
<hr>
...
<ul>
  ...
  <li>Helps keep your code DRY (<strong>Don't Repeat Yourself</strong>)</li>
  <li>Allows you to build reusable applications with less code</li>
</ul>

<p><strong>Tip:</strong> The DRY principle means you should avoid writing the same code more than once. Move repeated code into functions or classes and reuse it.</p>
<!--stop-->
<hr>
<!--start-->
<h2>What are Classes and Objects?</h2>
<p>Classes and objects are the two core concepts in object-oriented programming.</p>
<p>A class defines what an object should look like, and an object is created based on that class. For example:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>Car</td>
    <td>Volvo, Audi, Toyota</td>
  </tr>
</table>

<p>When you create an object from a class, it inherits all the variables and functions defined inside that class.</p>

<p>In the next chapters, you will learn about:</p>
<ul>
  <li><a href="python_classes.asp">Classes and objects</a></li>
  <li><a href="python_class_init.asp">The __init__() method</a></li>
  <li><a href="python_class_self.asp">The self parameter</a></li>
  <li><a href="python_class_properties.asp">Properties</a> and <a href="python_class_methods.asp">methods</a></li>
  <li><a href="python_inheritance.asp">Inheritance</a> and <a href="python_polymorphism.asp">polymorphism</a></li>
  <li><a href="python_encapsulation.asp">Encapsulation</a> and <a href="python_class_inner.asp">inner classes</a></li>
</ul>
<!--stop-->
<hr>
