...
<h1>SQL <span class="color_h1">ANY Operator</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_exists.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_all.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL ANY Operator</h2>
<p>The <code class="w3-codespan">ANY</code> operator is used to compare a value 
to every value returned by a subquery.</p>
<p>The <code class="w3-codespan">ANY</code> operator evaluates to TRUE if <strong>at 
least one value</strong> in the subquery result-set meet the condition.</p>
<h3>ANY Syntax</h3>
...
<div class="w3-code notranslate sqlHigh">
  ...
  WHERE 
  <em>column_name operator</em> ANY (<em>subquery</em>);</div></div>
...
<p>The following SQL returns the ProductName if it 
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT ProductName FROM Products<br>WHERE ProductID = ANY (<br>&nbsp; SELECT ProductID<br>&nbsp; FROM OrderDetails<br>&nbsp; WHERE Quantity = 10<br>);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_any" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>

<p>The following SQL returns the ProductName if it 
finds ANY records in the &quot;OrderDetails&quot; table that has Quantity larger than 99 (this 
will return TRUE because the Quantity column has some values larger than 99):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT ProductName FROM Products<br>WHERE ProductID = ANY (<br>&nbsp; SELECT ProductID<br>&nbsp; 
  FROM OrderDetails<br>&nbsp; WHERE Quantity &gt; 99<br>);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_any2" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>

<p>The following SQL returns the ProductName if it 
finds ANY records in the &quot;OrderDetails&quot; table that has Quantity larger than 1000 (this 
will return FALSE because the Quantity column has no values larger than 1000):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT ProductName FROM Products<br>WHERE ProductID = ANY (<br>&nbsp; SELECT ProductID<br>&nbsp; 
  FROM OrderDetails<br>&nbsp; WHERE Quantity &gt; 1000<br>);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_any3" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<br>
