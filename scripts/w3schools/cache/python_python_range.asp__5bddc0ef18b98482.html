...
<h1>Python <span class="color_h1">range</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_functions_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_range.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Python range</h2>
<p>The built-in <code class="w3-codespan">range()</code> function returns an immutable sequence of numbers, commonly used for looping a specific number of times.</p>
<p>This set of numbers has its own data type called <code class="w3-codespan">range</code>.</p>
<div class="ws-note"><b>Note:</b> Immutable means that it cannot be modified after it is created.</div>
<hr>
<h2>Creating ranges</h2>
<p>The <code class="w3-codespan">range()</code> function can be called with 1, 2, or 3 arguments, using this syntax:</p>
...
<hr>
<h2>Call range() With One Argument</h2>
<p>If the range function is called with only one argument, the argument represents the <code class="w3-codespan">stop</code> value.<p>
<p>The <code class="w3-codespan">start</code> argument is optional, and if not provided, it defaults to 0.</p>
<p><code class="w3-codespan">range(10)</code> returns a sequence of each number from 0 to 9. (The start argument, 0 is inclusive, and the stop argument, 10 is exclusive).</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a range of numbers from 0 to 9:</p>
<div class="w3-code notranslate pythonHigh">
x = range(10)<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_range">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Call range() With Two Arguments</h2>
<p>If the range function is called with two arguments,
    the first argument represents the <code class="w3-codespan">start</code> value,
    and the second argument represents the <code class="w3-codespan">stop</code> value.</p>

<p><code class="w3-codespan">range(3, 10)</code> returns a sequence of each number from 3 to 9:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a range of numbers from 3 to 9:</p>
<div class="w3-code notranslate pythonHigh">
x = range(3, 10)<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_range2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Call range() With Three Arguments</h2>
<p>If the range function is called with three arguments, the third argument represents the <code class="w3-codespan">step</code> value.</p>
<p>The step value means the difference between each number in the sequence. It is optional, and if not provided, it defaults to 1.</p>
<p><code class="w3-codespan">range(3, 10, 2)</code> returns a sequence of each number from 3 to 9, with a step of 2:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a range of numbers from 3 to 9:</p>
<div class="w3-code notranslate pythonHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_range3">Try it Yourself &raquo;</a>
</div>
...
<h2>Using ranges</h2>
<p>Ranges are often used in <code class="w3-codespan">for</code> loops to iterate over a sequence of numbers.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Iterate over each value in a range:</p>
<div class="w3-code notranslate pythonHigh">
for i in range(10):<br>
&nbsp;&nbsp;print(i)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_range_for">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using List to Display Ranges</h2>
<p>The range object is a data type that represents an immutable sequence of numbers, and it is not directly displayable.</p>
<p>Therefore, ranges are often converted to lists for display.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Convert different ranges to lists:</p>
<div class="w3-code notranslate pythonHigh">
print(list(range(5)))<br>
print(list(range(1, 6)))<br>
print(list(range(5, 20, 3)))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_range_list">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Slicing Ranges</h2>
<p>Like other sequences, ranges can be sliced to extract a subsequence.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Extract a subsequence from a range:</p>
<div class="w3-code notranslate pythonHigh">
r = range(10)<br>
print(r[2])<br>
print(r[:3])<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_range_slice">Try it Yourself &raquo;</a>
</div>

<div class="ws-note"><b>Note:</b> The first print statement returns the value at index 2, and the second print statement returns a new range object, from index 0 to 3.</div>
<hr>

<h2>Membership Testing</h2>
<p>Ranges support membership testing with the <code class="w3-codespan">in</code> operator.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Test if the numbers 6 and 7 are present in a range:</p>
<div class="w3-code notranslate pythonHigh">
r = range(0, 10, 2)<br>
print(6 in r)<br>
print(7 in r)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_range_membership">Try it Yourself &raquo;</a>
</div>
<p>The return value is <code class="w3-codespan">True</code> when the number is present in the range, and <code class="w3-codespan">False</code> when it is not.</p>
<hr>

<h2>Length</h2>
<p>Ranges support the <code class="w3-codespan">len()</code> function to get the number of elements in the range.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the length of a range:</p>
<div class="w3-code notranslate pythonHigh">
r = range(0, 10, 2)<br>
print(len(r))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_range_len">Try it Yourself &raquo;</a>
</div>

<hr>

<div id="exercisecontainer" src="xrcise_range.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_functions_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_range.asp">Next &#10095;</a>
