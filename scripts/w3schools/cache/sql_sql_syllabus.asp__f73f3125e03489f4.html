...
<html lang="en-US">
<head>
<title>SQL Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="sql_server.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools SQL Tutorial" href="default.asp">W3Schools SQL Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of SQL.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn SQL step by step, from the introduction to creating your first application with SQL. </p>
<p><a title="W3Schools SQL Tutorial" href="sql_intro.asp" class="ws-btn">Get Started With SQL &raquo;</a></p>
<hr>
...
<p><strong>Note:</strong> Are you a teacher teaching SQL? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are SQL Relevant For?</h2>
<ul>
    <li style="margin-bottom:16px;">
        <strong>Information Technology (IT):</strong><br>
        SQL is used to run and manage databases and IT systems.
    </li>
    <li style="margin-bottom:16px;">
        <strong>Computer Science (CS):</strong> <br>
    ...
    <li style="margin-bottom:16px;">
        <strong>Business and Management:</strong> <br>
    ...
    <li style="margin-bottom:16px;">
        <strong>Science (Biology, Chemistry, and more):</strong> <br>
        Handling, research, and analysis of experimental data.
    </li>
    <li style="margin-bottom:16px;">
        <strong>Retail and E-commerce:</strong> <br>
        Analysis of inventory, supply chain management, and sales. Customer database management.
    </li>
    <li style="margin-bottom:16px;">
        <strong>Other (Healthcare, Education, Engineering):</strong> <br>
...
<p><a title="W3Schools SQL Tutorial" href="sql_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
...
<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn SQL for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools SQL Tutorial">Lessons</a></li>
    <li><a href="sql_exercises.asp" title="W3Schools SQL Exercises">Exercises</a></li>
    <li><a href="sql_quiz.asp" title="W3Schools SQL Quiz">Quizzes</a></li>
</ul>
<hr>
...
<p>SQL, like any other coding language, is best learned by working hands-on with code.</p>
<p>With our online SQL editor, you can edit the SQL statements, and view the result in your browser:</p>
...
<p>If you want to explore more and host your project, we have a feature called <a href="/spaces/index.php" target="_blank">Spaces</a> 
that allows you to build, test and deploy static websites.</p>
...
<p>The SQL exam is a test that summarizes the W3Schools SQL syllabus.</p>
<p>After passing the exam you get the "Certified SQL Developer" Certification.</p>
...
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/sql-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>

<h2>Are You a Teacher?</h2>
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach 
SQL?</p>
...
<img src="../python/syllabus-webinar.png" style="max-width:100%;border-radius:5px">
</a>
