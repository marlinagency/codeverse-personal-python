...
<html lang="en-US">
<head>
<title>Python Elif Statement</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Elif Statement</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_conditions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_if_else.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Elif Keyword</h2>
<p>The <span class="w3-codespan"><a href="ref_keyword_elif.asp">elif</a></span> keyword is Python's way of saying "if the previous conditions were not true, then 
try this condition".</p>

<p>The <span class="w3-codespan">elif</span> keyword allows you to check multiple expressions for <span class="w3-codespan">True</span> and execute a block of code as soon as one of the conditions evaluates to <span class="w3-codespan">True</span>.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_elif">Try it Yourself &raquo;</a>
</div>

<p>In this example <span class="w3-codespan">a</span> is equal to <span class="w3-codespan">b</span>, so the first condition is not true, but the <span class="w3-codespan"><a href="ref_keyword_elif.asp">elif</a></span> condition is true, so we print to screen that "a and b are equal".</p>
...
<p>You can have as many <span class="w3-codespan">elif</span> statements as you need. Python will check each condition in order and execute the first one that is true.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Testing multiple conditions:</p>
<div class="w3-code notranslate pythonHigh">
score = 75<br><br>
if score &gt;= 90:<br>
&nbsp; print("Grade: A")<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_elif_multiple">Try it Yourself &raquo;</a>
</div>

<p>In this example, the program checks each condition in order. Since <span class="w3-codespan">score</span> is 75, it prints "Grade: C" (the first condition that evaluates to true).</p>

<hr>

<h2>How Elif Works</h2>

<p>When you use <span class="w3-codespan">elif</span>, Python evaluates the conditions from top to bottom. As soon as it finds a condition that is true, it executes that block and skips all remaining conditions.</p>

<div class="w3-panel ws-note">
<p><strong>Important:</strong> Only the first true condition will be executed. Even if multiple conditions are true, Python stops after executing the first matching block.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Categorizing age groups:</p>
<div class="w3-code notranslate pythonHigh">
age = 25<br><br>
if age &lt; 13:<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_elif_age">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>When to Use Elif</h2>

<p>Use <span class="w3-codespan">elif</span> when you have multiple mutually exclusive conditions to check. This is more efficient than using multiple separate <span class="w3-codespan">if</span> statements because Python stops checking once it finds a true condition.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Day of the week checker:</p>
<div class="w3-code notranslate pythonHigh">
day = 3<br><br>
if day == 1:<br>
&nbsp; print("Monday")<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_elif_days">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_if_elif.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_conditions.asp">&#10094; Previous</a>
