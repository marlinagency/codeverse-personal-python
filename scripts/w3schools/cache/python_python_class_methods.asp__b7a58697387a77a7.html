...
<h1>Python <span class="color_h1">Class Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_class_properties.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_class_methods.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Class Methods</h2>

<p>Methods are functions that belong to a class. They define the behavior of objects created from the class.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a method in a class:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br><br>&nbsp; def greet(self):<br>&nbsp;&nbsp;&nbsp; print("Hello, my name is " + self.name)<br><br>p1 = Person("Emil")<br>p1.greet()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class4">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> All methods must have <code class="w3-codespan">self</code> as the first parameter.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a method with parameters:</p>
<div class="w3-code notranslate pythonHigh">
class Calculator:<br>&nbsp; def add(self, a, b):<br>&nbsp;&nbsp;&nbsp; return a + b<br><br>&nbsp; def multiply(self, a, b):<br>&nbsp;&nbsp;&nbsp; return a * b<br><br>calc = Calculator()<br>print(calc.add(5, 3))<br>print(calc.multiply(4, 7))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_method_params">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Methods Accessing Properties</h2>

<p>Methods can access and modify object properties using <code class="w3-codespan">self</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>A method that accesses object properties:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>&nbsp; def get_info(self):<br>&nbsp;&nbsp;&nbsp; return f"{self.name} is {self.age} years old"<br><br>p1 = Person("Tobias", 28)<br>print(p1.get_info())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_method_access">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Methods Modifying Properties</h2>

<p>Methods can modify the properties of an object:</p>

<div class="w3-example">
<h3>Example</h3>
<p>A method that changes a property value:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>&nbsp; def celebrate_birthday(self):<br>&nbsp;&nbsp;&nbsp; self.age += 1<br>&nbsp;&nbsp;&nbsp; print(f"Happy birthday! You are now {self.age}")<br><br>p1 = Person("Linus", 25)<br>p1.celebrate_birthday()<br>p1.celebrate_birthday()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_method_modify">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The __str__() Method</h2>

<p>The <code class='w3-codespan'>__str__()</code> method is a special method that controls what is returned when the object is printed:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Without the <code class='w3-codespan'>__str__()</code> method:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person("Emil", 36)<br>print(p1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_str1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>With the <code class='w3-codespan'>__str__()</code> method:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>&nbsp; def __str__(self):<br>&nbsp;&nbsp;&nbsp; return f"{self.name} ({self.age})"<br><br>p1 = Person("Tobias", 36)<br>print(p1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_str2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>A class can have multiple methods that work together:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create multiple methods in a class:</p>
<div class="w3-code notranslate pythonHigh">
class Playlist:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.songs = []<br><br>&nbsp; def add_song(self, song):<br>&nbsp;&nbsp;&nbsp; self.songs.append(song)<br>&nbsp;&nbsp;&nbsp; print(f"Added: {song}")<br><br>&nbsp; def remove_song(self, song):<br>&nbsp;&nbsp;&nbsp; if song in self.songs:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.songs.remove(song)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print(f"Removed: {song}")<br><br>&nbsp; def show_songs(self):<br>&nbsp;&nbsp;&nbsp; print(f"Playlist '{self.name}':")<br>&nbsp;&nbsp;&nbsp; for song in self.songs:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print(f"- {song}")<br><br>my_playlist = Playlist("Favorites")<br>my_playlist.add_song("Bohemian Rhapsody")<br>my_playlist.add_song("Stairway to Heaven")<br>my_playlist.show_songs()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_multiple_methods">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can delete methods from a class using the <code class="w3-codespan"><a href="ref_keyword_del.asp">del</a></code> keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Delete a method from a class:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br><br>&nbsp; def greet(self):<br>&nbsp;&nbsp;&nbsp; print("Hello!")<br><br>p1 = Person("Emil")<br><br>del Person.greet<br><br>p1.greet()  # This will cause an error</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_method_delete">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_class_methods.js"></div>
<hr>
