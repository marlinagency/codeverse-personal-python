...
<html lang="en-US">
<head>
<title>Python Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_server.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<style>
.ws-purple:hover {
  background-color:#9723f5!important;
}
</style>
<p>The <a title="W3Schools Python Tutorial" href="default.asp">W3Schools Python Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of Python.</p>
<p>It is designed for beginners and requires no prior experience with programming.</p>
<p>The content has been carefully made to be bite-sized, simple, and easy to understand.</p>
<p>The content has been proven by millions of users over the years. It is updated and improved frequently.</p>
<p>The syllabus outline and its sequence are structured so you can learn Python step by step, from the introduction, to creating your first application with Python.</p>
<p><a title="W3Schools Python Tutorial" href="python_intro.asp" class="ws-btn">Get Started With Python &raquo;</a></p>
<hr>
...
<p><strong>Note:</strong> Are you a teacher teaching Python programming? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are Python Relevant For?</h2>
<ul>
    ...
    <li style="margin-bottom:16px"><strong>Science (Physics, Chemistry, Biology)</strong><br> 
    ...
    <li style="margin-bottom:16px">
        <strong>Data Science and Analytics</strong><br> 
        Python and its libraries can be used for big data and to find patterns
    </li>
    <li style="margin-bottom:16px">
        <strong>Robotics and Engineering</strong><br> 
...
<p><a title="W3Schools Python Tutorial" href="python_intro.asp" class="ws-btn">Get Started</a></p>
...
<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn Python for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools Python Tutorial">Lessons</a></li>
    <li><a href="python_exercises.asp" title="W3Schools Python Exercises">Exercises</a></li>
    <li><a href="python_quiz.asp" title="W3Schools Python Quiz">Quizzes</a></li>
</ul>
<hr>

<h2>Sign in to Track Progress</h2>
<p>You can also create an account to track your progress.</p>
<p>As a signed-in user, you get access to features such as:</p>
<ul>
    <li>Learning paths</li>
    <li>Sandbox and lab environments</li>
    <li>Achievements</li>
    <li>And much more!</li>
</ul>
<p><a title="Sign Up" target="_blank" href="https://my-learning.w3schools.com/" class="ws-btn">Sign Up</a></p>
<hr>

<h2>Overview of the Modules</h2>
<div style="width:100%;height:300px;overflow:auto;padding:10px 10px 10px 10px;border:1px solid #ccc;border-radius:5px;">
<style>
.link-boxes {
...
.link-boxes a {
    display: block;
    padding: 10px 15px; 
    background-color: #E7E9EB;    color: #333; 
    text-decoration: none;
...
<ul class="link-boxes">
    <li><a href="default.asp">Python HOME</a></li>
    <li><a href="python_intro.asp">Python Intro</a></li>
    <li><a href="python_getstarted.asp">Python Get Started</a></li>
    <li><a href="python_syntax.asp">Python Syntax</a></li>
    <li><a href="python_comments.asp">Python Comments</a></li>
    <li><a href="python_variables.asp">Python Variables</a></li>
    <li><a href="python_datatypes.asp">Python Data Types</a></li>
    <li><a href="python_numbers.asp">Python Numbers</a></li>
    <li><a href="python_casting.asp">Python Casting</a></li>
    <li><a href="python_strings.asp">Python Strings</a></li>
    <li><a href="python_booleans.asp">Python Booleans</a></li>
    <li><a href="python_operators.asp">Python Operators</a></li>
    <li><a href="python_lists.asp">Python Lists</a></li>
    <li><a href="python_tuples.asp">Python Tuples</a></li>
    <li><a href="python_sets.asp">Python Sets</a></li>
    <li><a href="python_dictionaries.asp">Python Dictionaries</a></li>
    <li><a href="python_conditions.asp">Python If...Else</a></li>
    <li><a href="python_while_loops.asp">Python While Loops</a></li>
    <li><a href="python_for_loops.asp">Python For Loops</a></li>
    <li><a href="python_functions.asp">Python Functions</a></li>
    <li><a href="python_lambda.asp">Python Lambda</a></li>
    <li><a href="python_arrays.asp">Python Arrays</a></li>
    <li><a href="python_classes.asp">Python Classes/Objects</a></li>
    <li><a href="python_inheritance.asp">Python Inheritance</a></li>
    <li><a href="python_iterators.asp">Python Iterators</a></li>
    <li><a href="python_polymorphism.asp">Python Polymorphism</a></li>
    <li><a href="python_scope.asp">Python Scope</a></li>
    <li><a href="python_modules.asp">Python Modules</a></li>
    <li><a href="python_datetime.asp">Python Dates</a></li>
    <li><a href="python_math.asp">Python Math</a></li>
    <li><a href="python_json.asp">Python JSON</a></li>
    <li><a href="python_regex.asp">Python RegEx</a></li>
    <li><a href="python_pip.asp">Python PIP</a></li>
    <li><a href="python_try_except.asp">Python Try...Except</a></li>
    <li><a href="python_user_input.asp">Python User Input</a></li>
    <li><a href="python_string_formatting.asp">Python String Formatting</a></li>
    <li><a href="python_file_handling.asp">Python File Handling</a></li>
    <li><a href="numpy/default.asp">Python NumPy</a></li>
    <li><a href="pandas/default.asp">Python Pandas</a></li>
    <li><a href="scipy/index.php">Python SciPy</a></li>
    <li><a href="/django/index.php">Python Django</a></li>
    <li><a href="matplotlib_intro.asp">Python Matplotlib</a></li>
    <li><a href="python_ml_getting_started.asp">Python Machine Learning</a></li>
    <li><a href="python_mysql_getstarted.asp">Python MySQL</a></li>
    <li><a href="python_mongodb_getstarted.asp">Python MongoDB</a></li>
</ul>
</div>
<p><a title="W3Schools Python Tutorial" href="default.asp" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>Python, like any other programming language, is best learned by working hands-on with code.</p>
<p>Easily try code with our "Try it Yourself" editor.</p>
<p>Here, you can edit Python code and view the result:</p>
...
<p>If you want to explore more and host your project, we have a feature called <a href="/spaces/index.php" target="_blank">Spaces</a> that allows you to build, test and deploy Python code and other backend languages.</p>
<p>Here you get a secure sandbox environment called Spaces, where you can practice coding and test projects in real-time.</p>
<p>Spaces allow you to test, build, and deploy code. This includes a W3Schools subdomain, hosting, and secure SSL certificates.</p>
<p>Spaces require no installation and run directly in the browser.</p>
...
<div class="ws-grey w3-padding w3-round">
<img class="image w3-round window" src="/spaces/dynamicspaces.gif" alt="Dynamic Spaces" style="max-width:850px;margin:20px auto;width:100%;height:auto;display:block;border:1px solid #ccc;border-radius:5px;" loading="lazy">
</div>
<p><a class="ws-btn" href="https://spaces.w3schools.com/" target="_blank">Create a Spaces Account</a></p>
<hr>

<h2>Python Certification</h2>
<p>W3Schools offers an end-of-pathway certification program.</p>
<p>Here you can take exams to get certified.</p>
<p>The Python exam is a test that summarizes the W3Schools Python syllabus.</p>
<p>After passing the exam you get the "Certified Python Developer" Certification.</p>
<p>There are two different types of certifications:</p>
<ul>
<li>Non-adaptive</li>
<li>Adaptive</li>
</ul>
<p>The non-adaptive is pass or no pass.</p>
<p>The adaptive certification is adaptive and graded; students will get a grade from intermediate, advanced to professional.</p>
<div class="ws-grey w3-padding w3-round">
<img src="syllabus-exam.png" style="width:100%;">
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/python-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>

<h2>Are You a Teacher?</h2>
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach Python programming? </p>

<p>Watch a demo of <a href="/academy/index.php" target="_blank">W3Schools Academy</a>. You'll see how it works, and discover how it can make teaching programming easier and more engaging.</p>
<a href="https://webinars.w3schools.com/webinar/w3schools-academy-for-educators-17442?session=replay&showform=1" target="_blank">
<img src="syllabus-webinar.png" style="max-width:100%;border-radius:5px">
</a>
<p><a class="ws-btn" href="https://webinars.w3schools.com/webinar/w3schools-academy-for-educators-17442?session=replay&showform=1" target="_blank">Watch Demo &raquo;</a></p>
<hr>
