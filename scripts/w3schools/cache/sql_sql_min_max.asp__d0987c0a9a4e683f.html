...
<h1>SQL <span class="color_h1">MIN() F</span>unction</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_aggregate_functions.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_max.asp">Next &#10095;</a>
</div>
<hr>

<h2>The SQL MIN() Function</h2>
<p>The <code class="w3-codespan">MIN()</code> function returns the smallest value of the selected column.</p>
<p>The <code class="w3-codespan">MIN()</code> function works with numeric, string, and date data types.</p>

<div class="w3-example">
<h3>MIN() Example</h3>
<p>Return the lowest price in the Price column, in the &quot;Products&quot; table:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT MIN(Price)<br>FROM Products;
</div>
...
<hr>
<h2>Set Column Name (Alias)</h2>
<p>When using <code class="w3-codespan">MIN()</code>, the returned column will not have a 
name.</p>
<p>Use the 
...
<a target="_blank" href="trysql.asp?filename=trysql_select_min_as" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Use MIN() with Date Column</h2>
<p>The following SQL returns the earliest BirthDate in the BirthDate column, in the <a href="trysql.asp?filename=trysql_employees" target="_blank"><strong>Employees</strong></a> table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT MIN(BirthDate) AS EarliestBirthdate<br>FROM Employees;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_min_as2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Use MIN() with GROUP BY</h2>
<p>Here we use the <code class="w3-codespan">MIN()</code> function and the
<code class="w3-codespan">GROUP BY</code> clause, to return the smallest price 
...
<a target="_blank" href="trysql.asp?filename=trysql_select_min_groupby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
