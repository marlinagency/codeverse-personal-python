...
<h1>SQL <span class="color_h1">Aggregate</span> Functions</h1>
...
<p>An aggregate function is a function that performs a calculation on a set of 
values, and returns a single value.</p>
<p>Aggregate functions are often used with the <code class="w3-codespan">GROUP 
BY</code> clause of the <code class="w3-codespan">SELECT</code> 
statement. The <code class="w3-codespan">GROUP BY</code> clause splits the result-set into groups of values and 
the aggregate function can be used to return a single value for each group.</p>
<p>The most commonly used SQL aggregate functions are:</p>
<ul>
  <li><code class="w3-codespan">MIN()</code> - returns the smallest value of a column</li>
  <li><code class="w3-codespan">MAX()</code> - returns the largest value of a column</li>
  <li><code class="w3-codespan">COUNT()</code> - returns the number of rows in a set</li>
  <li><code class="w3-codespan">SUM()</code> - returns the sum of a numerical column</li>
  <li><code class="w3-codespan">AVG()</code> - returns the average value of a numerical column</li>
</ul>
<p>Aggregate functions ignore null values (except for <code class="w3-codespan">COUNT(*)</code>).</p>
<p>We will go through the aggregate functions above in the next chapters.</p>
<hr>
