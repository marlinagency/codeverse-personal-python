...
<h1>Python <span class="color_h1">Interview Questions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_study_plan.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_bootcamp.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">This page contains a list of typical Python Interview Questions and Answers.</p>
<hr>
<h2>Python Interview Questions</h2>
<p>These questions and answers cover some fundamental Python concepts that are often discussed in interviews.</p>
<hr>


<h4>1) What is the difference between global and local scope?</h4>
<ul>
...
<li>A variable created in the main body of the Python code is a global variable and belongs to the global scope. Global variables are available from within any scope, global and local.</li>
</ul>
<hr>
<h4>2) What is an iterator in Python?</h4>
<ul>
...
<hr>
<h4>3) What is the __init__() function in Python?</h4>
<ul>
<li>All classes in Python have a function called __init__(), which is always executed when the class is being initiated.</li>
<li>We can use the __init__() function to assign values to object properties, or other operations that are necessary to do when the object is being created.</li>
</ul>
<hr>
<h4>4) When should you use lambda functions in Python?</h4>
<ul>
<li>Use lambda functions when an anonymous function is required for a short period of time.</li>
</ul>
<hr>

<h4>5) What is the difference between lists, tuples and sets?</h4>
<p>Lists, tuples, and sets are all used to store multiple items in a single variable, but they have different properties:</p>
<ul>
<li>A list is ordered and changeable. It allows duplicate values.
</li>
<li>A tuple is ordered but unchangeable (immutable). It also allows duplicates.
</li>
<li>A set is unordered, unindexed, and contains only unique items. It is changeable, but you cannot modify individual elements by index.</li>
</ul>
<hr>

<h4>6) How can you check if all the characters in a string are alphanumeric?</h4>
<ul>
<li>You can use the <code class="w3-codespan">isalnum()</code> method, which returns True if all the characters are alphanumeric, meaning alphabet letter (a-z) and numbers (0-9).</li>
</ul>
<hr>

<h4>7) How can you convert a string to an integer?</h4>
<ul>
<li>You can use the <code class="w3-codespan">int()</code> function, like this:</li>
...
<h4>8) What is indentation in Python, and why is it important?</h4>
<ul>
<li>Indentation refers to the spaces at the beginning of a code line. Where in other programming languages the indentation in code is for readability only, the indentation in Python is very important.</li>

<li>Python uses indentation to indicate a block of code.</li>
<li>Python will give you an error if you skip the indentation.</li>
</ul>
<hr>

<h4>9) What is the correct syntax to output the type of a variable or object in Python?</h4>
<ul>
<div class="w3-example">
<div class="w3-code notranslate pythonHigh">
print(type(x))  </div>
...
<h4>10) Which collection does not allow duplicate members?</h4>
<ul>
...
<h4>11) What is Inheritance in Python?</h4>
<ul>
...
<h4>12) What is the output of the following code?</h4>
<div class="w3-example">
  <div class="w3-code notranslate pythonHigh">
<pre>x = 41
...
<ul>
<li>Above ten,<br>
and also above 20!</li>
</ul>
<hr>


<h4>13) Can you list Python's primary built-in data types, in categories?</h4>
<ul>
<li>Text Type: <code class="w3-codespan">str</code></li>
<li>Numeric Types: <code class="w3-codespan">int</code>, <code class="w3-codespan">float</code>,
<code class="w3-codespan">complex</code></li>
<li>Sequence Types: <code class="w3-codespan">list</code>, <code class="w3-codespan">tuple</code>, 
    <code class="w3-codespan">range</code></li>
<li>Mapping Type: <code class="w3-codespan">dict</code></li>
<li>Set Types: <code class="w3-codespan">set</code>, <code class="w3-codespan">frozenset</code></li>
<li>Boolean Type: <code class="w3-codespan">bool</code></li>
<li>Binary Types: <code class="w3-codespan">bytes</code>, <code class="w3-codespan">bytearray</code>, 
    <code class="w3-codespan">memoryview</code></li>

</ul>
<hr>

<h4>14) What are Membership Operators?</h4>
<ul>
<li><p>Membership operators are used to test if a sequence is present in an object. The <code class="w3-codespan">in</code> and <code class="w3-codespan">not in</code> operators are examples of these:</p>
</li>
<div class="w3-example">
<div class="w3-code notranslate pythonHigh">
x = ["apple", "banana"]<br>
print("banana" in x) # returns True<br><br>
x = ["apple", "banana"]<br>
...
<h4>15) Which <span class="auto-style1">statement</span> can be used to avoid errors if an <code class="w3-codespan">if</code> statement has no content?</h4>
<ul>
<li>The <code class="w3-codespan">pass</code> statement</li>
</ul>
<hr>

<h4>16) What are Arbitrary Arguments?</h4>
<ul>
<li>Arbitrary Arguments are often shortened to <code class="w3-codespan">*args</code> in Python documentations.</li>
<li>If you do not know how many arguments that will be passed into your function, add a <code class="w3-codespan">*</code> before the parameter name in the function definition. This way the function will receive a tuple of arguments, and can access the items accordingly.</li>
</ul>
<hr>

<h4>17) How can you create and use a Module in Python??</h4>
<ul>
<li><p>To create a module just save the code you want in a file with the file extension <code class="w3-codespan">.py</code>:</p>
...
<h4>18) Can you copy a List in Python by simply writing: <code class="w3-codespan">list2 = 
list1</code>?</h4>
<ul>
<li>No, because: <code class="w3-codespan">list2</code> will only be a <em>
...
<code class="w3-codespan">list2</code>.</li>
<li>To make a copy of a list, you can use 
<code class="w3-codespan">copy()</code> or the <code class="w3-codespan">list()</code> method.</li>
</ul>
<hr>

<h4>19) How can you return a range of characters of a string?</h4>
<ul>
<li>You can return a range of characters by using the "slice syntax".</li>
<li>Specify the start index and the end index, separated by a colon, to return a part of the string, for example:</li>
<div class="w3-example">
...
<h4>20) What is a class in Python, and how do you use it?</h4>
<ul>

<li>A Class is like an object constructor, or a "blueprint" for creating objects.</li>

<li>You can create a class with the class keyword:
<div class="w3-example">
<div class="w3-code notranslate pythonHigh">
class MyClass:<br>
  x = 5
