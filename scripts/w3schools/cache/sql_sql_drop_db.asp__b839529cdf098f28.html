...
<p>The <code class="w3-codespan">DROP DATABASE</code> statement is used to permanently delete an existing SQL database.</p>
<div class="w3-panel ws-warning">
<p><strong>Note:</strong> Be careful before dropping a database! Dropping 
a database deletes the database and all its content (tables, views, stored procedures, and data)!</p>
</div>
...
<p><b>Tip:</b> You need administrative privileges to drop a database. </p>
</div>
<hr>

<h2>DROP DATABASE Example</h2>
<p>The following SQL statement drops an existing database named &quot;testDB&quot;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p><b>Tip:</b> Once a database is dropped, you can check that it is removed from the list of
databases with: <code class="w3-codespan">SHOW DATABASES;</code> (MySQL)
or <code class="w3-codespan">SELECT name FROM sys.databases;</code> (SQL Server).</p>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_drop_db.js"></div>
<hr>
