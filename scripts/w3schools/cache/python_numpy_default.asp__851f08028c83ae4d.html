...
<h2 class="left"><span class="left_h2">NumPy</span> Tutorial</h2>
<a target="_top" href="default.asp">NumPy HOME</a>
...
<a target="_top" href="numpy_array_filter.asp" class="not-wired">NumPy Array Filter</a>
<br>
<h2 class="left"><span class="left_h2">NumPy</span> Random</h2>
...
<a target="_top" href="numpy_random_zipf.asp" class="not-wired">Zipf Distribution</a>
<br>
<h2 class="left"><span class="left_h2">NumPy</span> ufunc</h2>
...
<a target="_top" href="numpy_ufunc_set_operations.asp" class="not-wired">ufunc Set Operations</a>
<br>
<h2 class="left"><span class="left_h2">NumPy</span> Cert</h2>
<a target="_top" class="no-checkmark" href="numpy_exam.asp">NumPy Certificate</a>
<br>
<h2 class="left">Quiz/Exercises</h2>
<a target="_top" class="no-checkmark" href="numpy_compiler.asp">NumPy Editor</a>
<a target="_top" class="no-checkmark" href="numpy_quiz.asp">NumPy Quiz</a>
<a target="_top" class="no-checkmark" href="numpy_exercises.asp">NumPy Exercises</a>
<a target="_top" class="no-checkmark" href="numpy_syllabus.asp">NumPy Syllabus</a>
<a target="_top" class="no-checkmark" href="numpy_study_plan.asp">NumPy Study Plan</a>
      <br><br>
    </div>
  </div>
</div>
...
<h1>NumPy <span class="color_h1">Tutorial</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="numpy_intro.asp">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#013243" viewBox="0 0 24 24"><path d="M10.315 4.876L6.3048 2.8517l-4.401 2.1965 4.1186 2.0683zm1.8381.9277l4.2045 2.1223-4.3622 2.1906-4.125-2.0718zm5.6153-2.9213l4.3193 2.1658-3.863 1.9402-4.2131-2.1252zm-1.859-.9329L12.021 0 8.1742 1.9193l4.0068 2.0208zm-3.0401 16.7443V24l4.7107-2.3507-.0053-5.3085zm4.7037-4.2057l-.0052-5.2528-4.6985 2.3356v5.2546zm5.6553-.9845v5.327l-4.0178 2.0052-.0029-5.3028zm0-1.8626V6.4214l-4.0253 2.001.0034 5.2633zM11.2062 11.571L8.0333 9.9756v6.895s-3.8804-8.2564-4.2399-8.998c-.0463-.0957-.2371-.2007-.2858-.2262C2.8118 7.2812.773 6.2485.773 6.2485V18.43l2.8204 1.5076v-6.3674s3.8392 7.3775 3.878 7.458c.0389.0807.4245.8582.8362 1.1314.5485.363 2.8992 1.7766 2.8992 1.7766z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn NumPy</h2>
    </div>
    <p class="cert-card-desc">NumPy is a Python library.</p>
    <p class="cert-card-desc">NumPy is used for working with arrays.</p>
    <p class="cert-card-desc">NumPy is short for "Numerical Python".</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="numpy_intro.asp" class="cert-card-btn">Learn NumPy now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become NumPy Certified</h3>
    <p class="cert-info-desc">Get certified with our NumPy exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/numpy-course" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="NumPy Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools NumPy Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#013243" viewBox="0 0 24 24"><path d="M10.315 4.876L6.3048 2.8517l-4.401 2.1965 4.1186 2.0683zm1.8381.9277l4.2045 2.1223-4.3622 2.1906-4.125-2.0718zm5.6153-2.9213l4.3193 2.1658-3.863 1.9402-4.2131-2.1252zm-1.859-.9329L12.021 0 8.1742 1.9193l4.0068 2.0208zm-3.0401 16.7443V24l4.7107-2.3507-.0053-5.3085zm4.7037-4.2057l-.0052-5.2528-4.6985 2.3356v5.2546zm5.6553-.9845v5.327l-4.0178 2.0052-.0029-5.3028zm0-1.8626V6.4214l-4.0253 2.001.0034 5.2633zM11.2062 11.571L8.0333 9.9756v6.895s-3.8804-8.2564-4.2399-8.998c-.0463-.0957-.2371-.2007-.2858-.2262C2.8118 7.2812.773 6.2485.773 6.2485V18.43l2.8204 1.5076v-6.3674s3.8392 7.3775 3.878 7.458c.0389.0807.4245.8582.8362 1.1314.5485.363 2.8992 1.7766 2.8992 1.7766z"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified NumPy Developer</text>
...
<p>In our &quot;Try it Yourself&quot; editor, you can use the NumPy module, and modify the code to see the result.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_create_array">Try it Yourself &raquo;</a>
</div>
...
<p><a class="w3-btn w3-margin-bottom ws-green" href="numpy_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all NumPy Exercises</a></p>


<hr>
<h2>Learning by Quiz Test</h2>
<p>Test your NumPy skills with a quiz test.</p>
<p><a href="numpy_quiz.asp" class="w3-button w3-blue">Start NumPy Quiz</a></p>
