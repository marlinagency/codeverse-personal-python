...
<html lang="en-US">
<head>
<title>SQL Parameters (Parameterized Queries)</title>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">Parameters</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_injection.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_prepared_statements.asp">Next &#10095;</a>
</div>
<hr>

<h2>SQL Parameters - Prevent SQL Injection</h2>
<p>SQL parameters (Parameterized Queries) can be used to protect a web site from SQL injections.</p>
<p>A parameterized query is a SQL statement that uses placeholders instead of 
directly adding the input values into the query text. The placeholders get replaced 
with the actual values when the query executes. This makes the queries more safe 
and more reusable.</p>
<p>Most databases support parameterized queries, but the syntax varies:</p>
<ul>
  <li>MySQL use ? for parameters</li>
  <li>SQL Server uses @ for parameters</li>
  <li>PostgreSQL uses $ for parameters</li>
</ul>
<p>SQL parameters are added to an SQL query at execution time, in a controlled manner.</p>
<div class="w3-example">
<h3>ASP.NET Razor Example</h3>
<div class="w3-code notranslate">
  userid = getRequestString(&quot;UserId&quot;);<br>query = &quot;SELECT *
FROM Users WHERE UserId = @userid&quot;;<br>db.Execute(query, userid);</div>
</div>
<p>Note that parameters in SQL Server are presented by a @ marker.</p>
...
<div class="w3-code notranslate">
  cname = getRequestString(&quot;CustomerName&quot;);<br>caddress = getRequestString(&quot;Address&quot;);<br>
  ccity = getRequestString(&quot;City&quot;);<br>
  query = &quot;INSERT INTO Customers (CustomerName, Address, City) Values(@cname, @caddress, @ccity)&quot;;<br>db.Execute(query, 
  cname, caddress, ccity);</div>
</div>
<hr>
...
<div class="w3-example">
<div class="w3-code notranslate">
  userid = getRequestString(&quot;UserId&quot;);<br>
  query = &quot;SELECT * FROM Customers WHERE CustomerId = @userid&quot;;<br>cmd = new SqlCommand(query);<br>cmd.Parameters.AddWithValue(&quot;@userid&quot;, 
  userid);<br>
...
<div class="w3-code notranslate">
  cname = getRequestString(&quot;CustomerName&quot;);<br>caddress = getRequestString(&quot;Address&quot;);<br>
  ccity = getRequestString(&quot;City&quot;);<br>
  query = &quot;INSERT INTO Customers (CustomerName, Address, City) Values(@cname, @caddress, @ccity)&quot;;<br>cmd = new SqlCommand(query);<br>
  cmd.Parameters.AddWithValue(&quot;@cname&quot;, cname);<br>
  cmd.Parameters.AddWithValue(&quot;@caddress&quot;, caddress);<br>
 cmd.Parameters.AddWithValue(&quot;@ccity&quot;, 
  ccity);<br>cmd.ExecuteNonQuery();</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_injection.js"></div>
<hr>
