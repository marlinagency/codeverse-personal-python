...
<h1>Python <span class="color_h1">Match</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_if_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_match.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">The <code class="w3-codespan">match</code> statement is used to perform different actions based on different conditions.</p>
<hr>
<h2>The Python Match Statement</h2>

<p>Instead of writing <strong>many</strong> <code class="w3-codespan">if..else</code> statements, you can use the <code class="w3-codespan">match</code> statement.</p>

<p>The <code class="w3-codespan">match</code> statement selects one of many code blocks to be executed.</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate pythonHigh">
match <em>expression</em>:<br>
&nbsp;&nbsp;case x:<br>
&nbsp;&nbsp;&nbsp;&nbsp;code block<br>
&nbsp;&nbsp;case y:<br>
&nbsp;&nbsp;&nbsp;&nbsp;code block<br>
...
<ul>
<li>The <code class="w3-codespan">match</code> expression is evaluated once.</li>
...
<p>The example below uses the weekday number to print the weekday name:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_match_case">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Default Value</h2>
<p>Use the underscore character <span class="w3-codespan">_</span> as the last 
case value if you want a code block to execute when there are not other matches:</p>
...
match day:<br>
&nbsp;&nbsp;case 6:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("Today is Saturday")<br>
&nbsp;&nbsp;case 7:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("Today is Sunday")<br>
&nbsp;&nbsp;case _:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("Looking forward to the Weekend")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_match_default">Try it Yourself &raquo;</a>
</div>

<p>The value <span class="w3-codespan">_</span> will always match, so it is important to place it as the 
<em>last</em> <span class="w3-codespan">case</span> to make it 
behave as a default <span class="w3-codespan">case</span>.</p>

<hr>
<h2>Combine Values</h2>
<p>Use the pipe character <span class="w3-codespan">|</span> as an or operator in the <span class="w3-codespan">case</span> evaluation to check 
for more than one value match in one <span class="w3-codespan">case</span>:</p>
...
match day:<br>
&nbsp;&nbsp;case 1 | 2 | 3 | 4 | 5:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("Today is a weekday")<br>
&nbsp;&nbsp;case 6 | 7:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("I love 
  weekends!")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_match_or">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>If Statements as Guards</h2>
<p>You can add <code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statements in the case evaluation as an extra condition-check:</p>
...
day = 4<br>
match day:<br>
&nbsp;&nbsp;case 1 | 2 | 3 | 4 | 5 if month == 4:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("A weekday in April")<br>
&nbsp;&nbsp;case 1 | 2 | 3 | 4 | 5 if month == 5:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("A weekday in May")<br>
&nbsp;&nbsp;case _:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("No match")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_match_guard">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_match.js"></div>
<hr>
