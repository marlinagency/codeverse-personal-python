...
<a class="w3-left w3-btn" href="python_compiler.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_quiz.asp">Next &#10095;</a>
</div>
<hr>
<p>Test your Python skills with exercises from all categories:</p>
<style>
.exercise_tiles {
  background:#f3f4f6;
  border-radius:12px;
...
.exercise_tile h2 {
font-family:'Source Sans Pro',system-ui,Segoe UI,Roboto,Ubuntu,sans-serif;
  font-size:16px;
  font-weight:600;
  line-height:1.2;
  margin:0;
}
.exercise_tile h2 small{
  display:block;
  font-weight:400;
  font-size:13px;
  color:#6b7280;
...
.exercise_tiles a { text-decoration:none; color:inherit; }
.exercise_toolbar{
  display:flex;
  align-items:center;
  gap:10px;
...
.exercise_tile .tile-content {
  display:flex;
  align-items:center;
  flex:1;
}
.exercise_tile .open-btn {
  background:#ffffff;
  border:1px solid #D1D5DB;
  border-radius:5px;
  padding:6px 14px;
...
.exercise_tile .open-btn:hover {
  background:#F9FAFB;
  border-color:#9CA3AF;
}
.exercise_tile .complete-checkbox {
  display:none;
  width:18px;
  height:18px;
  margin-left:12px;
...
.exercise_tile.completed .done-label {
  color:#10a37f;
}
...
<div class="exercise_tiles">
<h2 class="heading">Exercises</h2>
<p style="margin-top:6px;" class="ws-hide-on-logged-in"><strong>Tip:</strong> <a style="text-decoration:underline" href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-cssdefaultsignup" title="Create an account to track your progress and earn XP">Sign in</a> to track your progress.</p>
<div class="exercise_toolbar">
  
  <input id="exercise_filter" type="search" placeholder="Filter categories (e.g. strings, loops, files, etc.)" aria-label="Filter categories">
  <div id="exercise_counter"><span class="count">0</span>/99 done</div>
</div>

<a href='exercise.asp?x=xrcise_getstarted1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_getstarted'><div class='tile-content'><h2>Get Started<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Get Started exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Get Started completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_syntax1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_syntax'><div class='tile-content'><h2>Syntax<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Syntax exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Syntax completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_comments1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_comments'><div class='tile-content'><h2>Comments<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Comments exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Comments completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_variables1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_variables'><div class='tile-content'><h2>Variables<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Variables exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Variables completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_variables_names1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_variables_names'><div class='tile-content'><h2>Variable Names<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Variable Names exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Variable Names completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_variables_multiple1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_variables_multiple'><div class='tile-content'><h2>Multiple Variable Values<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Multiple Variable Values exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Multiple Variable Values completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_variables_output1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_variables_output'><div class='tile-content'><h2>Output Variable<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Output Variable exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Output Variable completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_variables_global1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_variables_global'><div class='tile-content'><h2>Global Variable<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Global Variable exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Global Variable completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_datatypes1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_datatypes'><div class='tile-content'><h2>Data Types<small>8 exercises</small></h2></div><button class='open-btn' aria-label='Open Data Types exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Data Types completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_numbers1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_numbers'><div class='tile-content'><h2>Numbers<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Numbers exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Numbers completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_casting1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_casting'><div class='tile-content'><h2>Casting<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Casting exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Casting completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_strings1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_strings'><div class='tile-content'><h2>Strings<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Strings exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Strings completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_strings_slicing1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_strings_slicing'><div class='tile-content'><h2>Slicing Strings<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Slicing Strings exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Slicing Strings completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_strings_modify1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_strings_modify'><div class='tile-content'><h2>Modify Strings<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open Modify Strings exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Modify Strings completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_strings_concatenate1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_strings_concatenate'><div class='tile-content'><h2>Concatenate Strings<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Concatenate Strings exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Concatenate Strings completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_strings_format1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_strings_format'><div class='tile-content'><h2>Format Strings<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Format Strings exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Format Strings completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_booleans1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_booleans'><div class='tile-content'><h2>Booleans<small>6 exercises</small></h2></div><button class='open-btn' aria-label='Open Booleans exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Booleans completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_arithmetic1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_arithmetic'><div class='tile-content'><h2>Arithmetic Operators<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open Arithmetic Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Arithmetic Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_assign1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_assign'><div class='tile-content'><h2>Assignment Operators<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Assignment Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Assignment Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_comparison1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_comparison'><div class='tile-content'><h2>Comparison Operators<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Comparison Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Comparison Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_logical1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_logical'><div class='tile-content'><h2>Logical Operators<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Logical Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Logical Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_identity1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_identity'><div class='tile-content'><h2>Identity Operators<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Identity Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Identity Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_membership1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_membership'><div class='tile-content'><h2>Membership Operators<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Membership Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Membership Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_bitwise1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_bitwise'><div class='tile-content'><h2>Bitwise Operators<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Bitwise Operators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Bitwise Operators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_operators_precedence1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_operators_precedence'><div class='tile-content'><h2>Operator Precedence<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Operator Precedence exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Operator Precedence completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists'><div class='tile-content'><h2>Lists<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_access1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_access'><div class='tile-content'><h2>Access Lists<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Access Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Access Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_change1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_change'><div class='tile-content'><h2>Change Lists<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Change Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Change Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_add1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_add'><div class='tile-content'><h2>Add List Items<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Add List Items exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Add List Items completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_remove1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_remove'><div class='tile-content'><h2>Remove List Items<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Remove List Items exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Remove List Items completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_loop1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_loop'><div class='tile-content'><h2>Loop Lists<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Loop Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Loop Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_comprehension1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_comprehension'><div class='tile-content'><h2>List Comprehension<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open List Comprehension exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='List Comprehension completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_sort1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_sort'><div class='tile-content'><h2>Sort Lists<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Sort Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Sort Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_copy1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_copy'><div class='tile-content'><h2>Copy Lists<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Copy Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Copy Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lists_join1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lists_join'><div class='tile-content'><h2>Join Lists<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Join Lists exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Join Lists completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_tuples1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_tuples'><div class='tile-content'><h2>Tuples<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Tuples exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Tuples completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_tuples_access1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_tuples_access'><div class='tile-content'><h2>Access Tuples<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Access Tuples exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Access Tuples completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_tuples_update1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_tuples_update'><div class='tile-content'><h2>Update Tuples<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Update Tuples exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Update Tuples completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_tuples_unpack1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_tuples_unpack'><div class='tile-content'><h2>Unpack Tuples<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Unpack Tuples exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Unpack Tuples completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_tuples_loop1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_tuples_loop'><div class='tile-content'><h2>Loop Tuples<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Loop Tuples exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Loop Tuples completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_tuples_join1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_tuples_join'><div class='tile-content'><h2>Join Tuples<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Join Tuples exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Join Tuples completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets'><div class='tile-content'><h2>Sets<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Sets exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Sets completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets_access1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets_access'><div class='tile-content'><h2>Access Sets<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Access Sets exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Access Sets completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets_add1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets_add'><div class='tile-content'><h2>Add Set Items<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Add Set Items exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Add Set Items completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets_remove1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets_remove'><div class='tile-content'><h2>Remove Set Items<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Remove Set Items exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Remove Set Items completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets_loop1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets_loop'><div class='tile-content'><h2>Loop Sets<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Loop Sets exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Loop Sets completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets_join1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets_join'><div class='tile-content'><h2>Join Sets<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Join Sets exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Join Sets completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_sets_frozenset1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sets_frozenset'><div class='tile-content'><h2>Frozenset<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Frozenset exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Frozenset completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries'><div class='tile-content'><h2>Dictionaries<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Dictionaries exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Dictionaries completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_access1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_access'><div class='tile-content'><h2>Access Dictionaries<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Access Dictionaries exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Access Dictionaries completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_change1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_change'><div class='tile-content'><h2>Change Dictionaries<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Change Dictionaries exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Change Dictionaries completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_add1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_add'><div class='tile-content'><h2>Add Dictionary Items<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Add Dictionary Items exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Add Dictionary Items completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_remove1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_remove'><div class='tile-content'><h2>Remove Dictionary Items<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Remove Dictionary Items exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Remove Dictionary Items completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_loop1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_loop'><div class='tile-content'><h2>Loop Dictionaries<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Loop Dictionaries exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Loop Dictionaries completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_copy1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_copy'><div class='tile-content'><h2>Copy Dictionaries<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Copy Dictionaries exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Copy Dictionaries completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dictionaries_nested1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dictionaries_nested'><div class='tile-content'><h2>Nested Dictionaries<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Nested Dictionaries exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Nested Dictionaries completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_conditions1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_conditions'><div class='tile-content'><h2>If<small>6 exercises</small></h2></div><button class='open-btn' aria-label='Open If exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='If completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_if_elif1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_if_elif'><div class='tile-content'><h2>Elif<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Elif exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Elif completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_if_else1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_if_else'><div class='tile-content'><h2>Else<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open Else exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Else completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_if_shorthand1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_if_shorthand'><div class='tile-content'><h2>Shorthand If<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Shorthand If exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Shorthand If completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_if_logical1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_if_logical'><div class='tile-content'><h2>Logical<small>6 exercises</small></h2></div><button class='open-btn' aria-label='Open Logical exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Logical completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_if_nested_if1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_if_nested_if'><div class='tile-content'><h2>Nested If<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Nested If exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Nested If completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_if_pass1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_if_pass'><div class='tile-content'><h2>Pass<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Pass exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Pass completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_match1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_match'><div class='tile-content'><h2>Match<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Match exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Match completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_while_loops1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_while_loops'><div class='tile-content'><h2>While Loops<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open While Loops exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='While Loops completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_for_loops1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_for_loops'><div class='tile-content'><h2>For Loops<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open For Loops exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='For Loops completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_functions1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_functions'><div class='tile-content'><h2>Functions<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Functions exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Functions completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_arguments1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_arguments'><div class='tile-content'><h2>Args / Kwargs<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Args / Kwargs exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Args / Kwargs completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_args_kwargs1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_args_kwargs'><div class='tile-content'><h2>Args / Kwargs<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Args / Kwargs exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Args / Kwargs completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_decorators1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_decorators'><div class='tile-content'><h2>Decorators<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Decorators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Decorators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_scope1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_scope'><div class='tile-content'><h2>Scope<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Scope exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Scope completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_lambda1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_lambda'><div class='tile-content'><h2>Lambda<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Lambda exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Lambda completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_range1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_range'><div class='tile-content'><h2>Range<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Range exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Range completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_arrays1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_arrays'><div class='tile-content'><h2>Arrays<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Arrays exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Arrays completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_iterators1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_iterators'><div class='tile-content'><h2>Iterators<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Iterators exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Iterators completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_modules1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_modules'><div class='tile-content'><h2>Modules<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open Modules exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Modules completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_dates1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_dates'><div class='tile-content'><h2>Dates<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Dates exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Dates completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_math1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_math'><div class='tile-content'><h2>Math<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Math exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Math completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_json1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_json'><div class='tile-content'><h2>JSON<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open JSON exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='JSON completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_regex1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_regex'><div class='tile-content'><h2>RegEx<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open RegEx exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='RegEx completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_pip1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_pip'><div class='tile-content'><h2>PIP<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open PIP exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='PIP completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_try_except1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_try_except'><div class='tile-content'><h2>Try Except<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Try Except exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Try Except completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_none1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_none'><div class='tile-content'><h2>None<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open None exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='None completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_user_input1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_user_input'><div class='tile-content'><h2>User Input<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open User Input exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='User Input completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_string_formatting1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_string_formatting'><div class='tile-content'><h2>String Formatting<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open String Formatting exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='String Formatting completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_virtualenv1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_virtualenv'><div class='tile-content'><h2>Virtual Environment<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Virtual Environment exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Virtual Environment completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_classes1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_classes'><div class='tile-content'><h2>Classes<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Classes exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Classes completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_class_init1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_class_init'><div class='tile-content'><h2>__init__ Method<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open __init__ Method exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='__init__ Method completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_class_self1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_class_self'><div class='tile-content'><h2>Self Parameter<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Self Parameter exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Self Parameter completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_class_properties1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_class_properties'><div class='tile-content'><h2>Class Properties<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Class Properties exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Class Properties completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_class_methods1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_class_methods'><div class='tile-content'><h2>Class Methods<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open Class Methods exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Class Methods completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_inheritance1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_inheritance'><div class='tile-content'><h2>Inheritance<small>5 exercises</small></h2></div><button class='open-btn' aria-label='Open Inheritance exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Inheritance completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_polymorphism1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_polymorphism'><div class='tile-content'><h2>Polymorphism<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Polymorphism exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Polymorphism completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_encapsulation1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_encapsulation'><div class='tile-content'><h2>Encapsulation<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Encapsulation exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Encapsulation completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_class_inner1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_class_inner'><div class='tile-content'><h2>Inner Class<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Inner Class exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Inner Class completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_file_handling1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_file_handling'><div class='tile-content'><h2>File Handling<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open File Handling exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='File Handling completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_file_open1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_file_open'><div class='tile-content'><h2>Open File<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Open File exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Open File completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_file_write1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_file_write'><div class='tile-content'><h2>Write to File<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Write to File exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Write to File completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.asp?x=xrcise_file_remove1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_file_remove'><div class='tile-content'><h2>Remove File<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Remove File exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Remove File completed' disabled><span class='done-label'>Done</span></div></a>
</div>

<script>
var storageBlip = "python_";
var exnames = [];
var answerObj = {};
...
function check_if_completed() {
  // Show counter for all users
  document.getElementById("exercise_counter").style.display = "block";

  // Always check new embedded exercise format (localStorage) - works for logged out users too
  checkNewExerciseCompletion();
  updateCompletionCounter();

  if (userLoggedOn == false) return false;
  document.querySelectorAll(".done-label").forEach(function(el) { el.style.display = "inline"; });
  document.querySelectorAll(".complete-checkbox").forEach(function(el) { el.style.display = "inline"; });
        ...
        for (i = 0; i < exnames.length; i++) {
          ...
          if (completed) {
            ...
            if (document.getElementById("xr_" + cc)) {
              var tile = document.getElementById("xr_" + cc);
              tile.classList.add("completed");
              var checkbox = tile.querySelector(".complete-checkbox");
...
function checkNewExerciseCompletion() {
  // Map of exercise IDs to topics in new format
  var exerciseTopics = {
    "intro": "intro",
    "basic": "basic",
    "elements": "elements",
    ...
    "quotation_elements": "quotation_elements",
    "comments": "comments",
    "colors": "colors",
    "colors_rgb": "colors_rgb",
    "colors_hex": "colors_hex",
    "colors_hsl": "colors_hsl",
    "css": "css",
    "links": "links",
    "links_colors": "links_colors",
    "links_bookmarks": "links_bookmarks",
    "images": "images",
    "images_imagemap": "images_imagemap",
    "images_background": "images_background",
    "images_picture": "images_picture",
    "favicon": "favicon",
    ...
    "table_padding_spacing": "table_padding_spacing",
    "table_colspan_rowspan": "table_colspan_rowspan",
    "lists": "lists",
    "lists_unordered": "lists_unordered",
    "lists_ordered": "lists_ordered",
    "lists_other": "lists_other",
    "blocks": "blocks",
    "div": "div",
    "classes": "classes",
    "id": "id",
    ...
    "computercode_elements": "computercode_elements",
    "semantic_elements": "semantic_elements",
    "entities": "entities",
    "forms": "forms",
    "forms_attributes": "forms_attributes",
    "form_elements": "form_elements",
    "form_input_types": "form_input_types",
    "form_attributes": "form_attributes",
    "form_attributes_form": "form_attributes_form"
  };

  var topicBase = storageBlip.replace("_", ""); // "html_" -> "html"

  for (var exId in exerciseTopics) {
    var topic = exerciseTopics[exId];
    var storageKey = topicBase + "_exercises_completed_" + topic;
    var stored = localStorage.getItem(storageKey);
    if (stored) {
      var completed = JSON.parse(stored);
      // Get total exercises for this topic from xrcisecategories.inc
      var totalExercises = getExerciseCountForTopic(topic);
      // Mark as completed only when ALL exercises for this topic are done
      if (completed.length >= totalExercises && document.getElementById("xr_" + exId)) {
        var tile = document.getElementById("xr_" + exId);
...
function getExerciseCountForTopic(topic) {
  // Exercise counts from xrcisecategories.inc
  var counts = {
    "intro": 3,
    "basic": 4,
    "elements": 3,
    ...
    "table_sizes": 3,
    "table_headers": 3,
    "table_padding_spacing": 3,
    "table_colspan_rowspan": 3,
    "lists": 3,
    "lists_unordered": 4,
    "lists_ordered": 4,
    "lists_other": 3,
    ...
    "form_input_types": 6,
    "form_attributes": 5,
    "form_attributes_form": 3
  };
  return counts[topic] || 1;
}

function updateCompletionCounter() {
  var completedCount = document.querySelectorAll(".exercise_tile.completed").length;
  var totalCount = document.querySelectorAll(".exercise_tile").length;
  var counter = document.getElementById("exercise_counter");
  if (counter) {
    counter.innerHTML = '<span class="count">' + completedCount + '</span>/' + totalCount + ' done';
  }
}

var filterInput = document.getElementById("exercise_filter");
if (filterInput) {
  filterInput.addEventListener("input", function() {
    var searchTerm = this.value.toLowerCase().trim();
    var tiles = document.querySelectorAll(".exercise_tile");
    
    tiles.forEach(function(tile) {
      var heading = tile.querySelector("h2");
      if (heading) {
        var text = heading.textContent.toLowerCase();
        var parentLink = tile.closest("a");
...
<p>If you haven't already, <a href="https://profile.w3schools.com/sign-up">sign up</a> to become a W3Schooler, and get points for every exercise you complete.</p>
<p>As a logged-in W3Schools user you will have access to many features like having <a href="/spaces/index.php">your own web page</a>,
<a href="https://profile.w3schools.com/signup?redirect_url=https%3A%2F%2Fwww.w3schools.com%2F">track your learning progress</a>,
<a href="/pathfinder/pathfinder_goals.php">receive personal guided paths</a>, and
<a href="https://order.w3schools.com/plans" target="_blank">more</a>.</p>
<hr>
</div>

<h2>The Exercise</h2>
<p>The exercises are a mix of "multiple choice" and "fill in the blanks" questions.</p>
<p>There are between 3 and 9 questions in each category.</p>
<p>The answer can be found in the corresponding tutorial chapter.</p>
<p>If you're stuck, or answer wrong, you can try again or hit the "Show Answer" button to see the correct answer.</p>
