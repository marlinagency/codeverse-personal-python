...
<h1>Python <span class="color_h1">Bitwise Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_membership.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_operators_precedence.asp">Next &#10095;</a>
</div>
<hr>
...
<td>x &amp; y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_and">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>|</td>
<td>OR</td>
...
<td>x | y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_or">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>^</td>
<td>XOR</td>
...
<td>x ^ y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_xor">Try it &raquo;</a></td>
  </tr>
<tr>
<td>~</td>
<td>NOT</td>
...
<td>~x</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_not">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;&lt;</td>
...
<td>x &lt;&lt; 2</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_left_shift">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;&gt;</td>
...
<td>x &gt;&gt; 2</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_right_shift">Try it &raquo;</a></td>
</tr>
</table>
...
<h3>Example</h3>
<p>The &amp; operator compares each bit and set it to 1 if both are 1, otherwise it is set to 0:</p>
<div class="w3-code notranslate pythonHigh">
print(6 &amp; 3)
</div>
<p>The binary representation of 6 is 0110<br>
The binary representation of 3 is 0011</p>
<p>Then the &amp; operator compares the bits and returns 0010, which is 2 in decimal.</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_bitwise_and">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The | operator compares each bit and set it to 1 if one or both is 1, otherwise it is set to 0:</p>
<div class="w3-code notranslate pythonHigh">
print(6 | 3)
</div>
<p>The binary representation of 6 is 0110<br>
The binary representation of 3 is 0011</p>
<p>Then the | operator compares the bits and returns 0111, which is 7 in decimal.</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_bitwise_or">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The ^ operator compares each bit and set it to 1 if only one is 1, otherwise (if both are 1 or both are 0) it is set to 0:</p>
<div class="w3-code notranslate pythonHigh">
print(6 ^ 3)
</div>
<p>The binary representation of 6 is 0110<br>
The binary representation of 3 is 0011</p>
<p>Then the ^ operator compares the bits and returns 0101, which is 5 in decimal.</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_xor">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_bitwise.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_membership.asp">&#10094; Previous</a>
