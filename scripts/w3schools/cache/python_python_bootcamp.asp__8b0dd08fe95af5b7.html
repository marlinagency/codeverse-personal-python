...
<html lang="en-US">
<head>
<title>W3Schools Python Bootcamp</title>
<meta charset="utf-8">
...
<h1>W3Schools <span class="color_h1">Python Bootcamp</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_interview_questions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_training.asp">Next &#10095;</a>
</div>
<hr>

<div class="ws-light-green caption w3-round" style="padding-top:50px;padding-bottom:50px;position:relative;">
  <div style="max-width:1300px;margin:auto">
    <h1 class="bctop">Python Bootcamp</h1>
    <h4 class="bctop" style="margin-top:15px"><i class="fa fa-logo" style="vertical-align:middle;color:#04AA6D;font-size:30px!important;margin-right:5px;"></i> Learn with W3Schools.</h4>
    <h4 style="margin-top:15px;">Live online learning sessions.</h4>
    <h4 style="margin-top:15px;"><strong>Duration</strong>: 4 Weeks.</h4>

    <p style="margin-top:8px;"><a title="Learn More" target="_blank" href="/bootcamp/python.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:8px 16px;margin-right:5px;margin-top:16px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>

    <svg class="ws-hide-700" style="width:180px;transform: rotate(10deg);position:absolute;right:45px;top:275px" id="w3_cert_badge" data-name="w3_cert_badge" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
      <defs>
      </defs>
      <circle class="cls-1" cx="150" cy="150" r="146.47" transform="translate(-62.13 150) rotate(-45)"></circle><text class="cls-2" transform="translate(93.54 63.89) rotate(-29.5)">w</text><text class="cls-2" transform="translate(107.13 56.35) rotate(-20.8)">3</text><text class="cls-2" transform="matrix(0.98, -0.21, 0.21, 0.98, 121.68, 50.97)">s</text><text class="cls-2" transform="translate(136.89 47.84) rotate(-3.47)">c</text><text class="cls-2" transform="translate(152.39 47.03) rotate(5.12)">h</text><text class="cls-2" transform="translate(167.85 48.54) rotate(13.72)">o</text><text class="cls-2" transform="translate(182.89 52.35) rotate(22.34)">o</text><text class="cls-2" transform="matrix(0.86, 0.52, -0.52, 0.86, 197.18, 58.36)">l</text><text class="cls-2" transform="matrix(0.77, 0.64, -0.64, 0.77, 210.4, 66.46)">s</text><text class="cls-3" transform="translate(35.51 186.66) rotate(69.37)"> </text><text class="cls-3" transform="matrix(0.47, 0.88, -0.88, 0.47, 41.27, 201.28)">B</text><text class="cls-3" transform="matrix(0.58, 0.81, -0.81, 0.58, 48.91, 215.03)">O</text><text class="cls-3" transform="matrix(0.67, 0.74, -0.74, 0.67, 58.13, 227.36)">O</text><text class="cls-3" transform="translate(69.16 238.92) rotate(39.44)">T</text><text class="cls-3" transform="matrix(0.85, 0.53, -0.53, 0.85, 81.47, 248.73)">C</text><text class="cls-3" transform="translate(94.94 256.83) rotate(24.36)">A</text><text class="cls-3" transform="translate(109.34 263.09) rotate(16.83)">M</text><text class="cls-3" transform="translate(124.46 267.41) rotate(9.34)">P</text><text class="cls-3" transform="translate(155.7 270.01) rotate(-5.58)"> </text><text class="cls-3" transform="translate(171.32 268.24) rotate(-13.06)"> </text><text class="cls-2" transform="translate(187.55 266.81) rotate(-21.04)">.</text><text class="cls-3" transform="translate(203.27 257.7) rotate(-29.24)"> </text><text class="cls-3" transform="translate(216.84 249.83) rotate(-36.75)"> </text><text class="cls-3" transform="translate(229.26 240.26) rotate(-44.15)">2</text><text class="cls-3" transform="translate(240.39 229.13) rotate(-51.62)">0</text><text class="cls-3" transform="translate(249.97 216.63) rotate(-59.17)">2</text><text class="cls-3" transform="matrix(0.4, -0.92, 0.92, 0.4, 257.81, 203.04)">6</text>
...
<div class="caption" style="padding-left:0;padding-right:0;font-family: 'Source Sans Pro', sans-serif;">
  <h1>Live Online Bootcamp</h1>
  <div style="max-width:950px">
      <p>In this bootcamp, you will learn the fundamentals of Python. This powerful programming language is widely used in web development, data science and artificial intelligence, and many other fields.</p>
      <p>You will learn the fundamentals of Python over a 4 weeks period together with a live instructor and an interactive cohort of engaged learners!</p>

    <h5 style="font-size:30px;font-weight:bold;">You Will Learn</h5>

    <ul style="font-size:16px;">
      <li>The fundamentals of the Python language & syntax. Fundamentals including variables and datatypes, through to control structures, arrays, functions, objects, and more.</li>
      <li>To write scripts for automating tasks using Python.</li>
      <li>To create and serve web applications.</li>
      <li>To write programs for mathematical and scientific computing using Python and relevant libraries.</li>
      <li>Use object-oriented programming and third-party libraries.</li>
      <li>To build secure and reliable applications.</li>
    </ul>

  </div>
</div>
<div style="background-color:#F3ECEA;padding-top:30px;color:black" class="w3-round">
  <h3 style="text-align:center;font-size:25px;font-weight:bold">3 Reasons to Join the Bootcamp</h3>
  <div class="col-container w3-center">
    <div class="col firstcol">
      <h4 style="font-size:18px;font-weight:700;margin-top:16px;">1. Live Online Instruction</h4>
      <h6>Learn directly from experienced instructors through live online learning sessions.</h6>
    </div>

    <div class="col secondcol">
      <h4 style="font-size:18px;font-weight:700;margin-top:16px;">2. Live Sessions</h4>
      <h6>Learn three evenings per week between 7pm and 9pm, available in multiple time zones.</h6>
    </div>


    <div class="col">
      <h4 style="font-size:18px;font-weight:700;margin-top:16px;">3. Affordable & Flexible</h4>
      <h6>One of the most affordable instructor-led online bootcamps, with flexible payment options.</h6>
    </div>
  </div>
  <p style="margin-top:8px;text-align:center;padding-bottom:45px;"><a title="Learn More" target="_blank" href="/bootcamp/python.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn ga-featured">Learn More</a></p>
</div>

<div class="w3-white learnproven lesserpaddingtopbtm " style="margin-top:40px;color:black;font-family: 'Source Sans Pro', sans-serif;">
  <div style="max-width:1350px;margin:auto;padding-left:24px;padding-right:24px;">
    <h5 style="font-size:30px;font-weight:bold;">How it Works</h5>

    <div style="text-align:left;font-family: 'Source Sans Pro', sans-serif;">
      <h4 style='font-size:18px;margin-bottom:20px'><strong>1. Application and Enrollment</strong>:<br>
      ...
      <h4 style='font-size:18px;margin-bottom:20px'><strong>2. Complete the Bootcamp</strong>:<br>
        ...
        <br><br>The bootcamp covers the fundamentals of Python. The curriculum used is the <a target="_blank" href="https://www.w3schools.com/python/default.asp">W3Schools Python Tutorial</a>. The bootcamp will help you prepare for the W3Schools Python exam so that you can document and validate your competence.
        <br><br>Throughout the bootcamp, you will receive support from your cohort and the W3Schools team to help you grow your skill set.
      </h4>

      <h4 style='font-size:18px;'><strong>3. Certification and Job Application</strong>:<br>
         Upon completing the bootcamp, you will have passed the W3Schools Python exam and obtained the <strong>Certified Python Developer</strong> Title and an extra acknowledgement that you were a part of the bootcamp on the certification. This certification demonstrates that you know the fundamentals of Python. 
      </h4>
      <p><a title="Learn More" target="_blank" href="/bootcamp/python.php" style="margin-top:15px;width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
    </div>
  </div>
</div>
