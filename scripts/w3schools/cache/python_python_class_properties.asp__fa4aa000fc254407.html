...
<html lang="en-US">
<head>
<title>Python Class Properties</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Class Properties</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_class_self.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_class_properties.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Class Properties</h2>

<p>Properties are variables that belong to a class. They store data for each object created from the class.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a class with properties:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person("Emil", 36)<br><br>print(p1.name)<br>print(p1.age)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_properties1">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can access object properties using dot notation:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Access the properties of an object:</p>
<div class="w3-code notranslate pythonHigh">
class Car:<br>&nbsp; def __init__(self, brand, model):<br>&nbsp;&nbsp;&nbsp; self.brand = brand<br>&nbsp;&nbsp;&nbsp; self.model = model<br><br>car1 = Car("Toyota", "Corolla")<br><br>print(car1.brand)<br>print(car1.model)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_properties2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>You can modify the value of properties on objects:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the age property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person("Tobias", 25)<br>print(p1.age)<br><br>p1.age = 26<br>print(p1.age)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class6">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can delete properties from objects using the <code class="w3-codespan"><a href="ref_keyword_del.asp">del</a></code> keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Delete the age property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person("Linus", 30)<br><br>del p1.age<br><br>print(p1.name)  # This works<br># print(p1.age)  # This would cause an error</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class7">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Class Properties vs Object Properties</h2>

<p>Properties defined inside <code class="w3-codespan">__init__()</code> belong to each object (instance properties).</p>

<p>Properties defined outside methods belong to the class itself (class properties) and are shared by all objects:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Class property vs instance property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; species = "Human"  # Class property<br><br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name  # Instance property<br><br>p1 = Person("Emil")<br>p2 = Person("Tobias")<br><br>print(p1.name)<br>print(p2.name)<br>print(p1.species)<br>print(p2.species)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_properties_class">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Modifying Class Properties</h2>

<p>When you modify a class property, it affects all objects:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change a class property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; lastname = ""<br><br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br><br>p1 = Person("Linus")<br>p2 = Person("Emil")<br><br>Person.lastname = "Refsnes"<br><br>print(p1.lastname)<br>print(p2.lastname)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_properties_modify">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-example">
<h3>Example</h3>
<p>Add a new property to an object:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br><br>p1 = Person("Tobias")<br><br>p1.age = 25<br>p1.city = "Oslo"<br><br>print(p1.name)<br>print(p1.age)<br>print(p1.city)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_properties_add">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Adding properties this way only adds them to that specific object, not to all objects of the class.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_class_properties.js"></div>
<hr>
