...
<h1>Python <span class="color_h1">Encapsulation</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_polymorphism.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_encapsulation.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Python Encapsulation</h2>

<p>Encapsulation is about protecting data inside a class.</p>

<p>It means keeping data (properties) and methods together in a class, while controlling how the data can be accessed from outside the class.</p>

<p>This prevents accidental changes to your data and hides the internal details of how your class works.</p>
<!--stop-->
<hr>
...
<p>In Python, you can make properties private by using a double underscore <code class="w3-codespan">__</code> prefix:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a private class property named <code class="w3-codespan">__age</code>:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.__age = age  # Private property<br><br>p1 = Person("Emil", 25)<br>print(p1.name)<br>print(p1.__age)  # This will cause an error</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_private">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Private properties cannot be accessed directly from outside the class.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Get Private Property Value</h2>

<p>To access a private property, you can create a getter method:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use a getter method to access a private property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.__age = age<br><br>&nbsp; def get_age(self):<br>&nbsp;&nbsp;&nbsp; return self.__age<br><br>p1 = Person("Tobias", 25)<br>print(p1.get_age())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_getter">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Set Private Property Value</h2>

<p>To modify a private property, you can create a setter method.</p>

<p>The setter method can also validate the value before setting it:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use a setter method to change a private property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.__age = age<br><br>&nbsp; def get_age(self):<br>&nbsp;&nbsp;&nbsp; return self.__age<br><br>&nbsp; def set_age(self, age):<br>&nbsp;&nbsp;&nbsp; if age &gt; 0:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.__age = age<br>&nbsp;&nbsp;&nbsp; else:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Age must be positive")<br><br>p1 = Person("Tobias", 25)<br>print(p1.get_age())<br><br>p1.set_age(26)<br>print(p1.get_age())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_setter">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>Encapsulation provides several benefits:</p>

<ul>
  <li><strong>Data Protection:</strong> Prevents accidental modification of data</li>
  ...
  <li><strong>Control:</strong> You have full control over how data is accessed and modified</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Use encapsulation to protect and validate data:</p>
<div class="w3-code notranslate pythonHigh">
class Student:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.__grade = 0<br><br>&nbsp; def set_grade(self, grade):<br>&nbsp;&nbsp;&nbsp; if 0 &lt;= grade &lt;= 100:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.__grade = grade<br>&nbsp;&nbsp;&nbsp; else:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Grade must be between 0 and 100")<br><br>&nbsp; def get_grade(self):<br>&nbsp;&nbsp;&nbsp; return self.__grade<br><br>&nbsp; def get_status(self):<br>&nbsp;&nbsp;&nbsp; if self.__grade &gt;= 60:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return "Passed"<br>&nbsp;&nbsp;&nbsp; else:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return "Failed"<br><br>student = Student("Emil")<br>student.set_grade(85)<br>print(student.get_grade())<br>print(student.get_status())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_validation">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Python also has a convention for protected properties using a single underscore <code class="w3-codespan">_</code> prefix:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a protected property:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, salary):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self._salary = salary  # Protected property<br><br>p1 = Person("Linus", 50000)<br>print(p1.name)<br>print(p1._salary)  # Can access, but shouldn't</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_protected">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> A single underscore <code class="w3-codespan">_</code> is just a convention. It tells other programmers that the property is intended for internal use, but Python doesn't enforce this restriction.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can also make methods private using the double underscore prefix:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a private method:</p>
<div class="w3-code notranslate pythonHigh">
class Calculator:<br>&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp; self.result = 0<br><br>&nbsp; def __validate(self, num):<br>&nbsp;&nbsp;&nbsp; if not isinstance(num, (int, float)):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return False<br>&nbsp;&nbsp;&nbsp; return True<br><br>&nbsp; def add(self, num):<br>&nbsp;&nbsp;&nbsp; if self.__validate(num):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.result += num<br>&nbsp;&nbsp;&nbsp; else:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Invalid number")<br><br>calc = Calculator()<br>calc.add(10)<br>calc.add(5)<br>print(calc.result)<br># calc.__validate(5)  # This would cause an error</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_private_method">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Just like private properties with double underscores, private methods cannot be called directly from outside the class. The <code class="w3-codespan">__validate</code> method can only be used by other methods inside the class.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Name mangling is how Python implements private properties and methods.</p>

<p>When you use double underscores <code class="w3-codespan">__</code>, Python automatically renames it internally by adding <code class="w3-codespan">_ClassName</code> in front.</p>

<p>For example, <code class="w3-codespan">__age</code> becomes <code class="w3-codespan">_Person__age</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>See how Python mangles the name:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.__age = age<br><br>p1 = Person("Emil", 30)<br><br># This is how Python mangles the name:<br>print(p1._Person__age)  # Not recommended!</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_encapsulation_mangling">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> While you <em>can</em> access private properties using the mangled name, it's not recommended. It defeats the purpose of encapsulation.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_encapsulation.js"></div>
<hr>
