...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_prepared_statements.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_exam.asp">Next &#10095;</a>
</div>
<hr>
<h2>SQL Hosting</h2>
<p>If you want your web site to store and retrieve data from a 
database, your web server must have access to a database-system.</p>
<p>If your web server is hosted by an Internet Service Provider (ISP), you will have to look for SQL hosting plans.</p>
<p>Some common SQL hosting databases are MySQL, PostgreSQL, SQL Server, and Oracle.</p>
<hr>
<h2>MySQL</h2>
<p>MySQL is a popular database software for web sites.</p>

<p>MySQL is known for speed, reliability, and ease of use.</p>

<p>MySQL is an inexpensive 
alternative to the expensive Microsoft and Oracle solutions.</p>
<p><strong>Tip:</strong> Read our <a href="/mysql/default.asp">MySQL Tutorial</a>.</p>

<hr>
<h2>SQL Server</h2>
<p>Microsoft SQL Server is a popular database software for  database-driven web sites 
with high traffic.</p>
<p>Microsoft SQL Server has a strong integration with other Microsoft products, 
powerful tools, and robust security features.</p>
<hr>
<h2>Oracle</h2>
<p>Oracle is a popular database software for  database-driven web sites 
with high traffic.</p>
<p>Oracle is known for extreme scalability, performance, reliability, and 
security.</p>
<p>Oracle has expensive licensing.</p>
<hr>
<h2>PostgreSQL</h2>
<p>PostgreSQL is a popular database software for web sites.</p>

<p>PostgreSQL has advanced features, high standards compliance, extensibility, 
and strong data integrity.</p>

<p>PostgreSQL is open-source and free.</p>
<p><strong>Tip:</strong> Read our <a href="/postgresql/index.php">PostgreSQL 
Tutorial</a>.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_hosting.js"></div>
<hr>
