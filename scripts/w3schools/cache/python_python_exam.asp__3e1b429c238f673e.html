...
<html lang="en-US">
<head>
<title>W3Schools Python Certificate</title>
<meta charset="utf-8">
...
<h1>W3Schools <span class="color_h1">Python Certificate</span></h1>
...
<style>
.w3-cert-content .ws-cert-section {
  margin: 50px 0 0 0;
}

.w3-cert-content .ws-cert-muted {
  color: #000;
}

.w3-cert-content .ws-cert-kicker {
  display: inline-block;
  margin-bottom: 20px;
  font-size: 12px;
  font-weight: 600;
...
.w3-cert-content .ws-cert-kicker i {
  margin-right: 6px;
  font-size: 15px;
  vertical-align: -1px;
}

.w3-cert-content .ws-cert-title {
  margin: 0 0 18px 0;
  font-size: 30px;
  line-height: 1.15;
  font-weight: 600;
...
.w3-cert-content .ws-cert-copy p {
  margin: 0 0 16px 0;
  font-size: 16px;
  line-height: 1.9;
  color: #000;
...
.w3-cert-content .ws-cert-link {
  margin-top: 26px;
}

.w3-cert-content .ws-cert-spacer {
  height: 28px;
}

.w3-cert-content .ws-cert-flex {
  display: flex;
  gap: 32px;
  align-items: stretch;
}

.w3-cert-content .ws-cert-col {
  min-width: 0;
}

.w3-cert-content .ws-cert-col-7 {
  flex: 0 0 calc(58.333333% - 16px);
  max-width: calc(58.333333% - 16px);
}

.w3-cert-content .ws-cert-col-5 {
  flex: 0 0 calc(41.666667% - 16px);
  max-width: calc(41.666667% - 16px);
}

.w3-cert-content .ws-cert-col-6 {
  flex: 0 0 calc(50% - 16px);
  max-width: calc(50% - 16px);
}

.w3-cert-content .ws-cert-hero {
  padding: 14px 0 8px 0;
}

.w3-cert-content .ws-cert-hero-copy {
  padding-right: 40px;
}

.w3-cert-content .ws-cert-hero h2 {
  margin: 0 0 28px 0;
  font-size: 30px;
  line-height: 1.25;
  font-weight: 600;
...
.w3-cert-content .ws-cert-hero p {
  margin: 0 0 18px 0;
  font-size: 17px;
  line-height: 1.9;
  max-width: 560px;
...
.w3-cert-content .ws-cert-hero-actions {
  margin-top: 38px;
}

.w3-cert-content .ws-cert-hero-note {
  margin-top: 18px;
  font-size: 13px;
  color: #000;
}

.w3-cert-content .ws-cert-hero-visual {
  height: 100%;
  border-radius: 5px;
  display: flex;
  align-items: center;
...
.w3-cert-content .ws-cert-hero-card {
  border-radius: 5px;
  width: 100%;
  min-height: 100%;
  position: relative;
...
.w3-cert-content .ws-cert-hero-image {
  position: relative;
  width: 100%;
  max-width: 330px;
}

.w3-cert-content .ws-cert-hero-image img {
  display: block;
  width: 100%;
  height: auto;
}

.w3-cert-content .ws-cert-badge {
  position: absolute;
  left: 15px;
  bottom: -48px;
  width: 85px;
...
.w3-cert-content .ws-cert-badge svg {
  width: 100%;
  height: 100%;
  display: block;
}

.w3-cert-content .ws-cert-copy-card {
  display: flex;
  flex-direction: column;
  height: 100%;
}

.w3-cert-content .ws-cert-overview {
  border-radius: 5px;
  height: 100%;
...
.w3-cert-content .ws-cert-overview-row {
  padding: 0 0 20px 0;
  margin-bottom: 20px;
  border-bottom: 1px solid #eceff3;
}

.w3-cert-content .ws-cert-overview-row:last-child {
  border-bottom: 0;
  margin-bottom: 0;
  padding-bottom: 0;
}

.w3-cert-content .ws-cert-overview-label {
  margin-bottom: 8px;
  font-size: 14px;
  font-weight: 600;
  color: #1f2937;
...
.w3-cert-content .ws-cert-overview-value {
  font-size: 16px;
  line-height: 1.8;
  color: #000;
}

.w3-cert-content .ws-cert-overview .ws-cert-link {
  margin-top: auto;
  padding-top: 26px;
}

.w3-cert-content .ws-cert-share-image {
  margin-top: 26px;
  max-width: 760px;
}

.w3-cert-content .ws-cert-share-image img {
  width: 100%;
  height: auto;
  display: block;
}

.w3-cert-content .ws-cert-career {
  height: 100%;
  display: flex;
  flex-direction: column;
}

.w3-cert-content .ws-cert-steps {
  height: 100%;
  display: flex;
  flex-direction: column;
  padding-left: 12px;
...
.w3-cert-content .ws-cert-step {
  padding: 0 0 22px 0;
  margin-bottom: 22px;
  border-bottom: 1px solid #eceff3;
}

.w3-cert-content .ws-cert-step:last-child {
  border-bottom: 0;
  margin-bottom: 0;
  padding-bottom: 0;
}

.w3-cert-content .ws-cert-step-number {
  display: inline-block;
  margin-bottom: 10px;
  font-size: 13px;
  font-weight: 600;
...
.w3-cert-content .ws-cert-step-text {
  font-size: 16px;
  line-height: 1.85;
  color: #000;
}

.w3-cert-content .ws-cert-cta {
  padding: 54px 0;
  border-top: 1px solid #eceff3;
  border-bottom: 1px solid #eceff3;
}

.w3-cert-content .ws-cert-cta-inner {
  max-width: 760px;
}

.w3-cert-content .ws-cert-team {
  max-width: 760px;
}

.w3-cert-content .ws-cert-banner-ad {
  background-color: #5b5ce9;
  border-radius: 8px;
  padding: 55px 26px;
  display: flex;
  align-items: center;
...
.w3-cert-content .ws-cert-banner-ad-left {
  display: flex;
  align-items: center;
  gap: 18px;
  min-width: 0;
...
.w3-cert-content .ws-cert-banner-ad-icon {
  flex: 0 0 64px;
  width: 64px;
  height: 64px;
  position: relative;
...
.w3-cert-content .ws-cert-banner-ad-icon img {
  width: 100%;
  height: 100%;
  object-fit: contain;
  display: block;
...
.w3-cert-content .ws-cert-banner-ad-copy {
  min-width: 0;
}

.w3-cert-content .ws-cert-banner-ad-copy h2 {
  margin: 0 0 6px 0;
  font-size: 18px;
  line-height: 1.25;
  font-weight: 700;
...
.w3-cert-content .ws-cert-banner-ad-action {
  flex: 0 0 auto;
}

.w3-cert-content .ws-cert-banner-ad-btn {
  display: inline-flex;
  align-items: center;
  margin-top: 15px;
  justify-content: center;
...
.w3-cert-content .ws-cert-banner-ad-btn:hover {
  background: #04AA6D;
  color: #ffffff;
  text-decoration: none;
}

body.darkpagetheme .w3-cert-content .ws-cert-title,
body.darkpagetheme .w3-cert-content .ws-cert-hero h2,
body.darkpagetheme .w3-cert-content .ws-cert-overview-label {
  color: #fff;
}

body.darkpagetheme .w3-cert-content .ws-cert-copy p,
body.darkpagetheme .w3-cert-content .ws-cert-hero p,
body.darkpagetheme .ws-cert-content .ws-cert-hero-note,
body.darkpagetheme .w3-cert-content .ws-cert-overview-value,
body.darkpagetheme .w3-cert-content .ws-cert-step-text,
body.darkpagetheme .w3-cert-content .ws-cert-muted {
  color: #ddd;
}

body.darkpagetheme .w3-cert-content .ws-cert-overview {
  background: #1f1f1f;
  border-color: #444;
}

body.darkpagetheme .w3-cert-content .ws-cert-overview-row,
body.darkpagetheme .w3-cert-content .ws-cert-step,
body.darkpagetheme .w3-cert-content .ws-cert-cta {
  border-color: #444;
}

body.darkpagetheme .w3-cert-content .ws-cert-hero-card {
  background: linear-gradient(135deg, #252a2f 0%, #1f2428 100%);
  border-color: #444;
}

body.darkpagetheme .w3-cert-content .ws-cert-hero-note,
body.darkpagetheme .w3-cert-content .ws-cert-copy p a,
body.darkpagetheme .w3-cert-content .ws-cert-overview-value a {
  color: #fff;
}

body.darkpagetheme .w3-cert-content .ws-cert-banner-ad {
  background: linear-gradient(90deg, #4b4cd6 0%, #5b4de8 50%, #4b4cd6 100%);
}
...
<div class="w3-cert-content" id="w3_cert_content" data-cert-type="">
  <div class="ws-cert-hero">
    <div class="ws-cert-flex">
      <div class="ws-cert-col ws-cert-col-7 ws-cert-hero-copy">
        <div class="ws-cert-kicker">
          <i id="w3_cert_kicker_icon" class="fa fa-html5" aria-hidden="true"></i>
          <span id="w3_cert_kicker_subject">HTML</span> Certification
        </div>
        <h2 style="font-size:38px">Get Certified in <span id="w3_cert_subject">HTML</span></h2>
        <p id="w3_cert_intro_1">Prepare online at your own pace, take the exam when you are ready, and add a verified credential to your CV, LinkedIn profile, and portfolio.</p>
        <p id="w3_cert_intro_2">Designed for students, developers, and professionals who want a practical way to document their knowledge.</p>

        <div class="ws-cert-hero-actions">
          <a class="ws-btn w3-large" id="w3_cert_btn_hero" href="https://campus.w3schools.com/products/html-certificate" target="_blank">Get Your HTML Certificate &raquo;</a>
        </div>

        <div class="ws-cert-hero-note">Online exam. No expiration. Shareable verification link.</div>
      </div>

      <div class="ws-cert-col ws-cert-col-5">
        <div class="ws-cert-hero-visual">
          <div class="ws-cert-hero-card">
            <div class="ws-cert-hero-image">
              <img id="w3_cert_img_main" src="/html/img_cert_html.jpg" alt="HTML Certificate">
              <div class="ws-cert-badge" aria-hidden="true">
                <svg data-name="w3_cert_badge2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                  <defs>
                    <style>
                      .cls-1{fill:#04aa6b;}
    ...
    <div class="ws-cert-section">
      <div class="ws-cert-flex">
        <div class="ws-cert-col ws-cert-col-7 ws-cert-copy">
          <div class="ws-cert-copy-card">
            <h2 class="ws-cert-title">Why Get Certified?</h2>
            <p>Any student or professional working in digital fields can benefit from documenting their skills with a certificate.</p>
            <p>Certifications help demonstrate knowledge to current or future employers, clients, and collaborators in an increasingly competitive market.</p>

            <div class="ws-cert-spacer" style="border-top:1px solid #f1f1f1"></div>

            <h2 class="ws-cert-title">Trusted Learning Platform</h2>
            <p>W3Schools has more than two decades of experience teaching coding online.</p>
            <p>Our certificates provide a practical and professional way to show your skills in a format that is easy to verify and share.</p>

            <div class="ws-cert-spacer" style="border-top:1px solid #f1f1f1"></div>

            <h2 class="ws-cert-title">Affordable and Flexible</h2>
            <p>The price is a small fraction of the cost of traditional education.</p>
            <p>You can prepare on your own schedule and take the exam when you are ready.</p>

            <div class="ws-cert-spacer" style="border-top:1px solid #f1f1f1"></div>

            <h2 class="ws-cert-title">Get Your Certificate and Share It</h2>
            <p>Each certificate includes a unique verification link that can be shared with employers, clients, and your network.</p>
            <p>Download your certificate to showcase it, and validate it using the unique link or QR code.</p>
            <p>See how it looks in this <a id="w3_cert_verify_link_text" href="https://verify.w3schools.com/1ML8E71MEL" target="_blank">example</a>.</p>

            <div class="ws-cert-share-image w3-hide-medium w3-hide-small">
              <a id="w3_cert_verify_link_img" href="https://verify.w3schools.com/1ML8E71MEL" target="_blank"><img id="w3_cert_img_share" src="/html/img_cert_html.jpg" alt="HTML Certificate"></a>
            </div>
          </div>
        </div>

        <div class="ws-cert-col ws-cert-col-5">
          <div class="ws-cert-overview">
            <h2 class="ws-cert-title">Exam Overview</h2>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Fee</div>
              <div class="ws-cert-overview-value">95 USD</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Achievable certification levels</div>
              <div class="ws-cert-overview-value">Intermediate (40%)<br>Advanced (75%)<br>Professional (90%)</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Number of questions</div>
              <div class="ws-cert-overview-value">Adaptive, 60 on average</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Requirement to pass</div>
              <div class="ws-cert-overview-value">Minimum 40% - Intermediate level</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Time limit</div>
              <div class="ws-cert-overview-value">60 minutes</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Number of attempts</div>
              <div class="ws-cert-overview-value">3</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Exam deadline</div>
              <div class="ws-cert-overview-value">None</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Certification expiration</div>
              <div class="ws-cert-overview-value">None</div>
            </div>

            <div class="ws-cert-overview-row">
              <div class="ws-cert-overview-label">Format</div>
              <div class="ws-cert-overview-value">Online, multiple choice</div>
            </div>

            <div class="ws-cert-link">
              <a class="ws-btn ws-black w3-large" id="w3_cert_btn_register" href="https://campus.w3schools.com/products/html-certificate" target="_blank">Register Now &raquo;</a>
            </div>
          </div>
        </div>
      </div>
<br>
      <p>Have any questions? Send us an e-mail: <i>sales@w3schools.com</i></p>
    </div>
    ...
    <div class="ws-cert-section">
      <div class="ws-cert-flex">
        <div class="ws-cert-col ws-cert-col-6 ws-cert-copy">
          <div class="ws-cert-career">
            <h2 class="ws-cert-title">Advance Faster in Your Career</h2>
            <p>Getting a certificate shows your commitment to improving your skills.</p>
            <p>You can add the certificate to your CV, resume, LinkedIn profile, and other professional platforms.</p>
            <p>It can help support career growth by making it easier to show your knowledge when applying for jobs, freelance work, or larger projects.</p>

            <div class="ws-cert-banner-ad">
              <div class="ws-cert-banner-ad-left">
                <div class="ws-cert-banner-ad-icon">
                  <img id="w3_cert_img_banner" src="/html/img_cert_html.jpg" alt="HTML Certificate">
                </div>

                <div class="ws-cert-banner-ad-copy">
                  <h2>Document Your Knowledge Today!</h2>
                </div>
              </div>

              <div class="ws-cert-banner-ad-action">
                <a class="ws-cert-banner-ad-btn" id="w3_cert_btn_banner" href="https://campus.w3schools.com/products/html-certificate" target="_blank">Get Certified</a>
              </div>
            </div>
          </div>
        </div>

        <div class="ws-cert-col ws-cert-col-6">
          <div class="ws-cert-steps">
            <h2 class="ws-cert-title">How It Works</h2>

            <div class="ws-cert-step">
              <div class="ws-cert-step-number">01</div>
              <div class="ws-cert-step-text">Study <span class="w3-cert-subject-inline">HTML</span> for free at W3Schools.com</div>
            </div>

            <div class="ws-cert-step">
              <div class="ws-cert-step-number">02</div>
              <div class="ws-cert-step-text">Learn at your own speed and focus on the topics you need most</div>
            </div>

            <div class="ws-cert-step">
              <div class="ws-cert-step-number">03</div>
              <div class="ws-cert-step-text">Practice with quizzes and exercises</div>
            </div>

            <div class="ws-cert-step">
              <div class="ws-cert-step-number">04</div>
              <div class="ws-cert-step-text">Apply by paying the exam fee</div>
            </div>

            <div class="ws-cert-step">
              <div class="ws-cert-step-number">05</div>
              <div class="ws-cert-step-text">Take the exam online at any time and from any location</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="ws-cert-section ws-cert-cta">
      <div class="ws-cert-cta-inner ws-cert-copy">
        <h2 class="ws-cert-title">Document Your Skills</h2>
        <p>Getting a certificate shows initiative, helps you build credibility, and gives you a professional way to present your <span class="w3-cert-subject-inline">HTML</span> knowledge.</p>
        <div class="ws-cert-link">
          <a class="ws-btn w3-large" id="w3_cert_btn_cta" href="https://campus.w3schools.com/products/html-certificate" target="_blank">Get Your HTML Certificate &raquo;</a>
        </div>
      </div>
    </div>

    <div class="ws-cert-section ws-cert-team ws-cert-copy">
      <h2 class="ws-cert-title">Looking to Add Multiple Users?</h2>
      <p>Are you an educator, manager, or business owner looking for courses or certifications for a group?</p>
      <p>We work with schools, companies, and organizations around the world.</p>
      <p>Send us an e-mail: <i>sales@w3schools.com</i></p>
    </div>
  </div>
</div>
...
<script>
(function () {
  var root = document.getElementById("w3_cert_content");
  if (!root) return;

  var certs = {
    html: {
      name: "HTML",
      img: "/html/img_cert_html.jpg",
      verify: "https://verify.w3schools.com/1ML8E71MEL",
      campus: "https://campus.w3schools.com/products/html-certificate",
      iconClass: "fa-html5",
      iconColor: "#E34F26"
    },
    css: {
      name: "CSS",
      img: "/css/img_cert_css.jpg",
      verify: "https://verify.w3schools.com/1MN4DGVZJU",
      campus: "https://campus.w3schools.com/products/css-certificate",
      iconClass: "fa-css3",
      iconColor: "#264de4"
    },
    bootstrap: {
      name: "Bootstrap 3",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_bootstrap_3_professional_675x534.jpg?v=1711015122",
      verify: "https://verify.w3schools.com/1MN4I879IP",
      campus: "https://campus.w3schools.com/collections/certifications/products/bootstrap-3-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    bootstrap4: {
      name: "Bootstrap 4",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_bootstrap_4_professional_675x534.jpg?v=1711015251",
      verify: "https://verify.w3schools.com/1MN4IFFBYK",
      campus: "https://campus.w3schools.com/products/bootstrap-4-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    bootstrap5: {
      name: "Bootstrap 5",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_bootstrap_5_professional_2f41cb35-6295-4c08-884b-f8e67f6afaf6_675x534.jpg?v=1712231206",
      verify: "https://verify.w3schools.com/1MRE6N5FQP",
      campus: "https://campus.w3schools.com/products/bootstrap-5-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    dsa: {
      name: "DSA",
      img: "/dsa/img_cert_dsa.jpg",
      verify: "https://verify.w3schools.com/1MN4FJHFZT",
      campus: "https://campus.w3schools.com/products/dsa-certification-exam",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    numpy: {
      name: "NumPy",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_numpy_professional_675x534.jpg?v=1711022465",
      verify: "https://verify.w3schools.com/1MRE98YSWK",
      campus: "https://campus.w3schools.com/products/numpy-certification-exam",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    pandas: {
      name: "Pandas",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_pandas_professional_675x534.jpg?v=1711022592",
      verify: "https://verify.w3schools.com/5VJFBPC6L",
      campus: "https://campus.w3schools.com/products/pandas-certification-exam",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    scipy: {
      name: "SciPy",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_scipy_professional_d691d8f1-8b97-457d-964d-4649e69ae61a_675x534.jpg?v=1710935753",
      verify: "https://verify.w3schools.com/1MN4FJHFZT",
      campus: "https://campus.w3schools.com/products/scipy-certificate",
      iconClass: "fa-scipy",
      iconColor: "#0054a6"
    },
    excel: {
      name: "Excel",
      img: "/excel/img_cert_excel.jpg",
      verify: "https://verify.w3schools.com/1MRE6Z9JP4",
      campus: "https://campus.w3schools.com/products/excel-certificate",
      iconClass: "fa-file-excel-o",
      iconColor: "#217346"
    },
    js: {
      name: "JavaScript",
      img: "/js/img_cert_js.jpg",
      verify: "https://verify.w3schools.com/1MN4EHTXOL",
      campus: "https://campus.w3schools.com/products/javascript-certificate",
      iconClass: "fa-js",
      iconColor: "#333"
    },
    react: {
      name: "React",
      img: "/react/img_cert_react.jpg",
      verify: "https://verify.w3schools.com/1MN4G4N8OS",
      campus: "https://campus.w3schools.com/products/react-js-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    jquery: {
      name: "jQuery",
      img: "/jquery/img_cert_jquery.jpg",
      verify: "https://verify.w3schools.com/1MN4HSWUQK",
      campus: "https://campus.w3schools.com/products/jquery-certificate",
      iconClass: "fa-jquery",
      iconColor: "#0769AD"
    },
    vue: {
      name: "Vue.js",
      img: "/vue/img_cert_vue.jpg",
      verify: "https://verify.w3schools.com/1NQCNALZCV",
      campus: "https://campus.w3schools.com/products/vue-js-certification-exam",
      iconClass: "fa-code",
      iconColor: "#42B883"
    },
    python: {
      name: "Python",
      img: "/python/img_cert_python.jpg",
      verify: "https://verify.w3schools.com/1MN4FJHFZT",
      campus: "https://campus.w3schools.com/products/python-certificate",
      iconClass: "fa-python",
      iconColor: "#333"
    },
    sql: {
      name: "SQL",
      img: "/sql/img_cert_sql.jpg",
      verify: "https://verify.w3schools.com/5V41L3MKS",
      campus: "https://campus.w3schools.com/products/sql-certificate",
      iconClass: "fa-sql",
      iconColor: "#00758F"
    },
    mysql: {
      name: "MySQL",
      img: "/mysql/img_cert_mysql.jpg",
      verify: "https://verify.w3schools.com/1MYZG9AF4Z",
      campus: "https://campus.w3schools.com/products/mysql-certificate",
      iconClass: "fa-mysql",
      iconColor: "#00758F"
    },
    postgresql: {
      name: "PostgreSQL",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_postgresql_professional_5672a22c-7707-4bcf-babe-ae7b09fbefe1_675x534.jpg?v=1710935379",
      verify: "https://verify.w3schools.com/5V41L3MKS",
      campus: "https://campus.w3schools.com/products/postgresql-certificate",
      iconClass: "fa-postgresql",
      iconColor: "#00758F"
    },
    mongodb: {
      name: "MongoDB",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_mongodb_professional_53739b3e-e501-4112-85fd-7cf7089a6979_675x534.jpg?v=1710935223",
      verify: "https://verify.w3schools.com/1MYZG9AF4Z",
      campus: "https://campus.w3schools.com/products/mongodb-certificate",
      iconClass: "fa-mongodb",
      iconColor: "#04AA6D"
    },
    php: {
      name: "PHP",
      img: "/php/img_cert_php.jpg",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/php-certificate",
      iconClass: "fa-php",
      iconColor: "#777BB4"
    },
    asp: {
      name: "ASP",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_asp_professional_428x342.png?v=1712303017",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/asp-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    r: {
      name: "R",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_r_professional_d874fc0b-a511-4e0a-957c-7223b7812893_675x534.jpg?v=1710935544",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/r-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    go: {
      name: "Go",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_go_professional_428x343.png?v=1712303548",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/go-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    kotlin: {
      name: "Kotlin",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_kotlin_professional_400744cb-9193-4081-b238-dfa1815adfd1_675x534.jpg?v=1710930314",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/kotin-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    sass: {
      name: "SASS",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_sass_professional_1b955061-75e3-4f3d-b656-abf43352365b_675x534.jpg?v=1710935639",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/sass-certificate",
      iconClass: "fa-sass",
      iconColor: "#CD6799"
    },
    java: {
      name: "Java",
      img: "/java/img_cert_java.jpg",
      verify: "https://verify.w3schools.com/1MN4HBII6V",
      campus: "https://campus.w3schools.com/products/java-certificate",
      iconClass: "fa-java",
      iconColor: "#F89820"
    },
    c: {
      name: "C",
      img: "/c/img_cert_c.jpg",
      verify: "https://verify.w3schools.com/1O3D2Q61K5",
      campus: "https://campus.w3schools.com/products/c-certification-exam",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    cpp: {
      name: "C++",
      img: "/cpp/img_cert_cpp.jpg",
      verify: "https://verify.w3schools.com/1MN4GH4A6M",
      campus: "https://campus.w3schools.com/products/cpp-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    "cs": {
      name: "C#",
      img: "https://verify.w3schools.com/5VJE0FEIL/certificate_of_completion_c%23.jpg",
      verify: "https://verify.w3schools.com/5VJE0FEIL",
      campus: "https://campus.w3schools.com/products/c-certificate-1",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    django: {
      name: "Django",
      img: "/django/img_cert_django.jpg",
      verify: "https://verify.w3schools.com/1NQCNABPPU",
      campus: "https://campus.w3schools.com/products/django-certification-exam",
      iconClass: "fa-code",
      iconColor: "#092E20"
    },
    nodejs: {
      name: "Node.js",
      img: "/nodejs/img_cert_nodejs.jpg",
      verify: "https://verify.w3schools.com/",
      campus: "https://campus.w3schools.com/products/nodejs-certificate",
      iconClass: "fa-code",
      iconColor: "#339933"
    },
    node: {
    ...
    typescript: {
      name: "TypeScript",
      img: "/typescript/img_cert_typescript.jpg",
      verify: "https://verify.w3schools.com/1MN4EZPOAZ",
      campus: "https://campus.w3schools.com/products/typescript-certificate",
      iconClass: "fa-code",
      iconColor: "#3178C6"
    },
    xml: {
      name: "XML",
      img: "/xml/img_cert_xml.jpg",
      verify: "https://verify.w3schools.com/1MN4I0VYQZ",
      campus: "https://campus.w3schools.com/products/xml-certificate",
      iconClass: "fa-code",
      iconColor: "#FF6600"
    },
    angularjs: {
      name: "AngularJS",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_angularjs_professional_d94c03b2-215c-4863-9c95-c4d8494440b5_675x534.jpg?v=1710928752",
      verify: "https://verify.w3schools.com/1MN4FJHFZT",
      campus: "https://campus.w3schools.com/products/angularjs-certificate",
      iconClass: "fa-angular",
      iconColor: "#c3002f"
    },
    git: {
      name: "Git",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_git_professional_aa6dd293-12ac-467c-8c5c-e31112a4f0ff_675x534.jpg?v=1710930031",
      verify: "https://verify.w3schools.com/1MN4FJHFZT",
      campus: "https://campus.w3schools.com/products/git-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    cybersecurity: {
      name: "Cyber Security",
      img: "/cybersecurity/img_cert_cybersecurity.jpg",
      verify: "https://verify.w3schools.com/5V41OWRE3",
      campus: "https://campus.w3schools.com/products/cyber-security-certificate",
      iconClass: "fa-shield",
      iconColor: "#0A8FDC"
    },
    "cyber security": {
    ...
    aws: {
      name: "AWS",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_aws_cloud_professional_a8931d37-ecc7-4144-9203-6acf1a51fa58_675x534.jpg?v=1710929203",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/aws-cloud-certificate",
      iconClass: "fa-aws",
      iconColor: "#000"
    },
    datascience: {
      name: "Data Science",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_data_science_professional_428x343.png?v=1712324934",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/data-science-certificate",
      iconClass: "fa-datascience",
      iconColor: "blue"
    },
    bash: {
      name: "Bash",
      img: "https://campus.w3schools.com/cdn/shop/files/bash-certo_676x479.png?v=1755260771",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/bash-certification-exam",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    rust: {
      name: "Rust",
      img: "https://campus.w3schools.com/cdn/shop/files/Rust-certo_676x479.png?v=1755260736",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/rust-certification-exam",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    w3css: {
      name: "W3.CSS",
      img: "https://campus.w3schools.com/cdn/shop/files/certificate_of_completion_w3.css_professional_396ff4ee-85c7-4da9-ad10-398161b876e0_675x534.jpg?v=1710936149",
      verify: "https://verify.w3schools.com/1MN4H49YY8",
      campus: "https://campus.w3schools.com/products/w3-css-certificate",
      iconClass: "fa-code",
      iconColor: "#04AA6D"
    },
    accessibility: {
      name: "Accessibility",
      img: "/accessibility/img_cert_accessibility.jpg",
      verify: "https://verify.w3schools.com/1ML8E71MEL",
      campus: "https://campus.w3schools.com/products/accessibility-certificate",
  ...
  function getFolderType() {
    ...
    if (parts[0] === "python") {
      if (parts[1] === "numpy" || parts[1] === "pandas" || parts[1] === "scipy") {
        return parts[1];
      }
      return "python";
    }
  ...
  var type = (root.getAttribute("data-cert-type") || "").toLowerCase();
  if (!type) type = getFolderType();

  if (type === "javascript") type = "js";
  if (type === "node.js") type = "nodejs";
  if (type === "bootstrap-3") type = "bootstrap3";
  if (type === "bootstrap-4") type = "bootstrap4";
  if (type === "bootstrap-5") type = "bootstrap5";
  if (type === "cyber-security") type = "cybersecurity";

  var cert = certs[type] || certs.html;
  ...
  function setHtmlCollection(selector, value) {
    var list = root.querySelectorAll(selector);
    for (var i = 0; i < list.length; i++) {
      list[i].textContent = value;
    }
  }
  ...
  function setKickerIcon(iconClass, iconColor) {
    var el = document.getElementById("w3_cert_kicker_icon");
    if (!el) return;
    el.className = "fa " + iconClass;
    el.style.color = iconColor || "#04AA6D";
  }

  setText("w3_cert_kicker_subject", cert.name);
  setText("w3_cert_subject", cert.name);

  setHref("w3_cert_btn_hero", cert.campus);
  setHref("w3_cert_btn_register", cert.campus);
  setHref("w3_cert_btn_cta", cert.campus);
  setHref("w3_cert_btn_banner", cert.campus);

  var heroBtn = document.getElementById("w3_cert_btn_hero");
  if (heroBtn) heroBtn.textContent = "Get Your " + cert.name + " Certificate \u00BB";

  var ctaBtn = document.getElementById("w3_cert_btn_cta");
  if (ctaBtn) ctaBtn.textContent = "Get Your " + cert.name + " Certificate \u00BB";

  setHref("w3_cert_verify_link_text", cert.verify);
  setHref("w3_cert_verify_link_img", cert.verify);

  setImg("w3_cert_img_main", cert.img, cert.name + " Certificate");
  setImg("w3_cert_img_share", cert.img, cert.name + " Certificate");
  setImg("w3_cert_img_banner", cert.img, cert.name + " Certificate");

  setHtmlCollection(".w3-cert-subject-inline", cert.name);
  setKickerIcon(cert.iconClass, cert.iconColor);
})();
</script>
