...
<a class="w3-left w3-btn" href="python_challenges_while_loops.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_for_loops.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Python For Loops</h2>

<p>A <span class="w3-codespan"><a href="ref_keyword_for.asp">for</a></span> loop is used for iterating over a sequence (that is either a list, a tuple, 
a dictionary, a set, or a string).</p>
<p>This is less like the <span class="w3-codespan"><a href="ref_keyword_for.asp">for</a></span> keyword in other programming languages, and works more like an iterator method as found in other object-orientated programming languages.</p>

<p>With the <span class="w3-codespan"><a href="ref_keyword_for.asp">for</a></span> loop we can execute a set of statements, once for each item in a list, tuple, set etc.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for">Try it Yourself &raquo;</a>
</div>

<p>The <span class="w3-codespan"><a href="ref_keyword_for.asp">for</a></span> loop does not require an indexing variable to set beforehand.</p>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_string">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>With the <span class="w3-codespan"><a href="ref_keyword_break.asp">break</a></span> statement we can stop the 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_break">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_break2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>With the <span class="w3-codespan"><a href="ref_keyword_continue.asp">continue</a></span> statement we can stop the 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_continue">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The range() Function</h2>
<p>To loop through a set of code a specified number of times, we can use the <code class="w3-codespan"><a href="ref_func_range.asp">range()</a></code> function,</p>
<p>The <code class="w3-codespan"><a href="ref_func_range.asp">range()</a></code> function returns a sequence of numbers, starting from 0 by default, and increments by 1 (by default), and ends at a specified number.</p>
<div class="w3-example">
  <h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_range">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>Note that <code class="w3-codespan">range(6)</code> is not the values of 0 to 6, but the values 0 to 5.</p>
</div>
<!--stop-->
<!--start-->
<p>The <code class="w3-codespan"><a href="ref_func_range.asp">range()</a></code> function defaults to 0 as a starting value, however it is possible to specify the starting value by adding a parameter: <code class="w3-codespan">range(2, 6)</code>, which 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_range2">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan"><a href="ref_func_range.asp">range()</a></code> function defaults to increment the sequence by 1,
however it is possible to specify the increment value by adding a third parameter: <code class="w3-codespan">range(2, 30, <strong>3</strong>)</code>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_range3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Else in For Loop</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_else.asp">else</a></code> keyword in a
<code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loop specifies a block of code to be 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_else">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan"><a href="ref_keyword_else.asp">else</a></code> block will NOT be executed if the loop is stopped by a <code class="w3-codespan"><a href="ref_keyword_break.asp">break</a></code> statement.</p>
</div>

<div class="w3-example">
  <h3>Example</h3>
<p>Break the loop when <code class="w3-codespan">x</code> is 3, and see what happens with the 
<code class="w3-codespan"><a href="ref_keyword_else.asp">else</a></code> block:</p>
<div class="w3-code notranslate pythonHigh">
  for x in range(6):<br>&nbsp; if x == 3: break<br>&nbsp;
	print(x)<br>else:<br>&nbsp;
	print(&quot;Finally finished!&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_else_break">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_nested">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The pass Statement</h2>
<p><code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loops cannot be empty, but if you for 
some reason have a <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loop with no content, put in the <code class="w3-codespan"><a href="ref_keyword_pass.asp">pass</a></code> statement to avoid getting an error.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  for x in [0, 1, 2]:<br>&nbsp; pass</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_for_pass">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_for_loops.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_while_loops.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_for_loops.asp">Next &#10095;</a>
