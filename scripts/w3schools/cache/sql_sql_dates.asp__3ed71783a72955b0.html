...
<h2>SQL Dates</h2>
<p>The most difficult part when working with dates in databases, is to be sure that the format of the date you are trying to insert/select,
matches the format of the date column in the database.</p>
<hr>

<h2>SQL Date Data Types</h2>
<p>Different SQL databases have various <a href="sql_datatypes.asp">data types</a> 
to store date and time values.</p>
<p><b>MySQL</b> has the following <strong>date</strong> data types:</p>
<ul>
  <li> <code class="w3-codespan">DATE</code> - format YYYY-MM-DD</li>
  <li> <code class="w3-codespan">DATETIME</code> - format: YYYY-MM-DD HH:MI:SS</li>
  <li><code class="w3-codespan">TIMESTAMP</code> - format: YYYY-MM-DD HH:MI:SS</li>
  <li><code class="w3-codespan">TIME</code> - format: HH:MI:SS</li>
  <li> <code class="w3-codespan">YEAR</code> - format YYYY or YY</li>
</ul>
<p><b>SQL Server</b> has the following <strong>date</strong> data types:</p>
<ul>
  <li> <code class="w3-codespan">DATE</code> - format YYYY-MM-DD</li>
  <li> <code class="w3-codespan">DATETIME</code> - format: YYYY-MM-DD HH:MI:SS</li>
  <li> <code class="w3-codespan">SMALLDATETIME</code> - format: YYYY-MM-DD HH:MI:SS</li>
  <li> <code class="w3-codespan">TIME</code> - format: HH:MI:SS</li>
  <li><code class="w3-codespan">TIMESTAMP</code> - format: a unique number</li>
</ul>
<p><b>Note:</b> The date data type are defined for a column upon creation of a 
new table in your database.</p>
<hr>
...
<p>Now we want to select the records with an OrderDate of &quot;2025-11-11&quot; from the table above.</p>
<p>We use the following <code class="w3-codespan">SELECT</code> statement:</p>
<div class="w3-code w3-border notranslate sqlHigh"><div>
SELECT * FROM Orders WHERE OrderDate='2025-11-11'</div></div>
...
<p><strong>Note:</strong> Two dates can easily be compared if there is no time component involved!</p>
</div>

<p>Now, assume that the &quot;Orders&quot; table looks like this (notice the 
...
<td>1</td>
<td>Geitost</td>
<td>2025-11-11 13:23:44</td>
</tr>
<tr>
<td>2</td>
<td>Camembert Pierrot</td>
<td>2025-11-09 15:45:21</td>
</tr>
<tr>
<td>3</td>
<td>Mozzarella di Giovanni</td>
<td>2025-11-11 11:12:01</td>
</tr>
<tr>
<td>4</td>
<td>Mascarpone Fabioli</td>
<td>2025-10-29 14:56:59</td>
</tr>
</table>
</div>

<p>If we use the same <code class="w3-codespan">SELECT</code> statement as above:</p>
<div class="w3-code w3-border notranslate sqlHigh"><div>
SELECT * FROM Orders WHERE OrderDate='2025-11-11'</div></div>
<p>we will get no result! This is because the query is looking only for dates with no time portion.</p>

<div class="w3-panel ws-note">
<p><b>Tip:</b> To keep your queries simple and easy to maintain, do not use time-components in your dates, unless you have to!</p>
</div>
<hr>
