...
<html lang="en-US">
<head>
<title>Python Virtual Environment - venv</title>
<meta charset="utf-8">
...
<style>
.w3-example-tab-header.active-tab {
...
<h1>Python <span class="color_h1">Virtual Environment</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_user_input.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_oop.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>What is a Virtual Environment?</h2>

<p>A <strong>virtual environment</strong> in Python is an isolated environment on your computer, where you can run and test your Python projects.</p>
  
<p>It allows you to manage project-specific dependencies without interfering with other projects or the original Python installation.</p>

<p>Think of a virtual environment as a separate container for each Python project. Each container:</p>
<ul>
<li>Has its own Python interpreter</li>
<li>Has its own set of installed packages</li>
<li>Is isolated from other virtual environments</li>
<li>Can have different versions of the same package</li>
</ul>

<p>Using virtual environments is important because:</p>
<ul>
<li>It prevents package version conflicts between projects</li>
<li>Makes projects more portable and reproducible</li>
<li>Keeps your system Python installation clean</li>
<li>Allows testing with different Python versions</li>
</ul>
...
<p>Python has the built-in <code class="w3-codespan">venv</code> module for creating virtual environments.</p>

<p>To create a virtual environment on your computer, open the command prompt, and navigate to the folder where you want to create your project, then type this command:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Run this command to create a virtual environment named <code class="w3-codespan">myfirstproject</code>:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">C:\Users\<em>Your Name</em>></span> python -m venv myfirstproject
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">$</span> python -m venv myfirstproject
</div>
</div>

<p>This will set up a virtual environment, and create a folder named "myfirstproject" with subfolders and files, like this:</p>

<div class="w3-example">
<h3>Result</h3>
<p>The file/folder structure will look like this:</p>
...
<p>To use the virtual environment, you have to activate it with this command:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Activate the virtual environment:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">C:\Users\<em>Your Name</em>></span> myfirstproject\Scripts\activate
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">$</span> source myfirstproject/bin/activate
</div>
</div>

<p>After activation, your prompt will change to show that you are now working in the active environment:</p>

<div class="w3-example">
<h3>Result</h3>
<p>The command line will look like this when the virtual environment is active:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
(myfirstproject) C:\Users\<em>Your Name</em>>
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
(myfirstproject) ... $
</div>
...
<p>Once your virtual environment is activated, you can install packages in it, using 
<code class="w3-codespan">pip</code>.</p>

<p>We will install a package called 'cowsay':</p>

<div class="w3-example">
<h3>Example</h3>
<p>Install 'cowsay' in the virtual environment:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">(myfirstproject) C:\Users\<em>Your Name</em>></span> pip install cowsay 
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">(myfirstproject) ... $</span> pip install cowsay 
</div>
</div>
...
<div class="w3-example">
<h3>Result</h3>
<p>'cowsay' is installed only in the virtual environment:</p>
<div class="w3-code notranslate w3-black">
Collecting cowsay<br>
&nbsp;&nbsp;Downloading cowsay-6.1-py3-none-any.whl.metadata (5.6 kB)<br>
Downloading cowsay-6.1-py3-none-any.whl (25 kB)<br>
Installing collected packages: cowsay<br>
Successfully installed cowsay-6.1<br>
<br>
[<span style="color:blue">notice</span>] A new release of pip is available: <span style="color:red">25.0.1</span> -> <span style="color:green">25.1.1</span><br>
[<span style="color:blue">notice</span>] To update, run: <span style="color:green">python.exe -m pip install --upgrade pip</span></div>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Now that the 'cowsay' module is installed in your virtual environment, lets use it to display a talking cow.</p>

<p>Create a file called <code class="w3-codespan">test.py</code> on your computer. You can place it wherever you want, but I will place it in the same location as the 
<code class="w3-codespan">myfirstproject</code> folder -not<em> in</em> the folder, but in the same location.</p>

<p>Open the file and insert these three lines in it:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Insert two lines in <code class="w3-codespan">test.py</code>:</p>
<div class="w3-code notranslate w3-white" data-tab-header="test.py">
import cowsay<br>
<br>
cowsay.cow("Good Mooooorning!")<br>
</div>
</div>

<p>Then, try to execute the file while you are in the virtual environment:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute <code class="w3-codespan">test.py</code> in the virtual environment:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">(myfirstproject) C:\Users\<em>Your Name</em>></span> python test.py
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">(myfirstproject) ... $</span> python test.py
</div>
</div>


<p>As a result a cow will appear in you terminal:</p>

<div class="w3-example">
<h3>Result</h3>
<p>The purpose of the 'cowsay' module is to draw a cow that says whatever input 
you give it:</p>
<div class="w3-code notranslate w3-black">
<pre>
  _________________
...
<p>To deactivate the virtual environment use this command:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Deactivate the virtual environment:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">(myfirstproject) C:\Users\<em>Your Name</em>></span> deactivate
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">(myfirstproject) ... $</span> deactivate
</div>
</div>

<p>As a result, you are now back in the normal command line interface:</p>

<div class="w3-example">
<h3>Result</h3>
<p>Normal command line interface:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
C:\Users\<em>Your Name</em>>
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
$
</div>
...
<p>If you try to execute the <code class="w3-codespan">test.py</code> file outside of the virtual environment, you will get an error because 'cowsay' is missing.
It was only installed in the virtual environment:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute <code class="w3-codespan">test.py</code> outside of the virtual environment:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">C:\Users\<em>Your Name</em>></span> python test.py
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">$</span> python test.py
</div>
</div>

<div class="w3-example w3-pale-red">
<h3>Result</h3>
<p>Error because 'cowsay' is missing:</p>
<div class="w3-code notranslate w3-black">
Traceback (most recent call last):<br>
&nbsp;&nbsp;File <span style="color:#cc00ff">"C:\Users\<em>Your Name</em>\test.py"</span>, line <span style="color:#cc00ff">1</span>, in <span style="color:#cc00ff">&lt;module></span><br>
&nbsp;&nbsp;&nbsp;&nbsp;import cowsay<br>
<span style="color:fuchsia">ModuleNotFoundError</span>: <span style="color:#cc00ff">No module named 'cowsay'</span>
</div>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The virtual environment <code class="w3-codespan">myfirstproject</code> still exists, it is just not activated.
  If you activate the virtual environment again, you can execute the <code class="w3-codespan">test.py</code>
  file, and the diagram will be displayed.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Another nice thing about working with a virtual environment is that when you, for some reason want to delete it,
there are no other projects depend on it, and only the modules and files in the specified virtual environment are deleted.</p>

<p>To delete a virtual environment, you can simply delete its folder with all its content. Either directly in the file system, or use the command line interface like this:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Delete <code class="w3-codespan">myfirstproject</code> from the command line interface:</p>
<div class="w3-code notranslate w3-black" data-tab-header="Windows">
<span style="color:#888888">C:\Users\<em>Your Name</em>></span> rmdir /s /q myfirstproject
</div>
<div class="w3-code notranslate w3-black" data-tab-header="macOS/Linux">
<span style="color:#888888">$</span> rm -rf myfirstproject
</div>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_virtualenv.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_user_input.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_oop.asp">Next &#10095;</a>
