...
<h1>Python <span class="color_h1">Nested If</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_logical.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_if_pass.asp">Next &#10095;</a>
</div>
<hr>

<h2>Nested If Statements</h2>

<p>You can have <code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statements inside 
<code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statements. This is called <em>nested</em>
<code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statements.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_nested">Try it Yourself &raquo;</a>
</div>

<p>In this example, the inner <span class="w3-codespan">if</span> statement only runs if the outer condition (<span class="w3-codespan">x &gt; 10</span>) is true.</p>
...
<h2>How Nested If Works</h2>

<p>Each level of nesting creates a deeper level of decision-making. The code evaluates from the outermost condition inward.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Checking multiple conditions with nesting:</p>
<div class="w3-code notranslate pythonHigh">
age = 25<br>
has_license = True<br><br>
if age &gt;= 18:<br>
&nbsp; if has_license:<br>
&nbsp;&nbsp;&nbsp; print("You can drive")<br>
&nbsp; else:<br>
&nbsp;&nbsp;&nbsp; print("You need a license")<br>
else:<br>
&nbsp; print("You are too young to drive")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_nested_license">Try it Yourself &raquo;</a>
</div>
...
<p>You can nest as many levels deep as needed, but keep in mind that too many levels can make code harder to read.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Three levels of nesting:</p>
<div class="w3-code notranslate pythonHigh">
score = 85<br>
attendance = 90<br>
submitted = True<br><br>
if score &gt;= 60:<br>
&nbsp; if attendance &gt;= 80:<br>
&nbsp;&nbsp;&nbsp; if submitted:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Pass with good standing")<br>
&nbsp;&nbsp;&nbsp; else:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Pass but missing assignment")<br>
&nbsp; else:<br>
&nbsp;&nbsp;&nbsp; print("Pass but low attendance")<br>
else:<br>
&nbsp; print("Fail")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_nested_three_levels">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Nested If vs Logical Operators</h2>

<p>Sometimes nested if statements can be simplified using logical operators like <span class="w3-codespan">and</span>. The choice depends on your logic.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_nested_vs_elif_a">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Could also be written with <span class="w3-codespan">and</span>:</p>
<div class="w3-code notranslate pythonHigh">
temperature = 25<br>
is_sunny = True<br><br>
if temperature &gt; 20 and is_sunny:<br>
&nbsp; print("Perfect beach weather!")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_nested_vs_elif_b">Try it Yourself &raquo;</a>
</div>

<p>Both approaches produce the same result. Use nested if statements when the inner logic is complex or depends on the outer condition. Use <span class="w3-codespan">and</span> when both conditions are simple and equally important.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Login validation with nested checks:</p>
<div class="w3-code notranslate pythonHigh">
username = "Emil"<br>
password = "python123"<br>
...
&nbsp;&nbsp;&nbsp; else:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Account is not active")<br>
&nbsp; else:<br>
&nbsp;&nbsp;&nbsp; print("Password required")<br>
else:<br>
&nbsp; print("Username required")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_nested_login">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Grade calculation with nested logic:</p>
<div class="w3-code notranslate pythonHigh">
score = 92<br>
extra_credit = 5<br><br>
if score &gt;= 90:<br>
&nbsp; if extra_credit &gt; 0:<br>
&nbsp;&nbsp;&nbsp; print("A+ grade")<br>
&nbsp; else:<br>
&nbsp;&nbsp;&nbsp; print("A grade")<br>
elif score &gt;= 80:<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_nested_grades">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_if_nested_if.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_logical.asp">&#10094; Previous</a>
