...
<p>SQL constraints are rules for data in a table.</p>
<p>Constraints are used to prevent insertion of invalid data in a table, and ensures the accuracy and reliability of 
the data in the table. If there is any violation between the constraint and the data action, 
the action is aborted.</p>
<p>Constraints can be specified in two ways:</p>
<ul>
  <li>When a table is created (through the <code class="w3-codespan">
  <a href="sql_create_table.asp">CREATE TABLE</a></code> statement)</li>
  <li>After a table is created (through the <code class="w3-codespan"><a href="sql_alter.asp">ALTER TABLE</a></code> 
  statement)</li>
</ul>
<hr>

<h2>SQL Constraint Types</h2>
<p>The following constraints are commonly used in SQL:</p>
<ul>
  <li><code class="w3-codespan"><a href="sql_notnull.asp">NOT NULL</a></code> - Ensures that a column cannot have a NULL value</li>
  <li><code class="w3-codespan"><a href="sql_unique.asp">UNIQUE</a></code> - Ensures that all values in a column are 
  unique</li>
  <li><code class="w3-codespan"><a href="sql_primarykey.asp">PRIMARY KEY</a></code> - 
  Uniquely identifies each row in a table (a combination of a 
  <code class="w3-codespan">NOT NULL</code> and <code class="w3-codespan">UNIQUE</code>)</li>
  <li><code class="w3-codespan"><a href="sql_foreignkey.asp">FOREIGN KEY</a></code> 
  - Establishes a link between data in two 
  tables, and prevents action that will destroy the link between them</li>
  <li> <code class="w3-codespan"><a href="sql_check.asp">CHECK</a></code> - Ensures that 
  the values in a column satisfies a specific condition</li>
  <li> <code class="w3-codespan"><a href="sql_default.asp">DEFAULT</a></code> - Sets a default value for a column 
  if no value 
  is specified</li>
  <li> <code class="w3-codespan"><a href="sql_create_index.asp">CREATE INDEX</a></code> - 
  Creates indexes on columns to retrieve data from the database 
  faster</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_constraints.js"></div>
<hr>
