...
<p>The <code class="w3-codespan">PRIMARY KEY</code> constraint uniquely identifies each record in a database table.</p>
<p>A <code class="w3-codespan">PRIMARY KEY</code> constraint ensures unique values, and cannot contain NULL values 
(it is a combination of both a <code class="w3-codespan"><a href="sql_unique.asp">UNIQUE</a></code> constraint and a
<code class="w3-codespan"><a href="sql_notnull.asp">NOT NULL</a></code> constraint).</p>
<p>A table can have only ONE <code class="w3-codespan">PRIMARY KEY</code> 
constraint. The primary key can either be a single column, or a combination of columns.</p>
<p><strong>Tip:</strong> The primary key is the target for <code class="w3-codespan">
<a href="sql_foreignkey.asp">FOREIGN KEY</a></code> 
constraints in other tables (which enforces referential integrity between data in two tables).</p>
<hr>

<h2>PRIMARY KEY on CREATE TABLE</h2>
<p>The following SQL creates a <code class="w3-codespan">PRIMARY KEY</code> on the &quot;ID&quot; column 
upon creation of the &quot;Persons&quot; table:</p>
...
<h3>PRIMARY KEY on Multiple Columns</h3>
<p>To define an <strong>un-named</strong> <code class="w3-codespan">PRIMARY KEY</code> constraint on multiple columns, use the following SQL syntax:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE TABLE Persons
(<br>
...
Age int,<br>
&nbsp;&nbsp;&nbsp;
  PRIMARY KEY (ID, LastName)<br>
);</div></div>

<p><b>Note:</b> In the example above, the <code class="w3-codespan">
PRIMARY KEY</code> value is made up of two columns (ID + LastName).</p>
<p>To define a <strong>named</strong> <code class="w3-codespan">PRIMARY KEY</code> constraint on multiple columns, use the following SQL syntax:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE TABLE Persons
(<br>
...
<p><b>Note:</b> In the example above, the <code class="w3-codespan">
PRIMARY KEY</code> is named &quot;PK_Person&quot;, and the value is made up of two columns (ID + LastName).<br>
</p>
<hr>
...
<p>To create a <code class="w3-codespan">PRIMARY KEY</code> constraint on the &quot;ID&quot; column when the table already 
has been created, use the following SQL:</p>
...
<p><b>Note:</b> When using <code class="w3-codespan">ALTER TABLE</code> to add a primary key, the primary key column(s) must
have been declared with NOT NULL upon creation of the table.</p>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_primarykey.js"></div>
<hr>
