...
<p>The <code class="w3-codespan">DEFAULT</code> constraint is used to 
...
<h2>DEFAULT Constraint on CREATE TABLE</h2>
<p>The following SQL sets a <code class="w3-codespan">DEFAULT</code> value for the &quot;City&quot; column 
...
<a href="func_mysql_current_date.asp">CURRENT_DATE()</a></code> to insert the current date:</p>
...
&nbsp;&nbsp;&nbsp;
OrderDate date DEFAULT CURRENT_DATE()<br>
);</div></div>

<h3>SQL Server:</h3>

<p>To achieve the same result in SQL Server use the following SQL (to insert the current date):&nbsp;</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE TABLE Orders
(<br>
...
OrderNumber int NOT NULL,<br>
&nbsp;&nbsp;&nbsp;
OrderDate date DEFAULT CAST(GETDATE() AS date)<br>
);</div></div>
...
<h2>DEFAULT Constraint on ALTER TABLE</h2>
<p>To define a <code class="w3-codespan">DEFAULT</code> constraint on the &quot;City&quot; column when the table is already created, use the following SQL:</p>
<h3>MySQL:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
...
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>ADD CONSTRAINT df_City DEFAULT 'Sandnes' FOR City;</div></div>
...
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
  DROP CONSTRAINT df_City;</div></div>
...
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
  MODIFY (City DEFAULT NULL);</div></div>
<hr>
<div id="exercisecontainer" src="xrcise_default.js"></div>
<hr>
