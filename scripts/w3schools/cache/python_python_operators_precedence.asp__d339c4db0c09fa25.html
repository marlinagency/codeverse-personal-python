...
<h1>Python <span class="color_h1">Operator Precedence</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_bitwise.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_operators_basics.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>Parentheses has the highest precedence, meaning that expressions inside 
parentheses must be evaluated first:</p>
<div class="w3-code notranslate pythonHigh">
print((6 + 3) - (6 + 3))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_precedence_parentheses">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Multiplication <code class="w3-codespan">*</code> has higher precedence than
addition <code class="w3-codespan">+</code>, and therefore multiplications are 
evaluated before additions:</p>
<div class="w3-code notranslate pythonHigh">
print(100 + 5 * 3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_precedence_multiplication">Try it Yourself &raquo;</a>
</div>
...
<p>The precedence order is described in the table below, starting with the highest precedence at the top:</p>
...
<td>Parentheses</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_parentheses">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">**</code></td>
<td>Exponentiation</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_exponent">Try it &raquo;</a></td>
</tr>
<tr>
<td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_bitwise_not">Try it &raquo;</a></td>
</tr>
<tr>
<td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_multiplication">Try it &raquo;</a></td>
</tr>
<tr>
<td>
  <code class="w3-codespan">+</code>&nbsp;
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_subtraction">Try it &raquo;</a></td>
</tr>
<tr>
<td>
  <code class="w3-codespan">&lt;&lt;</code>&nbsp;
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_shift">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">&amp;</code></td>
<td>Bitwise AND</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_bitwise_and">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">^</code></td>
<td>Bitwise XOR</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_bitwise_xor">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">|</code></td>
<td>Bitwise OR</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_bitwise_or">Try it &raquo;</a></td>
</tr>
<tr>
<td>
  <code class="w3-codespan">==</code>&nbsp;
  ...
  <code class="w3-codespan">&lt;</code>&nbsp;
  <code class="w3-codespan">&lt;=</code>&nbsp;
  <code class="w3-codespan">is</code>&nbsp;
  <code class="w3-codespan">is not</code>&nbsp;
  <code class="w3-codespan">in</code>&nbsp;
  <code class="w3-codespan">not in</code>&nbsp;
</td>
<td>Comparisons, identity, and membership operators</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_like">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">not</code></td>
<td>Logical NOT</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_not">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">and</code></td>
<td>AND</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_and">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">or</code></td>
<td>OR</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_precedence_or">Try it &raquo;</a></td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Addition <code class="w3-codespan">+</code> and
subtraction <code class="w3-codespan">-</code> has the same precedence, and therefore
we evaluate the expression from left to right:</p>
<div class="w3-code notranslate pythonHigh">
print(5 + 4 - 7 + 3)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_precedence_same">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_precedence.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_bitwise.asp">&#10094; Previous</a>
