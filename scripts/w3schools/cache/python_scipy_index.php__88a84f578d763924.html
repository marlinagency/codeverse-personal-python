...
<h2 class="left">SciPy Tutorial</h2>
<a target="_top" href="index.php">SciPy Home</a>
<a target="_top" href="scipy_intro.php">SciPy Intro</a>
<a target="_top" href="scipy_getting_started.php">SciPy Getting Started</a>
<a target="_top" href="scipy_constants.php">SciPy Constants</a>
<a target="_top" href="scipy_optimizers.php">SciPy Optimizers</a>
<a target="_top" href="scipy_sparse_data.php">SciPy Sparse Data</a>
<a target="_top" href="scipy_graphs.php">SciPy Graphs</a>
<a target="_top" href="scipy_spatial_data.php">SciPy Spatial Data</a>
<a target="_top" href="scipy_matlab_arrays.php">SciPy Matlab Arrays</a>
<a target="_top" href="scipy_interpolation.php">SciPy Interpolation</a>
<a target="_top" href="scipy_statistical_significance_tests.php" class="not-wired">SciPy Significance Tests</a>
<br>
<h2 class="left">SciPy Cert</h2>
<a target="_top" class="no-checkmark" href="scipy_exam.php">SciPy Certificate</a>
<br>
<h2 class="left">Quiz/Exercises</h2>
<a target="_top" class="no-checkmark" href="scipy_compiler.php">SciPy Editor</a>
<a target="_top" class="no-checkmark" href="scipy_quiz.php">SciPy Quiz</a>
<a target="_top" class="no-checkmark" href="scipy_exercises.php">SciPy Exercises</a>
<a target="_top" class="no-checkmark" href="scipy_syllabus.php">SciPy Syllabus</a>
<a target="_top" class="no-checkmark" href="scipy_study_plan.php">SciPy Study Plan</a>        <br><br>
    </div>
  </div>
</div>
<!--original:
...
<h1>SciPy <span class="color_h1">Tutorial</span></h1>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/learn-scipy" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="SciPy Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools SciPy Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#0053A9" viewBox="0 0 24 24"><path d="M15.697 13.496c-.784-1.072-1.982-1.519-3.694-1.88l-1.592-.375-1.201-.515c-.631-.446-1.17-1.634-1.017-2.681a3 3 0 0 1 3.386-2.526 2.962 2.962 0 0 1 1.962 1.155L15.35 9.05c1.033 1.33 2.195 1.727 3.459 1.098l.637-.27a.22.22 0 0 1 .278.087l.127.19a.311.311 0 0 0 .156.131.326.326 0 0 0 .33-.058l1.467-1.384c.257-.22.182-.422.182-.422l-.354-.806s-.097-.193-.431-.149l-1.968.181a.327.327 0 0 0-.27.411l.071.227c.014.047.014.1-.005.148a.219.219 0 0 1-.124.125l-.556.235c-.582.341-1.244.123-1.686-.417l-.505-.67-1.438-1.91a4.421 4.421 0 0 0-2.929-1.72C9.355 3.733 7.095 5.42 6.741 7.84c-.179 1.22.187 2.375.855 3.302.485.674 1.373 1.06 1.854 1.18l1.262.36 1.208.277c.166.04.634.155.91.255.256.092.845.31 1.324.701.572.582.875 1.413.746 2.284a2.744 2.744 0 0 1-4.897 1.255l-1.726-2.292a2.294 2.294 0 0 0-1.514-.89 2.31 2.31 0 0 0-1.708.439l-3.632 2.71A11.002 11.002 0 0 1 0 12C0 5.798 5.133.768 11.465.768c4.715 0 8.761 2.788 10.523 6.77l.581-.27.393-1.072.411.144-.353.96.98.337-.148.402-1.095-.382-.603.277c.5 1.262.778 2.632.778 4.066 0 6.203-5.135 11.232-11.467 11.232a11.526 11.526 0 0 1-9.26-4.61l3.721-2.788a.855.855 0 0 1 1.163.19l1.826 2.455a4.186 4.186 0 0 0 2.673 1.502c2.302.322 4.439-1.273 4.773-3.563a4.14 4.14 0 0 0-.664-2.922"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified SciPy Developer</text>
...
<p>We have created 10 tutorial pages for you to learn the fundamentals of SciPy:</p>
<style>
.pelle-btn {
  width:180px;
  border-radius:5px;
...
<div style="text-align:center;">
  <div class="w3-row">
    <div class="w3-col m12 l12">
      <h3 style="text-align:center">Basic SciPy</h3>
      <a href="scipy_intro.php" class="w3-btn pelle-btn">Introduction</a>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_getting_started.php" class="w3-btn pelle-btn">Getting Started</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_constants.php" class="w3-btn pelle-btn">Constants</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_optimizers.php" class="w3-btn pelle-btn">Optimizers</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_sparse_data.php" class="w3-btn pelle-btn">Sparse Data</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_graphs.php" class="w3-btn pelle-btn">Graphs</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_spatial_data.php" class="w3-btn pelle-btn">Spatial Data</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_matlab_arrays.php" class="w3-btn pelle-btn">Matlab Arrays</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_interpolation.php" class="w3-btn pelle-btn">Interpolation</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="scipy_statistical_significance_tests.php" class="w3-btn pelle-btn">Significance Tests</a><br>
    </div>
  </div>
</div>
...
<p>In our &quot;Try it Yourself&quot; editor, you can use the SciPy module, and modify the code to see the result.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>How many cubic meters are in one liter:</p>
<div class="w3-code notranslate pythonHigh">
from scipy import constants
<br><br>
  print(constants.liter)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_import">Try it Yourself &raquo;</a>
</div>
...
<div id="exercisecontainer" src="xrcise_graphs.js" data-extensions="php"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="scipy_exercises.php" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all SciPy Exercises</a></p>


<hr>
<h2>Learning by Quiz Test</h2>
<p>Test your SciPy skills with a quiz test.</p>
<p><a href="scipy_quiz.php" class="w3-button w3-blue">Start SciPy Quiz</a></p>
