...
<html lang="en-US">
<head>
<title>Python - Tuple Exercises</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Tuple Exercises</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_tuples_methods.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_tuples_basics.asp">Next &#10095;</a>
</div>
<hr>

<h2>Test Yourself With Exercises</h2>

<p>Now you have learned a lot about tuples, and how to use them in Python.</p>
<p>Are you ready for a test?</p>
<p>Test your Python Tuple skills with exercises from all categories:</p>
<style>
.exercise_tiles {
  background:#f3f4f6;
  border-radius:12px;
