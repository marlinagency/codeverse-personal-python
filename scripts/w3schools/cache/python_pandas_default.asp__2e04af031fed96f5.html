...
body.darkpagetheme .red-intro-emoji {
  color:#ee566a;
}
...
<h2 class="left">Pandas Tutorial</h2>
<a target="_top" href="default.asp">Pandas HOME</a>
<a target="_top" href="pandas_intro.asp">Pandas Intro</a>
...
<a target="_top" href="pandas_analyzing.asp" class="not-wired">Pandas Analyzing Data</a>
<br>
<h2 class="left">Cleaning Data</h2>
<a target="_top" href="pandas_cleaning.asp">Cleaning Data</a>
...
<a target="_top" href="pandas_cleaning_duplicates.asp" class="not-wired">Removing Duplicates</a>
<br>
<h2 class="left">Correlations</h2>
<a target="_top" href="pandas_correlations.asp" class="not-wired">Pandas Correlations</a>
<br>
<h2 class="left">Plotting</h2>
<a target="_top" href="pandas_plotting.asp" class="not-wired">Pandas Plotting</a>
<br>
<h2 class="left">Pandas Cert</h2>
<a target="_top" class="no-checkmark" href="pandas_exam.asp">Pandas Certificate</a>
<br>
<h2 class="left">Quiz/Exercises</h2>
<a target="_top" class="no-checkmark" href="pandas_compiler.asp">Pandas Editor</a>
<a target="_top" class="no-checkmark" href="pandas_quiz.asp">Pandas Quiz</a>
<a target="_top" class="no-checkmark" href="pandas_exercises.asp">Pandas Exercises</a>
<a target="_top" class="no-checkmark" href="pandas_syllabus.asp">Pandas Syllabus</a>
<a target="_top" class="no-checkmark" href="pandas_study_plan.asp">Pandas Study Plan</a>
<br>
<h2 class="left">References</h2>
<a target="_top" class="no-checkmark" href="pandas_ref_dataframe.asp">DataFrames Reference</a>
<br>
...
<h1>Pandas <span class="color_h1">Tutorial</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="pandas_intro.asp">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#150458" viewBox="0 0 24 24"><path d="M16.922 0h2.623v18.104h-2.623zm-4.126 12.94h2.623v2.57h-2.623zm0-7.037h2.623v5.446h-2.623zm0 11.197h2.623v5.446h-2.623zM4.456 5.896h2.622V24H4.455zm4.213 2.559h2.623v2.57H8.67zm0 4.151h2.623v5.447H8.67zm0-11.187h2.623v5.446H8.67Z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn Pandas</h2>
    </div>
    <p class="cert-card-desc">Pandas is a Python library.</p>
    <p class="cert-card-desc">Pandas is used to analyze data.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="pandas_intro.asp" class="cert-card-btn">Learn Pandas now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become Pandas Certified</h3>
    <p class="cert-info-desc">Get certified with our Pandas exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/pandas-course" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="Pandas Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools Pandas Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#150458" viewBox="0 0 24 24"><path d="M16.922 0h2.623v18.104h-2.623zm-4.126 12.94h2.623v2.57h-2.623zm0-7.037h2.623v5.446h-2.623zm0 11.197h2.623v5.446h-2.623zM4.456 5.896h2.622V24H4.455zm4.213 2.559h2.623v2.57H8.67zm0 4.151h2.623v5.447H8.67zm0-11.187h2.623v5.446H8.67Z"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified Pandas Developer</text>
            <text x="280" y="320" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="12" fill="#64748b">The candidate has passed the exam at the Professional level.</text>
...
<p>We have created 14 tutorial pages for you to learn more about Pandas.</p>
<p>Starting with a basic introduction and ends up with cleaning and plotting data:</p>
<style>
.pelle-btn {
  width:180px;
  border-radius:5px;
...
<a href="pandas_intro.asp" class="w3-btn pelle-btn">Introduction</a>
<div class="pelle-divider">&nbsp;</div>
<a href="pandas_getting_started.asp" class="w3-btn pelle-btn">Getting Started</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="pandas_series.asp" class="w3-btn pelle-btn">Pandas Series</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="pandas_dataframes.asp" class="w3-btn pelle-btn">DataFrames</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="pandas_csv.asp" class="w3-btn pelle-btn">Read CSV</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="pandas_json.asp" class="w3-btn pelle-btn">Read JSON</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="pandas_analyzing.asp" class="w3-btn pelle-btn">Analyze Data</a><br>
</div>
<div class="w3-col m4 l4">
<h3>Cleaning Data</h3>
<a href="pandas_cleaning.asp" class="w3-btn pelle-btn x2">Clean Data</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="pandas_cleaning_empty_cells.asp" class="w3-btn pelle-btn x2">Clean Empty Cells</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="pandas_cleaning_wrong_format.asp" class="w3-btn pelle-btn x2">Clean Wrong Format</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="pandas_cleaning_wrong_data.asp" class="w3-btn pelle-btn x2">Clean Wrong Data</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="pandas_cleaning_duplicates.asp" class="w3-btn pelle-btn x2">Remove Duplicates</a><br>
</div>
<div class="w3-col m4 l4">
<h3>Advanced</h3>
<a href="pandas_correlations.asp" class="w3-btn pelle-btn x3">Correlations</a><br>
<div class="pelle-divider x3">&nbsp;</div>
<a href="pandas_plotting.asp" class="w3-btn pelle-btn x3">Plotting</a><br>
</div>
</div>
</div>
...
<p>In our &quot;Try it Yourself&quot; editor, you can use the Pandas module, and modify the code to see the result.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_csv">Try it Yourself &raquo;</a>
</div>
...
<p>Most chapters in this tutorial end with an exercise where you can check your level of knowledge.</p>
<div id="exercisecontainer" src="xrcise_intro.js"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="pandas_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all Pandas Exercises</a></p>


<hr>

<h2>Learning by Quiz Test</h2>
<p>Test your Pandas skills with a quiz test.</p>
<p><a href="pandas_quiz.asp" class="w3-button w3-blue">Start Pandas Quiz</a></p>
