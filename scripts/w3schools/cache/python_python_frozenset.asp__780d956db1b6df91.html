...
<h1>Python <span class="color_h1">frozenset</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_sets_join.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets_methods.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Python frozenset</h2>
<p><code class="w3-codespan">frozenset</code> is an immutable version of a set.</p>
<p>Like sets, it contains unique, unordered, unchangeable elements.</p>
<p>Unlike sets, elements cannot be added or removed from a frozenset.</p>

<hr>
<h2>Creating a frozenset</h2>
<p>Use the <code class="w3-codespan">frozenset()</code> constructor to create a frozenset from any iterable.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a <code class="w3-codespan">frozenset</code> and check its type:</p>
<div class="w3-code notranslate pythonHigh">
x = frozenset({"apple", "banana", "cherry"})<br>
print(x)<br>
print(type(x))<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_frozenset">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Frozenset Methods</h2>
<p>Being immutable means you cannot add or remove elements. However, frozensets support all non-mutating operations of sets.</p>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_copy">Try it &raquo;</a></td>
</tr>
<tr>
<td>difference()</td>
<td><code class="w3-codespan">-</code></td>
<td>Returns a new frozenset with the difference</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_difference">Try it &raquo;</a></td>
</tr>
<tr>
<td>intersection()</td>
<td><code class="w3-codespan">&amp;</code></td>
<td>Returns a new frozenset with the intersection</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_intersection">Try it &raquo;</a></td>
</tr>
<tr>
<td>isdisjoint()</td>
<td>&nbsp;</td>
<td>Returns True if there is NO intersection between two frozensets</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_isdisjoint">Try it &raquo;</a></td>
</tr>
<tr>
<td>issubset()</td>
<td><code class="w3-codespan">&lt;=</code> / <code class="w3-codespan">&lt;</code></td>
<td>Returns True if this frozenset is a (proper) subset of another</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_issubset">Try it &raquo;</a></td>
</tr>
<tr>
<td>issuperset()</td>
<td><code class="w3-codespan">&gt;=</code> / <code class="w3-codespan">&gt;</code></td>
<td>Returns True if this frozenset is a (proper) superset of another</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_issuperset">Try it &raquo;</a></td>
</tr>
<tr>
<td>symmetric_difference()</td>
<td><code class="w3-codespan">^</code></td>
<td>Returns a new frozenset with the symmetric differences</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_symmetric_difference">Try it &raquo;</a></td>
</tr>
<tr>
<td>union()</td>
<td><code class="w3-codespan">|</code></td>
<td>Returns a new frozenset containing the union</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_frozenset_union">Try it &raquo;</a></td>
</tr>
</table>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_sets_frozenset.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_sets_join.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets_methods.asp">Next &#10095;</a>
