...
<html lang="en-US">
<head>
<title>Python Variables - Assign Multiple Values</title>
<meta charset="utf-8">
...
<h1>Python Variables - <span class="color_h1">Assign Multiple Values</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_variables_names.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_variables_output.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables8">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Make sure the number of variables matches the number of values, or else you will get an error.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables6">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>If you have a collection of values in a <code class="w3-codespan"><a href="python_lists.asp">list</a></code>,
  <code class="w3-codespan"><a href="python_tuples.asp">tuple</a></code> etc.
Python allows you to extract the values into variables. This is called <em>unpacking</em>.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_unpack">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<p>Learn more about unpacking in our <a href="python_tuples_unpack.asp">Unpack Tuples</a> Chapter.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_variables_multiple.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Multiple Values</h2>
  <a href="https://youtu.be/4oug4GEDSeM&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_variables_multiple_values.webp" type="image/webp" />
        <img src="images/img_python_variables_multiple_values.png" style="max-width:100%;height:auto;border-radius:6px" alt="Python Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
