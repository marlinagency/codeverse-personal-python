...
<p><b>Tip:</b> You need administrative privileges to create a new database. </p>
</div>

<h3>Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE DATABASE <em>database_name</em>;</div>
</div>
<hr>
...
<p>Once a database is created, you can check it in the list of databases with the following SQL command:</p>
<h3>Syntax for SQL Server</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT name FROM sys.databases;</div>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_create_db.js"></div>
<hr>
