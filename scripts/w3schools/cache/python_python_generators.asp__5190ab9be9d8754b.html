...
<h1>Python <span class="color_h1">Generators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_recursion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_functions_basics.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Generators</h2>
<p>Generators are functions that can pause and resume their execution.</p>
<p>When a generator function is called, it returns a <em>generator object</em>, which is an iterator.</p>
<p>The code inside the function is not executed yet, it is only compiled. The function only executes when you iterate over the generator.</p>

<div class="w3-example">
<h3>Example</h3>
<p>A simple generator function:</p>
<div class="w3-code notranslate pythonHigh">
def my_generator():<br>&nbsp; yield 1<br>&nbsp; yield 2<br>&nbsp; yield 3<br><br>
for value in my_generator():<br>&nbsp; print(value)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_simple">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>Generators allow you to iterate over data without storing the entire dataset in memory.</p>
<p>Instead of using <code class="w3-codespan">return</code>, generators use the <code class="w3-codespan"><a href="ref_keyword_yield.asp">yield</a></code> keyword.</p>
...
<p>The <code class="w3-codespan">yield</code> keyword is what makes a function a generator.</p>

<p>When <code class="w3-codespan">yield</code> is encountered, the function's state is saved, and the value is returned. The next time the generator is called, it continues from where it left off.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generator that yields numbers:</p>
<div class="w3-code notranslate pythonHigh">
def count_up_to(n):<br>&nbsp; count = 1<br>&nbsp; while count <= n:<br>&nbsp;&nbsp;&nbsp; yield count<br>&nbsp;&nbsp;&nbsp; count += 1<br><br>
for num in count_up_to(5):<br>&nbsp; print(num)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_yield">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>Unlike <code class="w3-codespan">return</code>, which terminates the function, <code class="w3-codespan">yield</code> pauses it and can be called multiple times.</p>
</div>
...
<hr>
<!--start-->
<h2>Generators Saves Memory</h2>

<p>Generators are memory-efficient because they generate values on-the-fly instead of storing everything in memory.</p>
<p>For large datasets, generators save memory:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generator for large sequences:</p>
<div class="w3-code notranslate pythonHigh">
def large_sequence(n):<br>&nbsp; for i in range(n):<br>&nbsp;&nbsp;&nbsp; yield i<br><br>
# This doesn't create a million numbers in memory<br>
gen = large_sequence(1000000)<br>
print(next(gen))<br>
print(next(gen))<br>
print(next(gen))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_large">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>Using next() with Generators</h2>

<p>You can manually iterate through a generator using the <code class="w3-codespan">next()</code> function:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
def simple_gen():<br>&nbsp; yield "Emil"<br>&nbsp; yield "Tobias"<br>&nbsp; yield "Linus"<br><br>
gen = simple_gen()<br>
print(next(gen))<br>
print(next(gen))<br>
print(next(gen))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_next">Try it Yourself &raquo;</a>
</div>

<p>When there are no more values to yield, the generator raises a <code class="w3-codespan">StopIteration</code> exception:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh w3-border-red">
def simple_gen():<br>&nbsp; yield 1<br>&nbsp; yield 2<br><br>
gen = simple_gen()<br>
print(next(gen))<br>
print(next(gen))<br>
print(next(gen))  # This will raise StopIteration</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_stopiteration">Try it Yourself &raquo;</a>
</div>
...
<p>Similar to list comprehensions, you can create generators using generator expressions with parentheses instead of square brackets:</p>

<div class="w3-example">
<h3>Example</h3>
<p>List comprehension vs generator expression:</p>
<div class="w3-code notranslate pythonHigh">
# List comprehension - creates a list<br>
list_comp = [x * x for x in range(5)]<br>
print(list_comp)<br><br>
# Generator expression - creates a generator<br>
gen_exp = (x * x for x in range(5))<br>
print(gen_exp)<br>
print(list(gen_exp))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_expression">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using a generator expression with sum:</p>
<div class="w3-code notranslate pythonHigh">
# Calculate sum of squares without creating a list<br>
total = sum(x * x for x in range(10))<br>
print(total)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_sum">Try it Yourself &raquo;</a>
</div>
...
<p>Generators can be used to create the Fibonacci sequence.</p>
<p>It can continue generating values indefinitely, without running out of memory:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate 100 Fibonacci numbers:</p>
<div class="w3-code notranslate pythonHigh">
def fibonacci():<br>&nbsp; a, b = 0, 1<br>&nbsp; while True:<br>&nbsp;&nbsp;&nbsp; yield a<br>&nbsp;&nbsp;&nbsp; a, b = b, a + b<br><br>
# Get first 100 Fibonacci numbers<br>
gen = fibonacci()<br>
for _ in range(100):<br>&nbsp; print(next(gen))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_fibonacci">Try it Yourself &raquo;</a>
</div>
...
<p>Generators have special methods for advanced control:</p>

<h3>send() Method</h3>

<p>The <code class="w3-codespan">send()</code> method allows you to send a value to the generator:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
def echo_generator():<br>&nbsp; while True:<br>&nbsp;&nbsp;&nbsp; received = yield<br>&nbsp;&nbsp;&nbsp; print("Received:", received)<br><br>
gen = echo_generator()<br>
next(gen)  # Prime the generator<br>
gen.send("Hello")<br>
gen.send("World")</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_send">Try it Yourself &raquo;</a>
</div>

<h3>close() Method</h3>

<p>The <code class="w3-codespan">close()</code> method stops the generator:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
def my_gen():<br>&nbsp; try:<br>&nbsp;&nbsp;&nbsp; yield 1<br>&nbsp;&nbsp;&nbsp; yield 2<br>&nbsp;&nbsp;&nbsp; yield 3<br>&nbsp; finally:<br>&nbsp;&nbsp;&nbsp; print("Generator closed")<br><br>
gen = my_gen()<br>
print(next(gen))<br>
gen.close()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_generator_close">Try it Yourself &raquo;</a>
</div>
