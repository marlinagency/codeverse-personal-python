...
<p>An SQL view is a virtual table based on the result-set of an SQL statement. An SQL view contains rows and columns, just like a real table. The fields in 
the view are fields from one or more real tables in the database.</p>
<p>You can add SQL statements and functions to a view and present the data as if 
it were coming from one single table.</p>
...
<p><b>Note:</b> A view always shows real-time data! The database engine only 
stores the view's definition (the SELECT statement), not a copy of the data.</p>
<hr>

<h2>CREATE VIEW Examples</h2>
<p>The following SQL creates a view named &quot;Brazil Customers&quot;, that shows all customers from Brazil:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>To query the view above, use the following SQL syntax:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>The following SQL creates a view named &quot;Products Above Average Price&quot;, that selects 
all products in the &quot;Products&quot; table with a Price higher than the average price:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<h2>ALTER VIEW Statement (SQL Server)</h2>
<p>In SQL Server, a view can be updated with the <code class="w3-codespan">ALTER 
VIEW</code> statement.</p>
<h3>ALTER VIEW Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
  ALTER VIEW <em>view_name</em> AS<br>
SELECT <em>column1</em>, <em>column2</em>, ...<br>
FROM <em>table_name</em><br>
WHERE <em>condition</em>;</div></div>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  ALTER VIEW [Brazil Customers] AS<br>
...
<h2>CREATE OR REPLACE VIEW Statement (MySQL and Oracle)</h2>
<p>In MySQL and Oracle, a view can be updated with the <code class="w3-codespan">CREATE OR REPLACE 
VIEW</code> statement.</p>
...
<p>The following SQL deletes the &quot;Brazil Customers&quot; view:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<hr>
<div id="exercisecontainer" src="xrcise_view.js"></div>
<hr>
