...
&nbsp;&nbsp;<em>column1 datatype constraint</em>,<br>
&nbsp;&nbsp;<em>column2 datatype constraint</em>,<br>
&nbsp;&nbsp;<em>column3 datatype constraint</em>,<br>
&nbsp;&nbsp;....<br>
);</div>
</div>

<p>The <em>table_name</em> parameter specifies the name of the new table.</p>
<p>The <em>column1</em>, <em>column2</em>, ... parameters specify the names of the columns 
within the table.</p>
<p>The <em>datatype</em> parameter specifies the data type of each column (e.g. varchar, int, date, etc.).</p>
<p>The <em>constraint</em> parameter is optional, and specifies rules for data 
integrity (e.g. primary key, not null, etc.).</p>
<p><strong>Tip:</strong> Learn more about constraints in our
<a href="sql_constraints.asp">SQL Constraints</a> chapter.</p>
...
<p>The following example creates a table named &quot;Persons&quot; with five columns:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<ul>
  <li><strong>PersonID</strong> - This column is of type integer (int). This is also the <a href="sql_primarykey.asp">PRIMARY KEY</a> field, that uniquely identifies 
  each row.</li>
  <li><strong>LastName</strong> - This column is a variable-length character string with a maximum length 
  of 255 characters (varchar(255)). NOT NULL specifies that this column cannot 
  be empty.</li>
  <li><strong>FirstName, Address, City</strong> - These columns are also variable-length character strings with a maximum length 
  of 255 characters (varchar(255)). These columns allow NULL values by default.</li>
</ul>
...
<h2>Create New Table From Existing Table</h2>
<p>The <code class="w3-codespan">CREATE TABLE</code> statement can also be used 
to create a new table that copies some/all data from an existing table.</p>
<p>If you create a new table from an existing table, the new table will be 
filled with the values from the existing table.</p>

<h3>Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE TABLE <em>new_table</em> AS<br>SELECT <em>column1, column2,...</em><br>FROM <em>
  existing_table</em><br>WHERE ....;</div>
</div>

<p>The following SQL creates a new table called &quot;GermanCustomers&quot; (which is 
a copy of the &quot;Customers&quot; table):&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
CREATE TABLE 
  GermanCustomers AS<br>SELECT * FROM Customers<br>WHERE Country = 'Germany';</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_create_table.js"></div>
<hr>
