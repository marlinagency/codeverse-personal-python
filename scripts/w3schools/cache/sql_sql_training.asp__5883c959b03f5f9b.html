...
<h1>SQL <span class="color_h1">Training</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_bootcamp.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="https://campus.w3schools.com/collections/certifications/products/sql-certificate">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel ws-info">
  <p><strong>Introduction:</strong> SQL is a standard language for storing, manipulating and retrieving data in databases.</p>
  <p>W3Schools offers an SQL training course that covers SQL foundations and more.</p>
  <p>The course includes the W3Schools <strong>Certified SQL Developer</strong> certification.</p>
  <p>The SQL training is relevant for companies and schools that want to certify their employees or students.</p>
  ...
  <p>Remember that you can always learn for free on W3Schools with the <a href="https://www.w3schools.com/sql/default.asp" target="_blank">SQL Tutorial</a>.</p>
...
<h2>SQL Training with W3Schools</h2>
...
<p>With the W3Schools Academy pricing model, it is now one of the worlds most affordable quality SQL training options there is.</p>
...
<p>The Certificate Course includes all the training materials to pass the <strong>Certified SQL Developer</strong> certification exam.</p>
<p>No prerequisites are required to take the course.</p>
<p>The learners will be able to:</p>

<ul>
  <li>Understand what SQL is and why you would use it.</li>
  <li>Create and manage databases and tables.</li>
  <li>Insert, update, and delete data in tables.</li>
  <li>Use SELECT with filters (WHERE) and sorting (ORDER BY) to get data.</li>
  <li>Use JOIN to combine data from multiple tables.</li>
  <li>Use functions like SUM, AVG, and COUNT to group data and add them up.</li>
  <li>Create table relationships with foreign keys.</li>
  <li>Use SQL functions like MIN, MAX, and COUNT.</li>
  <li>Understand subqueries and indexes.</li>
  <li>Manage user permissions and data security.</li>
</ul>
...
<h2>Certified SQL Developer</h2>
<p>After completing the training modules the learner will take the end of pathway exam.</p>
<p>When the learner passes the exam, the learner will get the <strong>Certified SQL Developer</strong> certification.</p>
<p>The exam is a multiple choice exam with 60 questions and a duration of 60 minutes.</p>
<p>Image of a SQL Certificate:</p>
<img src="./images/sql_certificate.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
...
<p>You can read more about the certificate here: <a href="sql_exam.asp" target="_blank">SQL Certificate</a></p>
<hr>
...
<img src="./images/sql_academy_class.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
...
<p>Image of one of the activity types in the course, a SQL Challenge:</p>
<img src="./images/sql_challenge.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
<p>SQL is best learned by doing, and this is why we have included a lot of challenges in the course.</p>
<ul>
...
<table class="ws-table-all" style="width:100%; border-collapse: collapse; margin: 25px 0;">
  ...
  <tr>
    ...
    <td style="padding:16px; border:1px solid #ddd;">48 hours on average</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding:16px; border:1px solid #ddd;">Certified SQL Developer</td>
  </tr>
  <tr>
