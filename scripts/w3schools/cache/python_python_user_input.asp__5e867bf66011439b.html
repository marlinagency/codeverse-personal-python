...
<h1>Python <span class="color_h1">User Input</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_none.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_virtualenv.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>User Input</h2>
...
<p>The following example asks for your name, and when you enter a name, it gets printed on the screen:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_user_input_1">Run Example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>Python stops executing when it comes to the <code class="w3-codespan"><a href="ref_func_input.asp">input()</a></code> function, and continues 
...
<p>In the example above, the user had to input their name on a new line. The Python <code class="w3-codespan"><a href="ref_func_input.asp">input()</a></code> function has a <code class="w3-codespan">prompt</code> parameter,
which acts as a message you can put in front of the user input, on the same line:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Add a message in front of the user input:</p>
<div class="w3-code notranslate pythonHigh">
name = input(&quot;Enter your name:&quot;)<br>
print(f"Hello {name}")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_user_input_prompt">Run Example &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can add as many inputs as you want, Python will stop executing at each of them,
...
name = input(&quot;Enter your name:&quot;)<br>
print(f"Hello {name}")<br>
fav1 = input(&quot;What is your favorite animal:&quot;)<br>
fav2 = input(&quot;What is your favorite color:&quot;)<br>
fav3 = input(&quot;What is your favorite number:&quot;)<br>
print(f"Do you want a {fav2} {fav1} with {fav3} legs?")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_user_input_multiple">Run Example &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The input from the user is treated as a string. Even if, in the example above, you can input a number,
the Python interpreter will still treat it as a string.</p>

<p>You can convert the input into a number with the <code class="w3-codespan"><a href="ref_func_float.asp">float()</a></code>
function:</p>

<div class="w3-example">
<h3>Example</h3>
<p>To find the square root, the input has to be converted into a number:</p>
<div class="w3-code notranslate pythonHigh">
x = input(&quot;Enter a number:&quot;)<br>
<br>
#find the square root of the number:<br>
y = math.sqrt(float(x))<br>
<br>
print(f"The square root of {x} is {y}")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_user_input_number">Run Example &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>It is a good practice to validate any input from the user. In the example above, 
an error will occur if the user inputs something other than a number.</p>

<p>To avoid getting an error, we can test the input, and if it is not a number, the user could get a message like "Wrong input, please try again",
and allowed to make a new input:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Keep asking until you get a number:</p>
<div class="w3-code notranslate pythonHigh">
y = True<br>
while y == True:<br>
&nbsp;&nbsp;x = input("Enter a number:")<br>
&nbsp; try:<br>&nbsp;&nbsp;&nbsp; x = float(x);<br>&nbsp;&nbsp;&nbsp; y = False<br>&nbsp; 
  except:<br>&nbsp;&nbsp;&nbsp; print("Wrong input, please try again.")<br>
<br>
print("Thank you!")</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_user_input_validate">Run Example &raquo;</a>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_user_input.js"></div>
<hr>
