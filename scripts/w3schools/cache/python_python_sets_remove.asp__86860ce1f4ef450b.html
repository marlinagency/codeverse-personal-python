...
<html lang="en-US">
<head>
<title>Python - Remove Set Items</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Remove Set Items</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_sets_add.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets_loop.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Remove Item</h2>

<p>To remove an item in a set, use the <code class="w3-codespan"><a href="ref_set_remove.asp">remove()</a></code>, or the <code class="w3-codespan"><a href="ref_set_discard.asp">discard()</a></code> method.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Remove &quot;banana&quot; by using the <code class="w3-codespan"><a href="ref_set_remove.asp">remove()</a></code> 
method:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>
  thisset.remove(&quot;banana&quot;)<br><br>
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_remove">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> If the item to remove does not exist, <code class="w3-codespan"><a href="ref_set_remove.asp">remove()</a></code> will raise an error.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Remove &quot;banana&quot; by using the <code class="w3-codespan"><a href="ref_set_discard.asp">discard()</a></code> 
method:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>
  thisset.discard(&quot;banana&quot;)<br><br>
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_discard">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> If the item to remove does not exist, <code class="w3-codespan"><a href="ref_set_discard.asp">discard()</a></code> will 
  <strong>NOT</strong> raise an error.</p>
</div>
<!--stop-->
<!--start-->
<p>You can also use the <code class="w3-codespan"><a href="ref_set_pop.asp">pop()</a></code> method to remove 
an item, but this method will remove a random item, so you cannot be sure what item that gets removed.</p>
<p>The return value of the <code class="w3-codespan"><a href="ref_set_pop.asp">pop()</a></code> method is the 
removed item.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Remove a random item by using the <code class="w3-codespan"><a href="ref_set_pop.asp">pop()</a></code> 
method:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>
  x =
  ...
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_pop">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Sets are <em>unordered</em>, so when using the <code class="w3-codespan"><a href="ref_set_pop.asp">pop()</a></code> method, 
you do not know which item that gets removed.</p>
</div>


<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan"><a href="ref_set_clear.asp">clear()</a></code> 
method empties the set:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>
  thisset.clear()<br><br>
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_clear">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan"><a href="ref_keyword_del.asp">del</a></code> keyword will delete the set 
completely:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>
  del
  thisset<br><br>
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_set_del">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_sets_remove.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_sets_add.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets_loop.asp">Next &#10095;</a>
