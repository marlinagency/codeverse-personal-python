...
<html lang="en-US">
<head>
<title>Matplotlib Scatter</title>
<meta charset="utf-8">
...
<h1>Matplotlib <span class="color_h1">Scatter</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="matplotlib_subplot.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="matplotlib_bars.asp">Next &#10095;</a>
</div>
<hr>

<h2>Creating Scatter Plots</h2>
<p>With Pyplot, you can use the <code class="w3-codespan">scatter()</code> function 
to draw a scatter plot.</p>
<p>The <code class="w3-codespan">scatter()</code> function plots one dot for 
each observation. It needs two arrays of the same length, one for the values of 
the x-axis, and one for values on the y-axis:</p>

<div class="w3-example">
<h3>Example</h3>
<p>A simple scatter plot:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br><br>plt.scatter(x, y)<br>plt.show()
</div>
<h3>Result:</h3>
<p><img src="img_matplotlib_scatter.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter">Try it Yourself &raquo;</a>
</div>

<p>The observation in the example above is the result of 13 cars passing by.</p>
<p>The X-axis shows how old the car is.</p>
<p>The Y-axis shows the speed of the car when it passes.</p>
<p>Are there any relationships between the observations?</p>
<p>It seems that the newer the car, the faster it drives, but that could be a coincidence, after all we only registered 13 cars.</p>
<hr>

<h2>Compare Plots</h2>
<p>In the example above, there seems to be a relationship between speed and age,
but what if we plot the observations from another day as well?
Will the scatter plot tell us something else?</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw two plots on the same figure:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>#day one, the age 
  and speed of 13 cars:<br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>plt.scatter(x, 
  y)<br><br>#day two, the age and speed of 15 cars:<br>x = np.array([2,2,8,1,15,8,12,9,7,3,11,4,7,14,12])<br>y = np.array([100,105,84,105,90,99,90,95,94,100,79,112,91,80,85])<br>
  plt.scatter(x, y)<br><br>plt.show()</div>
<h3>Result:</h3>
<p><img src="img_matplotlib_scatter_compare.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_compare">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The two plots are plotted with two different colors, by default blue and orange, you will learn how to change colors later in this chapter.</p>
</div>

<p>By comparing the two plots, I think it is safe to say that they both gives us the same conclusion: the newer the car, the faster it drives.</p>
<hr>
...
<h2>Colors</h2>
<p>You can set your own color for each scatter plot with the
<code class="w3-codespan">color</code> or the <code class="w3-codespan">c</code> 
argument:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set your own color of the markers:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>plt.scatter(x, 
  y, color = 'hotpink')<br><br>x = np.array([2,2,8,1,15,8,12,9,7,3,11,4,7,14,12])<br>y = np.array([100,105,84,105,90,99,90,95,94,100,79,112,91,80,85])<br>
  plt.scatter(x, y, color = '#88c999')<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_color.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_color">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Color Each Dot</h2>

<p>You can even set a specific color for each dot by using an array of colors as value for the
<code class="w3-codespan">c</code> argument:</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You <em>cannot</em> use the <code class="w3-codespan">color</code> argument for this, only the <code class="w3-codespan">c</code> argument.</p>
</div>
...
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>colors = np.array([&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;,&quot;pink&quot;,&quot;black&quot;,&quot;orange&quot;,&quot;purple&quot;,&quot;beige&quot;,&quot;brown&quot;,&quot;gray&quot;,&quot;cyan&quot;,&quot;magenta&quot;])<br>
  <br>plt.scatter(x, y, c=colors)<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_colors2.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_c">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ColorMap</h2>

<p>The Matplotlib module has a number of available colormaps.</p>
<p>A colormap is like a list of colors, where each color has a value that ranges 
from 0 to 100.</p>
<p>Here is an example of a colormap:</p>
<p>
  <img src="img_colorbar.png" style="max-width:100%">
</p>

<p>This colormap is called 'viridis' and as you can see it ranges from 0, which 
is a purple color, up to 100, which is a yellow color.</p>
<h3>How to Use the ColorMap</h3>
<p>You can specify the colormap with the keyword argument
<code class="w3-codespan">cmap</code> with the value of the colormap, in this 
case <code class="w3-codespan">'viridis'</code> which is one of the 
built-in colormaps available in Matplotlib.</p>
<p>In addition you have to create an array with values (from 0 to 100), one value for each point in the scatter plot:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a color array, and specify a colormap in the scatter plot:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>colors = np.array([0, 
  10, 20, 30, 40, 45, 50, 55, 60, 70, 80, 90, 100])<br>
  <br>plt.scatter(x, y, c=colors, cmap='viridis')<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_colormap1.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_cmap">Try it Yourself &raquo;</a>
</div>

<p>You can include the colormap in the drawing by including the <code class="w3-codespan">plt.colorbar()</code> statement:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Include the actual colormap:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>colors = np.array([0, 
  10, 20, 30, 40, 45, 50, 55, 60, 70, 80, 90, 100])<br>
  <br>plt.scatter(x, y, c=colors, cmap='viridis')<br><br>plt.colorbar()<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_colormap2.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_cmap2">Try it Yourself &raquo;</a>
</div>

<h3>Available ColorMaps</h3>

<p>You can choose any of the built-in colormaps:</p>
...
<tr>
<td>Accent</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Accent">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Accent_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Accent_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Blues</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Blues">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Blues_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Blues_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>BrBG</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_BrBG">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>BrBG_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_BrBG_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>BuGn</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_BuGn">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>BuGn_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_BuGn_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>BuPu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_BuPu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>BuPu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_BuPu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>CMRmap</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_CMRmap">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>CMRmap_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_CMRmap_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Dark2</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Dark2">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Dark2_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Dark2_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>GnBu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_GnBu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>GnBu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_GnBu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Greens</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Greens">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Greens_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Greens_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Greys</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Greys">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Greys_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Greys_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>OrRd</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_OrRd">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>OrRd_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_OrRd_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Oranges</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Oranges">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Oranges_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Oranges_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>PRGn</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PRGn">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>PRGn_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PRGn_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Paired</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Paired">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Paired_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Paired_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Pastel1</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Pastel1">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Pastel1_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Pastel1_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Pastel2</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Pastel2">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Pastel2_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Pastel2_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>PiYG</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PiYG">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>PiYG_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PiYG_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>PuBu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuBu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>PuBu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuBu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>PuBuGn</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuBuGn">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>PuBuGn_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuBuGn_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>PuOr</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuOr">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>PuOr_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuOr_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>PuRd</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuRd">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>PuRd_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_PuRd_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Purples</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Purples">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Purples_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Purples_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>RdBu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdBu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>RdBu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdBu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>RdGy</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdGy">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>RdGy_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdGy_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>RdPu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdPu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>RdPu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdPu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>RdYlBu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdYlBu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>RdYlBu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdYlBu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>RdYlGn</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdYlGn">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>RdYlGn_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_RdYlGn_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Reds</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Reds">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Reds_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Reds_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Set1</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Set1">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Set1_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Set1_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Set2</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Set2">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Set2_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Set2_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Set3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Set3">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Set3_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Set3_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Spectral</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Spectral">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Spectral_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Spectral_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>Wistia</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Wistia">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>Wistia_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_Wistia_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>YlGn</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlGn">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>YlGn_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlGn_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>YlGnBu</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlGnBu">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>YlGnBu_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlGnBu_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>YlOrBr</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlOrBr">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>YlOrBr_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlOrBr_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>YlOrRd</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlOrRd">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>YlOrRd_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_YlOrRd_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>afmhot</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_afmhot">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>afmhot_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_afmhot_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>autumn</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_autumn">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>autumn_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_autumn_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>binary</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_binary">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>binary_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_binary_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>bone</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_bone">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>bone_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_bone_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>brg</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_brg">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>brg_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_brg_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>bwr</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_bwr">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>bwr_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_bwr_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>cividis</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_cividis">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>cividis_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_cividis_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>cool</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_cool">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>cool_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_cool_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>coolwarm</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_coolwarm">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>coolwarm_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_coolwarm_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>copper</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_copper">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>copper_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_copper_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>cubehelix</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_cubehelix">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>cubehelix_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_cubehelix_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>flag</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_flag">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>flag_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_flag_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_earth</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_earth">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_earth_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_earth_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_gray</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_gray">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_gray_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_gray_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_heat</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_heat">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_heat_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_heat_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_ncar</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_ncar">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_ncar_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_ncar_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_rainbow</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_rainbow">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_rainbow_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_rainbow_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_stern</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_stern">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_stern_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_stern_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gist_yarg</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_yarg">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gist_yarg_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gist_yarg_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gnuplot</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gnuplot">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gnuplot_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gnuplot_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gnuplot2</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gnuplot2">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gnuplot2_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gnuplot2_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>gray</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gray">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>gray_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_gray_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>hot</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_hot">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>hot_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_hot_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>hsv</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_hsv">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>hsv_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_hsv_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>inferno</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_inferno">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>inferno_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_inferno_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>jet</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_jet">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>jet_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_jet_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>magma</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_magma">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>magma_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_magma_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>nipy_spectral</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_nipy_spectral">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>nipy_spectral_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_nipy_spectral_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>ocean</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_ocean">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>ocean_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_ocean_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>pink</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_pink">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>pink_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_pink_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>plasma</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_plasma">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>plasma_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_plasma_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>prism</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_prism">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>prism_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_prism_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>rainbow</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_rainbow">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>rainbow_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_rainbow_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>seismic</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_seismic">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>seismic_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_seismic_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>spring</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_spring">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>spring_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_spring_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>summer</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_summer">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>summer_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_summer_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>tab10</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab10">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>tab10_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab10_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>tab20</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab20">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>tab20_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab20_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>tab20b</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab20b">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>tab20b_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab20b_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>tab20c</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab20c">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>tab20c_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_tab20c_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>terrain</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_terrain">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>terrain_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_terrain_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>twilight</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_twilight">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>twilight_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_twilight_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>twilight_shifted</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_twilight_shifted">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>twilight_shifted_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_twilight_shifted_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>viridis</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_viridis">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>viridis_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_viridis_r">Try it  &raquo;</a></td>
</tr>
<tr>
<td>winter</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_winter">Try it  &raquo;</a></td>
<td>&nbsp;</td>
<td>winter_r</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_scatter_cmap_winter_r">Try it  &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
<p>You can change the size of the dots with the 
<code class="w3-codespan">s</code> argument.</p>

<p>Just like colors, make sure the array for sizes has the same length as the arrays for the x- and y-axis:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set your own size for the markers:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = np.array([5,7,8,7,2,17,2,9,4,11,12,9,6])<br>
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>sizes = 
  np.array([20,50,100,200,500,1000,60,90,10,300,600,800,75])<br><br>plt.scatter(x, 
  y, s=sizes)<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_size.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_size">Try it Yourself &raquo;</a>
</div>
...
<p>You can adjust the transparency of the dots with the 
<code class="w3-codespan">alpha</code> argument.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  y = np.array([99,86,87,88,111,86,103,87,94,78,77,85,86])<br>sizes = 
  np.array([20,50,100,200,500,1000,60,90,10,300,600,800,75])<br><br>plt.scatter(x, 
  y, s=sizes, alpha=0.5)<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_alpha.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_alpha">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Combine Color Size and Alpha</h2>

<p>You can combine a colormap with different sizes of the dots. This is best visualized if the dots are transparent:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create random arrays with 100 values for x-points, y-points, colors and 
sizes:</p>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import numpy as np<br><br>x = 
  np.random.randint(100, size=(100))<br>y = np.random.randint(100, size=(100))<br>
  colors = np.random.randint(100, size=(100))<br>sizes = 10 * np.random.randint(100, 
  size=(100))<br><br>plt.scatter(x, y, c=colors, s=sizes, alpha=0.5, cmap='nipy_spectral')<br>
  <br>plt.colorbar()<br><br>plt.show()</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_scatter_combine.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_scatter_combine">Try it Yourself &raquo;</a>
</div>
