...
<html lang="en-US">
<head>
<title>Hash Tables with Python</title>
<meta charset="utf-8">
...
<h1>Hash Tables with Python</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa_linkedlists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_trees.asp">Next &#10095;</a>
</div>
<hr>

<h2>Hash Table</h2>
<p>A Hash Table is a data structure designed to be fast to work with.</p>
<p>The reason Hash Tables are sometimes preferred instead of arrays or linked lists is because searching for, adding, and deleting data can be done really quickly, even for large amounts of data.</p>
<p>In a <a href="python_dsa_linkedlists.asp">Linked List</a>, finding a person "Bob" takes time because we would have to go from one node to the next, checking each node, until the node with "Bob" is found.</p>
<p>And finding "Bob" in an <a href="python_dsa_lists.asp">list/array</a> could be fast if we knew the index, but when we only know the name "Bob", we need to compare each element and that takes time.</p>
<p>With a Hash Table however, finding "Bob" is done really fast because there is a way to go directly to where "Bob" is stored, using something called a hash function.</p>
<hr>

<h2>Building A Hash Table from Scratch</h2>
<p>To get the idea of what a Hash Table is, let's try to build one from scratch, to store unique first names inside it.</p>
<p>We will build the Hash Table in 5 steps:</p>
<ol>
  <li>Create an empty list (it can also be a dictionary or a set).</li>
  <li>Create a hash function.</li>
  <li>Inserting an element using a hash function.</li>
  <li>Looking up an element using a hash function.</li>
  <li>Handling collisions.</li>
</ol>
<hr>

<h3>Step 1: Create an Empty List</h3>
<p>To keep it simple, let's create a list with 10 empty elements.</p>
...
<div class="ws-note">
  <p>Each of these elements is called a <strong>bucket</strong> in a Hash Table.</p>
</div>
<hr>

<h3>Step 2: Create a Hash Function</h3>
<p>Now comes the special way we interact with Hash Tables.</p>
<p>We want to store a name directly into its right place in the array, and this is where the <strong>hash function</strong> comes in.</p>
<p>A hash function can be made in many ways, it is up to the creator of the Hash Table.
...
<p>In our example we will use the Unicode number of each character, summarize them and do a modulo 10 operation to get index numbers 0-9.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a Hash Function that sums the Unicode numbers of each character and return a number between 0 and 9:</p>
<div class="w3-code notranslate pythonHigh">
def hash_function(value):<br>
&nbsp;&nbsp;sum_of_chars = 0<br>
&nbsp;&nbsp;for char in value:<br>
&nbsp;&nbsp;&nbsp;&nbsp;sum_of_chars += ord(char)<br>
<br>        
&nbsp;&nbsp;return sum_of_chars % 10<br>
<br>
print("'Bob' has hash code:", hash_function('Bob'))
</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_hashtable" target="_blank">Try it yourself &raquo;</a>
</div>

<p>The character <code class="w3-codespan">B</code> has Unicode number <code class="w3-codespan">66</code>,
  <code class="w3-codespan">o</code> has <code class="w3-codespan">111</code>,
  and <code class="w3-codespan">b</code> has <code class="w3-codespan">98</code>.
  Adding those together we get <code class="w3-codespan">275</code>.
  Modulo 10 of <code class="w3-codespan">275</code> is <code class="w3-codespan">5</code>,
  so <code class="w3-codespan">"Bob"</code> should be stored at index <code class="w3-codespan">5</code>.</p>
<p>The number returned by the hash function is called the <strong>hash code</strong>.</p>
<div class="ws-note">
  <p><strong>Unicode number: </strong>Everything in our computers are stored as numbers, and the Unicode code number is a unique number that exist for every character.
  For example, the character <code class="w3-codespan">A</code> has Unicode number <code class="w3-codespan">65</code>.</p>
  <p>See <a href="/charsets/ref_utf_basic_latin.asp">this page</a> for more information about how characters are represented as numbers.</p>
  <p><strong>Modulo: </strong>A modulo operation divides a number with another number, and gives us the resulting remainder.
    So for example, <code class="w3-codespan">7 % 3</code> will give us the remainder <code class="w3-codespan">1</code>.
    (Dividing 7 apples between 3 people, means that each person gets 2 apples, with 1 apple to spare.)</p>
  <p>In Python and most programming languages, the modolo operator is written as <code class="w3-codespan">%</code>.</p>
</div>
...
<h3>Step 3: Inserting an Element</h3>

<p>According to our hash function, "Bob" should be stored at index 5.</p>

<p>Lets create a function that add items to our hash table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
def add(name):<br>
&nbsp;&nbsp;index = hash_function(name)<br>
&nbsp;&nbsp;my_list[index] = name<br>
<br>
add('Bob')<br>
print(my_list)</div>
<a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_hashtable_insert" target="_blank">Run Example &raquo;</a>

</div>
<p>After storing "Bob" at index 5, our array now looks like this:</p>
<div class="w3-example">
<div class="w3-code notranslate pythonHigh">
my_list = [None, None, None, None, None, 'Bob', None, None, None, None]</div>
</div>
<p>We can use the same functions to store "Pete", "Jones", "Lisa", and "Siri" as well.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
  add('Pete')<br>
  ...
  add('Siri')<br>
  print(my_list)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_hashtable_insert_many" target="_blank">Run Example &raquo;</a>
  
  </div>
  
<p>After using the hash function to store those names in the correct position, our array looks like this:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
...
<h3>Step 4: Looking up a name</h3>
<p>Now that we have a super basic Hash Table, let's see how we can look up a name from it.</p>
<p>To find "Pete" in the Hash Table, we give the name "Pete" to our hash function. The hash function returns <code class="w3-codespan">8</code>,
meaning that "Pete" is stored at index 8.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
def contains(name):<br>
&nbsp;&nbsp;index = hash_function(name)<br>
&nbsp;&nbsp;return my_list[index] == name<br>
<br>
print("'Pete' is in the Hash Table:", contains('Pete'))</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_hashtable_lookup" target="_blank">Run Example &raquo;</a>
</div>

<p>Because we do not have to check element by element to find out if "Pete" is in there,
  we can just use the hash function to go straight to the right element!</p>
<hr>
<h3>Step 5: Handling collisions</h3>
<p>Let's also add "Stuart" to our Hash Table.</p>
<p>We give "Stuart" to our hash function, which returns <code class="w3-codespan">3</code>, meaning "Stuart" should be stored at index 3.</p>
<p>Trying to store "Stuart" in index 3, creates what is called a <strong>collision</strong>, because "Lisa" is already stored at index 3.</p>
<p>To fix the collision, we can make room for more elements in the same bucket.
...
<p>Start by creating a new list with the same size as the original list, but with empty buckets:</p>
<div class="w3-example">
  <div class="w3-code notranslate pythonHigh">
    my_list = [<br>
    &nbsp;&nbsp;[],<br>
...
<p>Rewrite the <code class="w3-codespan">add()</code> function, and add the same names as before:</p>
...
<div class="w3-example">
  ...
  add('Stuart')<br>
  print(my_list)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_hashtable_stuart" target="_blank">Run Example &raquo;</a>
  
  </div>
  
    <p>After implementing each bucket as a list, "Stuart" can also be stored at index 3, and our Hash Set now looks like this:</p>
<div class="w3-example">
  <h3>Result</h3>
<div class="w3-code notranslate pythonHigh">
my_list = [<br>
...
<div class="ws-note">
<p>Searching for "Stuart" now takes a little bit longer time, because we also find "Lisa" in the same bucket, but still much faster than searching the entire Hash Table.</p>
</div>
...
<h2>Uses of Hash Tables</h2>
<p>Hash Tables are great for:</p>
<ul>
...
<p>The most important reason why Hash Tables are great for these things is that Hash Tables are very fast compared Arrays and Linked Lists,
  especially for large sets.
  Arrays and Linked Lists have time complexity <code class="w3-codespan">O(n)</code> for search and delete,
  while Hash Tables have just <code class="w3-codespan">O(1)</code> on average.</p>
<hr>

<h2>Hash Tables Summarized</h2>
<p>Hash Table elements are stored in storage containers called <strong>buckets</strong>.</p>
<p>A <strong>hash function</strong> takes the key of an element to generate a <strong>hash code</strong>.</p>
<p>The hash code says what bucket the element belongs to, so now we can go directly to that Hash Table element: to modify it, or to delete it, or just to check if it exists.</p>
<p>A <strong>collision</strong> happens when two Hash Table elements have the same hash code, because that means they belong to the same <strong>bucket</strong>.</p>
<p>Collision can be solved by <strong>Chaining</strong> by using lists to allow more than one element in the same bucket.</p>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa_linkedlists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_trees.asp">Next &#10095;</a>
