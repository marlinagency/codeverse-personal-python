...
<h1>Python <span class="color_h1">Assignment Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_arithmetic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_ternary_operator.asp">Next &#10095;</a>
</div>
<hr>
...
<td>x = 5</td>
<td>x = 5</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass1">Try it &raquo;</a></td>
</tr>
  <tr>
<td>+=</td>
<td>x += 3</td>
<td>x = x + 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass2">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>-=</td>
<td>x -= 3</td>
<td>x = x - 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass3">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>*=</td>
<td>x *= 3</td>
<td>x = x * 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass4">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>/=</td>
<td>x /= 3</td>
<td>x = x / 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass5">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>%=</td>
<td>x %= 3</td>
<td>x = x % 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass6">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>//=</td>
<td>x //= 3</td>
<td>x = x // 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass7">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>**=</td>
<td>x **= 3</td>
<td>x = x ** 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass8">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>&amp;=</td>
<td>x &amp;= 3</td>
<td>x = x &amp; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass9">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>|=</td>
<td>x |= 3</td>
<td>x = x | 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass10">Try it &raquo;</a></td>
  </tr>
<tr>
<td>^=</td>
<td>x ^= 3</td>
<td>x = x ^ 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass11">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;&gt;=</td>
<td>x &gt;&gt;= 3</td>
<td>x = x &gt;&gt; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass12">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;&lt;=</td>
<td>x &lt;&lt;= 3</td>
<td>x = x &lt;&lt; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_ass13">Try it &raquo;</a></td>
</tr>
<tr>
<td>:=</td>
<td>print(x := 3)</td>
<td>x = 3<br>print(x)</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_walrus">Try it &raquo;</a></td>
</tr>
</table>
...
<p>Python 3.8 introduced the <strong>:=</strong> operator, known as the "walrus operator". It assigns values to variables as part of a larger expression:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The count variable is assigned in the if statement, and given the value 5:</p>
<div class="w3-code notranslate pythonHigh">
numbers = [1, 2, 3, 4, 5]<br>
<br>
if (count := len(numbers)) > 3:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print(f"List has {count} elements")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_walrus2">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_assign.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_arithmetic.asp">&#10094; Previous</a>
