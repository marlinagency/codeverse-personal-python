...
<a class="w3-left w3-btn" href="python_challenges_operators_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_access.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<p>Lists are one of 4 built-in data types in Python used to store collections of 
data, the other 3 are <a href="python_tuples.asp">Tuple</a>, 
<a href="python_sets.asp">Set</a>, and <a href="python_dictionaries.asp">Dictionary</a>, all with different qualities and usage.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>List items are indexed, the first item has index <code class="w3-codespan">[0]</code>,
the second item has index <code class="w3-codespan">[1]</code> etc.</p>
<hr>
<h2>Ordered</h2>

<p>When we say that lists are ordered, it means that the items have a defined order, and that order will not change.</p>

<p>If you add new items to a list,
the new items will be placed at the end of the list.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> There are some <a href="python_lists_methods.asp">list methods</a> that will change the order, but in general: the order of the items will not change.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate pythonHigh">
thislist = ["apple", "banana", "cherry", "apple", "cherry"]<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_duplicates">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>To determine how many items a list has, use the <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_len">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate pythonHigh">
list1 = ["apple", "banana", "cherry"]<br>
list2 = [1, 5, 7, 9, 3]<br>
list3 = [True, False, False]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_datatypes">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_datatypes2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_datatypes3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>It is also possible to use the <span class="w3-codespan"><a href="ref_func_list.asp">list()</a></span> constructor when creating a 
new list.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using the <code class="w3-codespan"><a href="ref_func_list.asp">list()</a></code> constructor to make a List:</p>
<div class="w3-code notranslate pythonHigh">
thislist = list(("apple", "banana", "cherry")) # note the double round-brackets<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_constructor">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-panel ws-note">
  <p>*Set <em>items</em> are unchangeable, but you can remove and/or add items 
  whenever you like.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_lists.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_operators_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_access.asp">Next &#10095;</a>
