...
<h1>Python <span class="color_h1">Statements</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_syntax.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_challenges_statements.asp">Next &#10095;</a>
</div>
<hr>

<h2>Statements</h2>
<p>A <strong>computer program</strong> is a list of "instructions" to be "executed" by a computer.</p>
<p>In a programming language, these programming instructions are called <strong>statements</strong>.</p>

<p>The following statement prints the text "Python is fun!" to the screen:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">print("Python is fun!")</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_statements">Try it Yourself &raquo;</a>
</div>

<p>In Python, a statement usually ends when the line ends. You do <em>not</em> need to use a semicolon (<code class="w3-codespan">;</code>) like in many other programming languages (for example, <a href="/java/default.asp">Java</a> or <a href="/c/index.php">C</a>).</p>
<hr>


<h2>Many Statements</h2>
<p>Most Python programs contain many statements.</p>
<p>The statements are executed one by one, in the same order as they are written:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">print("Hello World!")<br>print("Have a good day.")<br>print("Learning Python is fun!")</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_statements_many">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>From the example above, we have three statements:</p>
<ol>
  <li><code class="w3-codespan">print("Hello World!")</code></li>
  <li><code class="w3-codespan">print("Have a good day.")</code></li>
  <li><code class="w3-codespan">print("Learning Python is fun!")</code></li>
</ol>

<p>The first statement is executed first (print "Hello World!").<br>
Then the second statement is executed (print "Have a good day.").<br>
And at last, the third statement is executed (print "Learning Python is fun!").</p>
<hr>
...
<!--
<h2>Long Statements on Multiple Lines</h2>
<p>Sometimes, a statement can be too long to fit on one line. In that case, you can use a backslash (<code class="w3-codespan">\</code>) to continue the statement on the next line:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
    total = 10 + 20 + 30 + \<br>
    &nbsp;&nbsp;&nbsp;&nbsp;40 + 50<br>print(total)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_statements_continue">Try it Yourself &raquo;</a>
</div>

<p>Or you can use parentheses <code class="w3-codespan">()</code> to make long code lines easier to read - this is often preferred:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    total = (10 + 20 + 30 +<br>
    &nbsp;&nbsp;&nbsp;&nbsp;40 + 50)<br>print(total)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_statements_parentheses">Try it Yourself &raquo;</a>
</div>

-->
<h2>Semicolons (Optional, Rarely Used)</h2>
<p>Semicolons are optional in Python. You can write multiple statements on one line by separating them with <code class="w3-codespan">;</code> but this is 
rarely used because it makes it hard to read:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">print("Hello"); print("How are 
    you?"); print("Bye bye!")</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_statements_semicolons">Try it Yourself &raquo;</a>
</div>

<p>However, if you put two statements on the same line without a separator (newline or <code class="w3-codespan">;</code>), Python will give an error:</p>

<div class="w3-example w3-pale-red">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh w3-border-red">print("Python is fun!") print("Really!")</div>
  <p>Result:</p>
  <div class="w3-padding notranslate w3-black">
    <code>SyntaxError: invalid syntax</code>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trypython.asp?filename=demo_statements_error">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p><strong>Best practice:</strong> Put each statement on its own line so your code is easy to understand.</p>
</div>
<hr>
