...
<a class="w3-left w3-btn" href="python_decorators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_recursion.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  2))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_double">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_triple">Try it Yourself &raquo;</a>
</div>
...
<br>
  ...
  <br>print(mydoubler(11))<br>print(mytripler(11))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_both">Try it Yourself &raquo;</a>
</div>
...
<p>Lambda functions are commonly used with built-in functions like <code class="w3-codespan">map()</code>, <code class="w3-codespan">filter()</code>, and <code class="w3-codespan">sorted()</code>.</p>

<h3>Using Lambda with map()</h3>

<p>The <code class="w3-codespan">map()</code> function applies a function to every item in an iterable:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Double all numbers in a list:</p>
<div class="w3-code notranslate pythonHigh">
numbers = [1, 2, 3, 4, 5]<br>
doubled = list(map(lambda x: x * 2, numbers))<br>
print(doubled)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_map">Try it Yourself &raquo;</a>
</div>

<h3>Using Lambda with filter()</h3>

<p>The <code class="w3-codespan">filter()</code> function creates a list of items for which a function returns <code class="w3-codespan">True</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Filter out odd numbers from a list:</p>
<div class="w3-code notranslate pythonHigh">
numbers = [1, 2, 3, 4, 5, 6, 7, 8]<br>
odd_numbers = list(filter(lambda x: x % 2 != 0, numbers))<br>
print(odd_numbers)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_filter">Try it Yourself &raquo;</a>
</div>

<h3>Using Lambda with sorted()</h3>

<p>The <code class="w3-codespan">sorted()</code> function can use a lambda as a key for custom sorting:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort a list of tuples by the second element:</p>
<div class="w3-code notranslate pythonHigh">
students = [("Emil", 25), ("Tobias", 22), ("Linus", 28)]<br>
sorted_students = sorted(students, key=lambda x: x[1])<br>
print(sorted_students)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_sorted">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sort strings by length:</p>
<div class="w3-code notranslate pythonHigh">
words = ["apple", "pie", "banana", "cherry"]<br>
sorted_words = sorted(words, key=lambda x: len(x))<br>
print(sorted_words)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lambda_sorted_len">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_lambda.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_decorators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_recursion.asp">Next &#10095;</a>
