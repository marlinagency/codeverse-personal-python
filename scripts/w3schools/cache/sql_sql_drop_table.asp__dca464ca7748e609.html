...
<p>The <code class="w3-codespan">DROP TABLE</code> statement is used to permanently delete an existing table in a database.</p>
<div class="w3-panel ws-warning">
<p><strong>Note:</strong> Be careful before dropping a table! Dropping a table deletes the 
entire table and all its content!</p>
</div>
<h3>Syntax</h3>
...
<p>To prevent an error from occur (if the table does not exists), it is a good 
practice to add the <code class="w3-codespan">IF EXISTS</code> clause:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
DROP TABLE IF EXISTS <em>table_name</em>;</div>
</div>
<p><strong>Note:</strong> In most databases you cannot drop a table that is referenced by a 
<a href="sql_foreignkey.asp">foreign key constraint</a> in another table. To 
solve this, you must remove the foreign key constraint or drop the dependent table.</p>
<hr>

<h2>DROP TABLE Example</h2>
<p>The following SQL statement drops the &quot;Shippers&quot; table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>The <code class="w3-codespan">TRUNCATE TABLE</code> statement is used to delete 
all the records in a table, but it keeps the table structure, columns and constraints.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_drop_table.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_create_table.asp">&#10094; Previous</a>
