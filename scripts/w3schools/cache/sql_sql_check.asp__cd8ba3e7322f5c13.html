...
<p>The <code class="w3-codespan">CHECK</code> constraint is used to ensure that 
the values in a column satisfies a specific condition.</p>
<p>The <code class="w3-codespan">CHECK</code> constraint evaluates the data to 
...
<h2>CHECK Constraint on CREATE TABLE</h2>
<p>The following SQL creates a <code class="w3-codespan">CHECK</code> constraint on the &quot;Age&quot; column 
upon creation of the &quot;Persons&quot; table.</p>
<p>Here, the <code class="w3-codespan">CHECK</code> constraint ensures that the 
&quot;Age&quot; column must have a value of 18, or above:</p>
...
<h3>Naming a CHECK Constraint</h3>
<p>To name a <code class="w3-codespan">CHECK</code> constraint, and to define a <code class="w3-codespan">
...
City varchar(255),<br>
&nbsp;&nbsp;&nbsp;
CONSTRAINT chk_PersonAge CHECK (Age &gt;= 18 AND City = 'Sandnes')<br>
);</div></div>
<hr>
...
<h2>CHECK Constraint on ALTER TABLE</h2>
...
<hr>
<div id="exercisecontainer" src="xrcise_check.js"></div>
<hr>
