...
<h1>Matplotlib <span class="color_h1">Line</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="matplotlib_markers.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="matplotlib_labels.asp">Next &#10095;</a>
</div>
<hr>

<h2>Linestyle</h2>
<p>You can use the keyword argument <code class="w3-codespan">linestyle</code>, or shorter <code class="w3-codespan">ls</code>, to 
change the style of the plotted line:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use a dotted line:</p>
...
<br>
plt.plot(ypoints, linestyle = 'dotted')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_dotted.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_dotted">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use a dashed line:</p>
<div class="w3-code notranslate pythonHigh">
<br>
plt.plot(ypoints, linestyle = 'dashed')<br>
<br>
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_dashed.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_dashed">Try it Yourself &raquo;</a>
</div>
...
<p>The line style can be written in a shorter syntax:</p>
<p><code class="w3-codespan">linestyle</code> can be written as <code class="w3-codespan">ls</code>.</p>
<p><code class="w3-codespan">dotted</code> can be written as <code class="w3-codespan">:</code>.</p>
<p><code class="w3-codespan">dashed</code> can be written as <code class="w3-codespan">--</code>.</p>
...
<p>Shorter syntax:</p>
<div class="w3-code notranslate pythonHigh">
plt.plot(ypoints, ls = ':')<br>
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_dotted.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_short">Try it Yourself &raquo;</a>
</div>
...
<td>'solid' (default)</td>
<td>'-'</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_ls_solid">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'dotted'</td>
<td>':'</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_ls_dotted">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'dashed'</td>
<td>'--'</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_ls_dashed">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'dashdot'</td>
<td>'-.'</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_ls_dashdot">Try it  &raquo;</a></td>
</tr>
<tr>
<td>'None'</td>
<td>'' or ' '</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_matplotlib_ls_none">Try it  &raquo;</a></td>
</tr>
</tbody>
</table>
...
<p>You can use the keyword argument <code class="w3-codespan">color</code> or 
the shorter <code class="w3-codespan">c</code> to set the color of the line:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the line color to red:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, color = 'r')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_red.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_red">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Plot with a beautiful green line:</p>
<div class="w3-code notranslate pythonHigh">
...
<br>
plt.plot(ypoints, c = '#4CAF50')<br>
...
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_hex.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_green">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Plot with the color named "hotpink":</p>
<div class="w3-code notranslate pythonHigh">
...
<br>
plt.plot(ypoints, c = 'hotpink')<br>
...
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_hotpink.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_hotpink">Try it Yourself &raquo;</a>
</div>
...
<p>You can use the keyword argument <code class="w3-codespan">linewidth</code> or 
the shorter <code class="w3-codespan">lw</code> to change the width of the line.</p>

<p>The value is a floating number, in points:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Plot with a 20.5pt wide line:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
ypoints = np.array([3, 8, 1, 10])<br>
<br>
plt.plot(ypoints, linewidth = '20.5')<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_lw.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_line_width">Try it Yourself &raquo;</a>
</div>
...
<p>You can plot as many lines as you like by simply adding more <code class="w3-codespan">plt.plot()</code> functions:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw two lines by specifying a <code class="w3-codespan">plt.plot()</code> function for each line:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
y1 = np.array([3, 8, 1, 10])<br>
y2 = np.array([6, 2, 7, 11])<br>
<br>
plt.plot(y1)<br>
plt.plot(y2)<br>
<br>
...
<h3>Result:</h3>
<p>
  <img src="img_matplotlib_line_two.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_lines">Try it Yourself &raquo;</a>
</div>

<p>You can also plot many lines by adding the points for the x- and y-axis for each line in the same <code class="w3-codespan">plt.plot()</code> function.</p>

<p>(In the examples above we only specified the points on the y-axis, meaning that the points on the x-axis got the the default values (0, 1, 2, 3).)</p>

<p>The x- and y- values come in pairs:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw two lines by specifiyng the x- and y-point values for both lines:</p>
<div class="w3-code notranslate pythonHigh">
import matplotlib.pyplot as plt<br>
import numpy as np<br>
<br>
x1 = np.array([0, 1, 2, 3])<br>
y1 = np.array([3, 8, 1, 10])<br>

x2 = np.array([0, 1, 2, 3])<br>
y2 = np.array([6, 2, 7, 11])<br>
<br>
plt.plot(x1, y1, x2, y2)<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_lines2">Try it Yourself &raquo;</a>
</div>
