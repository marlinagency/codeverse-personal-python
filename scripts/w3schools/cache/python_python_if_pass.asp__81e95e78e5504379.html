...
<h1>Python <span class="color_h1">Pass Statement</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_nested_if.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_if_basics.asp">Next &#10095;</a>
</div>
<hr>

<h2>The pass Statement</h2>
<p><code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statements cannot be empty, but if you 
for some reason have an <code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statement with no content, put in the <code class="w3-codespan"><a href="ref_keyword_pass.asp">pass</a></code> statement to avoid getting an error.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_pass">Try it Yourself &raquo;</a>
</div>

<p>The <span class="w3-codespan">pass</span> statement is a null operation - nothing happens when it executes. It serves as a placeholder.</p>
...
<p>The <span class="w3-codespan">pass</span> statement is useful in several situations:</p>

<ul>
<li>When you're creating code structure but haven't implemented the logic yet</li>
<li>When a statement is required syntactically but no action is needed</li>
<li>As a placeholder for future code during development</li>
<li>In empty functions or classes that you plan to implement later</li>
</ul>

<hr>

<h2>pass in Development</h2>

<p>During development, you might want to sketch out your program structure before implementing the details. The <span class="w3-codespan">pass</span> statement allows you to do this without syntax errors.</p>
...
age = 16<br><br>
if age &lt; 18:<br>
&nbsp; pass  # TODO: Add underage logic later<br>
else:<br>
&nbsp; print("Access granted")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pass_todo">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>pass vs Comments</h2>

<p>A comment is ignored by Python, but <span class="w3-codespan">pass</span> is an actual statement that gets executed (though it does nothing). You need <span class="w3-codespan">pass</span> where Python expects a statement, not just a comment.</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<p>This will cause an error (empty code block):</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>This works correctly with pass:</p>
<div class="w3-code notranslate pythonHigh">
score = 85<br><br>
if score &gt; 90:<br>
&nbsp; pass  # This is excellent<br>
print("Score processed")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pass_vs_comment">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>pass with Multiple Conditions</h2>

<p>You can use <span class="w3-codespan">pass</span> in any branch of an if-elif-else statement.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using pass in different branches:</p>
<div class="w3-code notranslate pythonHigh">
value = 50<br><br>
if value &lt; 0:<br>
&nbsp; print("Negative value")<br>
elif value == 0:<br>
&nbsp; pass  # Zero case - no action needed<br>
else:<br>
&nbsp; print("Positive value")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pass_branches">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>pass in Other Contexts</h2>

<p>While we focus on <span class="w3-codespan">pass</span> with if statements here, it's also commonly used with loops, functions, and classes.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using pass with functions:</p>
<div class="w3-code notranslate pythonHigh">
def calculate_discount(price):<br>
&nbsp; pass  # TODO: Implement discount logic<br><br>
# Function exists but doesn't do anything yet
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pass_function">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_if_pass.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_nested_if.asp">&#10094; Previous</a>
