...
<h1>Python <span class="color_h1">Decorators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_scope.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lambda.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">Decorators let you add extra behavior to a function, without changing the function's code.</p>
<p class="intro">A decorator is a function that takes another function as input and returns a new function.</p>

<hr>
<h2>Basic Decorator</h2>
<p>Define the decorator first, then apply it with <code class="w3-codespan">@decorator_name</code> above the function.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>A basic decorator that uppercases the return value of the decorated function.</p>
  <div class="w3-code notranslate pythonHigh">
def changecase(func):<br>
&nbsp;&nbsp;def myinner():<br>
&nbsp;&nbsp;&nbsp;&nbsp;return func().upper()<br>
&nbsp;&nbsp;return myinner<br>
<br>
@changecase<br>
def myfunction():<br>
&nbsp;&nbsp;return "Hello Sally"<br>
<br>
print(myfunction())
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators">Try it Yourself &raquo;</a>
</div>
<p>By placing <code class="w3-codespan">@changecase</code> directly above the function definition,
the function <code class="w3-codespan">myfunction</code> is being "decorated" with the <code class="w3-codespan">changecase</code>
function.</p>
<p>The function <code class="w3-codespan">changecase</code> is the decorator.</p>
<p>The function <code class="w3-codespan">myfunction</code> is the function that gets decorated.</p>
<hr>
<h2>Multiple Decorator Calls</h2>
<p>A decorator can be called multiple times. Just place the decorator above the function you want to decorate.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Using the <code class="w3-codespan">@changecase</code> decorator on two functions:</p>
<div class="w3-code notranslate pythonHigh">
def changecase(func):<br>
&nbsp;&nbsp;def myinner():<br>
&nbsp;&nbsp;&nbsp;&nbsp;return func().upper()<br>
...
&nbsp;&nbsp;return "I am speed!"<br>
<br>
print(myfunction())<br>
print(otherfunction())
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_multiple">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Arguments in the Decorated Function</h2>

<p>Functions that require arguments can also be decorated, just make sure you pass the arguments to the wrapper function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Functions with arguments can also be decorated:</p>
<div class="w3-code notranslate pythonHigh">
def changecase(func):<br>
&nbsp;&nbsp;def myinner(x):<br>
&nbsp;&nbsp;&nbsp;&nbsp;return func(x).upper()<br>
&nbsp;&nbsp;return myinner<br>
<br>
@changecase<br>
def myfunction(nam):<br>
&nbsp;&nbsp;return "Hello " + nam<br>
<br>
print(myfunction("John"))
    </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_arguments">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<p>Sometimes the decorator function has no control over the arguments passed from decorated function, to solve this problem,
  add <code class="w3-codespan">(<a href="gloss_python_function_arbitrary_arguments.asp">*args</a>, <a href="gloss_python_function_keyword_arguments.asp">**kwargs</a>)</code>
  to the wrapper function, this way the wrapper function can accept any number, and any type of arguments, and pass them to the decorated function.</p>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Secure the function with <code class="w3-codespan"><a href="gloss_python_function_arbitrary_arguments.asp">*args</a></code> and <code class="w3-codespan"><a href="gloss_python_function_keyword_arguments.asp">**kwargs</a></code> arguments:</p>
  <div class="w3-code notranslate pythonHigh">
  def changecase(func):<br>
  &nbsp;&nbsp;def myinner(*args, **kwargs):<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return func(*args, **kwargs).upper()<br>
  &nbsp;&nbsp;return myinner<br>
  <br>
  @changecase<br>
  def myfunction(nam):<br>
  ...
  print(myfunction("John"))
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_kwargs">Try it Yourself &raquo;</a>
  </div>
...
<p>Decorators can accept their own arguments by adding another wrapper level.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>A decorator factory that takes an argument and transforms the casing based on the argument value.</p>
  <div class="w3-code notranslate pythonHigh">
def changecase(n):<br>
&nbsp;&nbsp;def changecase(func):<br>
&nbsp;&nbsp;&nbsp;&nbsp;def myinner():<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return a<br>
&nbsp;&nbsp;&nbsp;&nbsp;return myinner<br>
&nbsp;&nbsp;return changecase<br>
<br>
@changecase(1)<br>
def myfunction():<br>
&nbsp;&nbsp;return "Hello Linus"<br>
<br>
print(myfunction())
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_args">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Multiple Decorators</h2>
<p>You can use multiple decorators on one function.</p>
<p>This is done by placing the decorator calls on top of each other.</p>
<p>Decorators are called in the reverse order, starting with the one closest to the function.</p>
<div class="w3-example">
<h3>Example</h3>
<p>One decorator for upper case, and one for adding a greeting:</p>
<div class="w3-code notranslate pythonHigh">
def changecase(func):<br>
&nbsp;&nbsp;def myinner():<br>
&nbsp;&nbsp;&nbsp;&nbsp;return func().upper()<br>
&nbsp;&nbsp;return myinner<br>
<br>
def addgreeting(func):<br>
&nbsp;&nbsp;def myinner():<br>
&nbsp;&nbsp;&nbsp;&nbsp;return "Hello " + func() + " Have a good day!"<br>
&nbsp;&nbsp;return myinner<br>
<br>
@changecase<br>
@addgreeting<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_multiple2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Preserving Function Metadata</h2>
<p>Functions in Python has metadata that can be accessed using the <code class="w3-codespan">__name__</code> and <code class="w3-codespan">__doc__</code> attributes.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Normally, a function's name can be returned with the <code class="w3-codespan">__name__</code> attribute:</p>
<div class="w3-code notranslate pythonHigh">
def myfunction():<br>
&nbsp;&nbsp;return "Have a great day!"<br>
<br>
print(myfunction.__name__)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_name">Try it Yourself &raquo;</a>
</div>

<p>But, when a function is decorated, the metadata of the original function is lost.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Try returning the name from a decorated function and you will not get the same result:</p>
<div class="w3-code notranslate pythonHigh">
def changecase(func):<br>
&nbsp;&nbsp;def myinner():<br>
&nbsp;&nbsp;&nbsp;&nbsp;return func().upper()<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_nowrap">Try it Yourself &raquo;</a>
</div>
  

<p>To fix this, Python has a built-in function called <code class="w3-codespan">functools.wraps</code> that can be used to preserve the original function's name and docstring.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Import <code class="w3-codespan">functools.wraps</code> to preserve the original function name and docstring.</p>
<div class="w3-code notranslate pythonHigh">
import functools<br>
<br>
def changecase(func):<br>
...
print(myfunction.__name__)
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_decorators_wraps">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_decorators.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_scope.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lambda.asp">Next &#10095;</a>
