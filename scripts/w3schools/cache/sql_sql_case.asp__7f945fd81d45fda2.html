...
<p>The <code class="w3-codespan">CASE</code> expression is used to define 
different results based on specified conditions in an SQL statement.</p>
<p>The <code class="w3-codespan">CASE</code> expression goes through the conditions and 
...
the value in the <code class="w3-codespan">ELSE</code> clause. If there is no <code class="w3-codespan">ELSE</code> 
clause and no conditions are true, it returns NULL.</p>

<h2>CASE Syntax</h2>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CASE<br>
&nbsp;&nbsp;WHEN <em>condition1</em> THEN <em>result1</em><br>
&nbsp;&nbsp;WHEN <em>condition2</em> THEN <em>result2</em><br>
&nbsp;&nbsp;WHEN <em>conditionN</em> THEN <em>resultN</em><br>
&nbsp;&nbsp;ELSE <em>default_result</em><br>
END;
</div></div>
<hr>

<h2>SQL CASE Example</h2>
<p>Here we use the <code class="w3-codespan">CASE</code> expression to 
categorize data (Price) and we create a new column (PriceCategory) that shows in 
which price category each product is:</p>
...
<div class="w3-code notranslate sqlHigh">
  ...
  CASE<br>
  &nbsp; WHEN Price &lt; 20 THEN 'Low Cost'<br>
  &nbsp; WHEN Price BETWEEN 20 AND 50 THEN 'Medium Cost'<br>
  &nbsp; ELSE 'High Cost'<br>
...
<hr>
<div id="exercisecontainer" src="xrcise_case.js"></div>
<hr>
