...
<html lang="en-US">
<head>
<title>How to Add Two Numbers in Python</title>
<meta charset="utf-8">
...
<h1>How to Add Two Numbers in Python</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_howto_reverse_string.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_examples.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to add two numbers in Python.</p>

<hr>
<p>Use the <code class="w3-codespan">+</code> operator to add two numbers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
x = 5<br>y = 10<br>print(x + y)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_howto_add_two_numbers">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Add Two Numbers with User Input</h2>
<p>In this example, the user must input two numbers. Then we print the sum by calculating (adding) the two numbers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x = input(&quot;Type a number: &quot;)<br>y = input(&quot;Type another number: &quot;)<br><br>sum 
  = int(x) + int(y)<br><br>print(&quot;The sum is: &quot;, sum) </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_howto_add_two_numbers2">Try it Yourself &raquo;</a>
</div>
