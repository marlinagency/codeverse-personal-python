...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_sum.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_like.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL AVG() Function</h2>
<p>The <code class="w3-codespan">AVG()</code> function returns the average value of a numeric column.</p>
<p>The <code class="w3-codespan">AVG()</code> function ignores NULL values in the column.</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_avg" class="w3-btn w3-margin-bottom">
...
<div class="w3-code notranslate sqlHigh">
  SELECT AVG(Price)<br>FROM Products<br>WHERE CategoryID = 1;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_avg_where" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use an Alias</h2>
<p>Give the AVG column a name by using the <code class="w3-codespan">AS</code> keyword.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Name the column "average price":</p>
<div class="w3-code notranslate sqlHigh">
SELECT AVG(Price) AS [average price]<br>FROM Products;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_avg_as" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>To list all records with a higher price than average, we can use the
<code class="w3-codespan">AVG()</code> function in a sub query:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return all products with a higher price than the average price:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT * FROM Products<br>WHERE Price > 
  (SELECT AVG(Price) FROM Products);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_avg2" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use AVG() with GROUP BY</h2>
<p>Here we use the <code class="w3-codespan">AVG()</code> function and the
<code class="w3-codespan">GROUP BY</code> clause, to return the average price 
...
<a target="_blank" href="trysql.asp?filename=trysql_select_avg_groupby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_avg.js"></div>
<hr>
