...
<p>To open the file, use the built-in <code class="w3-codespan"><a href="ref_func_open.asp">open()</a></code> function.</p>
<p>The <code class="w3-codespan"><a href="ref_func_open.asp">open()</a></code> function returns a file object, which has a 
<code class="w3-codespan">read()</code> method for reading the content of the file:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  f = open(&quot;demofile.txt&quot;)<br>print(f.read())</div>
...
<div class="w3-code notranslate pythonHigh">
  f = open(&quot;D:\\myfiles\welcome.txt&quot;)<br>print(f.read())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_open_d">Run Example &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using the <code class="w3-codespan">with</code> statement</h2>

<p>You can also use the <code class="w3-codespan">with</code> statement when opening a file:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using the <code class="w3-codespan">with</code> keyword:</p>
<div class="w3-code notranslate pythonHigh">
with open(&quot;demofile.txt&quot;) as f:<br>
&nbsp;&nbsp;print(f.read())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_open_with">Run Example &raquo;</a>
</div>

<p>Then you do not have to worry about closing your files, the <code class="w3-codespan">with</code> statement takes care of that.</p>
...
<p>If you are not using the <code class="w3-codespan">with</code> statement, you must write a close statement in order to close the file:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Close the file when you are finished with it:</p>
<div class="w3-code notranslate pythonHigh">
  f = open(&quot;demofile.txt&quot;)<br>print(f.readline())<br>
  f.close()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_close">Run Example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  with open(&quot;demofile.txt&quot;) as f:<br>&nbsp; print(f.read(<strong>5</strong>))</div>
...
<div class="w3-code notranslate pythonHigh">
  with open(&quot;demofile.txt&quot;) as f:<br>&nbsp; print(f.readline())</div>
...
<div class="w3-code notranslate pythonHigh">
  with open(&quot;demofile.txt&quot;) as f:<br>&nbsp; print(f.readline())<br>&nbsp; print(f.readline())</div>
