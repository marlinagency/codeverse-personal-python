...
<html lang="en-US">
<head>
<title>W3Schools SQL Bootcamp</title>
<meta charset="utf-8">
...
<h1>W3Schools <span class="color_h1">SQL Bootcamp</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="sql_study_plan.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_training.asp">Next &#10095;</a>
</div>
<hr>

<div class="ws-light-green caption w3-round" style="padding-top:50px;padding-bottom:50px;position:relative;">
  <div style="max-width:1300px;margin:auto">
    <h1 class="bctop">SQL Bootcamp</h1>
    ...
    <p style="margin-top:8px;"><a title="Learn More" target="_blank" href="/bootcamp/sql.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:8px 16px;margin-right:5px;margin-top:16px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
...
<div class="caption" style="padding-left:0;padding-right:0;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <div style="max-width:950px">
      <p>In this bootcamp, you will learn the fundamentals of SQL. This powerful programming language is widely used in web development, data science and artificial intelligence, and many other fields.</p>
      <p>You will learn the fundamentals of SQL over a 4 weeks period together with a live instructor and an interactive cohort of engaged learners!</p>

    <h5 style="font-size:30px;font-weight:bold;">You Will Learn</h5>

    <ul style="font-size:16px;">
     <li>Use SQL to:
     <li>Structure, extract and analyse data from databases</li>
     <li>Interact with, query, manipulate, and update data in databases</li>
     <li>Write scripts to automate repetitive tasks in databases</li>
     <li>Create and manage databases and tables</li>
     <br>
     <li>Use SQL in: Data integrity and security</li>
     <li>Use SQL in: MySQL, SQL Server, MS Access, Oracle, Sybase, Informix, Postgres, and other database systems</li>
    </ul>
...
<div style="background-color:#F3ECEA;padding-top:30px;color:black" class="w3-round">
  ...
  <p style="margin-top:8px;text-align:center;padding-bottom:45px;"><a title="Learn More" target="_blank" href="/bootcamp/sql.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn ga-featured">Learn More</a></p>
</div>
  ...
  <div style="max-width:1350px;margin:auto;padding-left:24px;padding-right:24px;">
    ...
    <div style="text-align:left;font-family: 'Source Sans Pro', sans-serif;">
      ...
      <h4 style='font-size:18px;margin-bottom:20px'><strong>2. Complete the Bootcamp</strong>:<br>
        ...
        <br><br>The bootcamp covers the fundamentals of SQL. The curriculum used is the <a target="_blank" href="https://www.w3schools.com/sql/default.asp">W3Schools SQL Tutorial</a>. The bootcamp will help you prepare for the W3Schools SQL exam so that you can document and validate your competence.
      ...
      <p><a title="Learn More" target="_blank" href="/bootcamp/sql.php" style="margin-top:15px;width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
    </div>
  </div>
</div>
