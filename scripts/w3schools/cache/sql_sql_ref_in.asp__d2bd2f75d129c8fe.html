...
<a class="w3-left w3-btn" href="sql_ref_having.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sql_ref_index.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>

<hr>

<h2>IN</h2>
<p>The <code class="w3-codespan">IN</code> operator is used in the <code class="w3-codespan">WHERE</code> clause to check if a specified column's value matches
any value within a provided list.</p>
<p>The <code class="w3-codespan">IN</code> operator functions as a shorthand for multiple <code class="w3-codespan">OR</code> conditions, making queries shorter and more readable.</p>

<p>The following SQL uses the <code class="w3-codespan">IN</code> operator to select all customers from 
Germany, France, or UK:</p>
