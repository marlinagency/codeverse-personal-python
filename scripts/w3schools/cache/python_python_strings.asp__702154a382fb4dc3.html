...
<a class="w3-left w3-btn" href="python_challenges_casting.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_strings_slicing.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Strings</h2>
...
<p>You can display a string literal with the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_literal">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
print("It's alright")<br>
print("He is called 'Johnny'")<br>
print('He is called "Johnny"')
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_quotes">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_var">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_multi">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  a = '''Lorem ipsum dolor sit amet,<br>consectetur adipiscing elit,<br>sed do 
  eiusmod tempor incididunt<br>ut labore et dolore magna aliqua.'''<br>print(a)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_multi2">Try it Yourself &raquo;</a>
</div>
...
<p>Like many other popular programming languages, strings in Python are arrays of unicode characters.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string1">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Since strings are arrays, we can loop through the characters in a string, with a <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loop.</p>
...
<!--stop-->
<p>Learn more about For Loops in our <a href="python_for_loops.asp">Python For Loops</a> chapter.</p>

<hr>
<!--start-->
<h2>String Length</h2>

<p>To get the length of a string, use the <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> function.</p>
<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> function returns the length of a string:</p>
<div class="w3-code notranslate pythonHigh">
a = "Hello, World!"<br>
print(len(a))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_len">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
the keyword 
<code class="w3-codespan"><a href="ref_keyword_in.asp">in</a></code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if &quot;free&quot; is present in the following text:</p>
<div class="w3-code notranslate pythonHigh">
  txt = "The best things in life are free!&quot;<br>print(&quot;free&quot; in txt)<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_is_in">Try it Yourself &raquo;</a>
</div>

<p>Use it in an <code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> statement:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Print only if &quot;free&quot; is present:</p>
<div class="w3-code notranslate pythonHigh">
  txt = "The best things in life are free!&quot;<br>if &quot;free&quot; in txt:<br>&nbsp;
print(&quot;Yes, 'free' is present.&quot;)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_if_in">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<p>Learn more about If statements in our <a href="python_conditions.asp">Python 
If...Else</a> chapter.</p>
<hr>
<!--start-->
<h2>Check if NOT</h2>
...
the keyword <code class="w3-codespan"><a href="ref_keyword_not.asp">not in</a></code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if &quot;expensive&quot; is NOT present in the following text:</p>
<div class="w3-code notranslate pythonHigh">
  txt = "The best things in life are free!&quot;<br>print(&quot;expensive&quot; not in txt)
  </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_is_not_in">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  txt = "The best things in life are free!&quot;<br>if &quot;expensive&quot; not in txt:<br>&nbsp;
print(&quot;No, 'expensive' is NOT present.&quot;)
  </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_string_if_not_in">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_strings.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_casting.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_strings_slicing.asp">Next &#10095;</a>
