...
<a class="w3-left w3-btn" href="python_challenges_iterators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_modules.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<p>Now we can use the module we just created, by using the <code class="w3-codespan"><a href="ref_keyword_import.asp">import</a></code> statement:</p>
...
<p>You can create an alias when you import a module, by using the <code class="w3-codespan"><a href="ref_keyword_as.asp">as</a></code> keyword:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_module4">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
names) in a module. The <code class="w3-codespan"><a href="ref_func_dir.asp">dir()</a></code> function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_module5">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan"><a href="ref_func_dir.asp">dir()</a></code> function can be used on <em>all</em> 
...
<p>You can choose to import only parts from a module, by using the <code class="w3-codespan"><a href="ref_keyword_from.asp">from</a></code> keyword.</p>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> When importing using the <code class="w3-codespan"><a href="ref_keyword_from.asp">from</a></code> 
...
-->
<hr>
<div id="exercisecontainer" src="xrcise_modules.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_iterators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_modules.asp">Next &#10095;</a>
