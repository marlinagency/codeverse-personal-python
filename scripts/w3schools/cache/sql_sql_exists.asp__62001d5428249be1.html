...
<p>The <code class="w3-codespan">EXISTS</code> operator is used in a <code class="w3-codespan">WHERE</code> clause
to check whether a subquery returns any rows.</p>
<p>The <code class="w3-codespan">EXISTS</code> operator evaluates to TRUE if the subquery returns at least one row, and FALSE otherwise.</p>
...
<p>The following SQL checks if any suppliers has a product with a price lower than 10.
If the subquery evaluates to TRUE; list the suppliers with a product price less than 10:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT SupplierName<br>FROM Suppliers<br>WHERE EXISTS (<br>&nbsp; SELECT ProductName<br>&nbsp; FROM 
  Products<br>&nbsp; WHERE Products.SupplierID = Suppliers.supplierID AND Price &lt; 
  10<br>);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_exists" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>

<p>The following SQL checks if any suppliers has a product with a price equal to 
22.
...
<div class="w3-code notranslate sqlHigh">
  SELECT SupplierName<br>FROM Suppliers<br>WHERE EXISTS (<br>&nbsp; SELECT ProductName<br>&nbsp; FROM 
  Products<br>&nbsp; WHERE Products.SupplierID = Suppliers.supplierID AND Price = 22<br>);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_exists2" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_exists.js"></div>
<hr>
