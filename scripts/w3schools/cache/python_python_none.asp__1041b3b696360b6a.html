...
<h1>Python <span class="color_h1">None</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_string_formatting.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_none.asp">Next &#10095;</a>
</div>
<hr>

<h2>Python None</h2>
<p><code class="w3-codespan">None</code> is a special constant in Python that represents the absence of a value.</p>
<p>Its data type is <code class="w3-codespan">NoneType</code>, and <code class="w3-codespan">None</code> is the only instance of a <code class="w3-codespan">NoneType</code> object.</p>
<hr>
<h2>NoneType</h2>
<p>Variables can be assigned <code class="w3-codespan">None</code> to indicate "no value" or "not set".</p>
<div class="w3-example">
<h3>Example</h3>
<p>Assign and display a <code class="w3-codespan">None</code> value:</p>
<div class="w3-code notranslate pythonHigh">
x = None<br>
print(x)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_none_assign_print">Try it Yourself &raquo;</a>
</div>

<p>Use <code class="w3-codespan">type()</code> to see the type of a <code class="w3-codespan">None</code> value.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Assign and print the data type of a <code class="w3-codespan">None</code> value:</p>
<div class="w3-code notranslate pythonHigh">
x = None<br>
print(type(x))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_none_type">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Comparing to None</h2>
<p>To compare a value to <code class="w3-codespan">None</code>, use the identity operator <code class="w3-codespan">is</code> or <code class="w3-codespan">is not</code></p>
<div class="w3-example">
<h3>Example</h3>
<p>Use the identity operator <code class="w3-codespan">is</code> for comparisons with <code class="w3-codespan">None</code>:</p>
<div class="w3-code notranslate pythonHigh">
result = None<br>
if result is None:<br>
&nbsp;&nbsp;print("No result yet")<br>
else:<br>
&nbsp;&nbsp;print("Result is ready")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_none_compare_is">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Similar example, but using <code class="w3-codespan">is not</code> instead:</p>
<div class="w3-code notranslate pythonHigh">
result = None<br>
if result is not None:<br>
&nbsp;&nbsp;print("Result is ready")<br>
else:<br>
&nbsp;&nbsp;print("No result yet")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_none_compare_isnot">Try it Yourself &raquo;</a>
</div>
...
<h2>True or False</h2>
<p><code class="w3-codespan">None</code> evaluates to <code class="w3-codespan">False</code> in a boolean context.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Check truthiness:</p>
<div class="w3-code notranslate pythonHigh">
print(bool(None))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_none_truthiness">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Functions returning None</h2>
<p>Functions that do not explicitly return a value return <code class="w3-codespan">None</code> by default.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A function without a return statement returns <code class="w3-codespan">None</code>:</p>
<div class="w3-code notranslate pythonHigh">
def myfunc():<br>
&nbsp;&nbsp;x = 5<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_none_function_return">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_none.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_string_formatting.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_none.asp">Next &#10095;</a>
