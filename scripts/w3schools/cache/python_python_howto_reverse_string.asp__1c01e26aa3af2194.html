...
<a class="w3-right w3-btn" href="python_howto_add_two_numbers.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_howto_reverse_string">Try it Yourself &raquo;</a>
</div>
...
<p>In this particular example, the slice statement <code class="w3-codespan">[::-1]</code> means start at 
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>print(mytxt)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_howto_reverse_string2">Try it Yourself &raquo;</a>
</div>
