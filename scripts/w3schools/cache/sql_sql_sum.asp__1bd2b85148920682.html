...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_count.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_avg.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL SUM() Function</h2>
<p>The <code class="w3-codespan">SUM()</code> function is used to calculate the total sum of values within a numeric column.</p>
<p>The <code class="w3-codespan">SUM()</code> function ignores NULL values in the column.</p>
<p>The following SQL returns the sum of the Quantity field in the "OrderDetails" table:</p>
...
<!--start-->
<h2>Demo Database</h2>
<p>Below is a selection from the <a href="trysql.asp?filename=trysql_orderdetails" target="_blank"><strong>OrderDetails</strong></a> table used in the examples:</p>
...
<p>The following SQL returns the sum of the Quantity field for the product with
ProductID = 11, in the "OrderDetails" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT SUM(Quantity)<br>FROM OrderDetails<br>WHERE ProductId = 11;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_sum_where" class="w3-btn w3-margin-bottom">
...
<!--start-->
<h2>Use an Alias</h2>
<p>Give the summarized column a name by using the <code class="w3-codespan">AS</code> keyword.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Name the column "total":</p>
<div class="w3-code notranslate sqlHigh">
SELECT SUM(Quantity) AS total<br>FROM OrderDetails;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_sum_as" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use SUM() with GROUP BY</h2>
<p>Here we use the <code class="w3-codespan">SUM()</code> function and the
<code class="w3-codespan">GROUP BY</code> clause, to return the Quantity
for EACH OrderID in the &quot;OrderDetails&quot; table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT OrderID, SUM(Quantity) AS [Total Quantity]<br>FROM OrderDetails<br>
  GROUP BY OrderID; </div>
<a target="_blank" href="trysql.asp?filename=trysql_select_sum_groupby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<!--start-->
<h2>SUM() With an Expression</h2>
<p>The parameter inside the <code class="w3-codespan">SUM()</code> function can also be an expression.</p>
<p>If we assume that each product in the &quot;OrderDetails&quot; table costs 10 dollars, we can find the total earnings in dollars by 
multiply each quantity with 10:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Use an expression inside the <code class="w3-codespan">SUM()</code> function:</p>
<div class="w3-code notranslate sqlHigh">
SELECT SUM(Quantity * 10)<br>FROM OrderDetails;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_sum2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>We can also join the &quot;OrderDetails&quot; table with the &quot;Products&quot; table to find the actual 
price, instead of assuming it is 10 dollars:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Join <code class="w3-codespan">OrderDetails</code> with 
<code class="w3-codespan">Products</code>, and use <code class="w3-codespan">SUM()</code> to find the total amount:</p>
<div class="w3-code notranslate sqlHigh">
SELECT SUM(Price * Quantity)<br>
FROM OrderDetails<br>
LEFT JOIN Products ON OrderDetails.ProductID = Products.ProductID;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_sum3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<p>You will learn more about <a href="sql_join.asp">Joins</a> later in this tutorial.</p>

<hr>
<div id="exercisecontainer" src="xrcise_sum.js"></div>
<hr>
