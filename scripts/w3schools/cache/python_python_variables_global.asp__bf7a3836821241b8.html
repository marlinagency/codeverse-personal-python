...
<html lang="en-US">
<head>
<title>Python - Global Variables</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Global Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_variables_output.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_variables_exercises.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
in the previous pages) are known as global variables.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_global">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_global2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>print(&quot;Python is &quot; + x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_global3">Try it Yourself &raquo;</a>
</div>
<p>Also, use the <code class="w3-codespan"><a href="ref_keyword_global.asp">global</a></code> keyword if you want to change a global variable inside a function.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>To change the value of a global variable inside a function, refer to the 
  variable by using the <code class="w3-codespan"><a href="ref_keyword_global.asp">global</a></code> keyword:</p>
<div class="w3-code notranslate pythonHigh">
  x = &quot;awesome&quot;<br><br>def myfunc():<br>&nbsp; global x<br>&nbsp; x = &quot;fantastic&quot;<br><br>myfunc()<br>
  <br>print(&quot;Python is &quot; + x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_global4">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_variables_global.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Global Variables</h2>
  <a href="https://youtu.be/VZW9CGZymqU&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_variables_global.webp" type="image/webp" />
        <img src="images/img_python_variables_global.png" style="max-width:100%;height:auto;border-radius:6px" alt="Python Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
