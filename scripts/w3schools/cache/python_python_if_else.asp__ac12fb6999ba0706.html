...
<html lang="en-US">
<head>
<title>Python Else Statement</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Else Statement</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_elif.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_if_shorthand.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Else Keyword</h2>
<p>The <span class="w3-codespan"><a href="ref_keyword_else.asp">else</a></span> keyword catches anything which isn't caught by the preceding conditions.</p>

<p>The <span class="w3-codespan">else</span> statement is executed when the <span class="w3-codespan">if</span> condition (and any <span class="w3-codespan">elif</span> conditions) evaluate to <span class="w3-codespan">False</span>.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_else">Try it Yourself &raquo;</a>
</div>

<p>In this example <span class="w3-codespan">a</span> is greater than <span class="w3-codespan">b</span>,
so the first condition is not true, also the <span class="w3-codespan"><a href="ref_keyword_elif.asp">elif</a></span> condition is not true,
so we go to the <span class="w3-codespan"><a href="ref_keyword_else.asp">else</a></span> condition and print to screen that "a is greater than b".</p>
...
<h2>Else Without Elif</h2>

<p>You can also have an <code class="w3-codespan"><a href="ref_keyword_else.asp">else</a></code> without the
<code class="w3-codespan"><a href="ref_keyword_elif.asp">elif</a></code>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_else2">Try it Yourself &raquo;</a>
</div>

<p>This creates a simple two-way choice: if the condition is true, execute one block; otherwise, execute the else block.</p>

<hr>

<h2>How Else Works</h2>

<p>The <span class="w3-codespan">else</span> statement provides a default action when none of the previous conditions are true. Think of it as a "catch-all" for any scenario not covered by your <span class="w3-codespan">if</span> and <span class="w3-codespan">elif</span> statements.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <span class="w3-codespan">else</span> statement must come last. You cannot have an <span class="w3-codespan">elif</span> after an <span class="w3-codespan">else</span>.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Checking even or odd numbers:</p>
<div class="w3-code notranslate pythonHigh">
number = 7<br><br>
if number % 2 == 0:<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_else_even_odd">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Complete If-Elif-Else Chain</h2>

<p>You can combine <span class="w3-codespan">if</span>, <span class="w3-codespan">elif</span>, and <span class="w3-codespan">else</span> to create a comprehensive decision-making structure.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Temperature classifier:</p>
<div class="w3-code notranslate pythonHigh">
temperature = 22<br><br>
if temperature &gt; 30:<br>
&nbsp; print("It's hot outside!")<br>
elif temperature &gt; 20:<br>
&nbsp; print("It's warm outside")<br>
elif temperature &gt; 10:<br>
&nbsp; print("It's cool outside")<br>
else:<br>
&nbsp; print("It's cold outside!")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_else_temperature">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Else as Fallback</h2>

<p>The <span class="w3-codespan">else</span> statement acts as a fallback that executes when none of the preceding conditions are true. This makes it useful for error handling, validation, and providing default values.</p>
...
&nbsp; print(f"Welcome, {username}!")<br>
else:<br>
&nbsp; print("Error: Username cannot be empty")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_else_validation">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_if_else.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_elif.asp">&#10094; Previous</a>
