...
<p>The <code class="w3-codespan">NOT NULL</code> constraint enforces a column to NOT accept NULL values.
This enforces a field to always contain a value, which means that you cannot insert a new record,
or update a record without adding a value to this field.</p>
<p>By default, a column can hold NULL values.</p>
<hr>

<h2>NOT NULL on CREATE TABLE</h2>
<p>To define a <code class="w3-codespan">NOT NULL</code> constraint when 
creating a table, add NOT NULL after the data type of the column name.</p>
<p>The following SQL creates a &quot;Persons&quot; table, and ensures that the &quot;ID&quot;, &quot;LastName&quot;, and 
&quot;FirstName&quot; columns 
cannot accept NULL values:</p>
...
<p>To define a <code class="w3-codespan">NOT NULL</code> constraint on an 
existing table, use <code class="w3-codespan"><a href="sql_alter.asp">ALTER TABLE</a></code> 
  and add NOT NULL after the data type of the column name.</p>
<p>The following SQL adds a <code class="w3-codespan">NOT NULL</code> constraint on the &quot;Age&quot; column, 
after the &quot;Persons&quot; table is already created:</p>

<h3>Syntax for SQL Server / MS Access:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
ALTER COLUMN Age int NOT NULL;</div></div>

<h3>Syntax for My SQL:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
MODIFY COLUMN Age int NOT NULL;</div></div>

<h3>Syntax for Oracle 10G+:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
...
<h2>Remove a NOT NULL Constraint</h2>
<p>To remove a <code class="w3-codespan">NOT NULL</code> constraint from a 
column (to let the column accept NULL values again), use the following syntax:</p>

<h3>Syntax for SQL Server / MS Access:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
ALTER COLUMN Age int NULL;</div></div>

<h3>Syntax for My SQL:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
MODIFY COLUMN Age int NULL;</div></div>

<h3>Synatx for Oracle 10G+:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons<br>
MODIFY Age int NULL;</div></div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_notnull.js"></div>
<hr>
