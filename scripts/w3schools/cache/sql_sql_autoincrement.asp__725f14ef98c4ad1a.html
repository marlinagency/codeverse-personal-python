...
<p>An auto-increment field is a numeric column that automatically generates a 
unique number, when a new record is inserted into a table.</p>
<p>The auto-increment field is typically the <code class="w3-codespan">
<a href="sql_primarykey.asp">PRIMARY KEY</a></code> field that we want to 
automatically be assigned a unique number, every time a new record is inserted.</p>
<hr>
...
<p>The following SQL defines the &quot;Personid&quot; column to be an auto-increment primary key field in the &quot;Persons&quot; table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE TABLE Persons
(<br>
 &nbsp;&nbsp;&nbsp;
  Personid int AUTO_INCREMENT PRIMARY KEY,<br>
&nbsp;&nbsp;&nbsp;
...
<p>The default starting value for <code class="w3-codespan">AUTO_INCREMENT</code> is 1, and it will increment by 1 for each new record.</p>
<p>To let <code class="w3-codespan">AUTO_INCREMENT</code> start with another value, use the following SQL statement:</p>

<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Persons AUTO_INCREMENT = 100;</div></div>

<p>When we insert a new record into the &quot;Persons&quot; table, we will NOT have to specify a value for the &quot;Personid&quot;
...
<p>The SQL above inserts a new record into the &quot;Persons&quot; table, and the 
...
<p>The SQL Server uses the <code class="w3-codespan">IDENTITY</code> keyword to perform an auto-increment feature.</p>
<p>The following SQL defines the &quot;Personid&quot; column to be an auto-increment primary key field in the &quot;Persons&quot; table:</p>
...
(<br>
 &nbsp;&nbsp;&nbsp;
  Personid int IDENTITY(1,1) PRIMARY KEY,<br>
&nbsp;&nbsp;&nbsp;
LastName varchar(255) NOT NULL,<br>
&nbsp;&nbsp;&nbsp;
FirstName varchar(255),<br>
...
(<br>
 &nbsp;&nbsp;&nbsp;
  Personid AUTOINCREMENT PRIMARY KEY,<br>
&nbsp;&nbsp;&nbsp;
LastName varchar(255) NOT NULL,<br>
&nbsp;&nbsp;&nbsp;
FirstName varchar(255),<br>
...
<p>The default starting value for <code class="w3-codespan">AUTOINCREMENT</code> is 1, and it will increment by 1 for each new record.</p>
...
<p>In Oracle, you have to create an auto-increment field with the <code class="w3-codespan">
SEQUENCE</code> object (this object generates a number sequence).</p>
<p>Here is the <code class="w3-codespan">CREATE SEQUENCE</code> syntax:</p>
...
<p>The code above creates a <code class="w3-codespan">SEQUENCE</code> object called seq_person, that starts with 1 and will increment by 1.
...
<p>When we insert a new record into the &quot;Persons&quot; table, we will have to use the nextval function (this function retrieves the next value from seq_person 
sequence):</p>

<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
INSERT INTO Persons (Personid, FirstName, LastName)<br>
VALUES (seq_person.nextval, 'Lars', 'Monsen');</div></div>

<p>The SQL above inserts a new record into the &quot;Persons&quot; table, and the &quot;Personid&quot; column would be assigned the next 
unique number from the seq_person 
sequence.</p>

<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_autoincrement.js"></div>
<hr>
