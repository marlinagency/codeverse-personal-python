...
<h1>Python - <span class="color_h1">Variable Names</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_variables_multiple.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variable_names_legal">Try it Yourself &raquo;</a>
</div>
...
2myvar = "John"<br>my-var = "John"<br>
  my var = "John"</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variable_names_error">Try it Yourself &raquo;</a>
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_variables_names.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Variable Names</h2>
  <a href="https://youtu.be/Hsbo6V2BJ3U&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_variable_names.webp" type="image/webp" />
        <img src="images/img_python_variable_names.png" style="max-width:100%;height:auto;border-radius:6px" alt="Python Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
