...
<h1>SQL <span class="color_h1">RIGHT JOIN</span></h1>
...
<p>The <code class="w3-codespan">RIGHT JOIN</code> returns <b>all rows from the right table</b> (table2), and only the matched rows from the left table (table1).</p>
<p>If there is no match in the left table, the result for the columns from the left table will be NULL.</p> 
<p>The <code class="w3-codespan">RIGHT JOIN</code> and <code class="w3-codespan">RIGHT OUTER JOIN</code> keywords are equal - the <code class="w3-codespan">OUTER</code> keyword is optional.</p>
<p style="text-align:center;"><img class="invert-on-dark" alt="SQL RIGHT JOIN" src="img_right_join.png"></p>
...
<p>Here we see that the related column between the two tables above, is the "EmployeeID" column.</p>
<hr>
...
<p>The following SQL will return all employees, and any orders they might have placed:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<a target="_blank" href="trysql.asp?filename=trysql_select_join_right" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
(Orders).</p>
<hr>
<div id="exercisecontainer" src="xrcise_join_right.js"></div>
<hr>
