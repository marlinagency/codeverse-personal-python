...
<style>
  ...
  #divAnim circle, #divAnim line, #divAnim text{
...
<h1>Python <span class="color_h1">Trees</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa_hashtables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_binarytrees.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">A tree is a hierarchical data structure consisting of nodes connected by edges.</p>
<p class="intro">Each node contains a value and references to its child nodes.</p>

<hr>

<h2>Trees</h2>
<p>The Tree data structure is similar to <a href="python_dsa_linkedlists.asp">Linked Lists</a> in that each node contains data and can be linked to other nodes.</p>
...
<p>The data structure is called a "tree" because it looks like a tree's structure.</p>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 250" class="dsa_svg">
<defs>
  ...
  <text x="164" y="37" class="svgDataText">R</text>
  <line x1="155" y1="45" x2="101" y2="100" class="branch" marker-end="url(#arrowhead)" />
  <line x1="170" y1="50" x2="170" y2="91" class="branch" marker-end="url(#arrowhead)" />
  <line x1="185" y1="45" x2="250" y2="100" class="branch" marker-end="url(#arrowhead)" />
  <!-- 'A' node -->
  <circle cx="80" cy="120" r="20" class="node" />
  <text x="73" y="126" class="svgDataText">A</text>
  <line x1="70" y1="138" x2="50" y2="180" class="branch" marker-end="url(#arrowhead)" />
  <line x1="90" y1="138" x2="110" y2="180" class="branch" marker-end="url(#arrowhead)" />
  <!-- 'B' node -->
  ...
  <line x1="261" y1="138" x2="228" y2="183" class="branch" marker-end="url(#arrowhead)" />
  <line x1="271" y1="140" x2="271" y2="178" class="branch" marker-end="url(#arrowhead)" />
  <line x1="281" y1="138" x2="316" y2="183" class="branch" marker-end="url(#arrowhead)" />
  <line x1="286" y1="134" x2="369" y2="189" class="branch" marker-end="url(#arrowhead)" />
  ...
  <!-- 'F' node -->
  <circle cx="211" cy="207" r="20" class="node" />
  <text x="205" y="213" class="svgDataText">F</text>

  <!-- 'G' node -->
  <circle cx="271" cy="207" r="20" class="node" />
  <text x="265" y="213" class="svgDataText">G</text>

  <!-- 'H' node -->
  <circle cx="331" cy="207" r="20" class="node" />
  <text x="325" y="213" class="svgDataText">H</text>

  <!-- 'I' node -->
  <circle cx="391" cy="207" r="20" class="node" />
  <text x="385" y="213" class="svgDataText">I</text>
</svg>
<p>The Tree data structure can be useful in many cases:</p>
<ul>
...
<p>Trees are a fundamental data structure in computer science, used to represent hierarchical relationships. This tutorial covers several key types of trees.</p>
<p><strong>Binary Trees: </strong>Each node has up to two children, the left child node and the right child node. This structure is the foundation for more complex tree types like Binay Search Trees and AVL Trees.</p>
<p><strong>Binary Search Trees (BSTs): </strong>A type of Binary Tree where for each node, the left child node has a lower value, and the right child node has a higher value.</p>
<p><strong>AVL Trees: </strong>A type of Binary Search Tree that self-balances so that for every node, the difference in height between the left and right subtrees is at most one. This balance is maintained through rotations when nodes are inserted or deleted.</p>
<p>Each of these data structures are described in detail on the next pages, including animations and how to implement them.</p>
<hr>

<h2>Trees vs Arrays and Linked Lists</h2>
<p>Benefits of Trees over Arrays and Linked Lists:</p>
<ul>
  <li><strong>Arrays</strong> are fast when you want to access an element directly, like element number 700 in an array of 1000 elements for example. But inserting and deleting elements require other elements to shift in memory to make place for the new element, or to take the deleted elements place, and that is time consuming.</li>
  <li><strong>Linked Lists</strong> are fast when inserting or deleting nodes, no memory shifting needed, but to access an element inside the list, the list must be traversed, and that takes time.</li>
  <li><strong>Trees</strong>, such as Binary Trees, Binary Search Trees and AVL Trees, are great compared to Arrays and Linked Lists because they are BOTH fast at accessing a node, AND fast when it comes to deleting or inserting a node, with no shifts in memory needed.</li>
</ul>
