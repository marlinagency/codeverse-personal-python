...
<html lang="en-US">
<head>
<title>SQL Online Editor (Compiler)</title>
<meta charset="utf-8">
...
/* Syntax highlighting */
.sql-keyword    { color: #005cc5; }
.sql-operator   { color: #000000; }
.sql-identifier { color: #d73a49; }
.sql-symbol     { color: #000000; }
...
body.darktheme .sql-keyword    { color: #c5a5c5 ; }
body.darktheme .sql-operator   { color: #f1f1f1; }
body.darktheme .sql-identifier { color: #faca6b; }
body.darktheme .sql-symbol     { color: #f1f1f1; }
...
body.darktheme .sql-result-table {
  color: #f1f1f1;
}

body.darktheme .sql-result-table tr:nth-child(even) {
  background-color: rgba(255,255,255,0.08);
}

body.darktheme .editor h3,
body.darktheme .editor p,
body.darktheme .editor li {
  color: #f1f1f1;
}

body.darktheme .ws-note a,
...
<h1>SQL <span class="color_h1">Online Editor (Compiler)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="sql_examples.asp">&#10094; Previous</a>
...
<p>With our online SQL editor, you can edit SQL statements, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="sql-keyword">SELECT</span> <span class="sql-operator">*</span> <span class="sql-keyword">FROM</span> <span class="sql-identifier">Customers</span><span class="sql-symbol">;</span>
</pre>
    </div>
  ...
  <div class="compiler-footer">
    <a href="trysql.asp?filename=trysql_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish SQL Projects</h2>

<p>If you want to create your own website, or web applications with a SQL database, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>
