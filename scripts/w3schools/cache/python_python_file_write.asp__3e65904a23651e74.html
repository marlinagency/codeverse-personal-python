...
<code class="w3-codespan"><a href="ref_func_open.asp">open()</a></code> function:</p>
...
<div class="w3-code notranslate pythonHigh">
  with open(&quot;demofile.txt&quot;, &quot;a&quot;) as f:<br>&nbsp; f.write(&quot;Now the file has more content!&quot;)<br>
  <br>#open and read the file after the appending:<br>with open(&quot;demofile.txt&quot;) 
  as f:<br>&nbsp; print(f.read())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_append">Run Example &raquo;</a>
</div>
<!--stop-->
<!--start-->
<h2>Overwrite Existing Content</h2>

<p>To overwrite the existing content to the file, use the <code class="w3-codespan">w</code> parameter:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Open the file "demofile.txt" and overwrite the content:</p>
<div class="w3-code notranslate pythonHigh">
  with open(&quot;demofile.txt&quot;, &quot;w&quot;) as f:<br>
  &nbsp;
  f.write(&quot;Woops! I have deleted the content!&quot;)<br><br>
  #open and read the file after the overwriting:<br>with open(&quot;demofile.txt&quot;) 
  as f:<br>
  &nbsp;
  print(f.read())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_write">Run Example &raquo;</a>
</div>
...
<p>To create a new file in Python, use the <code class="w3-codespan"><a href="ref_func_open.asp">open()</a></code> method, 
...
<div class="w3-example">
  <h3>Example</h3>
<p>Create a new file called "myfile.txt":</p>
<div class="w3-code notranslate pythonHigh">
f = open(&quot;myfile.txt&quot;, &quot;x&quot;)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_create_new">Run Example &raquo;</a>

</div>

<p>Result: a new empty file is created.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> If the file already exists, an error will be raised.</p>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_file_write.js"></div>
<hr>
