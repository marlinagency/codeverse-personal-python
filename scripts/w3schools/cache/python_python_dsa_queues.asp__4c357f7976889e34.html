...
<html lang="en-US">
<head>
<title>Queues with Python</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="python_dsa_stacks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_linkedlists.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Queues are often mentioned together with Stacks, which is a similar data structure described on the <a href="dsa_data_stacks.php">previous page</a>.</p>
<hr>
...
<script>
let stack_arr = [5, 6, 2, 9, 3, 8, 4, 2];
write_stack();
function write_stack() {
    let x = document.getElementById("stacktest1");
    x.innerHTML = "x = [";
    let i = 0;
    for (let c of stack_arr) {
        if (i > 0) {
            x.innerHTML += ", ";
        }
        x.innerHTML += c;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_queues_list">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_queues_class">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_queues_linkedlist">Try it Yourself &raquo;</a>
</div>
