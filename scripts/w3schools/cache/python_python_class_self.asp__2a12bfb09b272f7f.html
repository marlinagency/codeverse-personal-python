...
<html lang="en-US">
<head>
<title>Python self Parameter</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">self Parameter</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_classes_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_class_self.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The self Parameter</h2>

<p>The <code class="w3-codespan">self</code> parameter is a reference to the current instance of the class.</p>

<p>It is used to access properties and methods that belong to the class.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use <code class="w3-codespan">self</code> to access class properties:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>&nbsp; def greet(self):<br>&nbsp;&nbsp;&nbsp; print("Hello, my name is " + self.name)<br><br>p1 = Person("Emil", 25)<br>p1.greet()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_self1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">self</code> parameter must be the first parameter of any method in the class.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Without <code class="w3-codespan">self</code>, Python would not know which object's properties you want to access:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">self</code> parameter links the method to the specific object:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br><br>&nbsp; def printname(self):<br>&nbsp;&nbsp;&nbsp; print(self.name)<br><br>p1 = Person("Tobias")<br>p2 = Person("Linus")<br><br>p1.printname()<br>p2.printname()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_self2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>self Does Not Have to Be Named "self"</h2>

<p>It does not have to be named <code class="w3-codespan">self</code>, you can call it whatever you like, but it has to be the first parameter of any method in the class:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the words <em>myobject</em> and <em>abc</em> instead of <em>self</em>:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(myobject, name, age):<br>&nbsp;&nbsp;&nbsp; myobject.name = name<br>&nbsp;&nbsp;&nbsp; myobject.age = age<br><br>&nbsp; def greet(abc):<br>&nbsp;&nbsp;&nbsp; print("Hello, my name is " + abc.name)<br><br>p1 = Person("Emil", 36)<br>p1.greet()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class5">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> While you <em>can</em> use a different name, it is strongly recommended to use <code class="w3-codespan">self</code> as it is the convention in Python and makes your code more readable to others.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Accessing Properties with self</h2>

<p>You can access any property of the class using <code class="w3-codespan">self</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Access multiple properties using <code class="w3-codespan">self</code>:</p>
<div class="w3-code notranslate pythonHigh">
class Car:<br>&nbsp; def __init__(self, brand, model, year):<br>&nbsp;&nbsp;&nbsp; self.brand = brand<br>&nbsp;&nbsp;&nbsp; self.model = model<br>&nbsp;&nbsp;&nbsp; self.year = year<br><br>&nbsp; def display_info(self):<br>&nbsp;&nbsp;&nbsp; print(f"{self.year} {self.brand} {self.model}")<br><br>car1 = Car("Toyota", "Corolla", 2020)<br>car1.display_info()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_self_access">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Calling Methods with self</h2>

<p>You can also call other methods within the class using <code class="w3-codespan">self</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Call one method from another method using <code class="w3-codespan">self</code>:</p>
<div class="w3-code notranslate pythonHigh">
class Person:<br>&nbsp; def __init__(self, name):<br>&nbsp;&nbsp;&nbsp; self.name = name<br><br>&nbsp; def greet(self):<br>&nbsp;&nbsp;&nbsp; return "Hello, " + self.name<br><br>&nbsp; def welcome(self):<br>&nbsp;&nbsp;&nbsp; message = self.greet()<br>&nbsp;&nbsp;&nbsp; print(message + "! Welcome to our website.")<br><br>p1 = Person("Tobias")<br>p1.welcome()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_class_self_method">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_class_self.js"></div>
<hr>
