...
<p>The <code class="w3-codespan">FOREIGN KEY</code> constraint establishes a link between two 
tables, and prevents action that will destroy the link between them.</p>
<p>A <code class="w3-codespan">FOREIGN KEY</code> is a column in a table that refers to 
the <code class="w3-codespan"><a href="sql_primarykey.asp">PRIMARY KEY</a></code> in another table.</p>
<p>The table with the foreign key column is called the child table, and the table 
with the primary key column is called the referenced or parent table.</p>
...
(in the child table),
because the value has to exist in the parent table.</p>
<p>The <code class="w3-codespan">FOREIGN KEY</code> constraint also prevents you 
...
<p>Here we see that the &quot;PersonID&quot; column in the &quot;Orders&quot; table points to the &quot;PersonID&quot; column in the &quot;Persons&quot; table.</p>
<p>The &quot;PersonID&quot; column in the &quot;Persons&quot; table is the <code class="w3-codespan">PRIMARY KEY</code> in the &quot;Persons&quot; table.</p>
<p>The &quot;PersonID&quot; column in the &quot;Orders&quot; table is the <code class="w3-codespan">
...
<p>The following SQL creates a <code class="w3-codespan">FOREIGN KEY</code> 
constraint on the &quot;PersonID&quot; column upon creation of the &quot;Orders&quot; table:</p>
...
PersonID int,<br>
&nbsp;&nbsp;&nbsp;
CONSTRAINT fk_Person<br>&nbsp;&nbsp;&nbsp; FOREIGN KEY (PersonID)<br>
&nbsp;&nbsp;&nbsp;
...
<p>To create a <code class="w3-codespan">FOREIGN KEY</code> constraint on the &quot;PersonID&quot; column 
after the &quot;Orders&quot; table is created, use the following SQL:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Orders<br>
ADD CONSTRAINT fk_Person<br>
FOREIGN KEY (PersonID)<br>REFERENCES Persons(PersonID);</div></div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Orders<br>
DROP CONSTRAINT fk_Person;</div></div>

<h3>MySQL:</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
ALTER TABLE Orders<br>
DROP FOREIGN KEY fk_Person;</div></div>
<hr>
<div id="exercisecontainer" src="xrcise_foreignkey.js"></div>
<hr>
