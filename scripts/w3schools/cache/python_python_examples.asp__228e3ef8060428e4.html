...
<h1>Python <span class="color_h1">Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_howto_add_two_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_compiler.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="showpython.asp?filename=demo_file_open">
Read a file</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_file_open2">
Read only parts of a file</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_file_readline">
Read one line of a file</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_file_readline3">
Loop through the lines of a file to read the whole file, line by line</a>
</div>
<p><a class="ws-btn" href="python_file_handling.asp">File Handling Explained</a></p>
<hr>

<h2>Python MySQL</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="showpython.asp?filename=demo_mysql_connection">
Create a connection to a database</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_create_db">
Create a database in MySQL</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_show_databases">
Check if a database exist</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_create_table">
Create a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_show_tables">
Check if a table exist</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_primary_key">
Create primary key when creating a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_insert">
Insert a record in a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_insert_many">
Insert multiple rows</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_insert_id">
Get inserted ID</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_select">
Select all records from a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_select_columns">
Select only some of the columns in a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_select_fetchone">
Use the fetchone() method to fetch only one row in a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_where">
Select with a filter</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_where_wildcard">
Wildcards characters</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_where_escape">
Prevent SQL injection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_orderby">
Sort the result of a table alphabetically</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_orderby_desc">
Sort the result in a descending order (reverse alphabetically)</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_delete">
Delete records from an existing table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_delete_escape">
Prevent SQL injection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_drop_table">
Delete an existing table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_drop_table2">
Delete a table if it exist</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_update">
Update existing records in a table</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_update_escape">
Prevent SQL injection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_limit">
Limit the number of records returned from a query</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_inner_join">
Combine rows from two or more tables, based on a related column between them</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_left_join">
LEFT JOIN</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mysql_right_join">
RIGHT JOIN</a>
</div>
...
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="showpython.asp?filename=demo_mongodb_create_db">
Create a database</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_check_db">
Check if a database exist</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_create_collection">
Create a collection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_check_collection">
Check if a collection exist</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_insert">
Insert into collection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_insert_id">
Return the id field</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_insert_many">
Insert multiple documents</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_insert_many2">
Insert multiple documents with specified IDs</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_find_one">
Find the first document in the selection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_find">
Find all documents in the selection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_find_some">
Find only some fields</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_query">
Filter the result</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_query_modifier">
Advanced query</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_query_regex">
Filter with regular expressions</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_sort">
Sort the result alphabetically</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_sort2">
Sort the result descending (reverse alphabetically)</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_delete_one">
Delete document</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_delete_many">
Delete many documents</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_delete_all">
Delete all documents in a collection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_drop_collection">
Delete a collection</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_update_one">
Update a document</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_update_many">
Update many/all documents</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="showpython.asp?filename=demo_mongodb_limit">
Limit the result</a>
</div>
