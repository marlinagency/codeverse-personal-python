...
<html lang="en-US">
<head>
<title>Python - Loop Tuples</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Loop Tuples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_tuples_unpack.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_tuples_join.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Loop Through a Tuple</h2>

<p>You can loop through the tuple items by using a <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loop.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_loop">Try it Yourself &raquo;</a>
</div>
...
<p>You can also loop through the tuple items by referring to their index number.</p>

<p>Use the <code class="w3-codespan"><a href="ref_func_range.asp">range()</a></code> and <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> functions to create a suitable iterable.</p>
...
<div class="w3-code notranslate pythonHigh">
thistuple = ("apple", "banana", "cherry")<br>
for i in range(len(thistuple)):<br>
&nbsp; print(thistuple[i])</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_loop_index">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>You can loop through the tuple items by using a <code class="w3-codespan"><a href="ref_keyword_while.asp">while</a></code> loop.</p>

<p>Use the <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> function to determine the length of the tuple,
then start at 0 and loop your way through the tuple items by referring to their indexes.</p>

<p>Remember to increase the index by 1 after each iteration.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Print all items, using a <code class="w3-codespan"><a href="ref_keyword_while.asp">while</a></code> loop to go through all the index numbers:</p>
<div class="w3-code notranslate pythonHigh">
thistuple = ("apple", "banana", "cherry")<br>
i = 0<br>
while i &lt; len(thistuple):<br>
&nbsp; print(thistuple[i])<br>
&nbsp; i = i + 1
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_while">Try it Yourself &raquo;</a>
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_tuples_loop.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_tuples_unpack.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_tuples_join.asp">Next &#10095;</a>
