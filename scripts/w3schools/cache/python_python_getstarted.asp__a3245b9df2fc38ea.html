...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
...
<p>To check if Python is installed on Windows, search in the start bar for Python or run the following on the Command Line (cmd.exe):</p>
...
<p>If Python is not installed on your computer, you can download it for free from the official website: <a href="https://www.python.org/" target="_blank">https://www.python.org/</a></p>
<!--stop-->
<hr>
<!--start-->
...
<p>Let's write our first Python file, called <code class="w3-codespan">hello.py</code>, which can be done in any text editor:</p>

<div class="w3-example">
<p><code class="w3-codespan">hello.py</code>:</p>
<pre class="notranslate w3-white" style="padding:20px">
print("Hello, World!")
</pre>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;python hello.py
</div>
</div>
...
<p>To check the Python version of the editor, you can find it by importing the <code class="w3-codespan">sys</code> module:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check the Python version of the editor:</p>
<div class="w3-code notranslate pythonHigh">
import sys<br>
<br>
print(sys.version)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_sys_version">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<p>You will learn more about importing modules in our 
<a href="python_modules.asp">Python Modules</a> chapter.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_getstarted.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Get Started</h2>
  <a href="https://youtu.be/z116jFWdfQc&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_getstarted.webp" type="image/webp" />
        <img src="images/img_python_getstarted.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
