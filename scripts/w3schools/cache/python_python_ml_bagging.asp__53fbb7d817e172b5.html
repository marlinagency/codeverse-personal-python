...
<html lang="en-US">
<head>
<title>Python Machine Learning - Bootstrap Aggregation (Bagging)</title>
<meta charset="utf-8">
...
<h1>Machine Learning - Bootstrap Aggregation (Bagging)</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_ml_k-means.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_ml_cross_validation.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Evaluating a Base Classifier</h2>

<p>To see how bagging can improve model performance, we must start by evaluating how the base classifier performs on the dataset. If you do not know what decision trees are review the lesson on decision trees before moving forward, as bagging is a continuation of the concept.</p>
...
<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">from sklearn import datasets<br>
from sklearn.model_selection import train_test_split<br>
from sklearn.metrics import accuracy_score<br>
from sklearn.tree import DecisionTreeClassifier</code></p>
</div>

<p>Next we need to load in the data and store it into X (input features) and y (target). The parameter as_frame is set equal to True so we do not lose the feature names when loading the data. 
(<code class="w3-codespan">sklearn</code> version older than 0.23 must skip the
<code class="w3-codespan">as_frame</code> argument as it is not supported) </p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">data = datasets.load_wine(as_frame = True)<br>
<br>
X = data.data<br>
y = data.target</code></p>
</div>

<p>In order to properly evaluate our model on unseen data, we need to split X and y into train and test sets. For information on splitting data, see the Train/Test lesson.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.25, random_state = 22)</code></p>
</div>

<p>With our data prepared, we can now instantiate a base classifier and fit it to the training data.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">dtree = DecisionTreeClassifier(random_state = 22)<br>
dtree.fit(X_train,y_train)</code></p>
</div>

<p>Result:</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">DecisionTreeClassifier(random_state=22)</code></p>
</div>

<p>We can now predict the class of wine the unseen test set and evaluate the model performance.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">y_pred = dtree.predict(X_test)<br>
<br>
print("Train data accuracy:",accuracy_score(y_true = y_train, y_pred = dtree.predict(X_train)))<br>
print("Test data accuracy:",accuracy_score(y_true = y_test, y_pred = y_pred))</code></p>
</div>

<p>Result:</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">Train data accuracy: 1.0<br>
Test data accuracy: 0.8222222222222222</code></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Import the necessary data and evaluate base classifier performance.</p>
...
<br>
data = datasets.load_wine(as_frame = True)<br>
<br>
X = data.data<br>
y = data.target<br>
<br>
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.25, random_state = 22)<br>
<br>
dtree = DecisionTreeClassifier(random_state = 22)<br>
dtree.fit(X_train,y_train)<br>
<br>
y_pred = dtree.predict(X_test)<br>
<br>
print("Train data accuracy:",accuracy_score(y_true = y_train, y_pred = dtree.predict(X_train)))<br>
print("Test data accuracy:",accuracy_score(y_true = y_test, y_pred = y_pred))

</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_bagging">Run example &raquo;</a>
</div>

<p>The base classifier performs reasonably well on the dataset achieving 82% accuracy on the test dataset with the current parameters (Different results may occur if you do not have the <code class="w3-codespan">random_state</code> parameter set).</p>
...
<h2>Creating a Bagging Classifier</h2>
...
<p>For this sample dataset the number of estimators is relatively low, it is often the case that much larger ranges are explored. Hyperparameter tuning is usually done with a 
...
<p>We start by importing the necessary model.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">from sklearn.ensemble import BaggingClassifier</code></p>
</div>

<p>Now lets create a range of values that represent the number of estimators we want to use in each ensemble.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">estimator_range = [2,4,6,8,10,12,14,16]</code></p>
</div>

<p>To see how the Bagging Classifier performs with differing values of n_estimators we need a way to iterate over the range of values and store the results from each ensemble. To do this we will create a for loop, storing the models and scores in separate lists for later 
visualizations.</p>

<p>Note: The default parameter for the base classifier in <code class="w3-codespan">BaggingClassifier</code> is the <code class="w3-codespan">DecisionTreeClassifier</code> therefore we do not need to set it when instantiating the bagging model.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">models = []<br>
scores = []<br>
<br>
for n_estimators in estimator_range:<br>
    <br>
&nbsp;&nbsp;&nbsp;&nbsp;# Create bagging classifier<br>
&nbsp;&nbsp;&nbsp;&nbsp;clf = BaggingClassifier(n_estimators = n_estimators, random_state = 22)<br>
    <br>
&nbsp;&nbsp;&nbsp;&nbsp;# Fit the model<br>
&nbsp;&nbsp;&nbsp;&nbsp;clf.fit(X_train, y_train)<br>
    <br>
&nbsp;&nbsp;&nbsp;&nbsp;# Append the model and score to their respective list<br>
&nbsp;&nbsp;&nbsp;&nbsp;models.append(clf)<br>
&nbsp;&nbsp;&nbsp;&nbsp;scores.append(accuracy_score(y_true = y_test, y_pred = clf.predict(X_test)))</code></p>
</div>

<p>With the models and scores stored, we can now visualize the improvement in model performance.</p>

<div class="w3-example ws-light-grey">
  <p><code class="pythonHigh">import matplotlib.pyplot as plt<br>
<br>
# Generate the plot of scores against number of estimators<br>
plt.figure(figsize=(9,6))<br>
plt.plot(estimator_range, scores)<br>
<br>
# Adjust labels and font (to make visable)<br>
plt.xlabel("n_estimators", fontsize = 18)<br>
plt.ylabel("score", fontsize = 18)<br>
plt.tick_params(labelsize = 16)<br>
<br>
# Visualize plot<br>
plt.show()</code></p>
<p><img src="img_ml_bagging2.png" style="max-width:100%"></p>
</div>


<div class="w3-example">
<h3>Example</h3>
<p>Import the necessary data and evaluate the <code class="w3-codespan">BaggingClassifier</code> performance.</p>
<div class="w3-code notranslate pythonHigh">
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.25, random_state = 22)<br>
<br>
estimator_range = [2,4,6,8,10,12,14,16]<br>
<br>
models = []<br>
scores = []<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;# Append the model and score to their respective list<br>
&nbsp;&nbsp;&nbsp;&nbsp;models.append(clf)<br>
&nbsp;&nbsp;&nbsp;&nbsp;scores.append(accuracy_score(y_true = y_test, y_pred = clf.predict(X_test)))<br>
    <br>
# Generate the plot of scores against number of estimators<br>
plt.figure(figsize=(9,6))<br>
plt.plot(estimator_range, scores)<br>
...
<h3>Result</h3>
<p><img src="img_ml_bagging2.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_bagging2">Run example &raquo;</a>
</div>
...
<p>By iterating through different values for the number of estimators we can see an increase in model performance from 82.2% to 95.5%. After 14 estimators the accuracy begins to drop, again if you set a different <code class="w3-codespan">random_state</code> the values you see will vary.
...
<h2>Another Form of Evaluation</h2>
...
<p>We saw in the last exercise that 12 estimators yielded the highest accuracy, so we will use that to create our model. This time setting the parameter <code class="w3-codespan">oob_score</code> to true to evaluate the model with out-of-bag score.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a model with out-of-bag metric.</p>
<div class="w3-code notranslate pythonHigh">
from sklearn import datasets<br>
from sklearn.model_selection import train_test_split<br>
from sklearn.ensemble import BaggingClassifier<br>
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.25, random_state = 22)<br>
<br>
oob_model = BaggingClassifier(n_estimators = 12, oob_score = True,random_state = 22)<br>
<br>
oob_model.fit(X_train, y_train)<br>
<br>
print(oob_model.oob_score_)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_bagging3">Run example &raquo;</a>
</div>
...
<h2>Generating Decision Trees from Bagging Classifier</h2>
...
<p>We will need to import <code class="w3-codespan">plot_tree</code> function from <code class="w3-codespan">sklearn.tree</code>. The different trees can be graphed by changing the estimator you wish to visualize.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate Decision Trees from Bagging Classifier</p>
<div class="w3-code notranslate pythonHigh">
from sklearn import datasets<br>
from sklearn.model_selection import train_test_split<br>
from sklearn.ensemble import BaggingClassifier<br>
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.25, random_state = 22)<br>
<br>
clf = BaggingClassifier(n_estimators = 12, oob_score = True,random_state = 22)<br>
<br>
clf.fit(X_train, y_train)<br>
<br>
plt.figure(figsize=(30, 20))<br>
<br>
plot_tree(clf.estimators_[0], feature_names = X.columns)</div>
<h3>Result</h3>
<p><img src="img_ml_bagging4.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_bagging4">Run example &raquo;</a>
</div>
