...
<h1>SQL <span class="color_h1">BACKUP DATABASE</span> Statement</h1>
...
<h2>The BACKUP DATABASE Statement</h2>
<p>The <code class="w3-codespan">BACKUP DATABASE</code> statement is used in SQL Server to create a full backup of an existing SQL database.</p>
<h3>Syntax</h3>
...
<p>The following SQL creates a full backup of the existing database &quot;testDB&quot; 
to the D drive:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p><b>Tip:</b> Always place the backup database in a different drive than the 
original database! If you get a disk crash, you will not lose your backup 
...
<h2>The BACKUP WITH DIFFERENTIAL Statement</h2>
<p>A differential backup only captures the data that has changed since the last full backup.</p>
<p>A differential backup requires at least one prior full backup!</p>
<h3>Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
...
<p>The following SQL creates a differential backup of the database &quot;testDB&quot;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<div class="w3-panel ws-note">
<p><b>Tip:</b> A differential backup reduces the backup time (since only the changes are backed up).</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_backup_db.js"></div>
<hr>
