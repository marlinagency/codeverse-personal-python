...
<h1>Python <span class="color_h1">Logical Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_shorthand.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_if_nested_if.asp">Next &#10095;</a>
</div>
<hr>

<h2>Python Logical Operators</h2>

<p>Logical operators are used to combine conditional statements. Python has three logical operators:</p>

<ul>
<li><code class="w3-codespan"><a href="ref_keyword_and.asp">and</a></code> - Returns True if both statements are true</li>
<li><code class="w3-codespan"><a href="ref_keyword_or.asp">or</a></code> - Returns True if one of the statements is true</li>
<li><code class="w3-codespan"><a href="ref_keyword_not.asp">not</a></code> - Reverses the result, returns False if the result is true</li>
</ul>

<hr>

<h2>The and Operator</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_and.asp">and</a></code> keyword is a logical operator, and 
is used to combine conditional statements. Both conditions must be true for the entire expression to be true.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_and">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan"><a href="ref_keyword_or.asp">or</a></code> keyword is a logical operator, and 
is used to combine conditional statements. At least one condition must be true for the entire expression to be true.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_or">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>The not Operator</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_not.asp">not</a></code> keyword is a logical operator, and 
is used to reverse the result of the conditional statement.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Test if <code class="w3-codespan">a</code> is NOT greater than
  <code class="w3-codespan">b</code>:</p>
<div class="w3-code notranslate pythonHigh">
a = 33<br>
b = 200<br>
if not a > b:<br>
&nbsp; print("a is NOT greater than b")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_not">Try it Yourself &raquo;</a>
</div>
...
<p>You can combine multiple logical operators in a single expression. Python evaluates <span class="w3-codespan">not</span> first, then <span class="w3-codespan">and</span>, then <span class="w3-codespan">or</span>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Combining <code class="w3-codespan">and</code>, <code class="w3-codespan">or</code>, and <code class="w3-codespan">not</code>:</p>
<div class="w3-code notranslate pythonHigh">
age = 25<br>
is_student = False<br>
has_discount_code = True<br><br>
if (age &lt; 18 or age &gt; 65) and not is_student or has_discount_code:<br>
&nbsp; print("Discount applies!")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_logical_combined">Try it Yourself &raquo;</a>
</div>
...
<p>Understanding how logical operators work with different values:</p>

<h3>and Operator Truth Table</h3>
<table class="ws-table-all">
<tr>
<th style="width:33%">Condition 1</th>
<th style="width:33%">Condition 2</th>
...
<h2>Using Parentheses for Clarity</h2>

<p>When combining multiple logical operators, use parentheses to make your intentions clear and control the order of evaluation.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using parentheses for complex conditions:</p>
<div class="w3-code notranslate pythonHigh">
temperature = 25<br>
is_raining = False<br>
is_weekend = True<br><br>
if (temperature &gt; 20 and not is_raining) or is_weekend:<br>
&nbsp; print("Great day for outdoor activities!")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_logical_parentheses">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>User authentication check:</p>
<div class="w3-code notranslate pythonHigh">
username = "Tobias"<br>
password = "secret123"<br>
is_verified = True<br><br>
if username and password and is_verified:<br>
&nbsp; print("Login successful")<br>
else:<br>
&nbsp; print("Login failed")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_logical_auth">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Range checking with logical operators:</p>
<div class="w3-code notranslate pythonHigh">
score = 85<br><br>
if score &gt;= 0 and score &lt;= 100:<br>
&nbsp; print("Valid score")<br>
else:<br>
&nbsp; print("Invalid score")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_logical_range">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_if_logical.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_shorthand.asp">&#10094; Previous</a>
