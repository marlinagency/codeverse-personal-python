...
<html lang="en-US">
<head>
<title>Python - Update Tuples</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Update Tuples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_tuples_access.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_tuples_unpack.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p>Tuples are unchangeable, meaning that you cannot change, add, or remove items once the tuple is created.</p>
<p>But there are some workarounds.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_change">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Since tuples are immutable, they do not have a built-in 
<code class="w3-codespan">append()</code> method, but 
there are other ways to add items to a tuple.</p>
<p>1. <strong>Convert into a list</strong>: Just like the workaround for<em> changing </em>a tuple, you can convert it into a list, add your item(s), and convert it back into a tuple.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Convert the tuple into a list, add "orange", and convert it back into a tuple:</p>
<div class="w3-code notranslate pythonHigh">
  thistuple = ("apple", "banana", "cherry")<br>y = list(thistuple)<br>y.append(&quot;orange&quot;)<br>
  thistuple = 
  tuple(y)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_add_orange">Try it Yourself &raquo;</a>
</div>

<p>2. <strong>Add tuple to a tuple</strong>. You are allowed to add tuples to 
tuples, so if you want to add one item, (or many), create a new tuple with the 
item(s), and add it to the existing tuple:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a new tuple with the value &quot;orange&quot;, and add that tuple:</p>
<div class="w3-code notranslate pythonHigh">
  thistuple = ("apple", "banana", "cherry")<br>y = (&quot;orange&quot;,)<br>thistuple += y<br>
  <br>print(thistuple)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_add_tuple">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> When creating a tuple with only one item, remember to include a comma 
  after the item, otherwise it will not be identified as a tuple.</p>
</div>
<!--stop-->
<hr>
...
from it, but you can use the same workaround as we used for changing and adding tuple items:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Convert the tuple into a list, remove &quot;apple&quot;, and convert it back into a tuple:</p>
<div class="w3-code notranslate pythonHigh">
  thistuple = ("apple", "banana", "cherry")<br>y = list(thistuple)<br>y.remove(&quot;apple&quot;)<br>
  thistuple = 
  tuple(y)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_remove">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<p>Or you can delete the tuple completely:</p>
<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan"><a href="ref_keyword_del.asp">del</a></code> keyword can delete the tuple 
completely:</p>
<div class="w3-code notranslate pythonHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_tuple_del">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_tuples_update.js"></div>
<hr>
