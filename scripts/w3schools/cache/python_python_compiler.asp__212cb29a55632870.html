...
<html lang="en-US">
<head>
<title>Python Online Compiler (Editor / Interpreter)</title>
<meta charset="utf-8">
...
/* Syntax highlighting */
.py-function { color: #005cc5 ; }   /* print */
.py-string   { color: green; }     /* "Hello, World!" */
.py-variable { color: #000000; }   /* x, y, z */
.py-symbol   { color: #000000; }   /* = , () */
...
body.darktheme .editor pre {
  color: #f1f1f1;
}

body.darktheme .py-function { color: #faca6b; }
body.darktheme .py-string   { color: #c3e88d; }
body.darktheme .py-variable { color: #f1f1f1; }
body.darktheme .py-symbol   { color: #f1f1f1; }
...
body.darktheme .compiler-wrapper {
  background-color: rgb(13,23,33);
}

body.darktheme .editor a {
  color: #9dcfff;
}
...
<h1>Python <span class="color_h1">Online Compiler</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_exercises.asp">Next &#10095;</a>
</div>
<hr>

<h2>Python Compiler (Editor)</h2>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="py-function">print</span><span class="py-symbol">(</span><span class="py-string">"Hello, World!"</span><span class="py-symbol">)</span>

<span class="py-variable">x</span> <span class="py-symbol">=</span> <span class="py-string">"Python"</span>
<span class="py-variable">y</span> <span class="py-symbol">=</span> <span class="py-string">"is"</span>
<span class="py-variable">z</span> <span class="py-symbol">=</span> <span class="py-string">"awesome"</span>
<span class="py-function">print</span><span class="py-symbol">(</span><span class="py-variable">x</span>, <span class="py-variable">y</span>, <span class="py-variable">z</span><span class="py-symbol">)</span>
</pre>
    </div>
...
Python is awesome
  ...
  <div class="compiler-footer">
    <a href="trypython.asp?filename=demo_compiler"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish Python Projects</h2>

<p>If you want to create your own Python applications, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>

<hr>
<div class="ws-note w3-panel" style="margin-top:20px;">
