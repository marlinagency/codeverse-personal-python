...
<html lang="en-US">
<head>
<title>Python Shorthand If</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Shorthand If</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_else.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_if_logical.asp">Next &#10095;</a>
</div>
<hr>

<h2>Short Hand If</h2>

<p>If you have only one statement to execute, you can put it on the same line as the <code class="w3-codespan">if</code> statement.</p>

<div class="w3-example">
<h3>Example</h3>
<p>One-line <code class="w3-codespan">if</code> statement:</p>
...
<p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_short">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> You still need the colon <code class="w3-codespan">:</code> after the condition.</p>
</div>
...
<p>If you have one statement for <code class="w3-codespan">if</code> and one for <code class="w3-codespan">else</code>, you can put them on the same line using a conditional expression:</p>

<div class="w3-example">
<h3>Example</h3>
<p>One-line <code class="w3-codespan">if</code>/<code class="w3-codespan">else</code> that prints a value:</p>
<div class="w3-code notranslate pythonHigh">
a = 2<br>
b = 330<br>
...
<p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_else_short">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-panel ws-note">
<p>This is called a <strong>conditional expression</strong> (sometimes known as a "ternary operator").</p>
</div>

<hr>

<h2>Assign a Value With If ... Else</h2>

<p>You can also use a one-line <code class="w3-codespan">if</code>/<code class="w3-codespan">else</code> to choose a value and assign it to a variable:</p>
...
a = 10<br>
b = 20<br>
bigger = a if a &gt; b else b<br>
print("Bigger is", bigger)
</div>
<p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_else_assign">Try it Yourself &raquo;</a>
</p>
</div>

<p>The syntax follows this pattern:</p>
...
<h2>Multiple Conditions on One Line</h2>

<p>You can chain conditional expressions, but keep it short so it stays readable:</p>

<div class="w3-example">
<h3>Example</h3>
<p>One line, three outcomes:</p>
<div class="w3-code notranslate pythonHigh">
a = 330<br>
b = 330<br>
...
<p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_else_short2">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>Ternary operators are particularly useful for simple assignments and return statements.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Finding the maximum of two numbers:</p>
<div class="w3-code notranslate pythonHigh">
x = 15<br>
y = 20<br>
max_value = x if x > y else y<br>
print("Maximum value:", max_value)<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ternary_max">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Setting a default value:</p>
<div class="w3-code notranslate pythonHigh">
username = ""<br>
display_name = username if username else "Guest"<br>
print("Welcome,", display_name)<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ternary_default">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>When to Use Shorthand If</h2>

<p>Shorthand if statements and ternary operators should be used when:</p>

<ul>
<li>The condition and actions are simple</li>
<li>It improves code readability</li>
<li>You want to make a quick assignment based on a condition</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Important:</strong> While shorthand if statements can make code more concise, avoid overusing them for complex conditions. For readability, use regular if-else statements when dealing with multiple lines of code or complex logic.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_if_shorthand.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_if_else.asp">&#10094; Previous</a>
