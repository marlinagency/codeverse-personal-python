...
<p>The <code class="w3-codespan">UNIQUE</code> constraint ensures that all values in a column are unique.</p>
<p>Both the <code class="w3-codespan">UNIQUE</code> and <code class="w3-codespan"><a href="sql_primarykey.asp">PRIMARY KEY</a></code> constraints provide a guarantee for uniqueness for a column or set of columns. However, you can have many <code class="w3-codespan">UNIQUE</code> constraints per table, but only one 
<code class="w3-codespan">PRIMARY KEY</code> constraint per table.</p>
<hr>

<h2>UNIQUE Constraint on CREATE TABLE</h2>
<p>The following SQL defines a <code class="w3-codespan">UNIQUE</code> constraint 
for the &quot;ID&quot; column upon creation of the &quot;Persons&quot; table:</p>
...
<h3>Naming a Unique Constraint</h3>
...
<p>To create a <code class="w3-codespan">UNIQUE</code> constraint on the &quot;ID&quot; column when the table is already created, use the following SQL 
syntax:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_unique.js"></div>
<hr>
