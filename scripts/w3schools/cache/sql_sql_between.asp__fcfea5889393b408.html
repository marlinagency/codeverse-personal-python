...
<p>The <code class="w3-codespan">BETWEEN</code> operator is used in the <code class="w3-codespan">WHERE</code> clause to select values within a specified range.</p>
<p>The range is <b>inclusive</b> - the beginning and end values of the range are included in the results.</p>
<p>The values can be numbers, text, or dates.</p>
...
WHERE <em>column_name </em>BETWEEN <em>value1</em> AND <em>value2;</em></code></p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<!--start-->
<h2>NOT BETWEEN</h2>
<p>The <code class="w3-codespan">NOT BETWEEN</code> operator is used in the <code class="w3-codespan">WHERE</code> clause to select values outside a specified range.</p>
<p>The following SQL returns all products with a price NOT between 10 and 20:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>The following SQL returns all products with a price between 10 and 
20. In addition, the CategoryID must be either 1, 2 or 3:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>WHERE Price BETWEEN 10 AND 20<br>AND CategoryID IN (1,2,3);
</div>
...
<p>The following SQL selects all products with a ProductName alphabetically between 
'Geitost' and 'Louisiana Hot Spiced Okra':</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>
 WHERE ProductName BETWEEN 'Geitost' AND 'Louisiana Hot Spiced Okra'<br>
...
<hr>
<!--start-->
<h2>NOT BETWEEN Text Values</h2>
<p>The following SQL selects all products with a ProductName NOT 
between 'Geitost' and 'Louisiana Hot Spiced Okra':</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>WHERE ProductName NOT BETWEEN 'Geitost' AND 
  'Louisiana Hot Spiced Okra'<br>ORDER BY ProductName;
</div>
...
<!--start-->
<h2>BETWEEN Dates</h2>
<p>The <code class="w3-codespan">BETWEEN</code> operator is useful for filtering records within a specific date or time period.
Ensure the date format matches the database (e.g. 'YYYY-MM-DD').</p>
<p>The following SQL selects all orders placed in July, 1996:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Orders<br>WHERE OrderDate BETWEEN '1996-07-01' AND '1996-07-31';
</div>
<a target="_blank" href="trymysql.asp?filename=trysql_select_between_date2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<h2>Sample Table</h2>
<p>Below is a selection from the <a href="trysql.asp?filename=trysql_orders" target="_blank"><strong>Orders</strong></a> table used in the example 
above:</p>
<div class="w3-responsive">
<table class="ws-table-all notranslate">
  <tr>
...
<hr>
<div id="exercisecontainer" src="xrcise_between.js"></div>
<hr>
