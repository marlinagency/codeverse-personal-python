...
<a class="w3-left w3-btn" href="python_challenges_sets_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dictionaries_access.asp">Next &#10095;</a>
</div>
...
<p>A dictionary is a collection which is ordered*, changeable and do not 
allow duplicates.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Dictionary items are presented in key:value pairs, and can be referred to by 
using the key name.</p>
<div class="w3-example">
<h3>Example</h3>
...
print(thisdict[&quot;brand&quot;])<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_brand">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Unordered means that the items do not 
have a defined order, you cannot refer to an item by using an index.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Changeable</h2>

<p>Dictionaries are changeable, meaning that we can change, add or remove items after the 
dictionary has been created.</p>
...
&nbsp;&nbsp;"brand": "Ford",<br>
&nbsp;&nbsp;"model": "Mustang&quot;,<br>
&nbsp;&nbsp;"year": 1964,<br>&nbsp; &quot;year&quot;: 2020<br>
}<br>
print(thisdict)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_duplicates">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>To determine how many items a dictionary has, use the <code class="w3-codespan">
<a href="ref_func_len.asp">len()</a></code> function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dict_len">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
&nbsp;&nbsp;"brand": "Ford",<br>
&nbsp;&nbsp;"electric": False,<br>
&nbsp;&nbsp;"year": 1964,<br>&nbsp; &quot;colors&quot;: [&quot;red&quot;, &quot;white&quot;, &quot;blue&quot;]<br>
} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dict_datatypes">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
print(type(thisdict))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dict_datatypes2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The dict() Constructor</h2>
<p>It is also possible to use the <span class="w3-codespan"><a href="ref_func_dict.asp">dict()</a></span> constructor to make a dictionary.</p>
...
<div class="w3-code notranslate pythonHigh">
thisdict = 
  dict(name = &quot;John&quot;, age = 36, country = &quot;Norway&quot;)<br>
print(thisdict)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dict_constructor">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_dictionaries.js"></div>
<hr>
