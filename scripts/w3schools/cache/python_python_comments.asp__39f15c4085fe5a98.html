...
<a class="w3-left w3-btn" href="python_challenges_output.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_comments.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_comment1">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_comment2">Try it Yourself &raquo;</a>
</div>

<p>A comment does not have to be text that explains the code, it can also be used to 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_comment3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_comment4">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_comment5">Try it Yourself &raquo;</a>
</div>
...
<a id="exercises"></a>
<hr>
<div id="exercisecontainer" src="xrcise_comments.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Comments</h2>
  <a href="https://youtu.be/9wouY9nWe0k&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_comments.webp" type="image/webp" />
        <img src="images/img_python_comments.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
