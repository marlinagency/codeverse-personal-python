...
<a class="w3-left w3-btn" href="python_challenges_comments.asp">&#10094; Previous</a>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables1">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate pythonHigh">
x = 
  str(3)&nbsp;&nbsp;&nbsp; # x will be '3'<br>y = int(3)&nbsp;&nbsp;&nbsp; # y 
  will be 3<br>z = float(3)&nbsp; # z will be 3.0</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_casting">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>You can get the data type of a variable with the <code class="w3-codespan"><a href="ref_func_type.asp">type()</a></code> function.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x = 5<br>y = &quot;John&quot;<br>print(type(x))<br>print(type(y))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_type">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<div class="ws-note w3-panel">You will learn more about 
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
x = &quot;John&quot;<br># is the same as<br>x = 
  'John'
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables7">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate pythonHigh">
  a = 4<br>A = 
  &quot;Sally&quot;<br>#A will not overwrite a</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_cs">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Variables</h2>
  <a href="https://youtu.be/Gf9wLsCJDqc&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_variables.webp" type="image/webp" />
        <img src="images/img_python_variables.png" style="max-width:100%;height:auto;border-radius:6px" alt="Python Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
