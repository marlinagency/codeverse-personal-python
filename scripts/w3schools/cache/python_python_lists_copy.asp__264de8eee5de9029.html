...
<a class="w3-left w3-btn" href="python_lists_sort.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_join.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Copy a List</h2>
...
<hr>
<!--start-->
<h2>Use the copy() method</h2>
<p>You can use the built-in List method <code class="w3-codespan"><a href="ref_list_copy.asp">copy()</a></code> to copy a list.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Make a copy of a list with the <code class="w3-codespan"><a href="ref_list_copy.asp">copy()</a></code> method:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>mylist 
  = thislist.copy()<br>
  print(mylist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_copy">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use the list() method</h2>
<p>Another way to make a copy is to use the built-in method <code class="w3-codespan"><a href="ref_func_list.asp">list()</a></code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Make a copy of a list with the <code class="w3-codespan"><a href="ref_func_list.asp">list()</a></code> method:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>mylist 
  = list(thislist)<br>
  print(mylist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_copy2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use the slice Operator</h2>

<p>You can also make a copy of a list by using the <code class="w3-codespan">:</code> (slice) operator.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Make a copy of a list with the <code class="w3-codespan">:</code> operator:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
mylist = thislist[:]<br>print(mylist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_copy3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_lists_copy.js"></div>
<hr>
