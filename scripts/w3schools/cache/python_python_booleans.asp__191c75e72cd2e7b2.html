...
<h1>Python <span class="color_h1">Booleans</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_strings_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_booleans.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">Booleans represent one of two values: 
<code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code> or <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>.</p>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans1">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Print a message based on whether the condition is <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code> or 
  <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>:</p>
<div class="w3-code notranslate pythonHigh">
  a = 200<br>b = 33<br><br>if b &gt; a:<br>&nbsp; print(&quot;b is greater than a&quot;)<br>
  else:<br>&nbsp; print(&quot;b is not greater than a&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans2">Try it Yourself &raquo;
</a>
</div>
<hr>
<h2>Evaluate Values and Variables</h2>
<p>The <code class="w3-codespan"><a href="ref_func_bool.asp">bool()</a></code> function allows you to evaluate 
any value, and give you 
<code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code> or <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code> 
in return,</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans3">Try it Yourself &raquo;
</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans4">Try it Yourself &raquo;
</a>
</div>
<!--stop-->
<hr>
...
<p>Almost any value is evaluated to <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code> if it 
has some sort of content.</p>
<p>Any string is <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code>, except empty strings.</p>
<p>Any number is <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code>, except 
<code class="w3-codespan">0</code>.</p>
<p>Any list, tuple, set, and dictionary are <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code>, except 
empty ones.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans5">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>In fact, there are not many values that evaluate to
<code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>, except empty values, such as <code class="w3-codespan">()</code>,
...
And of course the value <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code> evaluates to
<code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  bool({})</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans6">Try it Yourself &raquo;</a>
</div>

<p>One more value, or object in this case, evaluates to 
<code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code>, and that is if you have an object that 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans7">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_boolean_return">Try it Yourself &raquo;
</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_boolean_return2">Try it Yourself &raquo;
</a>
</div>

<p>Python also has many built-in functions that return a boolean value, like the 
<code class="w3-codespan"><a href="ref_func_isinstance.asp">isinstance()</a></code> 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_booleans8">Try it Yourself &raquo;
</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_booleans.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_strings_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_challenges_booleans.asp">Next &#10095;</a>
