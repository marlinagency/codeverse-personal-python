...
<a class="w3-right w3-btn" href="python_statements.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<div class="w3-example" style="width:auto;">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation_test">Try it Yourself &raquo;</a>
</div>

<p>The number of spaces is up to you as a programmer, the most common use is four, but it has 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation2">Try it Yourself &raquo;</a>
</div>

<p>You have to use the same number of spaces in the same block of code, 
otherwise Python will give you an error:</p>
...
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print(&quot;Five is greater than 
  two!&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation2_error">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>In Python, a variable is created when you assign a value to it:
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_syntax_variables">Try it Yourself &raquo;</a>
</div>

<p>Python has no command for declaring a variable.</p>
<p>You will learn more about variables in the <a href="python_variables.asp">
Python Variables</a> chapter.</p>
<hr>
<h2>Comments</h2>

<p>Python has commenting capability for the purpose of in-code documentation.</p>
<p>Comments start with a <code class="w3-codespan">#</code>, and Python will render the rest of the line as a comment:
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_comment">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Syntax</h2>
  <a href="https://youtu.be/4WVZBtqqVM4&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_python_syntax.webp" type="image/webp" />
        <img src="images/img_python_syntax.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
