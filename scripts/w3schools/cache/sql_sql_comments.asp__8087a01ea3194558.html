...
<h2>SQL Comments</h2>
<p>Comments are used to explain SQL code, or to temporarily prevent execution of SQL code (for debugging).</p>
<p>Comments are ignored by the database engine.</p>
<p>SQL supports single-line comments <code class="w3-codespan">--</code>, and multi-line comments <code class="w3-codespan">/* 
*/</code>.</p>
<p><strong>Note:</strong> Comments are not supported in Microsoft Access databases.</p>
<hr>

<h2>SQL Single-line Comments</h2>
<p>Single-line comments start with <code class="w3-codespan">--</code> and 
continue to the end of line.</p>
<p>Any text after <code class="w3-codespan">--</code> and to the end of the line will be ignored.</p>
...
-- Selects all German 
  customers<br>
SELECT * FROM Customers<br>WHERE Country = 'Germany';
</div>
<a target="_blank" href="trymysql.asp?filename=trysql_comment_single_1" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>

<p>The following example uses a single-line comment to comment away the end of a line:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers -- WHERE City='Berlin';
</div>
<a target="_blank" href="trymysql.asp?filename=trysql_comment_single_2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>

<p>The following example uses a single-line comment to temporarily prevent 
execution of an SQL statement:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<a target="_blank" href="trymysql.asp?filename=trysql_comment_single_3" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>SQL Multi-line Comments</h2>
<p>Multi-line comments start with <code class="w3-codespan">/*</code> and end with 
<code class="w3-codespan">*/</code>.</p>
<p>Any text between <code class="w3-codespan">/*</code> and  
<code class="w3-codespan">*/</code> will be ignored.</p>

<p>The following example uses a multi-line comment as an explanation:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
/* Selects all German customers<br>
  from Berlin */<br>
SELECT * FROM Customers<br>WHERE Country = 'Germany' AND City = 'Berlin';
</div>
<a target="_blank" href="trymysql.asp?filename=trysql_comment_multi_1" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>

<p>The following example uses a multi-line comment to ignore many SQL statements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
/* SELECT * FROM Customers;<br>
...
<a target="_blank" href="trymysql.asp?filename=trysql_comment_multi_2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<p>To ignore just a part of an SQL code, you can also use multi-line comment:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT CustomerName, /*City,*/ Country FROM Customers;
</div>
<a target="_blank" href="trymysql.asp?filename=trysql_comment_part_1" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>

<p>The following example uses a multi-line comment to ignore part of an SQL statement:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<a target="_blank" href="trymysql.asp?filename=trysql_comment_part_2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
