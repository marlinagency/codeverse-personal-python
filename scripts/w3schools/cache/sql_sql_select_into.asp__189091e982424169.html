...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_all.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_insert_into_select.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL SELECT INTO Statement</h2>
<p>The <code class="w3-codespan">SELECT INTO</code> statement is used to create 
a new table and fill it with data from an existing table.</p>
<p>The <code class="w3-codespan">SELECT INTO</code> statement is useful for 
creating backups or for creating a temporary table for analysis.</p>
<p><strong>Note:</strong> The new table will be created with the same column names and 
data types as defined in the source table. However, primary keys, indexes, or NOT NULL
constraints are not automatically transferred.</p>

<h3>SELECT INTO Syntax</h3>
<p>Copy entire table into a new table:</p>

<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT * INTO <em>newtable</em> [IN <em>external_db</em>]<br>
FROM <em>sourcetable</em><br>
...
INTO <em>newtable</em> [IN <em>external_db</em>]<br> 
FROM <em>sourcetable</em><br>
WHERE <em>condition;</em>
</div></div>
<!--stop-->
...
<p>The following SQL creates a backup copy of the &quot;Customers&quot; table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT * INTO CustomersBackup2026<br>
FROM Customers;</div></div>

<p>The following SQL creates a backup copy of the &quot;Customers&quot; table in another database 
('Backup.mdb'):</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT *
INTO CustomersBackup2026 IN 'Backup.mdb'<br>
FROM Customers;</div></div>

<p>The following SQL copies only a few columns from the &quot;Customers&quot; table into a new table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT CustomerName, ContactName INTO Customers2<br>
FROM Customers;</div></div>

<p>The following SQL copies only the customers from USA in the &quot;Customers&quot; 
table, into a new table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT *
INTO US_Customers<br>
FROM Customers<br>
WHERE Country = 'USA';</div></div>

<p>The following SQL copies data from more than one table into a new table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
 SELECT Customers.CustomerName, Orders.OrderID INTO CustomersOrder<br>FROM Customers<br>
 LEFT JOIN Orders
...
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT * INTO <em>newtable</em><br>FROM <em>sourcetable</em><br>WHERE 1 = 0;</div>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_select_into.js"></div>
<hr>
