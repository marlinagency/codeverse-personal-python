...
<html lang="en-US">
<head>
<title>Python Inner Classes</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Inner Classes</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_encapsulation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_file_handling.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Python Inner Classes</h2>

<p>An inner class is a class defined inside another class. The inner class can access the properties and methods of the outer class.</p>

<p>Inner classes are useful for grouping classes that are only used in one place, making your code more organized.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create an inner class:</p>
<div class="w3-code notranslate pythonHigh">
class Outer:<br>&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp; self.name = "Outer Class"<br><br>&nbsp; class Inner:<br>&nbsp;&nbsp;&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.name = "Inner Class"<br><br>&nbsp;&nbsp;&nbsp; def display(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("This is the inner class")<br><br>outer = Outer()<br>print(outer.name)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_inner_class1">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Accessing Inner Class from the Outside</h2>

<p>To access the inner class, create an object of the outer class, and then create an object of the inner class:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Access the inner class and create an object:</p>
<div class="w3-code notranslate pythonHigh">
class Outer:<br>&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp; self.name = "Outer"<br><br>&nbsp; class Inner:<br>&nbsp;&nbsp;&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.name = "Inner"<br><br>&nbsp;&nbsp;&nbsp; def display(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Hello from inner class")<br><br>outer = Outer()<br>inner = outer.Inner()<br>inner.display()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_inner_class2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Accessing Outer Class from Inner Class</h2>

<p>Inner classes in Python do not automatically have access to the outer class instance.</p>

<p>If you want the inner class to access the outer class, you need to pass the outer class instance as a parameter:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Pass the outer class instance to the inner class:</p>
<div class="w3-code notranslate pythonHigh">
class Outer:<br>&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp; self.name = "Emil"<br><br>&nbsp; class Inner:<br>&nbsp;&nbsp;&nbsp; def __init__(self, outer):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.outer = outer<br><br>&nbsp;&nbsp;&nbsp; def display(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print(f"Outer class name: {self.outer.name}")<br><br>outer = Outer()<br>inner = outer.Inner(outer)<br>inner.display()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_inner_class_access">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Inner classes are useful for creating helper classes that are only used within the context of the outer class:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use an inner class to represent a car's engine:</p>
<div class="w3-code notranslate pythonHigh">
class Car:<br>&nbsp; def __init__(self, brand, model):<br>&nbsp;&nbsp;&nbsp; self.brand = brand<br>&nbsp;&nbsp;&nbsp; self.model = model<br>&nbsp;&nbsp;&nbsp; self.engine = self.Engine()<br><br>&nbsp; class Engine:<br>&nbsp;&nbsp;&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.status = "Off"<br><br>&nbsp;&nbsp;&nbsp; def start(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.status = "Running"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Engine started")<br><br>&nbsp;&nbsp;&nbsp; def stop(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; self.status = "Off"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Engine stopped")<br><br>&nbsp; def drive(self):<br>&nbsp;&nbsp;&nbsp; if self.engine.status == "Running":<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print(f"Driving the {self.brand} {self.model}")<br>&nbsp;&nbsp;&nbsp; else:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Start the engine first!")<br><br>car = Car("Toyota", "Corolla")<br>car.drive()<br>car.engine.start()<br>car.drive()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_inner_class_car">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Multiple Inner Classes</h2>

<p>A class can have multiple inner classes:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create multiple inner classes:</p>
<div class="w3-code notranslate pythonHigh">
class Computer:<br>&nbsp; def __init__(self):<br>&nbsp;&nbsp;&nbsp; self.cpu = self.CPU()<br>&nbsp;&nbsp;&nbsp; self.ram = self.RAM()<br><br>&nbsp; class CPU:<br>&nbsp;&nbsp;&nbsp; def process(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Processing data...")<br><br>&nbsp; class RAM:<br>&nbsp;&nbsp;&nbsp; def store(self):<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; print("Storing data...")<br><br>computer = Computer()<br>computer.cpu.process()<br>computer.ram.store()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_inner_class_multiple">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_class_inner.js"></div>
<hr>
