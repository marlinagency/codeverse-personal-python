...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="sql_parameterized_queries.asp">Next &#10095;</a>
</div>
<hr>

<h2>SQL Injection</h2>
<p>SQL injection is a code injection technique that can destroy your database. SQL injections 
are a common web hacking technique.</p>
<p>SQL injections are when attackers insert malicious SQL code into user-input fields, and this way can read, modify, or delete sensitive data in 
a database.</p>
<p>SQL injections usually occur when you ask a user for input, like  
username/userid, and instead of giving a name/id, the attacker inserts an SQL 
command 
that executes something in your database.</p>
...
<p>The next chapters show the most effective methods to <strong>prevent SQL 
injections</strong>, using <a href="sql_parameterized_queries.asp">SQL 
Parameters</a> and <a href="sql_prepared_statements.asp">SQL Prepared Statements</a>.</p>
<hr>

<h2>SQL Injection Based on 1=1 is Always True</h2>
<p>Look at the example above again. The original purpose of the SQL code was to select a 
...
<h2>SQL Injection Based on OR &quot;&quot;=&quot;&quot; is Always True</h2>
...
<p>The SQL statement will now look like this:</p>
<div class="w3-example">
<h3>Result</h3>
<div class="w3-code notranslate sqlHigh">
...
<h2>SQL Injection From Batched SQL Statements</h2>
<p>Batched SQL statements is a group of two or more SQL statements, separated by semicolons.</p>
