...
<a class="w3-left w3-btn" href="sql_where.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_and.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL ORDER BY</h2>
<p>The <code class="w3-codespan">ORDER BY</code> keyword is used to sort the result-set in ascending or 
descending order.</p>
<p>The <code class="w3-codespan">ORDER BY</code> keyword sorts the result-set in ascending order 
(ASC) by default.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort the products from lowest to highest price:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>
 ORDER BY Price;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby_price" class="w3-btn w3-margin-bottom">
...
<!--start-->
<h2>ORDER BY DESC</h2>
<p>&nbsp;To sort the records in descending order, use the <code class="w3-codespan">
DESC</code> keyword.</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby_price_desc" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Order Alphabetically</h2>

<p>For string values, the <code class="w3-codespan">ORDER BY</code> keyword will 
sort the values in the column alphabetically:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort the ProductName column in alphabetically order:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>
 ORDER BY ProductName;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby_name" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Alphabetically DESC</h2>

<p>To sort the text values in a column in a descending order, use the <code class="w3-codespan">DESC</code> keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort the ProductName column in descending alphabetically order:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>
 ORDER BY ProductName DESC;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby_name_desc" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>ORDER BY Several Columns</h2>
<p>The following SQL statement selects all customers from the "Customers" table 
- and sorts it by the "Country" and the "CustomerName" column.</p>
<p>This means that it sorts it first 
...
<hr>
<!--start-->
<h2>Combine ASC and DESC</h2>
<p>The following SQL statement selects all customers from the "Customers" table, 
and sorts it ASCENDING by the "Country" and DESCENDING by the "CustomerName" column:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_orderby.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL ORDER BY Keyword</h2>
  <a href="https://youtu.be/uUO-ynRJKo0&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_order_by.webp" type="image/webp" />
        <img src="images/img_sql_order_by.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
