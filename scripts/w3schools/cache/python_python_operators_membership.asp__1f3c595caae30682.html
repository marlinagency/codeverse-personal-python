...
<h1>Python <span class="color_h1">Membership Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_identity.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_operators_bitwise.asp">Next &#10095;</a>
</div>
<hr>
...
<td>x in y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_membership1">Try it &raquo;</a></td>
</tr>
<tr>
<td>not in</td>
<td>Returns True if a sequence with the specified value is not present in the object</td>
<td>x not in y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_membership2">Try it &raquo;</a></td>
</tr>
</table>
...
<h3>Example</h3>
<p>Check if "banana" is present in a list:</p>
<div class="w3-code notranslate pythonHigh">
fruits = ["apple", "banana", "cherry"]<br>
<br>
print("banana" in fruits)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_membership_in">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Check if "pineapple" is NOT present in a list:</p>
<div class="w3-code notranslate pythonHigh">
fruits = ["apple", "banana", "cherry"]<br>
<br>
print("pineapple" not in fruits)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_membership_not_in">Try it Yourself &raquo;</a>
</div>
...
<h2>Membership in Strings</h2>

<p>The membership operators also work with strings:</p>
...
<br>
print("H" in text)<br>
print("hello" in text)<br>
print("z" not in text)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_membership_string">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_membership.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_identity.asp">&#10094; Previous</a>
