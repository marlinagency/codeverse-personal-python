...
<h1>Python <span class="color_h1">Ternary Operator</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_assign.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_operators_comparison.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Ternary Operator</h2>

<p>The ternary operator allows you to assign one value if a condition is true, and another if it is false:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Assign a value to <code class="w3-codespan">x</code>:</p>
<p>Assign the value "WEEKEND!" if the number is higher than 5, otherwise "Workday":</p>
<div class="w3-code notranslate pythonHigh">
num = 6<br>
<br>
x = "WEEKEND!" if num > 5 else "Workday"<br>
<br>
print(x)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_ternary">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p><b>Note:</b> The ternary operator is not an actual operator, it is a <i>conditional expression</i>,
or a <a href="python_if_shorthand.asp">shorthand if statement</a>.</p>
</div>

<hr>

<h2>Instead of Elif:</h2>

<p>The ternary operator can be used instead of <code class="w3-codespan"><a href="python_if_elif.asp">elif</a></code> in longer if statements:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Assign:<br>
- "Fri" if <code class="w3-codespan">num</code> is 5<br>
- "Sat" if <code class="w3-codespan">num</code> is 6<br>
- "Sun" if <code class="w3-codespan">num</code> is 7<br>
- otherwise assign "weekday":</p>
<div class="w3-code notranslate pythonHigh">
num = 6<br>
<br>
x = "Fri" if num == 5 else "Sat" if num == 6 else "Sun" if num == 7 else "weekday"<br>
<br>
print(x)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_ternary2">Try it Yourself &raquo;</a>
</div>
