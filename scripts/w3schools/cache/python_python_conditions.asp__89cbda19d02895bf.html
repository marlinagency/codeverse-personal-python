...
<h1>Python <span class="color_h1">If Statement</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_challenges_dictionaries_basics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_if_elif.asp">Next &#10095;</a>
</div>
<hr>
...
<p>An "if statement" is written by using the <span class="w3-codespan"><a href="ref_keyword_if.asp">if</a></span> keyword.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if2">Try it Yourself &raquo;</a>
</div>
...
<h2>How If Statements Work</h2>

<p>The if statement evaluates a condition (an expression that results in <span class="w3-codespan">True</span> or <span class="w3-codespan">False</span>). If the condition is true, the code block inside the if statement is executed. If the condition is false, the code block is skipped.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Checking if a number is positive:</p>
<div class="w3-code notranslate pythonHigh">
number = 15<br>
if number &gt; 0:<br>&nbsp; print("The number is positive")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_positive">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_error">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> You can use spaces or tabs for indentation, but you must use the same amount of indentation for all statements within the same code block.</p>
</div>

<hr>

<h2>Multiple Statements in If Block</h2>

<p>You can have multiple statements inside an if block. All statements must be indented at the same level.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Multiple statements in an if block:</p>
<div class="w3-code notranslate pythonHigh">
age = 20<br>
if age &gt;= 18:<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_multiple">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Using Variables in Conditions</h2>

<p>Boolean variables can be used directly in if statements without comparison operators.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using a boolean variable:</p>
<div class="w3-code notranslate pythonHigh">
is_logged_in = True<br>
if is_logged_in:<br>
&nbsp; print("Welcome back!")
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_if_boolean">Try it Yourself &raquo;</a>
</div>

<p>Python can evaluate many types of values as <span class="w3-codespan">True</span> or <span class="w3-codespan">False</span> in an if statement.</p>
<p>Zero (<span class="w3-codespan">0</span>), empty strings (<span class="w3-codespan">""</span>), <span class="w3-codespan">None</span>, and empty collections are treated as <span class="w3-codespan">False</span>. Everything else is treated as <span class="w3-codespan">True</span>.</p>
<p>This includes positive numbers (<span class="w3-codespan">5</span>), negative numbers (<span class="w3-codespan">-3</span>), and any non-empty string (even <span class="w3-codespan">"False"</span> is treated as <span class="w3-codespan">True</span> because it's a non-empty string).</p>

<hr>
<div id="exercisecontainer" src="xrcise_conditions.js"></div>
<hr>
