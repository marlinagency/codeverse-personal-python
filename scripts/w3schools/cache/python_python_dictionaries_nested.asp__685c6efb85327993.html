...
<html lang="en-US">
<head>
<title>Python - Nested Dictionaries</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Nested Dictionaries</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dictionaries_copy.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dictionaries_methods.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Nested Dictionaries</h2>
<p>A dictionary can contain dictionaries, this is called nested 
dictionaries.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  &nbsp;&nbsp;&nbsp; &quot;year&quot; : 2011<br>&nbsp; }<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_nested">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<p>Or, if you want to add three dictionaries into a new 
dictionary:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_nested2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Access Items in Nested Dictionaries</h2>
<p>To access items from a nested dictionary, you use the name of the dictionaries, starting with the 
outer dictionary:</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Print the name of child 2:</p>
<div class="w3-code notranslate pythonHigh">
  print(myfamily["child2"]["name"]) </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_nested_access">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Loop Through Nested Dictionaries</h2>

<p>You can loop through a dictionary by using the <code class="w3-codespan"><a href="ref_dictionary_items.asp">items()</a></code> method like this:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through the keys and values of all nested dictionaries:</p>
<div class="w3-code notranslate pythonHigh">
for x, obj in myfamily.items():<br>
&nbsp;&nbsp;print(x)<br>
<br>    
&nbsp;&nbsp;for y in obj:<br>
&nbsp;&nbsp;&nbsp;&nbsp;print(y + ':', obj[y])
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_nested_loop">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_dictionaries_nested.js"></div>
<hr>
