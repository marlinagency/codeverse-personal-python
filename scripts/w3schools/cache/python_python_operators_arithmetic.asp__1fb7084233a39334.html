...
<h1>Python <span class="color_h1">Arithmetic Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_operators_assign.asp">Next &#10095;</a>
</div>
<hr>
...
<td>Addition</td>
<td>x + y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_add">Try it &raquo;</a></td>
</tr>
<tr>
<td>-</td>
<td>Subtraction</td>
<td>x - y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_sub">Try it &raquo;</a></td>
</tr>
<tr>
<td>*</td>
<td>Multiplication</td>
<td>x * y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_mult">Try it &raquo;</a></td>
</tr>
<tr>
<td>/</td>
<td>Division</td>
<td>x / y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_div">Try it &raquo;</a></td>
</tr>
<tr>
<td>%</td>
<td>Modulus</td>
<td>x % y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_mod">Try it &raquo;</a></td>
</tr>
  <tr>
<td>**</td>
<td>Exponentiation</td>
<td>x ** y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_exp">Try it &raquo;</a></td>
  </tr>
<tr>
<td>//</td>
<td>Floor division</td>
<td>x // y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_floordiv">Try it &raquo;</a></td>
</tr>
</table>
...
<p>Here is an example using different arithmetic operators:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_arithmetic_all">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Division in Python</h2>

<p>Python has two division operators:</p>

<ul>
  <li><strong>/</strong> - Division (returns a float)</li>
  <li><strong>//</strong> - Floor division (returns an integer)</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Division always returns a float:</p>
<div class="w3-code notranslate pythonHigh">
x = 12<br>
y = 5<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_division">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Floor division always returns an integer.</p>
<p>It rounds DOWN to the nearest integer:</p>
<div class="w3-code notranslate pythonHigh">
x = 12<br>
y = 5<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_floor_division">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_arithmetic.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators.asp">&#10094; Previous</a>
