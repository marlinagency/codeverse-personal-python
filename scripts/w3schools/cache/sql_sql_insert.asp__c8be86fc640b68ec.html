...
<a class="w3-left w3-btn" href="sql_not.asp">&#10094; Previous</a>
...
<p>It is possible to write the <code class="w3-codespan">INSERT INTO</code> statement in two ways:</p>
<h3>Syntax 1</h3>
<p>Specify both the column names and the values to be inserted:</p>
...
<h3>Syntax 2</h3>
<p>If you insert values for ALL the columns of the table, you can omit the column names.</p>
<p>However, the order of the values must be in the same order as the columns in the table:</p>
<div class="w3-example ws-light-grey">
<p><code class="sqlHigh">
...
<p>Here we insert values for ALL the columns of the table, so we omit the column names.</p>
...
<p>The last record in the &quot;Customers&quot; table will now look like this:</p>
<div class="w3-responsive">
<table class="ws-table-all notranslate">
  <tr>
    <th>CustomerID</th>
...
<p><strong>Notice that we did not insert any number into the CustomerID field!</strong></p>
<p>The CustomerID column is an <a href="sql_autoincrement.asp">auto-increment</a> field and will be
automatically generated when a new record is inserted.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Insert Data Only in Specific Columns</h2>
<p>Here we insert values only in some specific columns of the table.</p>
<p>The following SQL inserts a new record - but only inserts data in the &quot;CustomerName&quot;,
...
<p>To insert multiple rows of data, we use the same <code class="w3-codespan">INSERT INTO</code> statement, but with multiple values:</p>
<p>The following SQL inserts three new records in the &quot;Customers&quot; table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
INSERT INTO Customers (CustomerName, ContactName, Address, City, PostalCode, Country)<br>
VALUES<br>
('Cardinal', 'Tom B. Erichsen', 'Skagen 21', 'Stavanger', '4006', 'Norway'),<br>
('Greasy Burger', 'Per Olsen', 'Gateveien 15', 'Sandnes', '4306', 'Norway'),<br>
('Tasty Tee', 'Finn Egan', 'Streetroad 19B', 'Liverpool', 'L1 0AA', 'UK');
</div>
</div>
<p><b>Note:</b> Make sure you separate each set of values with a comma <code class="w3-codespan">,</code>.</p>
<p>The last three records in the &quot;Customers&quot; table will now look like this:</p>
<div class="w3-responsive">
<table class="ws-table-all notranslate">
  <tr>
    <th>CustomerID</th>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_insert.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL INSERT INTO</h2>
  <a href="https://youtu.be/Dndsh1dcx-U&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_insert_into.webp" type="image/webp" />
        <img src="images/img_sql_insert_into.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
