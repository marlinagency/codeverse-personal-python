...
<h1>Python - Loop Lists</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_lists_remove.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_comprehension.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Loop Through a List</h2>

<p>You can loop through the list items by using a <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> 
loop:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_loop">Try it Yourself &raquo;</a>
</div>

<p>Learn more about <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loops in our <a href="python_for_loops.asp">Python For Loops</a> Chapter.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Loop Through the Index Numbers</h2>
<p>You can also loop through the list items by referring to their index number.</p>

<p>Use the <code class="w3-codespan"><a href="ref_func_range.asp">range()</a></code> and
<code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> functions to create a suitable iterable.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Print all items by referring to their index number:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>for i 
  in range(len(thislist)):<br>
&nbsp;
print(thislist[i])</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_loop2">Try it Yourself &raquo;</a>
</div>

<p>The iterable created in the example above is <code class="w3-codespan">[0, 1, 2]</code>.</p>
<!--stop-->
<hr>
...
<p>You can loop through the list items by using a <code class="w3-codespan"><a href="ref_keyword_while.asp">while</a></code> loop.</p>

<p>Use the <code class="w3-codespan"><a href="ref_func_len.asp">len()</a></code> function to determine the length of the list,
then start at 0 and loop your way through the list items by referring to their indexes.</p>

<p>Remember to increase the index by 1 after each iteration.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Print all items, using a <code class="w3-codespan"><a href="ref_keyword_while.asp">while</a></code> loop to go 
  through all the index numbers</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>i = 0<br>
  while i &lt; len(thislist):<br>
&nbsp;
print(thislist[i])<br>&nbsp; i = i + 1</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_while_loop">Try it Yourself &raquo;</a>
</div>

<p>Learn more about <code class="w3-codespan"><a href="ref_keyword_while.asp">while</a></code> loops in our 
<a href="python_while_loops.asp">Python While Loops</a> Chapter.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Looping Using List Comprehension</h2>

<p>List Comprehension offers the shortest syntax for looping through lists:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>A short hand <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> loop that will print all items in a list:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>[print(x) for x in thislist]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_loop_comprehensive">Try it Yourself &raquo;</a>
</div>

<p>Learn more about list comprehension in the next chapter:
<a href="python_lists_comprehension.asp">List Comprehension</a>.</p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_lists_loop.js"></div>
<hr>
