...
<html lang="en-US">
<head>
<title>Python Standard Library Modules (3.13)</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Python Built-in Modules</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_ref_glossary.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="module_random.asp">Next &#10095;</a>
</div>

<hr>

<p>This page lists the built-in modules that ship with the Python 3.13 Standard Library.</p>
<p>These modules are available without extra installation (some are platform-dependent).</p>

<hr>

  <h2 id="A">A</h2>
  <table class="ws-table-all notranslate module-table">
  <tr>
  <th style="width:25%">Module</th>
  <th>Description</th>
  <th style="width:12%">Introduced</th>
  </tr>
  <tr><td><a href="ref_module_abc.asp">abc</a></td><td>Tools for defining Abstract Base Classes (interfaces for Python classes).</td><td>2.6</td></tr>
  <tr><td><a href="ref_module_aifc.asp">aifc</a></td><td>Read and write AIFF/AIFF-C audio files.</td><td>1.5.2</td></tr>
  <tr><td><a href="ref_module_argparse.asp">argparse</a></td><td>Parse command line arguments and create user-friendly CLIs.</td><td>2.7</td></tr>
  <tr><td><a href="ref_module_array.asp">array</a></td><td>Efficient arrays of basic numeric types (compact alternative to lists).</td><td>1.0</td></tr>
  <tr><td><a href="ref_module_ast.asp">ast</a></td><td>Work with Python code as an Abstract Syntax Tree (analyze or transform code).</td><td>2.6</td></tr>
  <tr><td><a href="ref_module_asyncio.asp">asyncio</a></td><td>Write concurrent code using the async/await syntax (event loop, tasks, IO).</td><td>3.4</td></tr>
  <tr><td><a href="ref_module_atexit.asp">atexit</a></td><td>Register functions to run automatically when the program exits.</td><td>2.0</td></tr>
  </table>
...
<hr>
  ...
  <tr><td><a href="ref_module_base64.asp">base64</a></td><td>Encode and decode data using Base16, Base32, Base64, etc.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_bdb.asp">bdb</a></td><td>Debugger framework used by pdb (implements the core debugging logic).</td><td>-</td></tr>
  <tr><td><a href="ref_module_binascii.asp">binascii</a></td><td>Convert between binary and ASCII (hex, base64 helpers at C speed).</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_bisect.asp">bisect</a></td><td>Maintain sorted lists; insert and search with binary search.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_builtins.asp">builtins</a></td><td>Access Python's built-in objects like len, range, and exceptions.</td><td>3.0</td></tr>
  <tr><td><a href="ref_module_bz2.asp">bz2</a></td><td>Read and write bzip2-compressed files and streams.</td><td>2.3</td></tr>
  </table>
...
<hr>
  ...
  <tr><td><a href="ref_module_calendar.asp">calendar</a></td><td>Work with dates as calendars; print text calendars and compute month info.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_cgi.asp">cgi</a></td><td>Helpers for Common Gateway Interface (legacy web server scripts).</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_cgitb.asp">cgitb</a></td><td>Pretty tracebacks for CGI scripts (HTML formatted error reports).</td><td>-</td></tr>
  <tr><td><a href="ref_module_cmd.asp">cmd</a></td><td>Build simple line-oriented command interpreters (REPL-like shells).</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_code.asp">code</a></td><td>Run an interactive interpreter or embed one in your program.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_codecs.asp">codecs</a></td><td>Text encodings and decoding/encoding helpers.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_codeop.asp">codeop</a></td><td>Compile Python code objects conditionally (used by code editors and shells).</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_collections.asp">collections</a></td><td>High-performance container datatypes like deque, Counter, namedtuple.</td><td>2.4</td></tr>
  <tr><td><a href="ref_module_colorsys.asp">colorsys</a></td><td>Convert between color systems: RGB, YIQ, HLS, HSV.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_concurrent.asp">concurrent</a></td><td>Concurrency framework (futures) for running callables asynchronously.</td><td>3.2</td></tr>
  <tr><td><a href="ref_module_configparser.asp">configparser</a></td><td>Read and write INI-style configuration files.</td><td>3.0</td></tr>
  <tr><td><a href="ref_module_contextlib.asp">contextlib</a></td><td>Utilities for context managers and the with-statement.</td><td>2.5</td></tr>
  <tr><td><a href="ref_module_contextvars.asp">contextvars</a></td><td>Context-local storage for async code (like thread-local, but for tasks).</td><td>3.7</td></tr>
  <tr><td><a href="ref_module_copy.asp">copy</a></td><td>Shallow and deep copy operations for Python objects.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_copyreg.asp">copyreg</a></td><td>Register custom pickling functions for complex objects.</td><td>3.0</td></tr>
  <tr><td><a href="ref_module_csv.asp">csv</a></td><td>Read and write CSV files (comma-separated values) with ease.</td><td>2.3</td></tr>
  <tr><td><a href="ref_module_ctypes.asp">ctypes</a></td><td>Call C libraries and work with C-compatible data types.</td><td>2.5</td></tr>
  <tr><td><a href="ref_module_curses.asp">curses</a></td><td>Terminal handling for character-cell UIs (Unix-like systems only).</td><td>2.0</td></tr>
  </table>
...
<hr>
  ...
  <tr><td><a href="ref_module_dataclasses.asp">dataclasses</a></td><td>Decorator and helpers for classes that store data (auto-generate init, repr, etc.).</td><td>3.7</td></tr>
  <tr><td><a href="ref_module_datetime.asp">datetime</a></td><td>Dates, times, time zones, and timedeltas made simple and precise.</td><td>2.3</td></tr>
  <tr><td><a href="ref_module_dbm.asp">dbm</a></td><td>Family of simple on-disk key/value databases (backed by platform libs).</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_decimal.asp">decimal</a></td><td>Fixed-point and floating decimal arithmetic for money and exact math.</td><td>2.4</td></tr>
  <tr><td><a href="ref_module_difflib.asp">difflib</a></td><td>Compare sequences and create human-readable diffs.</td><td>2.1</td></tr>
  <tr><td><a href="ref_module_dis.asp">dis</a></td><td>Disassemble Python bytecode for inspection and debugging.</td><td>2.0</td></tr>
  <tr><td><a href="ref_module_doctest.asp">doctest</a></td><td>Test examples embedded in docstrings (keeps docs and code in sync).</td><td>2.1</td></tr>
  </table>
...
<tr><td><a href="ref_module_email.asp">email</a></td><td>Parse, build, and send email messages (headers, MIME, attachments).</td><td>2.2</td></tr>
<tr><td><a href="ref_module_encodings.asp">encodings</a></td><td>Implementation of text encodings used by Python's codec system.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_ensurepip.asp">ensurepip</a></td><td>Bootstraps pip into a Python installation.</td><td>3.4</td></tr>
<tr><td><a href="ref_module_enum.asp">enum</a></td><td>Define enumerations (named constants) with nice semantics.</td><td>3.4</td></tr>
<tr><td><a href="ref_module_errno.asp">errno</a></td><td>Standard error number constants from the OS.</td><td>2.0</td></tr>
</table>
...
<tr><td><a href="ref_module_faulthandler.asp">faulthandler</a></td><td>Dump Python tracebacks on a crash or on demand (helps debug hard faults).</td><td>3.3</td></tr>
<tr><td><a href="ref_module_filecmp.asp">filecmp</a></td><td>Compare files and directories to see what changed.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_fileinput.asp">fileinput</a></td><td>Loop over lines from stdin or a list of files as a single stream.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_fnmatch.asp">fnmatch</a></td><td>Match filenames using shell-style wildcards.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_fractions.asp">fractions</a></td><td>Rational numbers (Fractions) for exact arithmetic.</td><td>2.6</td></tr>
<tr><td><a href="ref_module_ftplib.asp">ftplib</a></td><td>FTP client library for transferring files.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_functools.asp">functools</a></td><td>Higher-order functions and utilities (lru_cache, partial, wraps, etc.).</td><td>2.5</td></tr>
</table>
...
<tr><td><a href="ref_module_gc.asp">gc</a></td><td>Control the garbage collector and inspect tracked objects.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_getopt.asp">getopt</a></td><td>Parse command-line options (POSIX-style).</td><td>1.5.2</td></tr>
<tr><td><a href="ref_module_getpass.asp">getpass</a></td><td>Prompt for a password without echoing it to the console.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_gettext.asp">gettext</a></td><td>Internationalization (i18n) support for translating messages.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_glob.asp">glob</a></td><td>Find pathnames matching a pattern like *.py.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_graphlib.asp">graphlib</a></td><td>Topological sorting utilities for dependency graphs.</td><td>3.9</td></tr>
<tr><td><a href="ref_module_gzip.asp">gzip</a></td><td>Read and write gzip-compressed files and streams.</td><td>2.0</td></tr>
</table>
...
<tr><td><a href="ref_module_hashlib.asp">hashlib</a></td><td>Secure hashes and message digests (SHA, MD5, BLAKE2, etc.).</td><td>2.5</td></tr>
<tr><td><a href="ref_module_heapq.asp">heapq</a></td><td>Heap queue (priority queue) algorithms on plain lists.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_hmac.asp">hmac</a></td><td>Keyed-hash message authentication codes (HMAC).</td><td>2.2</td></tr>
<tr><td><a href="ref_module_html.asp">html</a></td><td>HTML helpers (escape/unescape text).</td><td>3.2</td></tr>
<tr><td><a href="ref_module_http.asp">http</a></td><td>HTTP modules package (client, server, cookies).</td><td>3.0</td></tr>
</table>
...
<tr><td><a href="ref_module_idlelib.asp">idlelib</a></td><td>Support for the IDLE interactive Python environment.</td><td>-</td></tr>
<tr><td><a href="ref_module_imaplib.asp">imaplib</a></td><td>IMAP4 client library for accessing email servers.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_imghdr.asp">imghdr</a></td><td>Determine the type of an image file.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_imp.asp">imp</a></td><td>Access the import internals (deprecated; use <span class="w3-codespan">importlib</span>).</td><td>-</td></tr>
<tr><td><a href="ref_module_importlib.asp">importlib</a></td><td>Programmatic interface to Python's import mechanism.</td><td>3.1</td></tr>
<tr><td><a href="ref_module_inspect.asp">inspect</a></td><td>Inspect live objects such as modules, classes, and functions.</td><td>-</td></tr>
<tr><td><a href="ref_module_io.asp">io</a></td><td>Input/Output streams and buffering (text and binary).</td><td>2.6</td></tr>
</table>
...
<tr><td><a href="ref_module_json.asp">json</a></td><td>Encode and decode JSON data (JavaScript Object Notation).</td><td>2.6</td></tr>
</table>
...
<tr><td><a href="ref_module_keyword.asp">keyword</a></td><td>Test for Python keywords; list all keywords.</td><td>-</td></tr>
</table>
...
<tr><td><a href="ref_module_linecache.asp">linecache</a></td><td>Read text lines from files with random access.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_locale.asp">locale</a></td><td>Internationalization (i18n) support for formatting numbers and dates.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_logging.asp">logging</a></td><td>Flexible event logging system with various handlers.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_lzma.asp">lzma</a></td><td>Compression using the LZMA algorithm (xz format).</td><td>3.3</td></tr>
</table>
...
<tr><td><a href="ref_module_mailbox.asp">mailbox</a></td><td>Work with various mailbox formats (mbox, Maildir, etc.).</td><td>2.3</td></tr>
<tr><td><a href="ref_module_mailcap.asp">mailcap</a></td><td>Read mailcap files (MIME handlers configuration).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_marshal.asp">marshal</a></td><td>Read and write Python values in a binary format (for .pyc internals).</td><td>-</td></tr>
<tr><td><a href="ref_module_math.asp">math</a></td><td>Fast math functions: trigonometry, logarithms, constants, etc.</td><td>-</td></tr>
<tr><td><a href="ref_module_mimetypes.asp">mimetypes</a></td><td>Guess a file's type based on its filename or URL.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_mmap.asp">mmap</a></td><td>Memory-map files for efficient random access.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_modulefinder.asp">modulefinder</a></td><td>Find modules used by a script (dependency scanning).</td><td>-</td></tr>
<tr><td><a href="ref_module_msilib.asp">msilib</a></td><td>Create and read Microsoft Installer (.msi) files (Windows only).</td><td>-</td></tr>
<tr><td><a href="ref_module_msvcrt.asp">msvcrt</a></td><td>Access to Microsoft C runtime routines (Windows only).</td><td>-</td></tr>
<tr><td><a href="ref_module_multiprocessing.asp">multiprocessing</a></td><td>Run code in parallel using processes (bypass the GIL).</td><td>2.6</td></tr>
</table>
...
<tr><td><a href="ref_module_netrc.asp">netrc</a></td><td>Parse .netrc files for machine login credentials.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_nntplib.asp">nntplib</a></td><td>Client for NNTP (Usenet) news servers.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_numbers.asp">numbers</a></td><td>Abstract base classes for numeric types.</td><td>2.6</td></tr>
<tr><td><a href="ref_module_nis.asp">nis</a></td><td>Interface to Sun's NIS (Yellow Pages) service (Unix platforms).</td><td>-</td></tr>
<tr><td><a href="ref_module_ntpath.asp">ntpath</a></td><td>Windows path operations (used by os.path on Windows).</td><td>2.0</td></tr>
</table>
...
<tr><td><a href="ref_module_operator.asp">operator</a></td><td>Functional interface to operators (add, mul, itemgetter, attrgetter).</td><td>1.5.2</td></tr>
<tr><td><a href="ref_module_optparse.asp">optparse</a></td><td>Deprecated parser for command line options (use argparse).</td><td>2.3</td></tr>
<tr><td><a href="ref_module_os.asp">os</a></td><td>Operating system interfaces: files, environment, processes.</td><td>-</td></tr>
</table>
<hr>
...
<tr><td><a href="ref_module_pathlib.asp">pathlib</a></td><td>Object-oriented filesystem paths.</td><td>3.4</td></tr>
<tr><td><a href="ref_module_pdb.asp">pdb</a></td><td>Interactive debugger for Python programs.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pickle.asp">pickle</a></td><td>Serialize and deserialize Python objects (not secure against untrusted data).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pickletools.asp">pickletools</a></td><td>Tools for analyzing pickled data.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_pipes.asp">pipes</a></td><td>Pipe shell commands together (Unix).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pkgutil.asp">pkgutil</a></td><td>Utilities for packages: walk packages, find loaders, etc.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_platform.asp">platform</a></td><td>Access to underlying platform information.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_plistlib.asp">plistlib</a></td><td>Read and write Apple .plist files.</td><td>2.6</td></tr>
<tr><td><a href="ref_module_poplib.asp">poplib</a></td><td>POP3 email client.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_posix.asp">posix</a></td><td>POSIX APIs (Unix-only, low-level).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pprint.asp">pprint</a></td><td>Pretty-print Python data structures.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_profile.asp">profile</a></td><td>Deterministic profiling of Python programs.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pstats.asp">pstats</a></td><td>Work with profiling results produced by profile/cProfile.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pty.asp">pty</a></td><td>Pseudo-terminal utilities (Unix).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pyclbr.asp">pyclbr</a></td><td>Read module to get class browser information without importing it.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_pydoc.asp">pydoc</a></td><td>Generate and view Python documentation.</td><td>2.1</td></tr>
<tr><td><a href="ref_module_py_compile.asp">py_compile</a></td><td>Compile Python source files to bytecode.</td><td>2.0</td></tr>
</table>
...
<tr><td><a href="ref_module_queue.asp">queue</a></td><td>Thread-safe FIFO/LIFO/priority queues.</td><td>2.6</td></tr>
<tr><td><a href="ref_module_quopri.asp">quopri</a></td><td>Encode/decode MIME quoted-printable data.</td><td>2.0</td></tr>
</table>
...
<tr><td><a href="ref_module_random.asp">random</a></td><td>Generate pseudo-random numbers for various distributions.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_re.asp">re</a></td><td>Regular expression operations for pattern matching in strings.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_reprlib.asp">reprlib</a></td><td>Safe string representations for large or recursive structures.</td><td>3.0</td></tr>
<tr><td><a href="ref_module_resource.asp">resource</a></td><td>Control and query system resource limits (Unix).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_rlcompleter.asp">rlcompleter</a></td><td>Tab-completion support for the interactive interpreter.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_runpy.asp">runpy</a></td><td>Run modules as scripts (like python -m).</td><td>2.5</td></tr>
</table>
...
<tr><td><a href="ref_module_sched.asp">sched</a></td><td>Event scheduler for running functions at specific times.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_secrets.asp">secrets</a></td><td>Generate cryptographically strong random numbers and tokens.</td><td>3.6</td></tr>
<tr><td><a href="ref_module_select.asp">select</a></td><td>Low-level I/O multiplexing (select, poll, epoll, kqueue).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_selectors.asp">selectors</a></td><td>High-level I/O multiplexing built on select module.</td><td>3.4</td></tr>
<tr><td><a href="ref_module_shelve.asp">shelve</a></td><td>Simple persistent storage for Python objects (dict-like API).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_shlex.asp">shlex</a></td><td>Parse shell-like syntaxes into tokens.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_shutil.asp">shutil</a></td><td>High-level file operations: copy, move, archive, disk usage.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_signal.asp">signal</a></td><td>Set handlers for asynchronous signals.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_site.asp">site</a></td><td>Site-specific configuration hook that runs at startup.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_smtplib.asp">smtplib</a></td><td>Send emails using the SMTP protocol.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_socket.asp">socket</a></td><td>Low-level networking interface.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_socketserver.asp">socketserver</a></td><td>Framework for network servers (TCP/UDP).</td><td>3.0</td></tr>
<tr><td><a href="ref_module_sqlite3.asp">sqlite3</a></td><td>Built-in lightweight SQL database (SQLite).</td><td>2.5</td></tr>
<tr><td><a href="ref_module_ssl.asp">ssl</a></td><td>TLS/SSL wrapper for secure network connections.</td><td>2.6</td></tr>
<tr><td><a href="ref_module_stat.asp">stat</a></td><td>Constants and helpers for interpreting os.stat() results.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_statistics.asp">statistics</a></td><td>Basic statistics (mean, median, stdev).</td><td>3.4</td></tr>
<tr><td><a href="ref_module_string.asp">string</a></td><td>Common string constants and helpers.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_stringprep.asp">stringprep</a></td><td>String preparation for internet protocols (IDNA).</td><td>2.3</td></tr>
<tr><td><a href="ref_module_struct.asp">struct</a></td><td>Convert between Python values and C structs packed as bytes.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_subprocess.asp">subprocess</a></td><td>Spawn new processes and connect to their input/output/error pipes.</td><td>2.4</td></tr>
<tr><td><a href="ref_module_sunau.asp">sunau</a></td><td>Read and write Sun AU audio files.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_symtable.asp">symtable</a></td><td>Access the compiler's internal symbol tables.</td><td>2.6</td></tr>
<tr><td><a href="ref_module_sys.asp">sys</a></td><td>Access to interpreter variables and functions.</td><td>-</td></tr>
<tr><td><a href="ref_module_sysconfig.asp">sysconfig</a></td><td>Access Python's configuration information.</td><td>3.2</td></tr>
</table>
...
<tr><td><a href="ref_module_tabnanny.asp">tabnanny</a></td><td>Detect ambiguous indentation in Python source files.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_tarfile.asp">tarfile</a></td><td>Read and write tar archives, including gzip/bz2/xz.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_telnetlib.asp">telnetlib</a></td><td>Telnet client implementation.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_tempfile.asp">tempfile</a></td><td>Create temporary files and directories safely.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_termios.asp">termios</a></td><td>POSIX terminal control (Unix).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_test.asp">test</a></td><td>Regression tests package for the Python standard library.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_textwrap.asp">textwrap</a></td><td>Wrap and fill text paragraphs.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_threading.asp">threading</a></td><td>Higher-level threading interface (locks, events, threads).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_time.asp">time</a></td><td>Time access and conversions.</td><td>-</td></tr>
<tr><td><a href="ref_module_timeit.asp">timeit</a></td><td>Measure execution time of small code snippets.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_tkinter.asp">tkinter</a></td><td>Standard GUI toolkit (Tk interface) package.</td><td>3.0</td></tr>
<tr><td><a href="ref_module_token.asp">token</a></td><td>Token constants used by the Python tokenizer.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_tokenize.asp">tokenize</a></td><td>Turn Python source into tokens (lexical scanner).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_tomllib.asp">tomllib</a></td><td>Read TOML files into Python data structures.</td><td>3.11</td></tr>
<tr><td><a href="ref_module_trace.asp">trace</a></td><td>Trace program execution and produce coverage reports.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_traceback.asp">traceback</a></td><td>Print or retrieve stack traces.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_tracemalloc.asp">tracemalloc</a></td><td>Track memory allocations to find leaks and hotspots.</td><td>3.4</td></tr>
<tr><td><a href="ref_module_tty.asp">tty</a></td><td>Terminal control functions (Unix).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_turtle.asp">turtle</a></td><td>Simple graphics library for teaching and fun.</td><td>2.5</td></tr>
<tr><td><a href="ref_module_types.asp">types</a></td><td>Names for built-in types and helper factories.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_typing.asp">typing</a></td><td>Type hints and typing helpers for static analysis and tooling.</td><td>3.5</td></tr>
</table>
...
<tr><td><a href="ref_module_unicodedata.asp">unicodedata</a></td><td>Access the Unicode Character Database (properties, normalization).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_unittest.asp">unittest</a></td><td>Unit testing framework (xUnit style) for Python.</td><td>2.1</td></tr>
<tr><td><a href="ref_module_urllib.asp">urllib</a></td><td>Package for working with URLs (requests, parsing, robots).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_uuid.asp">uuid</a></td><td>Generate universally unique identifiers (UUIDs).</td><td>2.5</td></tr>
</table>
...
<tr><td><a href="ref_module_venv.asp">venv</a></td><td>Create lightweight isolated Python environments.</td><td>3.3</td></tr>
</table>
...
<tr><td><a href="ref_module_warnings.asp">warnings</a></td><td>Issue and control warning messages.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_wave.asp">wave</a></td><td>Read and write WAV audio files.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_weakref.asp">weakref</a></td><td>Weak references to objects (avoid reference cycles).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_webbrowser.asp">webbrowser</a></td><td>Open URLs in a web browser.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_wsgiref.asp">wsgiref</a></td><td>WSGI utilities and simple reference server for web apps.</td><td>2.3</td></tr>
</table>
...
<tr><td><a href="ref_module_xdrlib.asp">xdrlib</a></td><td>Pack and unpack XDR data (External Data Representation).</td><td>2.0</td></tr>
<tr><td><a href="ref_module_xml.asp">xml</a></td><td>XML processing package.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_xmlrpc.asp">xmlrpc</a></td><td>XML-RPC client and server package.</td><td>2.2</td></tr>
</table>
...
<tr><td><a href="ref_module_zipapp.asp">zipapp</a></td><td>Create executable Python zip applications.</td><td>3.5</td></tr>
<tr><td><a href="ref_module_zipfile.asp">zipfile</a></td><td>Read and write ZIP archives.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_zipimport.asp">zipimport</a></td><td>Import modules from ZIP archives.</td><td>2.3</td></tr>
<tr><td><a href="ref_module_zlib.asp">zlib</a></td><td>Compress and decompress data using zlib.</td><td>2.0</td></tr>
<tr><td><a href="ref_module_zoneinfo.asp">zoneinfo</a></td><td>IANA time zone support for datetime.</td><td>3.9</td></tr>
</table>

<hr>

<p><em>Note:</em> This page lists Python 3.13 Standard Library modules. Some modules are platform-specific (Unix/Windows) or optional at build time.</p>
