...
<h1>Python <span class="color_h1">Identity Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_logical.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_operators_membership.asp">Next &#10095;</a>
</div>
<hr>
...
<td>x is y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_identity1">Try it &raquo;</a></td>
</tr>
<tr>
<td>is not</td>
<td>Returns True if both variables are not the same object</td>
<td>x is not y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trypython.asp?filename=demo_oper_identity2">Try it &raquo;</a></td>
</tr>
</table>
...
<h3>Example</h3>
<p>The <code class="w3-codespan">is</code> operator returns <code class="w3-codespan">True</code> if both variables point to the same object:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_identity_example">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">is not</code> operator returns <code class="w3-codespan">True</code> if both variables do not point to the same object:</p>
<div class="w3-code notranslate pythonHigh">
x = ["apple", "banana"]<br>
y = ["apple", "banana"]<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_identity_not">Try it Yourself &raquo;</a>
</div>
...
<h2>Difference Between <code class="w3-codespan">is</code> and <code class="w3-codespan">==</code></h2>

<ul>
  <li><strong>is</strong> - Checks if both variables point to the same object in memory</li>
  <li><strong>==</strong> - Checks if the values of both variables are equal</li>
</ul>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_oper_identity_vs_equal">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_identity.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_operators_logical.asp">&#10094; Previous</a>
