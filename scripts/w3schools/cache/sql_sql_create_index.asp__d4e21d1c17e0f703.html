...
<p>The <code class="w3-codespan">CREATE INDEX</code> statement is used to create indexes 
on tables in databases, to speed up data retrieval.</p>
<p>The users cannot see the indexes, they are just used to speed up searches/queries.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Updating tables with indexes are more time-consuming 
than tables without indexes (because the indexes must also be updated).
So, only create indexes on columns that are frequently searched against.</p>
</div>
<hr>

<h2>Types of Indexes: Non-unique and Unique</h2>
  <p>There are two types of indexes:</p>
  <ul>
    <li><code class="w3-codespan">CREATE INDEX</code> - Creates a non-unique index (duplicate values are allowed)</li>
    <li><code class="w3-codespan">CREATE UNIQUE INDEX</code> - Creates a unique index (duplicate values are not allowed)</li>
  </ul>
...
ON <em>table_name</em> (<em>column1</em>, <em>column2</em>, ...);</div></div>
<p><b>Note:</b> The syntax for creating indexes varies among different databases. 
Check the syntax for creating indexes in your database!</p>
<hr>

<h2>CREATE INDEX Example</h2>
<p>The following SQL creates a non-unique index named &quot;idx_lastname&quot; on the &quot;LastName&quot; column in the &quot;Persons&quot; table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
...
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
CREATE INDEX idx_lname_fname<br>
...
<p>The <code class="w3-codespan">DROP INDEX</code> statement is used to remove an index.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_create_index.js"></div>
<hr>
