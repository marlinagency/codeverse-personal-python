...
<html lang="en-US">
<head>
<title>Python - Output Variables</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Output Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_variables_multiple.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_variables_global.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Output Variables</h2>

<p>The <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function is often used to output variables.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
x = "Python is awesome"<br>
print(x)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_print">Try it Yourself &raquo;</a>
</div>


<p>In the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function, you output multiple 
variables, separated by a comma:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x = &quot;Python&quot;<br>y = &quot;is&quot;<br>z = &quot;awesome&quot;<br>print(x, y, z)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables3">Try it Yourself &raquo;</a>
</div>

<p>You can also use the <code class="w3-codespan">+</code> operator to output 
multiple variables:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
x = &quot;Python &quot;<br>y = &quot;is &quot;<br>z = &quot;awesome&quot;<br>print(x 
  + y + z)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables4">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>Notice the space character after <code class="w3-codespan">"Python "</code> and <code class="w3-codespan">"is "</code>,
  without them the result would be "Pythonisawesome".</p>
</div>
<!--stop-->
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables5">Try it Yourself &raquo;</a>
</div>

<p>In the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function, when you try to 
combine a string and a number with the <code class="w3-codespan">+</code> 
operator, Python will give you an error:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_test">Try it Yourself &raquo;</a>
</div>

<p>The best way to output multiple variables in the <code class="w3-codespan"><a href="ref_func_print.asp">print()</a></code> function is to separate them with commas,
which even support different data types:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_variables_comma">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_variables_output.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Python Output Variables</h2>
  <a href="https://youtu.be/cVUwwZ9IVGI&list=PLP9IO4UYNF0UgPfkTBECSKIJGdc_9FYZ9" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      <div style="position:absolute;top:40%;text-align: center;margin:auto;">
        <picture>
          ...
          <img src="images/yt_logo_rgb_dark.png" style="width:30%;" alt="Python Tutorial on YouTube" loading="lazy">
        </picture>
      </div>
      <picture id="yt_div">
        <source srcset="images/img_python_variables_output.webp" type="image/webp" />
        <img src="images/img_python_variables_output.png" style="max-width:100%;height:auto;border-radius:6px" alt="Python Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
