...
<html lang="en-US">
<head>
<title>Python - Loop Dictionaries</title>
<meta charset="utf-8">
...
<h1>Python - <span class="color_h1">Loop Dictionaries</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dictionaries_remove.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dictionaries_copy.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_loop">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<div class="w3-example">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_loop2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>You can also use the <code class="w3-codespan"><a href="ref_dictionary_values.asp">values()</a></code> method to 
return values of a dictionary:</p>
<div class="w3-code notranslate pythonHigh">
  for x in thisdict.values():<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_loop_values">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<div class="w3-example">
<h3>Example</h3>
<p>You can use the <code class="w3-codespan"><a href="ref_dictionary_keys.asp">keys()</a></code> method to 
return the keys of a dictionary:</p>
<div class="w3-code notranslate pythonHigh">
  for x in thisdict.keys():<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_loop_keys">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through both <em>keys</em> and <em>values</em>, by using the
<code class="w3-codespan"><a href="ref_dictionary_items.asp">items()</a></code> method:</p>
<div class="w3-code notranslate pythonHigh">
  for x, y in thisdict.items():<br>&nbsp; print(x, y)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dictionary_loop_items">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_dictionaries_loop.js"></div>
<hr>
