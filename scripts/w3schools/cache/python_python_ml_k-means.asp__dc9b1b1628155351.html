...
<html lang="en-US">
<head>
<title>Python Machine Learning - K-means</title>
<meta charset="utf-8">
...
<h1>Machine Learning - K-means</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_ml_preprocessing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_ml_bagging.asp">Next &#10095;</a>
</div>
<hr>

<h2>K-means</h2>

<p>K-means is an unsupervised learning method for clustering data points. The algorithm iteratively divides data points into K clusters by minimizing the variance in each cluster.</p>

<p>Here, we will show you how to estimate the best value for K using the elbow method, then use K-means clustering to group the data points into clusters.</p>

<hr>

<h2>How does it work?</h2>

<p>First, each data point is randomly assigned to one of the K clusters. Then, we compute the centroid (functionally the center) of each cluster, and reassign each data point to the cluster with the closest centroid. We repeat this process until the cluster assignments for each data point are no longer changing.</p>
...
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br><br>x = [4, 5, 10, 4, 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_k-means">Run example &raquo;</a>
</div>
<hr>

<p>Now we utilize the elbow method to visualize the intertia for different values of K:</p>
...
plt.show()</div>
<h3>Result</h3>
<p><img src="img_ml_k-means2.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_k-means2">Run example &raquo;</a>
</div>

<p>The elbow method shows that 2 is a good value for K, so we retrain and visualize the result:</p>
...
plt.show()</div>
<h3>Result</h3>
<p><img src="img_ml_k-means3.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_ml_k-means3">Run example &raquo;</a>
</div>
...
<p>Create arrays that resemble two variables in a dataset. Note that while we only use two variables here, this method will work with any number of variables:</p>
...
<p>In order to find the best value for K, we need to run K-means across our data for a range of possible values. We only have 10 data points, so the maximum number of clusters is 10. So for each value K in range(1,11), we train a K-means model and plot the intertia at that number of clusters:</p>
...
<p>We can see that the "elbow" on the graph above (where the interia becomes more linear) is at K=2. We can then fit our K-means algorithm one more time and plot the different clusters assigned to the data:</p>
