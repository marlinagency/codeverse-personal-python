...
<h1>Python <span class="color_h1">Recursion</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_lambda.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_generators.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Recursion</h2>
<p>Recursion is when a function calls itself.</p>
<p>Recursion is a common mathematical and programming concept.
  It means that a function calls itself.
  This has the benefit of meaning that you can loop through data to reach a result.</p>

<p>The developer should be very careful with recursion as it can be quite easy to slip into writing a function which never terminates,
  or one that uses excess amounts of memory or processor power.
  However, when written correctly recursion can be a very efficient and mathematically-elegant approach to programming.</p>

<div class="w3-example">
<h3>Example</h3>
<p>A simple recursive function that counts down from 5:</p>
<div class="w3-code notranslate pythonHigh">
def countdown(n):<br>&nbsp; if n <= 0:<br>&nbsp;&nbsp;&nbsp; print("Done!")<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; print(n)<br>&nbsp;&nbsp;&nbsp; countdown(n - 1)<br><br>
countdown(5)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_recursion_countdown">Try it Yourself &raquo;</a>
</div>
...
<ul>
  <li>A <strong>base case</strong> - A condition that stops the recursion</li>
  <li>A <strong>recursive case</strong> - The function calling itself with a modified argument</li>
</ul>

<p>Without a base case, the function would call itself forever, causing a stack overflow error.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Identifying base case and recursive case:</p>
<div class="w3-code notranslate pythonHigh">
def factorial(n):<br>&nbsp; # Base case<br>&nbsp; if n == 0 or n == 1:<br>&nbsp;&nbsp;&nbsp; return 1<br>&nbsp; # Recursive case<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; return n * factorial(n - 1)<br><br>
print(factorial(5))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_recursion_factorial">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The base case is crucial. Always make sure your recursive function has a condition that will eventually be met.</p>
</div>
...
<p>The Fibonacci sequence is a classic example where each number is the sum of the two preceding ones. The sequence starts with 0 and 1:</p>
<p>0, 1, 1, 2, 3, 5, 8, 13, ...</p>
<p>The sequence continues indefinitely, with each number being the sum of the two preceding ones.</p>
<p>We can use recursion to find a specific number in the sequence:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the 7th number in the Fibonacci sequence:</p>
<div class="w3-code notranslate pythonHigh">
def fibonacci(n):<br>&nbsp; if n <= 1:<br>&nbsp;&nbsp;&nbsp; return n<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; return fibonacci(n - 1) + fibonacci(n - 2)<br><br>
print(fibonacci(7))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_recursion_fibonacci">Try it Yourself &raquo;</a>
</div>
...
<hr>
<!--start-->
<h2>Recursion with Lists</h2>

<p>Recursion can be used to process lists by handling one element at a time:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Calculate the sum of all elements in a list:</p>
<div class="w3-code notranslate pythonHigh">
def sum_list(numbers):<br>&nbsp; if len(numbers) == 0:<br>&nbsp;&nbsp;&nbsp; return 0<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; return numbers[0] + sum_list(numbers[1:])<br><br>
my_list = [1, 2, 3, 4, 5]<br>
print(sum_list(my_list))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_recursion_list_sum">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find the maximum value in a list:</p>
<div class="w3-code notranslate pythonHigh">
def find_max(numbers):<br>&nbsp; if len(numbers) == 1:<br>&nbsp;&nbsp;&nbsp; return numbers[0]<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; max_of_rest = find_max(numbers[1:])<br>&nbsp;&nbsp;&nbsp; return numbers[0] if numbers[0] > max_of_rest else max_of_rest<br><br>
my_list = [3, 7, 2, 9, 1]<br>
print(find_max(my_list))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_recursion_list_max">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>Recursion Depth Limit</h2>

<p>Python has a limit on how deep recursion can go. The default limit is usually around 1000 recursive calls.</p>
...
<div class="w3-code notranslate pythonHigh">
import sys<br>
print(sys.getrecursionlimit())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_recursion_limit">Try it Yourself &raquo;</a>
</div>

<p>If you need deeper recursion, you can increase the limit, but be careful as this can cause crashes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
import sys<br>
sys.setrecursionlimit(2000)<br>
print(sys.getrecursionlimit())</div>
</div>

<div class="w3-panel ws-note">
  <p>Increasing the recursion limit should be done with caution. For very deep recursion, consider using iteration instead.</p>
</div>
