...
<h1>Python - Add List Items</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_lists_change.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lists_remove.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Append Items</h2>

<p>To add an item to the end of the list, use the <code class="w3-codespan"><a href="ref_list_append.asp">append()</a></code> 
method:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using the <code class="w3-codespan"><a href="ref_list_append.asp">append()</a></code> method to append an item:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
thislist.append("orange")<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_append">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>To insert a list item at a specified index, use the <code class="w3-codespan"><a href="ref_list_insert.asp">insert()</a></code> method.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_insert">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> As a result of the examples above, the lists will now contain 4 items.</p>
</div>
<!--stop-->
<hr>
...
<p>To append elements from <em>another list</em> to the current list, use the <code class="w3-codespan"><a href="ref_list_extend.asp">extend()</a></code> method.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Add the elements of <code class="w3-codespan">tropical</code> to <code class="w3-codespan">thislist</code>:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
tropical = [&quot;mango&quot;, &quot;pineapple&quot;, &quot;papaya&quot;]<br>
thislist.extend(tropical)<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_add_extend">Try it Yourself &raquo;</a>
</div>

<p>The elements will be added to the <em>end</em> of the list.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Add Any Iterable</h2>

<p>The <code class="w3-codespan"><a href="ref_list_extend.asp">extend()</a></code> method does not have to append
<em>lists</em>, you can add any iterable object (tuples, sets, dictionaries 
etc.).</p>

<div class="w3-example">
<h3>Example</h3>
<p>Add elements of a tuple to a list:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
  thistuple = (&quot;kiwi&quot;, &quot;orange&quot;)<br>
thislist.extend(thistuple)<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_list_add_extend_tuple">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_lists_add.js"></div>
<hr>
